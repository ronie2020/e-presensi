<div class="space-y-8 font-jakarta">
    ...
    <div class="pt-4 border-t border-slate-100">
        <form action="<?php echo e(route('teacher.habits.feedback', $habit->id)); ?>" method="POST" id="form-feedback-<?php echo e($habit->id); ?>" onsubmit="submitFeedbackAjax(event, this, <?php echo e($habit->id); ?>)" class="bg-slate-900 p-6 rounded-[2rem] shadow-xl relative overflow-hidden">
            <?php echo csrf_field(); ?>
