...
<div class="py-6 md:py-10 font-sans text-slate-800" x-data="bkStudentChatHandler(<?php echo e($session->id); ?>)">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            ...
            <div class="px-4 py-1.5 rounded-full bg-slate-100 border border-slate-200 text-xs font-mono font-bold text-slate-500 shadow-sm">
                ID TIKET: #<?php echo e(str_pad($session->id, 5, '0', STR_PAD_LEFT)); ?>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-[2rem] p-6 border border-slate-100 shadow-xl shadow-slate-200/50 relative overflow-hidden">
                    ...
                    <div class="flex items-center gap-4 mb-6">
                        ...
                        ?>
                        <div class="px-4 py-2 rounded-xl border <?php echo e($statusColor[$session->status]); ?> text-xs font-black uppercase tracking-wider shadow-sm">
                            <?php echo e($statusLabel[$session->status]); ?>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center justify-between text-xs font-bold p-3 bg-slate-50 rounded-xl border border-slate-100">
                            ...
                            <span class="text-slate-700 uppercase flex items-center gap-1">
                                <i class="ph-fill <?php echo e($session->method == 'online' ? 'ph-globe' : 'ph-users'); ?>"></i>
                                <?php echo e(strtoupper($session->method)); ?>

                            </span>
                        </div>
                        <div class="flex items-center justify-between text-xs font-bold p-3 bg-slate-50 rounded-xl border border-slate-100">
                            <span class="text-slate-400 uppercase tracking-tighter">Topik Utama</span>
                            <span class="text-slate-700 uppercase"><?php echo e($session->category->name ?? '-'); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-[2rem] p-6 border border-slate-100 shadow-lg">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="font-black text-slate-800 text-sm leading-tight"><?php echo e($session->teacher->name); ?></p>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <?php else: ?>
                    ...
                    <div class="bg-white rounded-[2.5rem] p-6 sm:p-8 border border-slate-100 shadow-xl shadow-slate-200/50 space-y-8">
                        ...
                        <?php if($session->status == 'approved' && $session->scheduled_at): ?>
                        <div class="p-6 bg-blue-50 rounded-3xl border border-blue-100 relative overflow-hidden">
                            ...
                            <p class="text-xl sm:text-2xl font-black text-slate-800 mb-1 relative z-10"><?php echo e($session->scheduled_at->translatedFormat('l, d F Y')); ?></p>
                            <p class="text-sm font-bold text-slate-500 relative z-10 flex items-center gap-1.5">
                                <i class="ph-fill ph-clock"></i> Pukul <?php echo e($session->scheduled_at->format('H:i')); ?> WIB <span class="mx-1">•</span> Ruang BK
                            </p>
                        </div>
                        <?php endif; ?>
