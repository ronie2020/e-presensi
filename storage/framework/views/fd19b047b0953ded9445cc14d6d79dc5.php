       ...
       <div class="animate-enter relative rounded-[2rem] md:rounded-[3rem] bg-gradient-to-br from-[#25D0FF] via-[#5295FF] to-[#FFC9B9] p-8 md:p-12 text-[#2A3B52] shadow-[0_10px_40px_-10px_rgba(37,208,255,0.4)] overflow-hidden group border border-white/40 no-print">
            ...
            <div class="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-10">
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-[#2A3B52]/80 text-sm md:text-lg max-w-xl leading-relaxed font-medium">
                        ...
                        <br><span class="text-[#2A3B52] font-black"><?php echo e(\Carbon\Carbon::parse($date)->locale('id')->isoFormat('dddd, D MMMM Y')); ?></span>
                    </p>
                </div>
                ...
                <div class="w-full lg:w-[450px] xl:w-[500px] shrink-0 flex flex-col gap-4">
                    ...
                    <?php if($selectedClass): ?>
                        <div class="flex items-center gap-2 mt-2">
                            ...
                            <a href="<?php echo e(route('admin.ramadan.exportPdf', ['class_id' => $selectedClass])); ?>" target="_blank" class="flex-1 py-3 bg-[#D13438] hover:bg-[#b02a2d] text-white rounded-xl font-bold shadow-sm flex flex-col items-center justify-center gap-1 transition-all active:scale-95 border border-transparent">
                                <i class="ph-bold ph-file-pdf text-xl"></i>
                                <span class="uppercase tracking-wider text-[9px]">Rekap Full PDF</span>
                            </a>
                            <a href="<?php echo e(route('admin.ramadan.exportExcel', ['class_id' => $selectedClass])); ?>" class="flex-1 py-3 bg-[#107C10] hover:bg-[#0c5e0c] text-white rounded-xl font-bold shadow-sm flex flex-col items-center justify-center gap-1 transition-all active:scale-95 border border-transparent">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-5 animate-enter no-print" style="animation-delay: 100ms">
            <div class="bg-white fluent-card p-6 rounded-[1.5rem] flex items-center gap-4 group hover:border-[#5295FF]">
                ...
                <div>
                    <div class="text-2xl font-black text-[#2A3B52] tracking-tight"><?php echo e($stats['total_students']); ?></div>
             ...
             <div class="bg-white fluent-card p-6 rounded-[1.5rem] flex items-center gap-4 group hover:border-[#107C10]">
                ...
                <div class="flex-1 w-full">
                    <div class="text-2xl font-black text-[#2A3B52] tracking-tight"><?php echo e($stats['fasting_count']); ?> <span class="text-xs text-[#107C10] font-bold">(<?php echo e($stats['percentage_fasting']); ?>%)</span></div>
                    <div class="text-[9px] uppercase font-bold text-slate-400 tracking-widest mb-1.5">Berpuasa</div>
                    <div class="w-full bg-slate-100 rounded-full h-1.5 overflow-hidden">
                        <div class="bg-[#107C10] h-1.5 rounded-full transition-all duration-1000" style="width: <?php echo e($stats['percentage_fasting']); ?>%"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white fluent-card p-6 rounded-[1.5rem] flex items-center gap-4 group hover:border-[#D83B01]">
                ...
                <div>
                    <div class="text-2xl font-black text-[#2A3B52] tracking-tight"><?php echo e($stats['prayer_complete_count']); ?></div>
  ...
  <?php if($isFriday): ?>
            <div class="bg-white fluent-card p-6 rounded-[1.5rem] flex items-center gap-4 group hover:border-[#5295FF] relative overflow-hidden">
                ...
                <div class="relative z-10">
                    <div class="text-2xl font-black text-[#2A3B52] tracking-tight"><?php echo e($stats['friday_log_count']); ?></div>
        ...
        <div class="animate-enter bg-white rounded-[2rem] fluent-card p-6 md:p-8 no-print" style="animation-delay: 150ms">
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                ...
                <div class="shrink-0 flex items-center gap-3">
                    ...
                    <a href="<?php echo e(route('admin.ramadan.leaderboard')); ?>" class="px-5 py-2 rounded-xl bg-[#2A3B52] hover:bg-[#182436] text-white text-xs font-bold uppercase tracking-wider transition-colors shadow-sm flex items-center gap-2">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                <?php $__currentLoopData = $topStudents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $topStudent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex items-center gap-4 p-5 rounded-[1.5rem] bg-white border border-slate-100 hover:border-[#5295FF] transition-all hover:-translate-y-1 hover:shadow-lg hover:shadow-[#5295FF]/10 fluent-card">
                        ...
                        <div class="flex-1 min-w-0">
                            <h4 class="font-bold text-[#2A3B52] text-sm truncate" title="<?php echo e($topStudent->name); ?>">
                    ...
                    <table class="w-full text-left print-table text-[#2A3B52]">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors group">
                                ...
                                <td class="px-6 py-4">
                                    <div class="font-bold text-[#2A3B52] text-sm group-hover:text-[#5295FF] transition-colors"><?php echo e($student->name); ?></div>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <?php if($log): ?>
                                        <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg text-xs font-bold border <?php echo e($prayerCount == 5 ? 'bg-[#DFF6DD] text-[#107C10] border-[#B7DFB9]' : 'bg-[#FFEFD6] text-[#D83B01] border-[#FFD8A8]'); ?>">
                                    ...
                                    <?php if($log && is_array($log->prayers)): ?>
                                        <div class="flex justify-center gap-1.5">
                                            <?php $__currentLoopData = ['subuh','dzuhur','ashar','maghrib','isya']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div title="<?php echo e(ucfirst($p)); ?>" class="w-2.5 h-2.5 rounded-full border border-white <?php echo e(($log->prayers[$p] ?? false) ? 'bg-[#5295FF]' : 'bg-slate-200'); ?>"></div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    <?php else: ?>
                                        -
                                ...
                                <td class="px-6 py-4 text-center bg-[#F3F9FD]/30">
                                    <?php if($log && $log->friday_khotib): ?>
                                        <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-md bg-[#F3F9FD] text-[#5295FF] text-[10px] font-bold border border-[#D0E7F8] shadow-sm" title="<?php echo e(Str::limit($log->friday_summary, 50)); ?>">
                                ...
                                <td class="px-6 py-4">
                                    <?php if($log && $log->tadarus_surah): ?>
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="text-xs font-bold text-[#2A3B52]"><?php echo e(Str::limit($log->tadarus_surah, 12)); ?> <span class="text-slate-400 font-normal ml-1">Ayat <?php echo e($log->tadarus_ayah); ?></span></span>
                                        </div>
                                    <?php else: ?>
                                ...
                                <td class="px-6 py-4 text-center bg-white border-l border-slate-100">
                                    <?php if($log): ?>
                                        <button type="button" 
                                            ...
                                            <?php echo e($log->teacher_verified_at ? 'bg-[#DFF6DD] text-[#107C10] border-[#B7DFB9] hover:bg-[#c2f0c1]' : 'bg-white border-slate-200 text-slate-500 hover:bg-[#5295FF] hover:text-white hover:border-[#5295FF]'); ?>">
                ...
                <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 px-2">
                    ...
                    <div class="flex items-center gap-2 bg-slate-50 p-1.5 rounded-xl border border-slate-200 shadow-sm">
                        <a href="<?php echo e(request()->fullUrlWithQuery(['status' => null, 'page' => 1])); ?>" 
                           class="px-4 py-2 rounded-lg text-xs font-bold uppercase tracking-wider transition-all <?php echo e(!request('status') ? 'bg-white text-[#5295FF] shadow-sm border border-slate-200' : 'text-slate-500 hover:text-[#2A3B52] hover:bg-slate-100'); ?>">
                            <i class="ph-bold ph-list-dashes"></i> Semua
                        </a>
                        <a href="<?php echo e(request()->fullUrlWithQuery(['status' => 'pending', 'page' => 1])); ?>" 
                           class="px-4 py-2 rounded-lg text-xs font-bold uppercase tracking-wider transition-all flex items-center gap-2 <?php echo e(request('status') == 'pending' ? 'bg-[#FFEFD6] text-[#D83B01] shadow-sm border border-[#FFD8A8]' : 'text-slate-500 hover:text-[#2A3B52] hover:bg-slate-100'); ?>">
                        ...
                        <div class="group bg-white rounded-[2rem] p-6 fluent-card hover:border-[#5295FF] transition-all duration-300 relative overflow-hidden">
                            ...
                            <div class="relative z-10">
                                ...
                                <div class="flex items-center gap-4 mb-6">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <h4 class="font-bold text-[#2A3B52] text-sm truncate group-hover:text-[#5295FF] transition-colors"><?php echo e($log->student->name); ?></h4>
                                ...
                                <div class="flex gap-2 mb-6">
                                    <div class="flex-1 py-3 px-1 rounded-xl bg-slate-50 border border-slate-100 text-center transition-colors group-hover:bg-white group-hover:shadow-sm">
                                        <i class="ph-fill ph-bowl-food text-xl <?php echo e($log->is_fasting ? 'text-[#107C10]' : 'text-[#D13438]'); ?> mb-1.5 block"></i>
                                        <span class="text-[9px] font-bold text-slate-500 uppercase tracking-wide">Puasa</span>
                                    </div>
                                    <div class="flex-1 py-3 px-1 rounded-xl bg-slate-50 border border-slate-100 text-center transition-colors group-hover:bg-white group-hover:shadow-sm">
                                        <div class="flex items-center justify-center gap-0.5 text-xl font-black <?php echo e($prayerCount == 5 ? 'text-[#107C10]' : 'text-[#D83B01]'); ?> mb-1.5">
                                    ...
                                    <div class="flex-1 py-3 px-1 rounded-xl bg-slate-50 border border-slate-100 text-center transition-colors group-hover:bg-white group-hover:shadow-sm">
                                        <i class="ph-fill ph-book-open-text text-xl <?php echo e($log->tadarus_surah ? 'text-[#5295FF]' : 'text-slate-300'); ?> mb-1.5 block"></i>
                ...
                <?php else: ?>
                    ...
                    <div class="text-center py-24 bg-white fluent-card rounded-[2.5rem]">
                        ...
                        <?php if(request('status') || request('search')): ?>
                            <a href="<?php echo e(route('admin.ramadan.reports')); ?>" class="inline-block mt-6 px-5 py-2.5 bg-slate-100 border border-slate-200 text-slate-600 rounded-lg text-xs font-bold uppercase tracking-wider hover:bg-slate-200 hover:text-[#2A3B52] transition-colors shadow-sm">Reset Filter</a>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
            </div>
...
$message = $__bag->first($__errorArgs[0]); ?>
                                    <p class="text-[#D13438] text-[10px] mt-1.5 font-bold"><?php echo e($message); ?></p>
                                <?php unset($message);
...
<?php endif; ?><?php /**PATH C:\Users\ronie\Documents\aplikasi terpadu\sistem_absensi_sekolah\resources\views/ramadan/admin_report.blade.php ENDPATH**/ ?>