                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
                    ...
                    <div class="flex gap-4">
                        <div class="bg-white/10 backdrop-blur-md px-6 py-5 rounded-2xl border border-white/10 min-w-[140px] text-center md:text-left hover:bg-white/15 transition-colors">
                            ...
                            <span class="block text-3xl font-black text-white tracking-tight"><?php echo e($years->count()); ?></span>
                        </div>
                    </div>
                            ...
                            <table class="w-full text-left text-sm text-slate-600">
                                ...
                                <tbody class="divide-y divide-slate-50">
                                    <?php $__currentLoopData = $years; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="group hover:bg-blue-50/30 transition-colors <?php echo e($year->is_active ? 'bg-blue-50/50' : ''); ?>">
                                            <td class="px-8 py-5">
                                                <div class="flex items-center gap-4">
                                                    <div class="w-12 h-12 rounded-2xl flex items-center justify-center text-xl shadow-sm <?php echo e($year->is_active ? 'bg-blue-100 text-blue-600 border border-blue-200' : 'bg-slate-100 text-slate-400 border border-slate-200'); ?>">
                                                        <i class="ph-duotone ph-calendar-blank"></i>
                                                    </div>
                                                    <div>
                                                        <p class="font-black text-slate-800 text-base mb-0.5"><?php echo e($year->name); ?></p>
                                                        <p class="text-xs font-bold text-slate-500 uppercase tracking-wide">Semester <?php echo e($year->semester); ?></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-6 py-5">
...
<?php endif; ?><?php /**PATH E:\drive aplikasi\aplikasi terpadu\sistem_absensi_sekolah versi 3.00\resources\views/settings/academic-year.blade.php ENDPATH**/ ?>