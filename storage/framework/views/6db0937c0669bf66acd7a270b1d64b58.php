        ...
        <div class="max-w-[95%] mx-auto px-2 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-6 no-print">
                ...
                <div class="animate-enter lg:col-span-3 bg-white rounded-[2rem] p-6 border border-slate-100 shadow-sm relative overflow-hidden flex items-center" style="animation-delay: 100ms">
                     <form action="<?php echo e(route('reports.classReport')); ?>" method="GET" class="w-full flex flex-col md:flex-row gap-4 items-end md:items-center" @submit="loading = true">
...
<?php endif; ?><?php /**PATH E:\drive aplikasi\aplikasi terpadu\sistem_absensi_sekolah versi 3.00\resources\views/reports/class_report.blade.php ENDPATH**/ ?>