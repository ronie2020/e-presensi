    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-gradient-to-br from-emerald-600 to-teal-700 rounded-[2.5rem] p-6 md:p-8 text-white shadow-xl shadow-teal-500/20 mb-8 relative overflow-hidden animate-in fade-in duration-700 slide-in-from-bottom-4 border border-emerald-400/30">
            ...
            <div class="relative z-10">
                ...
                <?php if(isset($topStudents) && $topStudents->isNotEmpty()): ?>
                <div class="bg-white/10 backdrop-blur-md rounded-3xl p-5 md:p-6 border border-white/10 mt-6">
                        ...
                        <?php $__currentLoopData = $topStudents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-white rounded-2xl p-4 flex items-center gap-4 text-slate-800 shadow-sm transform hover:-translate-y-1 transition-transform">
                                ...
                                <div class="w-12 h-12 rounded-full flex items-center justify-center font-black text-lg shadow-inner
                                    <?php echo e($index == 0 ? 'bg-gradient-to-br from-amber-200 to-amber-400 text-amber-800' : ($index == 1 ? 'bg-gradient-to-br from-slate-200 to-slate-400 text-slate-800' : 'bg-gradient-to-br from-orange-200 to-orange-400 text-orange-800')); ?>">
                                    #<?php echo e($index + 1); ?>

                                </div>
                                
                                <div class="flex-1 overflow-hidden">
                                    <h5 class="font-bold text-sm truncate capitalize"><?php echo e(strtolower($student->name)); ?></h5>
                                    <p class="text-xs text-slate-500 font-medium mt-0.5">
                                        <i class="ph-fill ph-star text-amber-400"></i> <?php echo e($student->ramadan_points ?? 0); ?> Pts
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="mt-6 flex justify-center md:justify-end">
                        <a href="<?php echo e(route('portal.show', Auth::guard('student')->id() ?? 0)); ?>?tab=ramadan_rank" class="inline-flex items-center gap-2 bg-white text-emerald-700 font-bold px-6 py-2.5 rounded-xl text-sm hover:bg-emerald-50 hover:shadow-lg transition-all">
                            ...
                            <div class="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100">
                                ...
                                <div class="space-y-4">
                                    <div class="space-y-2">
                                        ...
                                        <input type="text" name="kultum_penceramah" value="<?php echo e($todayRamadanLog->kultum_penceramah ?? ''); ?>" class="w-full bg-slate-50 border-none rounded-xl text-sm font-bold focus:ring-purple-500 text-slate-700" placeholder="Nama Penceramah...">
                                    </div>
                                    <div class="space-y-2">
                                        <label class="text-[10px] font-bold text-slate-400 uppercase tracking-widest ml-1">Ringkasan Materi</label>
                                        <textarea name="kultum_summary" rows="4" class="w-full bg-slate-50 border-none rounded-xl text-sm font-medium focus:ring-purple-500 text-slate-600 resize-none" placeholder="Apa isi ceramahnya?"><?php echo e($todayRamadanLog->kultum_summary ?? ''); ?></textarea>
                                    </div>
                                </div>
                            </div>
        ...
        <?php endif; ?> <!-- End Check !isRamadanEnded -->
    </div>
</div>
