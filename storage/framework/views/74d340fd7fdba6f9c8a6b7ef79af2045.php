...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-slate-800 leading-tight">
            <?php echo e(__('Buat Jadwal Ujian')); ?>
    ...
    <div class="py-8 sm:py-10 font-sans text-slate-800">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="relative rounded-[2rem] bg-gray-900 bg-gradient-to-br from-slate-900 via-blue-900 to-cyan-900 p-8 mb-8 text-white shadow-xl shadow-blue-900/30 overflow-hidden border border-white/10">
                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div>
                        ...
                        <p class="text-blue-200 text-sm font-medium">Atur detail pelaksanaan ujian, metode, durasi, dan kelas target.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
                ...
                <div class="p-8">
                    ...
                    <form action="<?php echo e(route('cbt.store')); ?>" method="POST" class="space-y-8" 
                          x-data="{ 
                              startTime: '<?php echo e(old('start_time')); ?>', 
                              endTime: '<?php echo e(old('end_time')); ?>',
                              examType: '<?php echo e(old('exam_type', 'cbt')); ?>' 
                          }">
                        <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <label class="relative cursor-pointer group">
                                    ...
                                    <div class="p-5 rounded-2xl border-2 transition-all peer-checked:border-blue-500 peer-checked:bg-cyan-50/50 bg-white border-slate-200 hover:border-blue-200">
                                        <div class="flex items-center gap-4 relative z-10">
                                            <div class="w-12 h-12 rounded-xl bg-blue-100 text-blue-600 flex items-center justify-center text-2xl shrink-0 transition-transform peer-checked:scale-110">
                                        ...
                                        <div class="absolute top-5 right-5 w-5 h-5 rounded-full border-2 border-slate-200 flex items-center justify-center peer-checked:border-blue-500 peer-checked:bg-blue-500 text-transparent peer-checked:text-white transition-all">
                        ...
                        <div x-show="examType === 'google_form'" 
                            ...
                            <div class="relative">
                                ...
                                <input type="url" name="google_form_url" value="<?php echo e(old('google_form_url')); ?>" :required="examType === 'google_form'" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative flex items-center">
                                ...
                                <select name="cbt_event_id" required class="w-full pl-12 rounded-2xl border-blue-200 bg-blue-50/50 focus:bg-white focus:border-blue-500 focus:ring-blue-500 font-bold text-slate-800 py-3.5 px-5 appearance-none cursor-pointer transition-all <?php $__errorArgs = ['cbt_event_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>">
                                    <option value="" disabled <?php echo e(!old('cbt_event_id') && !isset($selectedEventId) ? 'selected' : ''); ?>>-- Pilih Folder Kegiatan --</option>
                                    <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($evt->id); ?>" <?php echo e((old('cbt_event_id') ?? ($selectedEventId ?? '')) == $evt->id ? 'selected' : ''); ?>>
                                            <?php echo e($evt->name); ?>

                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <div class="absolute inset-y-0 right-5 flex items-center pointer-events-none text-blue-500">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="title" value="<?php echo e(old('title')); ?>" required 
                                   class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-blue-500 focus:ring-blue-500 font-bold text-slate-700 py-3.5 px-5 transition-all placeholder:font-normal placeholder:text-slate-400 <?php $__errorArgs = ['title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <select name="subject_name" required class="w-full pl-11 rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-blue-500 focus:ring-blue-500 font-bold text-slate-700 py-3.5 px-5 appearance-none cursor-pointer transition-all <?php $__errorArgs = ['subject_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="start_time" x-model="startTime" value="<?php echo e(old('start_time')); ?>" required 
                                       class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-blue-500 focus:ring-blue-500 font-bold text-slate-700 py-3.5 px-5 transition-all <?php $__errorArgs = ['start_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="end_time" x-model="endTime" value="<?php echo e(old('end_time')); ?>" required 
                                       class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-blue-500 focus:ring-blue-500 font-bold text-slate-700 py-3.5 px-5 transition-all <?php $__errorArgs = ['end_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-6">
                            ...
                            <div class="col-span-1">
                                ...
                                <div class="relative">
                                    <input type="number" name="duration_minutes" value="<?php echo e(old('duration_minutes', 90)); ?>" required class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-blue-500 focus:ring-blue-500 font-bold text-slate-700 py-3.5 px-5 transition-all text-center">
                            ...
                            <div class="col-span-1" x-show="examType === 'cbt'">
                                ...
                                <div class="relative">
                                    <input type="number" name="question_limit" value="<?php echo e(old('question_limit', 0)); ?>" class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-blue-500 focus:ring-blue-500 font-bold text-slate-700 py-3.5 px-5 transition-all text-center" placeholder="0 = Semua">
                            ...
                            <div class="col-span-1" x-show="examType === 'cbt'">
                                ...
                                <input type="number" name="passing_grade" value="<?php echo e(old('passing_grade', 75)); ?>" class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-blue-500 focus:ring-blue-500 font-bold text-slate-700 py-3.5 px-5 transition-all text-center">
                            </div>
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            ...
                                            <label class="flex items-start gap-4 p-4 bg-white rounded-xl border border-rose-100 cursor-pointer hover:border-rose-300 transition-colors group">
                                                <div class="relative flex items-center mt-1">
                                                    <input type="checkbox" name="randomize_questions" value="1" <?php echo e(old('randomize_questions') ? 'checked' : ''); ?> class="peer sr-only">
                                            ...
                                            <label class="flex items-start gap-4 p-4 bg-white rounded-xl border border-rose-100 cursor-pointer hover:border-rose-300 transition-colors group">
                                                <div class="relative flex items-center mt-1">
                                                    <input type="checkbox" name="randomize_options" value="1" <?php echo e(old('randomize_options') ? 'checked' : ''); ?> class="peer sr-only">
                                                    <div class="w-10 h-6 bg-slate-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-rose-500"></div>
                                                </div>
                                                <div>
                             ...
                             <div class="col-span-2 md:col-span-1">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="token" value="<?php echo e(old('token')); ?>" maxlength="6" class="w-full pl-11 rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-blue-500 focus:ring-blue-500 font-mono font-black text-slate-800 py-3.5 px-5 transition-all uppercase tracking-widest placeholder:tracking-normal <?php $__errorArgs = ['token'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="AUTO">
                                </div>
                                <p class="text-[10px] text-slate-400 mt-1 ml-1 font-medium">*Kosongkan untuk generate otomatis</p>
                            </div>
                        </div>

                        <div class="flex items-center gap-3 p-4 bg-cyan-50 rounded-2xl border border-cyan-100">
                            <div class="relative flex items-center">
                                <input type="checkbox" name="is_active" value="1" <?php echo e(old('is_active', 1) ? 'checked' : ''); ?> id="active" class="peer sr-only">
...
<?php endif; ?><?php /**PATH E:\aplikasi terpadu\sistem_absensi_sekolah\resources\views/cbt/create.blade.php ENDPATH**/ ?>