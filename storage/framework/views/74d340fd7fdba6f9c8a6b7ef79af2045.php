                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <label class="relative cursor-pointer group">
                                    ...
                                    <div class="p-5 rounded-2xl border-2 transition-all peer-checked:border-blue-500 peer-checked:bg-blue-50/50 bg-white border-slate-200 hover:border-blue-200">
