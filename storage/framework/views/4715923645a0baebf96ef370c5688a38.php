                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="hover:bg-slate-50/80 transition-colors group">
                                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                                <input type="checkbox" value="<?php echo e($student->id); ?>" class="student-checkbox rounded border-slate-300 text-elevate-primary focus:ring-elevate-primary cursor-pointer">
                                            </td>
                                                ...
                                                <div class="flex items-center gap-4">
                                                    <div class="relative shrink-0">
                                                        <div class="w-12 h-12 rounded-2xl overflow-hidden shadow-sm border border-slate-100 bg-white flex items-center justify-center group-hover:border-elevate-accent/50 transition-colors">
                                                            ...
                                                            <?php else: ?>
                                                                <div class="font-black text-sm <?php echo e($student->gender == 'L' ? 'text-elevate-primary' : 'text-pink-500'); ?>"><?php echo e(substr($student->name, 0, 2)); ?></div>
                                                            <?php endif; ?>
                                                        </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="flex items-center gap-2 mt-1">
                                                            ...
                                                            <span class="text-[10px] font-bold <?php echo e($student->gender == 'L' ? 'text-elevate-primary' : 'text-pink-500'); ?>"><?php echo e($student->gender); ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right">
                                                <div class="flex items-center justify-end gap-1">
                                                    <a href="<?php echo e(route('students.show', $student->id)); ?>" target="_blank" class="w-9 h-9 rounded-xl bg-white border border-slate-200 text-slate-400 hover:text-elevate-primary hover:border-elevate-primary/30 hover:bg-elevate-accent/10 flex items-center justify-center transition-all shadow-sm" title="Cetak Buku Induk">
                                                        <i class="ph-bold ph-printer text-lg"></i>
                                                    </a>

                                                    <a href="<?php echo e(route('students.card', $student->id)); ?>" target="_blank" class="w-9 h-9 rounded-xl bg-white border border-slate-200 text-slate-400 hover:text-elevate-primary hover:border-elevate-primary/30 hover:bg-elevate-accent/10 flex items-center justify-center transition-all shadow-sm" title="Cetak Kartu OSIS">
        ...
        <div class="relative top-20 mx-auto p-0 border-0 w-full max-w-md shadow-2xl rounded-[2rem] bg-white overflow-hidden">
            ...
            <form id="absen-manual-form" action="<?php echo e(route('reports.storeManual')); ?>" method="POST" class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="date" value="<?php echo e(date('Y-m-d')); ?>" class="datepicker w-full rounded-xl border-slate-200 bg-slate-50 focus:ring-elevate-primary focus:border-elevate-primary font-bold text-elevate-dark" placeholder="dd/mm/yyyy">
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="time" name="time_in" value="<?php echo e(now()->format('H:i')); ?>" class="w-full rounded-xl border-slate-200 bg-slate-50 focus:ring-elevate-primary focus:border-elevate-primary text-center font-mono font-bold text-elevate-dark">
                    </div>
                    <div>
