    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm flex items-center gap-5 group hover:border-amber-100 transition-all">
            ...
            <div>
                ...
                <p class="text-3xl font-black text-slate-800 tracking-tight"><?php echo e($complaints->where('status', 'pending')->count() + $complaints->where('status', 'investigating')->count()); ?></p>
            </div>
        </div>
...
</div><?php /**PATH E:\drive aplikasi\aplikasi terpadu\sistem_absensi_sekolah versi 3.00\resources\views/students/portal/partials/tab-pengaduan.blade.php ENDPATH**/ ?>