...
<head>
    ...
    <script>
        window.examData = { 
            ...
            examType: '<?php echo e($exam->exam_type ?? 'cbt'); ?>', // PERBAIKAN: Deteksi tipe ujian di frontend
            ...
            return {
                ...
                initData() {
                    try {
                        ...
                        // Mapping jawaban dari server (Khusus CBT internal)
                ...
                initSecurity() {
                    ...
                    window.addEventListener("blur", () => {
                        this.blurTimeout = setTimeout(() => { 
                            // Pastikan klik di dalam iFrame (Google Form) tidak memicu pelanggaran
                ...
                finishExam() {
                    ...
                    // Teks peringatan yang berbeda untuk Google Form
                    let htmlContent = "";
                    if (this.examType === 'google_form') {
