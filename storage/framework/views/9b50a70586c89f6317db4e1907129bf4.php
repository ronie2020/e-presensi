    ...
    <div class="no-print fixed top-0 left-0 right-0 bg-slate-900 text-white shadow-lg p-4 flex justify-between items-center z-50">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-xs text-slate-300">Siap mencetak <?php echo e(count($registrants)); ?> surat sekaligus.</p>
            </div>
        </div>
...
</html><?php /**PATH E:\aplikasi terpadu\sistem_absensi_sekolah\resources\views\admin\ppdb\print_mass_letters.blade.php ENDPATH**/ ?>