...
<?php $component->withAttributes([]); ?>
    <div class="py-8 sm:py-10 font-sans text-slate-800">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <a href="<?php echo e(route('sppd.index')); ?>" class="inline-flex items-center gap-2 text-sm font-bold text-slate-500 hover:text-blue-600 mb-6 transition-colors">
                ...
                <div class="p-8">
                    ...
                    <form action="<?php echo e(route('sppd.store')); ?>" method="POST" class="space-y-8">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pl-8">
                                <div>
                                    ...
                                    <input type="text" name="nomor_sppd" value="<?php echo e($nomor_otomatis); ?>" class="w-full px-4 rounded-2xl border-slate-200 bg-slate-50 text-slate-500 font-mono font-bold text-sm py-3" readonly>
                                </div>
                                <div>
                        ...
                        <div class="flex items-center justify-end gap-4 pt-8 mt-4 border-t border-slate-100">
                            <a href="<?php echo e(route('sppd.index')); ?>" class="px-6 py-3 rounded-xl text-slate-500 font-bold text-sm hover:bg-slate-50 hover:text-slate-700 transition-colors">Batal</a>
