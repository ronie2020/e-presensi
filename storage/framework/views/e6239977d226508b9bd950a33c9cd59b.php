<?php $__env->startSection('content'); ?>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 pb-20 pt-24">
            ...
            <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div>
                    ...
                    <p class="text-blue-100/90 text-sm max-w-xl leading-relaxed">
                        Lihat jadwal belajarmu di kelas <span class="font-bold text-white"><?php echo e(Auth::guard('student')->user()->schoolClass->name ?? '-'); ?></span>.
                    </p>
                </div>
                ...
                <div class="bg-white/10 backdrop-blur-md px-5 py-3 rounded-2xl border border-white/20 flex items-center gap-3 shrink-0">
                    <div class="text-right">
                        ...
                        <p class="text-xl font-black"><?php echo e(\Carbon\Carbon::now()->translatedFormat('l, d M Y')); ?></p>
                    </div>
        ...
        <div x-data="{ activeDay: '<?php echo e($defaultTab); ?>' }" class="space-y-6">
                                            ...
                                            <div class="relative z-10">
                                                ...
                                                <div class="flex flex-wrap items-center gap-4 mt-4">
                                                    ...
                                                    <div class="flex items-center gap-1.5 text-slate-400 text-xs font-bold">
                                                        ...
                                                        R. Kelas <?php echo e(Auth::guard('student')->user()->schoolClass->name ?? '-'); ?>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ronie\Documents\aplikasi terpadu\sistem_absensi_sekolah\resources\views/students/schedule/index.blade.php ENDPATH**/ ?>