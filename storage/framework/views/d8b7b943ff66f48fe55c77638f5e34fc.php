...
<head>
    ...
    <title>Arsip Prestasi - <?php echo e(config('app.name', 'SMP Negeri 3 Lakbok')); ?></title>
...
<body class="antialiased text-slate-800 bg-slate-50 flex flex-col min-h-screen font-[Plus_Jakarta_Sans]">
    ...
    <footer class="bg-white border-t border-slate-200 py-10 mt-auto">
        <div class="max-w-7xl mx-auto px-4 text-center">
             <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo" class="h-12 w-auto mx-auto mb-4 opacity-80 grayscale hover:grayscale-0 transition-all">
            <p class="text-slate-500 text-sm font-medium">&copy; <?php echo e(date('Y')); ?> SMP Negeri 3 Lakbok. Unggul & Berkarakter.</p>
        </div>
    </footer>

</body>
</html><?php /**PATH E:\aplikasi terpadu\sistem_absensi_sekolah\resources\views\achievements.blade.php ENDPATH**/ ?>