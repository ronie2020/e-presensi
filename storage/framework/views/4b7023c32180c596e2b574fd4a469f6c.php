...
<body class="bg-slate-50 font-sans text-slate-800">
    ...
    <div class="bg-gray-900 bg-gradient-to-b from-blue-900 to-slate-900 pt-16 pb-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div class="absolute top-6 left-6 z-20">
            <?php if(Auth::guard('student')->check()): ?>
                ...
                <a href="<?php echo e(route('portal.show', Auth::guard('student')->id())); ?>?tab=perpustakaan" class="text-blue-200 hover:text-white flex items-center gap-2 text-sm font-bold transition-colors bg-white/10 hover:bg-white/20 px-4 py-2 rounded-full backdrop-blur-sm border border-white/10">
                    <i class="ph-bold ph-arrow-left"></i> Kembali ke Portal
                </a>
            <?php else: ?>
                
                <a href="<?php echo e(url('/')); ?>" class="text-blue-200 hover:text-white flex items-center gap-2 text-sm font-bold transition-colors">
        ...
        <div class="max-w-7xl mx-auto relative z-10 text-center mt-8">
            <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-500/20 border border-blue-400/30 text-blue-200 text-xs font-bold uppercase tracking-widest mb-6 backdrop-blur-md">
                <i class="ph-fill ph-student"></i> Perpustakaan Digital
            </div>
            <h1 class="text-4xl md:text-5xl font-black tracking-tight text-white mb-4 leading-tight">
                Jelajahi Dunia Lewat <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300">Buku</span>
            </h1>
            <p class="text-blue-100/80 text-lg font-medium max-w-2xl mx-auto">
            ...
            <div class="mt-10 max-w-3xl mx-auto">
                <form method="GET" class="relative group">
                    ...
                    <div class="relative flex bg-white rounded-2xl shadow-2xl overflow-hidden p-1.5">
                        ...
                        <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-8 rounded-xl font-bold transition-colors shadow-lg shadow-blue-600/20">
                            Cari
                        </button>
                    </div>
                </form>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 relative z-20 pb-20">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <?php $__empty_1 = true; $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="group bg-white rounded-[2rem] border border-slate-100 hover:border-blue-300 hover:shadow-2xl hover:shadow-blue-900/10 transition-all duration-300 flex flex-col h-full overflow-hidden relative transform hover:-translate-y-1">
                        ...
                        <div class="mt-auto pt-4 border-t border-slate-50">
                            <?php if($book->ebook_path): ?>
                                ...
                                <a href="<?php echo e(route('library.books.read', $book->id)); ?>" 
                                   class="w-full py-3 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 transition-all flex items-center justify-center gap-2 group/btn transform active:scale-95">
