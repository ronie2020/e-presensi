                            ...
                            <tr class="hover:bg-slate-50/80 transition-colors group">
                                <td class="px-6 py-5 align-top">
                                    ...
                                    <div class="text-xs text-slate-500 font-medium flex items-center gap-1.5 mt-1">
                                        <i class="ph-bold ph-calendar-blank"></i> <?php echo e(\Carbon\Carbon::parse($letter->tgl_surat)->format('d M Y')); ?>
...
<?php endif; ?><?php /**PATH E:\drive aplikasi\aplikasi terpadu\sistem_absensi_sekolah versi 3.00\resources\views/letters/outgoing/index.blade.php ENDPATH**/ ?>