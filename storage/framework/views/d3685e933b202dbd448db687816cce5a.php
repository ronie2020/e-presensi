<div class="space-y-8 animate-in fade-in duration-500 font-sans">
            ...
            <div class="flex flex-col items-center <?php echo e(!isset($topRamadanStudents[1]) ? 'invisible' : ''); ?>">
                ...
                <div class="relative group">
                    <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-full border-4 border-slate-300 p-1 bg-white shadow-xl relative z-10 group-hover:scale-105 transition-transform duration-300">
                        <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($topRamadanStudents[1]->name)); ?>&background=e5eff5&color=2c3f61&bold=true" class="w-full h-full object-cover rounded-full">
                ...
                <div class="bg-white/80 backdrop-blur-sm p-3 rounded-2xl shadow-sm border border-slate-200 mt-4 w-full text-center relative hover:border-elevate-accent/30 transition-colors">
                    ...
                    <p class="text-[10px] font-black text-elevate-dark line-clamp-1 capitalize"><?php echo e(strtolower(strtok($topRamadanStudents[1]->name, ' '))); ?></p>
                    <p class="text-[9px] font-bold text-slate-500"><?php echo e(number_format($topRamadanStudents[1]->ramadan_points)); ?> Pts</p>
                </div>
                <?php endif; ?>
            </div>
            ...
            <div class="flex flex-col items-center -mt-8 relative z-20">
                ...
                <div class="relative group">
                    ...
                    <div class="w-20 h-20 sm:w-24 sm:h-24 rounded-full border-4 border-elevate-peach p-1 bg-gradient-to-b from-elevate-peach-light/50 to-white shadow-2xl relative z-10 ring-4 ring-elevate-peach/20 group-hover:scale-105 transition-transform duration-300">
                        <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($topRamadanStudents[0]->name)); ?>&background=f9a282&color=ffffff&bold=true" class="w-full h-full object-cover rounded-full">
                ...
                <div class="bg-gradient-to-b from-white to-elevate-peach-light/20 p-4 rounded-3xl shadow-lg border border-elevate-peach/30 mt-5 w-full text-center relative min-w-[120px]">
                    <p class="text-xs font-black text-elevate-dark line-clamp-1 capitalize mb-0.5"><?php echo e(strtolower(strtok($topRamadanStudents[0]->name, ' '))); ?></p>
            ...
            <div class="flex flex-col items-center <?php echo e(!isset($topRamadanStudents[2]) ? 'invisible' : ''); ?>">
                ...
                <div class="relative group">
                    <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-full border-4 border-orange-700/40 p-1 bg-white shadow-xl relative z-10 group-hover:scale-105 transition-transform duration-300">
                        <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($topRamadanStudents[2]->name)); ?>&background=c86845&color=ffffff&bold=true" class="w-full h-full object-cover rounded-full">
                ...
                <div class="bg-white/80 backdrop-blur-sm p-3 rounded-2xl shadow-sm border border-slate-200 mt-4 w-full text-center relative hover:border-elevate-accent/30 transition-colors">
                    ...
                    <p class="text-[10px] font-black text-elevate-dark line-clamp-1 capitalize"><?php echo e(strtolower(strtok($topRamadanStudents[2]->name, ' '))); ?></p>
                    <p class="text-[9px] font-bold text-slate-500"><?php echo e(number_format($topRamadanStudents[2]->ramadan_points)); ?> Pts</p>
                </div>
                <?php endif; ?>
            </div>                   
        </div>
    ...
    <div class="px-2">
        <div class="flex items-center gap-3 mb-4 px-2">
            ...
            <a href="<?php echo e(route('ramadan.leaderboard')); ?>" class="px-4 py-1.5 rounded-xl bg-elevate-dark hover:bg-elevate-primary text-white text-[10px] font-black uppercase tracking-wider transition-colors shadow-md flex items-center gap-1">
        ...
        <div class="space-y-3">
            ...
            <div class="flex items-center gap-4 p-4 rounded-2xl border transition-all duration-300
                ...
                <div class="flex-shrink-0 w-8 text-center">
                    <span class="text-sm font-black <?php echo e($isMe ? 'text-elevate-accent' : 'text-slate-400'); ?>">#<?php echo e($index + 4); ?></span>
                </div>

                
                <div class="relative">
                    <div class="w-12 h-12 rounded-full overflow-hidden border-2 <?php echo e($isMe ? 'border-white' : 'border-elevate-soft'); ?>">
                        <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($s->name)); ?>&size=100&background=<?php echo e($isMe ? 'ffffff' : 'e5eff5'); ?>&color=<?php echo e($isMe ? '0d52a1' : '2c3f61'); ?>" class="w-full h-full object-cover">
                    </div>
                </div>
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-[10px] font-bold uppercase tracking-wide <?php echo e($isMe ? 'text-white/80' : 'text-slate-400'); ?>">
                ...
                <div class="text-right">
                    <div class="text-base font-black <?php echo e($isMe ? 'text-white' : 'text-elevate-primary'); ?>">
                        <?php echo e(number_format($s->ramadan_points, 0, ',', '.')); ?>

                    </div>
                    <div class="text-[9px] font-bold uppercase <?php echo e($isMe ? 'text-elevate-accent' : 'text-slate-400'); ?>">Poin</div>
                </div>
            </div>
    ...
    <?php endif; ?>
</div><?php /**PATH C:\Users\ronie\Documents\aplikasi terpadu\sistem_absensi_sekolah\resources\views/students/portal/partials/tab-ramadan-leaderboard.blade.php ENDPATH**/ ?>