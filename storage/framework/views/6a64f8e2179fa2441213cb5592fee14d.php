            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                ...
                <div class="bg-white rounded-[2rem] shadow-xl shadow-blue-900/5 border border-slate-100 overflow-hidden relative group transition-all duration-300 flex flex-col h-full hover:border-blue-200">
                    ...
                    <div class="p-8 flex flex-col h-full">
                        ...
                        <div class="bg-slate-100 p-1.5 rounded-xl flex mb-6 relative gap-1 overflow-x-auto custom-scrollbar">
                            ...
                            <button @click="inputMode = 'leger'; importMode = true" 
                                    :class="inputMode === 'leger' ? 'bg-white text-blue-700 shadow-sm' : 'text-slate-500 hover:text-slate-700'"
                                ...
                                <i class="ph-bold ph-microsoft-excel-logo text-emerald-600"></i> Leger Kelas
                            </button>
                        </div>
                        ...
                        <div x-show="inputMode === 'leger'" x-transition style="display: none;">
                            ...
                            <form action="<?php echo e(route('grades.template_leger')); ?>" method="GET" class="mb-4">
                                <div class="bg-emerald-50/50 border border-emerald-100 rounded-2xl p-4 flex gap-4 items-center">
                                ...
                                <div class="flex gap-2 mt-3">
                                    <select name="class_id" class="flex-1 rounded-xl border-slate-200 text-xs font-bold" required>
                                        <option value="">- Pilih Kelas -</option>
                                        <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($c->id); ?>"><?php echo e($c->name); ?></option> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <button type="submit" class="px-4 py-2 bg-slate-800 text-white text-xs font-bold rounded-xl hover:bg-slate-700 transition whitespace-nowrap">
                            ...
                            <form action="<?php echo e(route('grades.import_leger')); ?>" method="POST" enctype="multipart/form-data" class="flex-1 flex flex-col gap-4">
                                <?php echo csrf_field(); ?>
                                <div class="space-y-3">
                                    <div class="grid grid-cols-2 gap-3">
                                        <select name="academic_year" class="w-full rounded-xl border-slate-200 text-xs font-bold bg-white" required>
                                            <option value="">- Tahun Ajaran -</option>
                                            <?php $__currentLoopData = $years; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($y->name); ?>" <?php echo e(($activeYear && $activeYear->name == $y->name) ? 'selected' : ''); ?>><?php echo e($y->name); ?></option> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <select name="semester" class="w-full rounded-xl border-slate-200 text-xs font-bold bg-white" required>
...
<?php endif; ?><?php /**PATH E:\drive aplikasi\aplikasi terpadu\sistem_absensi_sekolah versi 3.00\resources\views/grades/index.blade.php ENDPATH**/ ?>