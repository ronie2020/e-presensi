            ...
            <?php $__empty_1 = true; $__currentLoopData = $literacy_journals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $journal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="relative z-10 flex flex-col sm:flex-row gap-6 group animate-in slide-in-from-bottom-4 duration-700" style="animation-delay: <?php echo e($loop->index * 100); ?>ms">
                    ...
                    <div class="flex-grow min-w-0 bg-white p-6 rounded-[2.5rem] rounded-tl-none sm:rounded-tl-[2.5rem] shadow-sm border border-slate-100 group-hover:shadow-md group-hover:border-elevate-primary/20 transition-all">
                        ...
                        <?php if($journal->status === 'rejected'): ?>
                            <div class="mb-4 p-3 bg-rose-50 border border-rose-100 rounded-xl flex items-start gap-2">
                                ...
                                <div>
                                    ...
                                    <p class="text-[10px] text-rose-600 mt-0.5"><?php echo e($journal->rejection_reason ?? 'Silakan periksa kembali laporan bacaanmu.'); ?></p>
                                </div>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="flex flex-col sm:flex-row justify-between items-start gap-2 mb-3">
                            <div>
                                ...
                                <p class="text-xs text-slate-400 font-bold mt-0.5 flex items-center gap-2">
                                    <span><i class="ph-bold ph-pen-nib text-elevate-accent"></i> <?php echo e($journal->author ?? 'Tanpa Penulis'); ?></span>
                                    <span class="text-yellow-400 tracking-widest text-[10px]">
                                        <?php for($i=1; $i<=5; $i++): ?>
                                            <?php if($i <= ($journal->rating ?? 0)): ?> ★ <?php else: ?> ☆ <?php endif; ?>
                                        <?php endfor; ?>
                                    </span>
                                </p>
                            </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
                            <?php if($journal->favorite_character): ?>
                                <div class="bg-slate-50 p-3 rounded-xl border border-slate-100">
                                    <p class="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1">Tokoh Favorit</p>
                                    <p class="text-xs font-medium text-slate-700 break-all"><?php echo e($journal->favorite_character); ?></p>
                                </div>
                            <?php endif; ?>
                            <?php if($journal->new_vocabulary): ?>
                                <div class="bg-slate-50 p-3 rounded-xl border border-slate-100">
                                    <p class="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1">Kosakata Baru</p>
                                    <p class="text-xs font-medium text-slate-700 break-all"><?php echo e($journal->new_vocabulary); ?></p>
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="flex items-center justify-between pt-2 border-t border-slate-50">
                            ...
                            <?php elseif($journal->status === 'rejected'): ?>
                                <div class="flex items-center gap-2">
...
</div><?php /**PATH C:\Users\ronie\Documents\aplikasi terpadu\sistem_absensi_sekolah\resources\views/students/portal/partials/tab-literasi-mandiri.blade.php ENDPATH**/ ?>