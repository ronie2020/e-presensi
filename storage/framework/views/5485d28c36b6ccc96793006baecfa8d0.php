                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
                    ...
                    <div class="flex gap-4">
                        <div class="bg-white/60 backdrop-blur-md px-6 py-5 rounded-2xl border border-white/80 min-w-[140px] text-center md:text-left hover:bg-white transition-colors shadow-sm">
                            ...
                            <span class="block text-3xl font-black text-elevate-dark tracking-tight"><?php echo e($events->count()); ?></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden sticky top-6 group/form hover:shadow-2xl hover:shadow-elevate-accent/10 transition-all duration-300">
                        ...
                        <div class="p-8">
                            <form action="<?php echo e(route('admin.academic-calendar.store')); ?>" method="POST" class="space-y-5">
                                <?php echo csrf_field(); ?>
                                <div>
                    ...
                    <div class="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 overflow-hidden flex flex-col h-full min-h-[600px]">
                        ...
                        <div class="p-6 md:p-8 space-y-4 overflow-y-auto custom-scrollbar flex-1 bg-slate-50/30">
                            <?php $__empty_1 = true; $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                ?>
                                <div class="bg-elevate-gradient-card p-6 rounded-[2rem] shadow-sm border <?php echo e($isPast ? 'border-slate-100 opacity-60' : 'border-slate-200 hover:shadow-xl hover:shadow-elevate-accent/10 hover:border-elevate-accent/50'); ?> flex flex-col sm:flex-row gap-5 items-start sm:items-center justify-between group transition-all duration-300">
                                    <div class="flex items-start gap-5">
                                        <div class="w-14 h-14 rounded-2xl flex items-center justify-center text-3xl shrink-0 <?php echo e($iconColor); ?> border shadow-sm">
                                            <i class="ph-duotone <?php echo e($icon); ?>"></i>
                                        </div>
                                        <div>
                                            <div class="flex items-center gap-2 mb-1.5">
                                                <span class="text-[10px] font-black uppercase tracking-wider px-2.5 py-1 rounded-lg border <?php echo e($badgeColor); ?> shadow-sm">
                                            ...
                                            <h4 class="font-black text-elevate-dark text-lg leading-tight mb-1.5 group-hover:text-elevate-primary transition-colors"><?php echo e($event->title); ?></h4>
                                    ...
                                    <div class="flex items-center gap-2 mt-4 sm:mt-0 w-full sm:w-auto border-t sm:border-0 border-slate-100 pt-4 sm:pt-0 justify-end opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity">
                                        ...
                                        <form action="<?php echo e(route('admin.academic-calendar.destroy', $event->id)); ?>" method="POST" id="delete-form-<?php echo e($event->id); ?>">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
                                            <button type="button" onclick="confirmDelete('<?php echo e($event->id); ?>', '<?php echo e(addslashes($event->title)); ?>')" 
...
<?php endif; ?><?php /**PATH C:\Users\ronie\Documents\aplikasi terpadu\sistem_absensi_sekolah\resources\views/admin/academic-calendar/index.blade.php ENDPATH**/ ?>