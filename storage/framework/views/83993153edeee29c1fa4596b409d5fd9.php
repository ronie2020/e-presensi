...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- 2. DATA PROFIL GURU -->
                        <!-- Pengecekan isTeacher menggunakan Spatie hasAnyRole -->
                        <div x-data="{ isTeacher: <?php echo e($user->hasAnyRole(['Guru', 'Wali Kelas', 'Guru Mata Pelajaran']) ? 'true' : 'false'); ?> }">
                        ...
                        <div x-data="{ showPassword: false }">
                         ...
                         <!-- 5. KELOLA PORTOFOLIO GURU (KHUSUS ADMIN/KEPSEK/GURU) -->
