                    ...
                    <div class="bg-white rounded-[2rem] p-6 shadow-xl shadow-slate-200/60 border border-slate-100 relative overflow-hidden">
                        ...
                        <div class="space-y-4 relative z-10">
                            <div class="flex justify-between items-center p-3 bg-slate-50 rounded-xl">
                                ...
                                <span class="font-bold text-slate-700 font-mono"><?php echo e($session->student->nis ?? '-'); ?> / <?php echo e($session->student->nisn ?? '-'); ?></span>
                            </div>
                            
                            <?php if($session->student->parent_wa_number ?? false): ?>
                                <a href="https://wa.me/<?php echo e(preg_replace('/^0/', '62', $session->student->parent_wa_number)); ?>" target="_blank" class="flex items-center justify-center gap-2 w-full py-3 bg-emerald-50 text-emerald-600 font-bold rounded-xl border border-emerald-100 hover:bg-emerald-100 transition-colors">
                                ...
                                <div class="mt-4 space-y-2">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="font-bold text-slate-800"><?php echo e($session->scheduled_at ? $session->scheduled_at->translatedFormat('l, d F Y - H:i') : '-'); ?> WIB</div>
                                        </div>
                                    </div>
                                    <div class="flex items-start gap-3 pt-2">
                                        ...
                                        <div>
                                            ...
                                            <div class="font-medium text-slate-600 text-sm italic">"<?php echo e($session->response_message); ?>"</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
