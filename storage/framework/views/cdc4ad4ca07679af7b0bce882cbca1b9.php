                             ...
                             <li class="relative">
                                <a href="<?php echo e(isset($item['route']) ? route($item['route']) : '#'); ?>" 
                                   ...
                                   :class="sidebarExpanded ? 'px-3 justify-start' : 'justify-center px-0 w-full'">
                                    ...
                                    <div class="absolute left-0 top-0 bottom-0 w-1 rounded-r-full transition-all duration-300 <?php echo e($isActive ? 'bg-elevate-accent' : 'bg-transparent'); ?>"></div>

                                    <!-- Icon -->
                                    <i class="ph-duotone <?php echo e($item['icon'] ?? 'ph-circle'); ?> shrink-0 transition-all duration-200 relative z-10
                                              <?php echo e($isActive ? 'text-elevate-accent' : 'text-slate-400 group-hover:text-elevate-accent'); ?>"
