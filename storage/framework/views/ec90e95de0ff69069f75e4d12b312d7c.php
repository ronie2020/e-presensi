    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-4 mb-20">
            ...
            <div class="bg-white/5 dark:bg-slate-800/40 backdrop-blur-md border border-white/10 dark:border-slate-700/50 rounded-[2rem] p-6 text-center hover:bg-white/10 dark:hover:bg-slate-800/60 transition-all duration-300 group shadow-lg" data-aos="fade-up" data-aos-delay="200">
                <p class="text-4xl font-black text-elevate-peach mb-2 group-hover:scale-110 transition-transform"><?php echo e($alumniStats['smk'] ?? 0); ?></p>
        ...
        <?php if(isset($alumniTestimonials) && count($alumniTestimonials) > 0): ?>
            <div class="flex overflow-x-auto gap-6 pb-12 snap-x snap-mandatory hide-scrollbar custom-scrollbar md:grid md:grid-cols-3 md:overflow-visible">
                <?php $__currentLoopData = $alumniTestimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="snap-center shrink-0 w-[85vw] md:w-auto flex flex-col h-full" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                        ...
                        <div class="bg-white/5 dark:bg-slate-800/40 backdrop-blur-xl border border-white/10 dark:border-slate-700/50 p-8 md:p-10 rounded-[2.5rem] shadow-xl shadow-black/20 hover:bg-white/10 dark:hover:bg-slate-800/60 hover:-translate-y-2 hover:border-white/20 dark:hover:border-slate-600 transition-all duration-300 relative overflow-hidden group flex-1 flex flex-col">
                            ...
                            <div class="relative z-10 h-full flex flex-col">
                                <div class="flex items-center gap-4 mb-6">
                                    ...
                                    <div>
                                        <h4 class="font-black text-white text-base leading-tight line-clamp-1"><?php echo e($testi->student->name ?? 'Alumni'); ?></h4>
                                        <p class="text-[10px] text-elevate-primary dark:text-elevate-accent font-black uppercase tracking-widest mt-0.5 transition-colors">
                                            ...
                                            <?php if($testi->campus_name || $testi->company_name): ?>
                                                <span class="text-white/60 font-bold">@ <?php echo e(Str::limit($testi->campus_name ?? $testi->company_name, 20)); ?></span>
                                            <?php endif; ?>
                                        </p>
                                    </div>
                                </div>
            ...
            <div class="mt-14 text-center" data-aos="fade-up">
                <a href="<?php echo e(route('public.testimonials')); ?>" class="inline-flex items-center justify-center px-8 py-3.5 text-xs font-black uppercase tracking-widest text-elevate-dark dark:text-white bg-white dark:bg-elevate-primary border border-transparent rounded-full hover:bg-elevate-soft dark:hover:bg-elevate-dark transition-all shadow-xl shadow-white/10 dark:shadow-elevate-primary/20 group">
...
</div><?php /**PATH E:\drive aplikasi\aplikasi terpadu\sistem_absensi_sekolah versi 3.00\resources\views/landing/alumni.blade.php ENDPATH**/ ?>