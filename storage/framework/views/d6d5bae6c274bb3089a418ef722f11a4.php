...
<head>
    <meta charset="utf-8">
    <title>Ujian CBT - <?php echo e($exam->title); ?></title>
    <style>
        body {
...
<body>
    ...
    <div class="header-box">
        ...
        <h3><?php echo e(strtoupper($exam->title)); ?></h3>
        <table class="meta">
            <tr>
                <td width="15%">Mata Pelajaran</td><td width="2%">:</td><td><?php echo e($exam->subject_name); ?></td>
                <td width="15%">Kelas</td><td width="2%">:</td><td><?php echo e($exam->class_level); ?></td>
            </tr>
            <tr>
                <td>Waktu / Durasi</td><td>:</td><td><?php echo e(\Carbon\Carbon::parse($exam->start_time)->format('d M Y')); ?> (<?php echo e($exam->duration_minutes); ?> Menit)</td>
                <td>Total Soal</td><td>:</td><td><?php echo e($exam->questions->count()); ?></td>
            </tr>
        </table>
    </div>
...
</html><?php /**PATH C:\Users\ronie\Documents\aplikasi terpadu\sistem_absensi_sekolah\resources\views/cbt/export_word.blade.php ENDPATH**/ ?>