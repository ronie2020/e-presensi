    ...
    <div class="bg-elevate-gradient-main pt-16 pb-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden border-b border-white/60">
        ...
        <div class="absolute top-6 left-6 z-20">
            <?php if(Auth::guard('student')->check()): ?>
                ...
                <a href="<?php echo e(route('portal.show', Auth::guard('student')->id())); ?>?tab=perpustakaan" class="text-elevate-primary hover:text-elevate-dark flex items-center gap-2 text-sm font-bold transition-colors bg-white/50 hover:bg-white/80 px-4 py-2 rounded-full backdrop-blur-sm border border-white/60 shadow-sm">
                    <i class="ph-bold ph-arrow-left"></i> Kembali ke Portal
                </a>
            <?php else: ?>
                
                <a href="<?php echo e(url('/')); ?>" class="text-elevate-primary hover:text-elevate-dark flex items-center gap-2 text-sm font-bold transition-colors bg-white/50 hover:bg-white/80 px-4 py-2 rounded-full backdrop-blur-sm border border-white/60 shadow-sm">
