...
<div class="py-6 md:py-10 font-sans text-slate-800">
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            <a href="<?php echo e(route('student.bk.index')); ?>" class="group inline-flex items-center text-sm text-slate-500 hover:text-blue-600 font-bold transition-colors">
            ...
            <div class="px-3 py-1 rounded-full bg-slate-100 border border-slate-200 text-xs font-mono font-bold text-slate-500">
                TIKET ID: #<?php echo e($session->id); ?>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-[2rem] p-6 border border-slate-100 shadow-xl shadow-slate-200/50 relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        ...
                        ?>
                        <span class="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-black border <?php echo e($statusColor); ?>">
                            <i class="ph-fill <?php echo e($statusIcon); ?>"></i> <?php echo e($statusText); ?>
                        ...
                        <div class="mt-8 space-y-5">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-bold text-slate-700"><?php echo e($session->created_at->translatedFormat('d F Y, H:i')); ?></p>
                                </div>
                            </div>
                            <div class="flex items-center gap-4">
                                <div class="w-10 h-10 rounded-xl bg-slate-50 flex items-center justify-center text-slate-400 border border-slate-100">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-bold text-slate-700"><?php echo e($session->method == 'online' ? 'Online (Daring)' : 'Tatap Muka'); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        <div>
                            <label class="text-xs font-bold text-slate-400 uppercase tracking-widest">
                                <?php echo e(($session->is_system_generated ?? false) ? 'Pemberitahuan dari Sekolah' : 'Keluhan / Pesan Kamu'); ?>
                            ...
                            <?php if($session->is_system_generated ?? false): ?>
                                ...
                                ?>
                                <div class="mt-3 p-6 <?php echo e($sysBg); ?> rounded-2xl border <?php echo e($sysBorder); ?> <?php echo e($sysText); ?> font-medium leading-relaxed relative">
                                    <i class="ph-fill <?php echo e($sysIcon); ?> text-4xl <?php echo e($sysIconColor); ?> absolute -top-3 -left-2"></i>
                                    <span class="relative z-10 whitespace-pre-line"><?php echo e($session->initial_message); ?></span>
                                </div>
                            <?php else: ?>
                                <div class="mt-3 p-6 bg-slate-50 rounded-2xl border border-slate-100 text-slate-700 leading-relaxed italic relative">
                                    ...
                                    <span class="relative z-10">"<?php echo e($session->initial_message); ?>"</span>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-[2rem] p-8 border-l-4 border-blue-500 shadow-xl shadow-slate-200/50 relative">
                        ...
                        <div class="flex flex-col sm:flex-row items-start gap-5 mb-6 p-5 bg-blue-50/50 rounded-2xl border border-blue-100">
                            ...
                            <div>
                                ...
                                <p class="text-xl font-black text-slate-800"><?php echo e($session->scheduled_at->translatedFormat('l, d F Y')); ?></p>
                                <p class="text-base font-bold text-slate-600">Pukul <?php echo e($session->scheduled_at->format('H:i')); ?> WIB</p>
                                <div class="flex items-center gap-2 mt-2 pt-2 border-t border-blue-100/50">
                                    <i class="ph-bold ph-user-circle text-blue-400"></i>
                                    <p class="text-xs text-slate-500 font-bold">Konselor: <?php echo e($session->teacher->name ?? 'Guru BK'); ?></p>
                                </div>
                            </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <!-- Pesan Balasan -->
                        <?php if($session->response_message): ?>
                            <div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\aplikasi terpadu\sistem_absensi_sekolah\resources\views\students\bk\show.blade.php ENDPATH**/ ?>