        ...
        <div class="id-card items-center justify-center">
            ...
            <div class="z-10 flex flex-col items-center w-full px-6 flex-1 justify-center mt-6">
                ...
                <div class="text-center mb-4 w-full px-1">
                    <p class="text-[9px] font-black text-slate-900 uppercase leading-tight"><?php echo e(\Illuminate\Support\Str::limit($student->name, 22)); ?></p>
                    <p class="text-[7px] font-bold text-slate-600 font-mono tracking-wide mt-0.5"><?php echo e($student->student_id); ?></p>
                </div>
