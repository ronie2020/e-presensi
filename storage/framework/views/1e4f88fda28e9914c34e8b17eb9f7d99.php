...
<head>
    ...
    <style>
        ...
        .id-card-wrapper {
            /* Container untuk sepasang kartu (Depan + Belakang) agar tidak terpisah saat baris baru */
            display: flex;
            gap: 2mm; /* Jarak antara Depan dan Belakang */
            margin-bottom: 5mm;
        ...
        .id-card {
            ...
            /* float, margin dihapus karena sudah dihandle oleh flex parent */
        ...
        @media print {
            ...
            .page-container { width: 100%; margin: 0; box-shadow: none; padding: 5mm; }
            /* Memaksa Page Break jika penuh */
            .id-card-wrapper { break-inside: avoid; }
        }
    </style>
</head>
                ...
                <div class="z-10 flex flex-col items-center w-full px-6 flex-1 justify-center mt-6">
                    ...
                    <div class="w-full">
                        ...
                        <ul class="text-[6px] text-slate-800 font-bold list-disc pl-4 space-y-1 text-justify leading-relaxed">
                            ...
                            <li>Hilangnya kartu harap lapor petugas.</li>
                        </ul>
                    </div>
                </div>
...
</html><?php /**PATH E:\aplikasi terpadu\sistem_absensi_sekolah\resources\views/library/tools/print-card.blade.php ENDPATH**/ ?>