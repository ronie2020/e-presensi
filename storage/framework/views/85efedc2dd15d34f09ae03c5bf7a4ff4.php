...
<?php $component->withAttributes([]); ?>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-1 lg:grid-cols-2 gap-4">
                            <div class="bg-white/10 backdrop-blur-md px-5 py-5 rounded-2xl border border-white/20 hover:bg-white/15 transition-all hover:scale-105 duration-300">
                                <div class="flex flex-col items-start gap-1 text-blue-300">
                                    ...
                                    <span class="text-3xl font-black text-shimmer count-up" data-target="<?php echo e($totalBooks); ?>">0</span>
                                </div>
                            </div>
                            <div class="bg-orange-500/20 backdrop-blur-md px-5 py-5 rounded-2xl border border-orange-400/30 hover:bg-orange-500/30 transition-all hover:scale-105 duration-300">
                                <div class="flex flex-col items-start gap-1 text-orange-300">
                                    ...
                                    <span class="text-3xl font-black text-shimmer count-up" data-target="<?php echo e($todayVisits); ?>">0</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="animate-enter delay-100 bg-white p-6 sm:p-8 rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 relative overflow-hidden">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <a href="<?php echo e(route('library.circulation.index')); ?>" class="group flex flex-col items-center justify-center p-4 bg-blue-50/50 hover:bg-blue-600 border border-blue-100 hover:border-blue-500 rounded-[2rem] transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                            ...
                            <a href="<?php echo e(route('library.books.create')); ?>" class="group flex flex-col items-center justify-center p-4 bg-emerald-50/50 hover:bg-emerald-600 border border-emerald-100 hover:border-emerald-500 rounded-[2rem] transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                            ...
                            <a href="<?php echo e(route('library.kiosk.index')); ?>" target="_blank" class="group flex flex-col items-center justify-center p-4 bg-orange-50/50 hover:bg-orange-600 border border-orange-100 hover:border-orange-500 rounded-[2rem] transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-enter delay-100">
                        <div class="bg-gradient-to-br from-indigo-600 to-violet-600 rounded-[2rem] p-6 text-white shadow-xl shadow-indigo-600/20 relative overflow-hidden">
                            <div class="relative z-10">
                                ...
                                <h2 class="text-4xl font-black mb-1"><?php echo e($ebookReadsThisMonth ?? 0); ?></h2>
                            ...
                            <div class="divide-y divide-slate-50">
                                <?php $__empty_1 = true; $__currentLoopData = $recentActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="p-4 hover:bg-slate-50 transition-colors flex gap-3 items-start">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <p class="text-xs font-bold text-slate-800 truncate"><?php echo e($activity->student->name); ?></p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const loanLabels = <?php echo json_encode($loanChartLabels ?? [], 15, 512) ?>;
            const loanData = <?php echo json_encode($loanChartData ?? [], 15, 512) ?>;
