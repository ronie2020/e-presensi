        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <?php if($assignments->count() > 0): ?>
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <?php $__currentLoopData = $assignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="animate-enter group relative bg-white rounded-[2rem] shadow-xl shadow-slate-200/40 border border-slate-100 hover:shadow-elevate-accent/10 transition-all duration-300 flex flex-col h-full hover:-translate-y-1 <?php echo e($theme['ring']); ?> overflow-hidden" style="animation-delay: <?php echo e(($index + 1) * 100); ?>ms">
                            ...
                            <div class="bg-white p-6 md:p-8 h-full flex flex-col relative overflow-hidden">
                                ...
                                <div class="mb-5 relative z-10">
                                    <h3 class="font-black text-xl text-elevate-dark group-hover:text-elevate-primary transition-colors line-clamp-1" title="<?php echo e($task->title); ?>">
                                        <?php echo e($task->title); ?>

                                    </h3>
                                    <p class="text-sm font-bold text-slate-400 mt-1"><?php echo e($task->subject->name); ?></p>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-4 mb-6 relative z-10">
                                    ...
                                    <div class="bg-elevate-soft/50 p-4 rounded-xl border border-slate-100">
                                        ...
                                        <div class="text-xs font-black <?php echo e($isExpired ? 'text-[#D13438]' : 'text-elevate-dark'); ?> flex items-center gap-1.5">
                                ...
                                <div class="mb-6 relative z-10">
                                    <div class="flex justify-between text-xs font-bold text-slate-500 mb-2">
                                        ...
                                        <span class="text-elevate-primary"><?php echo e($task->is_bulk ? $task->global_submissions_count : $task->submissions_count); ?> Siswa</span>
                                    </div>
                                ...
                                <div class="pt-5 border-t border-slate-100 mt-auto flex items-center justify-between gap-2 relative z-10">
                                    ...
                                    <a href="<?php echo e(route('lms.assignments.submissions', $task->id)); ?>" class="flex-1 bg-elevate-dark hover:bg-elevate-primary text-white px-3 py-3 rounded-2xl font-bold text-sm transition-all shadow-md flex items-center justify-center gap-2 group/btn border border-transparent active:scale-95" title="Periksa Jawaban Siswa">
                                        <i class="ph-bold ph-list-checks text-lg text-elevate-accent"></i>
                                        <span class="hidden sm:inline">Periksa</span>
                                    </a>

                                    
                                    <a href="<?php echo e(route('lms.preview.player', ['subject' => $task->subject_id, 'class' => $task->class_id])); ?>" target="_blank" class="w-12 h-12 shrink-0 rounded-2xl bg-slate-50 text-slate-500 hover:bg-elevate-primary hover:text-white transition-all flex items-center justify-center border border-slate-200 shadow-sm active:scale-95" title="Preview Tampilan Siswa">
                                        <i class="ph-bold ph-presentation-chart text-xl"></i>
                                    </a>

                                    
                                    <a href="<?php echo e(route('lms.assignments.edit', $task->id)); ?>" class="w-12 h-12 shrink-0 rounded-2xl bg-white border border-[#FFD8A8] text-[#D83B01] hover:bg-[#FFEFD6] transition-all flex items-center justify-center shadow-sm active:scale-95" title="Edit Latihan">
                                        <i class="ph-bold ph-pencil-simple text-xl"></i>
                                    </a>

                                    
                                    <form action="<?php echo e(route('lms.assignments.destroy', $task->id)); ?>" method="POST" class="form-delete-task shrink-0">
            ...
            <?php else: ?>
                ...
                <div class="animate-enter bg-white rounded-[2.5rem] border-2 border-dashed border-slate-200 p-16 flex flex-col items-center justify-center text-center group hover:border-elevate-primary transition-colors" style="animation-delay: 200ms">
                    ...
                    <a href="<?php echo e(route('lms.assignments.create')); ?>" class="px-8 py-4 bg-elevate-dark text-white font-bold rounded-2xl hover:bg-elevate-primary transition-colors shadow-lg shadow-elevate-dark/30 transform flex items-center gap-2 active:scale-95 border border-transparent">
...
<?php endif; ?><?php /**PATH E:\aplikasi terpadu\sistem_absensi_sekolah\resources\views/lms/assignments/index.blade.php ENDPATH**/ ?>