                        ...
                        <div class="animate-enter group relative bg-white rounded-[2rem] shadow-xl shadow-slate-200/40 border border-slate-100 hover:shadow-elevate-accent/10 transition-all duration-300 flex flex-col h-full hover:-translate-y-1 <?php echo e($theme['ring']); ?> overflow-hidden" style="animation-delay: <?php echo e(($index + 1) * 100); ?>ms">
                            ...
                            <div class="bg-white p-6 md:p-8 h-full flex flex-col relative overflow-hidden">
                                ...
                                <div class="pt-5 border-t border-slate-100 mt-auto flex items-center justify-between gap-3 relative z-10">
                                    ...
                                    <a href="<?php echo e(route('lms.assignments.submissions', $task->id)); ?>" class="flex-1 bg-elevate-dark hover:bg-elevate-primary text-white px-5 py-3 rounded-2xl font-bold text-sm transition-all shadow-md flex items-center justify-center gap-2 group/btn border border-transparent active:scale-95">
                                        <i class="ph-bold ph-list-checks text-lg text-elevate-accent"></i>
                                        <span>Periksa Jawaban</span>
                                    </a>

                                    
                                    <a href="<?php echo e(route('lms.assignments.edit', $task->id)); ?>" class="w-12 h-12 rounded-2xl bg-white border border-[#FFD8A8] text-[#D83B01] hover:bg-[#FFEFD6] transition-all flex items-center justify-center shadow-sm active:scale-95" title="Edit Tugas">
