...
<?php $component->withAttributes([]); ?>
    ...
    <div x-data="{ 
        ...
        <div class="animate-enter mb-8 no-print" style="animation-delay: 50ms">
                ...
                <div class="bg-orange-50 rounded-[2rem] border border-orange-100 p-6 relative overflow-hidden">
                    ...
                    <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative z-10">
                        <div>
                            ...
                            <p class="text-sm text-orange-600/80">Terdapat <span class="font-bold"><?php echo e($countOut); ?> siswa</span> yang belum kembali ke kelas saat ini.</p>
                        </div>
                        
                        <a href="<?php echo e(route('permit.index')); ?>" class="px-5 py-2.5 bg-white text-orange-600 text-sm font-bold rounded-xl shadow-sm border border-orange-100 hover:bg-orange-100 transition-colors flex items-center gap-2">
                    ...
                    <div class="mt-6 flex gap-3 overflow-x-auto pb-2 custom-scrollbar">
                        <?php $__currentLoopData = $studentsOut; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <div class="flex-shrink-0 w-64 bg-white p-3 rounded-xl border <?php echo e($isOverdue ? 'border-rose-200 bg-rose-50/50' : 'border-orange-100'); ?> shadow-sm flex items-center gap-3">
                                <div class="w-10 h-10 rounded-full <?php echo e($isOverdue ? 'bg-rose-100 text-rose-600' : 'bg-orange-100 text-orange-600'); ?> flex items-center justify-center font-bold text-sm">
            ...
            <?php else: ?>
                ...
                <div class="bg-emerald-50 rounded-[2rem] border border-emerald-100 p-6 relative overflow-hidden flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('permit.index')); ?>" class="px-5 py-2.5 bg-white text-emerald-600 text-sm font-bold rounded-xl shadow-sm border border-emerald-100 hover:bg-emerald-100 transition-colors hidden md:flex items-center gap-2">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 mb-8 no-print animate-enter quick-actions" style="animation-delay: 100ms">
            ...
            <a href="<?php echo e(route('students.index')); ?>" @click.prevent="navigate('<?php echo e(route('students.index')); ?>')" class="group bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex flex-col items-center justify-center gap-2 hover:shadow-md transition-all hover:border-cyan-300 cursor-pointer text-center">
            ...
            <a href="<?php echo e(route('letters.spt.index')); ?>" @click.prevent="navigate('<?php echo e(route('letters.spt.index')); ?>')" class="group bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex flex-col items-center justify-center gap-2 hover:shadow-md transition-all hover:border-cyan-300 cursor-pointer text-center">
                <div class="w-12 h-12 rounded-xl bg-cyan-50 text-cyan-600 flex items-center justify-center group-hover:scale-110 transition-transform shadow-sm">
            ...
            <a href="<?php echo e(route('teaching.index')); ?>" @click.prevent="navigate('<?php echo e(route('teaching.index')); ?>')" class="group bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex flex-col items-center justify-center gap-2 hover:shadow-md transition-all hover:border-cyan-300 cursor-pointer text-center">
                <div class="w-12 h-12 rounded-xl bg-cyan-50 text-cyan-600 flex items-center justify-center group-hover:scale-110 transition-transform shadow-sm">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            <div class="animate-enter bg-white p-5 md:p-8 rounded-[2rem] shadow-sm border border-slate-100 flex flex-col h-full card-print" style="animation-delay: 700ms">
                ...
                <div class="grid grid-cols-2 gap-3 mt-auto">
                    <div class="bg-cyan-50/50 p-3 rounded-xl border border-cyan-100"><span class="block text-[10px] font-bold text-cyan-600 uppercase mb-1">Hadir Tepat</span><span class="text-lg font-black text-slate-800"><?php echo e($presentOnTimeCount ?? 0); ?></span></div>
                            ...
                            <div class="relative group">
                                ...
                                <div class="flex items-start justify-between gap-3 p-3 rounded-2xl hover:bg-slate-50 transition-colors -mt-2 -ml-2">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="text-sm font-bold text-slate-800 line-clamp-1 group-hover:text-cyan-700 transition-colors"><?php echo e($log->student->name ?? 'Siswa'); ?></p>
                                ...
                                <tr class="group hover:bg-slate-50 transition-colors">
                                    ...
                                    <td class="py-4">
                                        ...
                                        <div class="w-full bg-slate-100 rounded-full h-1.5 overflow-hidden max-w-[150px]">
                                            ...
                                            <div class="h-1.5 rounded-full <?php echo e($index == 0 ? 'bg-yellow-400' : 'bg-cyan-500'); ?>" style="width: <?php echo e($percent); ?>%"></div>
                                        </div>
                                    </td>
