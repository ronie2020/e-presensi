<div class="space-y-6 font-sans text-slate-800">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 md:p-8 rounded-[2rem] shadow-xl shadow-slate-200/40 border border-slate-100 relative overflow-hidden">
        ...
        <a href="<?php echo e(route('student.bk.create')); ?>" class="relative z-10 inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white text-sm font-bold rounded-xl transition-all shadow-lg shadow-blue-500/30 group hover:-translate-y-1">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div class="bg-white p-5 rounded-2xl border border-blue-100 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
            ...
            <p class="text-3xl font-black text-slate-800"><?php echo e($bkSessions->where('status', 'approved')->count()); ?></p>
        </div>
        <div class="bg-white p-5 rounded-2xl border border-amber-100 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
            ...
            <p class="text-3xl font-black text-slate-800"><?php echo e($bkSessions->where('status', 'pending')->count()); ?></p>
        </div>
        <div class="bg-white p-5 rounded-2xl border border-emerald-100 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
            ...
            <p class="text-3xl font-black text-slate-800"><?php echo e($bkSessions->where('status', 'finished')->count()); ?></p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-[2rem] shadow-xl shadow-slate-200/60 border border-slate-100 overflow-hidden">
        <div class="px-6 py-5 border-b border-slate-100 bg-slate-50/50 flex justify-between items-center">
            ...
            <a href="<?php echo e(route('student.bk.index')); ?>" class="text-xs font-bold text-blue-600 hover:text-blue-700 hover:underline">
                Lihat Semua
            </a>
        </div>
                        ...
                        <tr class="hover:bg-blue-50/30 transition-colors group">
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="font-bold text-slate-800 text-sm group-hover:text-blue-600 transition-colors"><?php echo e($session->category->name); ?></p>
                                        <p class="text-xs text-slate-400 mt-0.5 truncate max-w-[150px]"><?php echo e($session->initial_message); ?></p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex flex-col">
                                    ...
                                    <?php if($session->scheduled_at): ?>
                                        <span class="text-xs text-blue-600 font-bold mt-0.5 flex items-center gap-1">
                                            <i class="ph-bold ph-clock"></i> <?php echo e($session->scheduled_at->format('H:i')); ?>
                            ...
                            <td class="px-6 py-4">
                                ...
                                ?>
                                <span class="px-2.5 py-1 rounded-lg text-[10px] font-black uppercase tracking-wide border <?php echo e($statusStyle); ?>">
                                    <?php echo e($statusLabel); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4 text-center">
                                <a href="<?php echo e(route('student.bk.show', $session->id)); ?>" class="inline-flex items-center justify-center w-8 h-8 rounded-xl bg-slate-100 text-slate-400 hover:bg-blue-600 hover:text-white hover:shadow-lg hover:shadow-blue-500/30 transition-all duration-300">
        ...
        <?php else: ?>
            <div class="text-center py-16 px-4">
                ...
                <a href="<?php echo e(route('student.bk.create')); ?>" class="inline-flex items-center justify-center px-6 py-3 bg-white border border-slate-200 text-slate-700 font-bold rounded-xl text-sm hover:border-blue-500 hover:text-blue-600 hover:shadow-md transition-all">
                    Mulai Konsultasi
                </a>
            </div>
        <?php endif; ?>
    </div>
</div><?php /**PATH E:\aplikasi terpadu\sistem_absensi_sekolah\resources\views\students\portal\partials\tab-bk.blade.php ENDPATH**/ ?>