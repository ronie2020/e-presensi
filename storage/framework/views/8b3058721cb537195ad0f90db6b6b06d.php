                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    ...
                    <div class="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden relative">
                        ...
                        <form action="<?php echo e(route('schedules.regular.store')); ?>" method="POST" class="p-6 sm:p-8 space-y-8">
                            ...
                            <div class="bg-slate-50/80 p-5 sm:p-6 rounded-[2rem] border border-slate-200 relative group hover:border-blue-200 transition-colors">
                                ...
                                <!-- PERUBAHAN DI SINI: grid-cols-1 untuk HP, sm:grid-cols-2 untuk Desktop -->
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-4">
                                    <div>
                                        <label class="block text-[10px] uppercase font-bold text-slate-400 mb-2 sm:text-center">Masuk</label>
                                        <div class="flex gap-2 sm:gap-1.5">
                                            <div class="w-full">
                                                <input type="time" name="start_in[]" value="<?php echo e(optional($regularSchedules->get('Biasa'))->start_in ? \Carbon\Carbon::parse($regularSchedules->get('Biasa')->start_in)->format('H:i') : ''); ?>" class="w-full rounded-xl border-slate-200 text-xs font-bold text-center bg-white py-2.5 px-1 shadow-sm focus:ring-blue-500" title="Jam Buka Scanner Masuk">
                                                <p class="text-[9px] text-slate-400 text-center mt-1">Buka Scan</p>
                                            </div>
                                            <div class="w-full">
                                                <input type="time" name="end_in[]" value="<?php echo e(optional($regularSchedules->get('Biasa'))->end_in ? \Carbon\Carbon::parse($regularSchedules->get('Biasa')->end_in)->format('H:i') : ''); ?>" class="w-full rounded-xl border-slate-200 text-xs font-bold text-center bg-white py-2.5 px-1 shadow-sm focus:ring-blue-500" title="Batas Terlambat">
                                                <p class="text-[9px] text-slate-400 text-center mt-1">Batas Telat</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                        <label class="block text-[10px] uppercase font-bold text-slate-400 mb-2 mt-2 sm:mt-0 sm:text-center">Pulang</label>
                                        <div class="flex gap-2 sm:gap-1.5">
                                            <div class="w-full">
                                                <input type="time" name="start_out[]" value="<?php echo e(optional($regularSchedules->get('Biasa'))->start_out ? \Carbon\Carbon::parse($regularSchedules->get('Biasa')->start_out)->format('H:i') : ''); ?>" class="w-full rounded-xl border-slate-200 text-xs font-bold text-center bg-white py-2.5 px-1 shadow-sm focus:ring-blue-500" title="Jam Boleh Pulang">
                                                <p class="text-[9px] text-slate-400 text-center mt-1">Boleh Plg</p>
                                            </div>
                                            <div class="w-full">
                                                <input type="time" name="end_out[]" value="<?php echo e(optional($regularSchedules->get('Biasa'))->end_out ? \Carbon\Carbon::parse($regularSchedules->get('Biasa')->end_out)->format('H:i') : ''); ?>" class="w-full rounded-xl border-slate-200 text-xs font-bold text-center bg-white py-2.5 px-1 shadow-sm focus:ring-blue-500" title="Tutup Scanner Pulang">
                            ...
                            <div class="bg-purple-50/50 p-5 sm:p-6 rounded-[2rem] border border-purple-100 relative group hover:border-purple-200 transition-colors">
                                <div class="flex items-center justify-between mb-4">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-4">
                                    <div>
                                        <label class="block text-[10px] uppercase font-bold text-purple-400 mb-2 sm:text-center">Masuk</label>
                                        <div class="flex gap-2 sm:gap-1.5">
                                            <div class="w-full">
                                                <input type="time" name="start_in[]" value="<?php echo e(optional($regularSchedules->get('Jumat'))->start_in ? \Carbon\Carbon::parse($regularSchedules->get('Jumat')->start_in)->format('H:i') : ''); ?>" class="w-full rounded-xl border-purple-200 text-xs font-bold text-center bg-white py-2.5 px-1 shadow-sm text-purple-900 focus:ring-purple-500">
                                                <p class="text-[9px] text-purple-400/80 text-center mt-1">Buka Scan</p>
                                            </div>
                                            <div class="w-full">
                                                <input type="time" name="end_in[]" value="<?php echo e(optional($regularSchedules->get('Jumat'))->end_in ? \Carbon\Carbon::parse($regularSchedules->get('Jumat')->end_in)->format('H:i') : ''); ?>" class="w-full rounded-xl border-purple-200 text-xs font-bold text-center bg-white py-2.5 px-1 shadow-sm text-purple-900 focus:ring-purple-500">
                                                <p class="text-[9px] text-purple-400/80 text-center mt-1">Batas Telat</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                        <label class="block text-[10px] uppercase font-bold text-purple-400 mb-2 mt-2 sm:mt-0 sm:text-center">Pulang</label>
                                        <div class="flex gap-2 sm:gap-1.5">
                                            <div class="w-full">
                                                <input type="time" name="start_out[]" value="<?php echo e(optional($regularSchedules->get('Jumat'))->start_out ? \Carbon\Carbon::parse($regularSchedules->get('Jumat')->start_out)->format('H:i') : ''); ?>" class="w-full rounded-xl border-purple-200 text-xs font-bold text-center bg-white py-2.5 px-1 shadow-sm text-purple-900 focus:ring-purple-500">
                                                <p class="text-[9px] text-purple-400/80 text-center mt-1">Boleh Plg</p>
                                            </div>
                                            <div class="w-full">
                                                <input type="time" name="end_out[]" value="<?php echo e(optional($regularSchedules->get('Jumat'))->end_out ? \Carbon\Carbon::parse($regularSchedules->get('Jumat')->end_out)->format('H:i') : ''); ?>" class="w-full rounded-xl border-purple-200 text-xs font-bold text-center bg-white py-2.5 px-1 shadow-sm text-purple-900 focus:ring-purple-500">
                                                <p class="text-[9px] text-purple-400/80 text-center mt-1">Tutup Scan</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div x-show="!isHoliday" x-transition class="bg-slate-50 p-4 rounded-2xl border border-slate-200 space-y-3">
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        <div class="text-center">
                                            <input type="time" name="start_in" class="w-full rounded-xl border-slate-200 text-xs text-center font-bold py-2 px-1">
                                            <p class="text-[9px] text-slate-400 mt-1">Buka Masuk</p>
                                        </div>
                                        <div class="text-center">
                                            <input type="time" name="end_in" class="w-full rounded-xl border-slate-200 text-xs text-center font-bold py-2 px-1">
                                            <p class="text-[9px] text-slate-400 mt-1">Batas Telat</p>
                                        </div>
                                        <div class="text-center">
                                            <input type="time" name="start_out" class="w-full rounded-xl border-slate-200 text-xs text-center font-bold py-2 px-1">
                                            <p class="text-[9px] text-slate-400 mt-1">Boleh Plg</p>
                                        </div>
                                        <div class="text-center">
                                            <input type="time" name="end_out" class="w-full rounded-xl border-slate-200 text-xs text-center font-bold py-2 px-1">
