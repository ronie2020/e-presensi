    ...
    <div class="sheet">
        ...
        <div style="line-height: 1.3;">
            ...
            <div style="margin-top: 30px;">
                ...
                <!-- KANAN: Tanda Tangan Kepala Sekolah (SUDAH DIUBAH) -->
                <div style="float: right; width: 48%; text-align: center;">
                    <p style="margin: 0;">Lakbok, <?php echo e(\Carbon\Carbon::now()->locale('id')->isoFormat('D MMMM Y')); ?></p>
                    <p style="margin: 0;">Kepala Sekolah,</p>
                    
                    <!-- ========================================== -->
                    <!-- OPSI 1: STEMPEL TANDA TANGAN ELEKTRONIK    -->
                    <!-- ========================================== -->
                    <div style="height: 70px; margin: 8px 0; text-align: center;">
                        <table style="margin: 0 auto; border: 1.5px solid #1e293b; padding: 3px; border-radius: 4px; background-color: #f8fafc;">
                            <tr>
                                <td style="padding: 2px 6px; border-right: 1px solid #1e293b; vertical-align: middle;">
                                    <span style="font-family: Arial, sans-serif; font-size: 11pt; font-weight: 900; color: #1e293b;">TTE</span>
                                </td>
                                <td style="padding: 2px 8px; text-align: left; vertical-align: middle; line-height: 1.2;">
                                    <span style="font-family: Arial, sans-serif; font-size: 7pt; font-weight: bold; color: #1e293b; display: block;">Ditandatangani secara elektronik</span>
                                    <span style="font-family: Arial, sans-serif; font-size: 6pt; color: #475569;">Validasi Sistem Informasi (SIMADU)</span>
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <!-- ========================================== -->
                    <!-- OPSI 2: JIKA INGIN GAMBAR SCAN TTD & CAP   -->
                    <!-- (Hapus komentar kode di bawah ini, lalu  -->
                    <!-- hapus/komentari kode OPSI 1 di atas)       -->
                    <!-- ========================================== -->
                    <!--
                    <div style="height: 70px; position: relative; margin: 8px 0;">
                        <img src="<?php echo e(asset('img/ttd_cap_sekolah.png')); ?>" style="height: 100px; position: absolute; top: -15px; left: 50%; transform: translateX(-50%); mix-blend-mode: multiply;" alt="Tanda Tangan dan Cap">
                    </div>
                    -->
