                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
                    ...
                    <div class="flex gap-4 w-full md:w-auto">
                        <div class="bg-white/40 backdrop-blur-md px-6 py-5 rounded-xl border border-white/50 flex-1 md:flex-none min-w-[140px] text-center md:text-left hover:bg-white/50 transition-colors shadow-sm">
                            ...
                            <span class="block text-3xl font-black text-[#2A3B52] tracking-tight"><?php echo e($users->total()); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl fluent-card overflow-hidden flex flex-col h-full min-h-[600px] relative">
                        ...
                        <div class="p-8 border-b border-slate-50 bg-slate-50/50 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <a href="<?php echo e(route('users.export')); ?>" target="_blank" class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#DFF6DD] text-[#107C10] text-xs font-bold border border-[#B7DFB9] hover:opacity-80 transition-all shadow-sm group">
                            ...
                            <div @click.away="showImport = false" 
                                ...
                                <form action="<?php echo e(route('users.import')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
                                    ...
                                    <div class="flex flex-col gap-3">
                                        ...
                                        <a href="<?php echo e(asset('template/template_users.xlsx')); ?>" class="w-full py-4 rounded-xl bg-white border border-slate-200 text-slate-500 font-bold hover:bg-slate-50 hover:text-[#5295FF] transition-colors text-center text-sm flex items-center justify-center gap-2">
                                                ...
                                                <div class="flex items-center gap-4">
                                                    ...
                                                    <div class="relative shrink-0">
                                                        <?php if($user->photo_path): ?>
                                                            <img src="<?php echo e(asset('storage/' . $user->photo_path)); ?>" class="w-10 h-10 rounded-xl object-cover shadow-sm border border-slate-200">
                                                        <?php else: ?>
                                                    ...
                                                    <div>
                                                        <div class="font-bold text-[#2A3B52] text-sm group-hover:text-[#5295FF] transition-colors"><?php echo e($user->name); ?></div>
                                            ...
                                            <td class="px-6 py-5 whitespace-nowrap text-right">
                                                <div class="flex justify-end gap-2 opacity-60 group-hover:opacity-100 transition-opacity">
                                                    <?php if(Auth::id() != $user->id): ?>
                                                        <a href="<?php echo e(route('users.edit', $user->id)); ?>" class="w-9 h-9 flex items-center justify-center rounded-lg bg-white border border-slate-200 text-slate-400 hover:text-[#5295FF] hover:border-[#D0E7F8] hover:bg-[#F3F9FD] transition-all shadow-sm" title="Edit Data Lengkap">
                                                    ...
                                                    <?php else: ?>
                                                        ...
                                                        <a href="<?php echo e(route('profile.edit')); ?>" class="w-9 h-9 flex items-center justify-center rounded-lg bg-white border border-slate-200 text-[#5295FF] hover:text-[#005A9E] hover:border-[#D0E7F8] hover:bg-[#F3F9FD] transition-all shadow-sm" title="Edit Profil Saya">
...
<?php endif; ?><?php /**PATH C:\Users\ronie\Documents\aplikasi terpadu\sistem_absensi_sekolah\resources\views/users/index.blade.php ENDPATH**/ ?>