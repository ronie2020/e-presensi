                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
                    ...
                    <div class="flex gap-4">
                        <div class="bg-white/10 backdrop-blur-md px-6 py-5 rounded-2xl border border-white/10 min-w-[140px] text-center md:text-left hover:bg-white/15 transition-colors">
                            ...
                            <span class="block text-3xl font-black text-white tracking-tight"><?php echo e($subjects->count()); ?></span>
                        </div>
                    </div>
                                ...
                                <tbody class="divide-y divide-slate-50">
                                    <?php $__empty_1 = true; $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="hover:bg-blue-50/30 transition-colors group"
                                            ...
                                            <td class="px-6 py-5">
                                                <div class="font-bold text-slate-800 text-base mb-0.5"><?php echo e($subject->name); ?></div>
                                                <?php if($subject->code): ?>
                                                    <span class="text-[10px] font-mono font-bold text-slate-400 bg-slate-50 px-1.5 py-0.5 rounded border border-slate-100"><?php echo e($subject->code); ?></span>
                                                <?php endif; ?>
                                            </td>
...
<?php endif; ?><?php /**PATH E:\drive aplikasi\aplikasi terpadu\sistem_absensi_sekolah versi 3.00\resources\views/settings/subjects.blade.php ENDPATH**/ ?>