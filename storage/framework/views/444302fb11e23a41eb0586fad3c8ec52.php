...
<head>
    ...
    <style>
        ...
        .sheet {
            ...
            margin: 30px auto;
            padding: 1.5cm 2cm;
            box-sizing: border-box; /* FIX: Agar padding tidak menambah ukuran kertas */
            box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04);
            position: relative;
            page-break-after: always; 
            page-break-inside: avoid; /* FIX: Mencegah halaman terpotong di tengah */
        }
        ...
        @media print {
            ...
            .sheet { 
                width: 21.5cm; 
                margin: 0; 
                padding: 1cm 2cm; /* Margin untuk cetakan */
                box-sizing: border-box; /* FIX: Wajib ada di mode print */
                box-shadow: none; 
                border: none; 
                page-break-after: always; 
...
<body class="relative">
    ...
    <div class="sheet">
        <table class="visum">
            ...
            <!-- FIX: Override tinggi baris di bawah ini agar menyesuaikan kontennya -->
            <tr><td colspan="2" style="height: 70px;"><p>V. Catatan Lain-lain:</p></td></tr>
            <tr><td colspan="2" style="height: auto; padding-bottom: 15px;"><p style="font-weight:bold;">VI. PERHATIAN:</p><p style="text-align: justify; font-size: 9pt;">Pejabat yang berwenang dan pejabat/pegawai yang melakukan perjalanan dinas bertanggung jawab sepenuhnya atas kerugian yang diderita oleh negara.</p></td></tr>
        </table>
    </div>
...
</html><?php /**PATH C:\Users\ronie\Documents\aplikasi terpadu\sistem_absensi_sekolah\resources\views/sppd/print.blade.php ENDPATH**/ ?>