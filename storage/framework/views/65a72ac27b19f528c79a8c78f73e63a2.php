...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-8 sm:py-10 font-sans text-slate-800" x-data="bkTeacherChatHandler(<?php echo e($session->id); ?>)">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-6">
                            ...
                            <div class="flex items-center gap-3 md:gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-1.5 mt-0.5">
                                        ...
                                        <p class="text-[9px] md:text-[10px] font-bold text-indigo-300 uppercase tracking-widest">Sesi Aktif Bersama <?php echo e(current(explode(' ', $session->student->name))); ?></p>
                                    </div>
                                </div>
                            </div>
                            
                            <form action="<?php echo e(route('admin.bk.update_status', $session->id)); ?>" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin mengakhiri sesi chat ini dan melanjutkan ke pengisian jurnal? Siswa tidak akan bisa membalas lagi.');">
                    ...
                    <div class="bg-white rounded-[2rem] p-8 shadow-xl shadow-slate-200/60 border <?php echo e($isLocked ? 'border-emerald-200' : 'border-slate-100'); ?> mt-6 break-inside-avoid">
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <textarea name="problem_analysis" rows="3" oninput="this.style.height = ''; this.style.height = this.scrollHeight + 'px'" 
                                              class="w-full px-4 py-3 rounded-xl border-slate-200 text-sm font-medium focus:ring-blue-500 focus:border-blue-500 transition-all shadow-sm resize-none overflow-hidden <?php echo e($isLocked ? 'input-locked' : 'bg-slate-50 focus:bg-white'); ?>" 
                                ...
                                <?php if(!$isLocked): ?>
                                    <label class="flex items-center gap-3 p-4 rounded-xl border border-slate-200 bg-slate-50 hover:bg-slate-100 cursor-pointer transition-colors group print:hidden">
                                        <input type="checkbox" name="is_confidential" value="1" <?php echo e(isset($session->record) && $session->record->is_confidential ? 'checked' : ''); ?> class="w-5 h-5 rounded border-slate-300 text-blue-600 focus:ring-blue-500 transition-colors">
                                        <div>
                                ...
                                <?php if($session->rating): ?>
                                    <div class="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-6 border border-amber-100 shadow-sm relative overflow-hidden">
                                        ...
                                        <div class="flex items-center gap-2 text-amber-500 text-2xl mb-4 relative z-10">
                                            <?php for($i=1; $i<=5; $i++): ?>
                                                <i class="<?php echo e($i <= $session->rating ? 'ph-fill' : 'ph-bold'); ?> ph-star"></i>
                                            <?php endfor; ?>
                                            <span class="font-black text-amber-800 ml-3 text-xl"><?php echo e($session->rating); ?>/5</span>
                                        </div>
