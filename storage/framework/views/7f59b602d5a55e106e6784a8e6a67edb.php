...
<head>
    ...
    <style>
        ...
        /* SETTING UKURAN KERTAS AGAR OTOMATIS PAS SAAT PRINT */
        @page {
            size: 54mm 85.6mm; /* Ukuran ID Card Standar */
            margin: 0;
        }
        ...
        @media print {
            ...
            .id-card {
                box-shadow: none;
                /* Hapus margin saat print agar pas di setting kertas ID Card */
                margin: 0; 
                margin-right: 5mm; 
                margin-bottom: 5mm;
            ...
            /* Hilangkan container wrapper default saat print */
            .print-container {
                padding: 0 !important;
...
<body class="flex flex-col items-center py-10 min-h-screen">
    ...
    <div class="no-print fixed top-5 right-5 z-50 flex gap-3">
        ...
        <button onclick="window.print()" class="px-4 py-2 bg-blue-600 text-white rounded-full shadow hover:bg-blue-700 text-sm font-bold transition flex items-center gap-2">
            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"/></svg>
            Cetak Kartu
        </button>
    </div>

    <!-- Tambahkan class print-container untuk kontrol print -->
    <div class="print-container max-w-[210mm] w-full bg-white p-8 shadow-2xl rounded-2xl flex flex-wrap justify-center content-start gap-8 min-h-[297mm]">
        ...
        <div class="id-card">
            ...
            <div class="card-header-text">
                <h1 class="text-[12px] font-black text-slate-900 tracking-wide uppercase leading-tight">KARTU PERPUSTAKAAN</h1>
        ...
        <div class="id-card items-center justify-center">
            ...
            <!-- Gelombang Belakang (Blue Theme) -->
            <div class="wave-decoration-back absolute top-[-20px] left-[-20px] w-[100px] h-[60px] bg-blue-400 rounded-br-[100%] transform -rotate-12 z-0"></div>
            <div class="wave-decoration-back absolute top-[-25px] left-[-25px] w-[110px] h-[70px] bg-blue-600 rounded-br-[100%] transform -rotate-12 -z-10"></div>
            <div class="wave-decoration-back absolute bottom-[-20px] right-[-20px] w-[120px] h-[60px] bg-blue-700 rounded-tl-[100%] z-0"></div>
            ...
            <div class="z-10 flex flex-col items-center w-full px-6 flex-1 justify-center mt-6">
                ...
                <!-- Tata Tertib Perpus -->
                <div class="w-full">
                    <h4 class="text-[7px] font-black text-center mb-1 text-slate-800 uppercase">TATA TERTIB PERPUSTAKAAN</h4>
                    <ul class="text-[6px] text-slate-800 font-bold list-disc pl-4 space-y-1 text-justify leading-relaxed">
                        <li>Kartu ini wajib dibawa saat meminjam buku.</li>
                        <li>Keterlambatan pengembalian buku dikenakan denda.</li>
                        <li>Dilarang mencoret atau merusak buku.</li>
                        <li>Hilangnya kartu harap lapor ke petugas.</li>
                    </ul>
                </div>
            </div>
            ...
            <!-- Footer Bar Back -->
             <div class="footer-bar !justify-center">
                <span class="text-[7px] font-bold text-white opacity-90 tracking-wider">LITERASI JENDELA DUNIA</span>
            </div>
        </div>
    </div>
</body>
</html><?php /**PATH E:\aplikasi terpadu\sistem_absensi_sekolah\resources\views\library\tools\print-card.blade.php ENDPATH**/ ?>