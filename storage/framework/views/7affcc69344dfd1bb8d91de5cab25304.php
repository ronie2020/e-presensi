...
<body>
    ...
    <table class="kop-surat text-center">
        <tr>
            <!-- Logo Kiri -->
            <td width="15%">
                <img src="<?php echo e(asset('assets/images/logo_dinas.png')); ?>" alt="Logo" style="width: 80px; height: auto;" onerror="this.style.display='none'">
            </td>
            <td width="70%">
            ...
            <!-- Logo Kanan -->
            <td width="15%">
                <img src="<?php echo e(asset('assets/images/logo_sekolah.png')); ?>" alt="Logo" style="width: 85px; height: auto;" onerror="this.style.display='none'">
            </td>
        </tr>
    </table>
