            ...
            <div class="bg-white rounded-xl fluent-card overflow-hidden animate-enter" style="animation-delay: 100ms">
                <form action="<?php echo e(route('lms.assignments.update', $assignment->id)); ?>" method="POST" id="editAssignmentForm" 
                    ...
                    <div class="p-8 space-y-8">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="col-span-2">
                                    ...
                                    <input type="text" name="title" value="<?php echo e(old('title', $assignment->title)); ?>" required class="w-full rounded-xl border-slate-200 bg-slate-50 font-bold text-[#2A3B52] focus:ring-[#5295FF] focus:border-[#5295FF] h-12 px-4 transition-colors">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="datetime-local" name="deadline" value="<?php echo e(old('deadline', $assignment->deadline->format('Y-m-d\TH:i'))); ?>" required class="w-full rounded-xl border-slate-200 bg-slate-50 font-bold text-[#2A3B52] focus:ring-[#5295FF] focus:border-[#5295FF] h-12 px-4 transition-colors">
                                </div>
                        ...
                        <div class="bg-slate-50 rounded-xl p-6 border border-slate-100">
                            ...
                            <div x-show="assignmentType === 'file_upload'">
                                ...
                                <textarea name="description" rows="5" class="w-full rounded-xl border-slate-200 bg-white focus:ring-[#5295FF] focus:border-[#5295FF] p-4 text-[#2A3B52] font-medium transition-colors shadow-sm"><?php echo e(old('description', $assignment->description)); ?></textarea>
                            </div>
                            ...
                            <div x-show="assignmentType === 'link'">
                                <div class="mb-4">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="url" name="link_url" value="<?php echo e(old('link_url', $assignment->link_url)); ?>" class="w-full rounded-xl border-slate-200 bg-white pl-10 font-bold text-[#5295FF] focus:ring-[#5295FF] h-12 transition-colors shadow-sm">
                                    </div>
                                </div>
                                <label class="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-2 ml-1">Instruksi Tambahan</label>
                                <textarea name="description" rows="3" class="w-full rounded-xl border-slate-200 bg-white focus:ring-[#5295FF] focus:border-[#5295FF] p-4 font-medium transition-colors shadow-sm"><?php echo e(old('description', $assignment->description)); ?></textarea>
                            </div>
                            ...
                            <div x-show="assignmentType === 'quiz'">
                                <div class="mb-6 flex flex-col md:flex-row gap-4">
                                    <div class="flex-1">
                                        ...
                                        <textarea name="description" rows="2" class="w-full rounded-xl border-slate-200 bg-white focus:ring-purple-500 focus:border-purple-500 p-3 transition-colors shadow-sm"><?php echo e(old('description', $assignment->description)); ?></textarea>
                                    </div>
                                    <div class="w-full md:w-1/3">
                                        ...
                                        <div class="relative">
                                            <input type="number" name="duration_minutes" value="<?php echo e(old('duration_minutes', $assignment->duration_minutes)); ?>" class="w-full rounded-xl border-slate-200 bg-white font-bold text-[#2A3B52] focus:ring-purple-500 focus:border-purple-500 h-11 pl-4 pr-10 transition-colors shadow-sm">
                    ...
                    <div class="bg-slate-50 px-8 py-6 flex justify-end gap-3 border-t border-slate-100">
                        <a href="<?php echo e(route('lms.assignments.index')); ?>" class="px-6 py-3 bg-white border border-slate-200 text-slate-600 font-bold rounded-xl hover:bg-slate-100 transition text-center text-sm btn-cancel-confirm active:scale-95 shadow-sm">Batal</a>
