    ...
    <nav class="fixed top-0 w-full z-50 transition-all duration-300 border-b border-blue-600/30 bg-gradient-to-r from-cyan-600 via-blue-600 to-blue-900 shadow-xl shadow-blue-900/10"
            ...
            <div class="flex justify-between h-20 items-center">
                ...
                <div class="hidden md:flex items-center gap-8">
                    ...
                    <div class="flex items-center gap-6">
                        <a href="<?php echo e(url('/')); ?>#profil" class="text-sm font-bold text-blue-100 hover:text-white transition relative group">
                            Profil
                            <span class="absolute -bottom-1 left-0 w-0 h-0.5 bg-cyan-300 transition-all group-hover:w-full"></span>
                        </a>
                        <a href="<?php echo e(url('/')); ?>#guru" class="text-sm font-bold text-blue-100 hover:text-white transition relative group">
                            Guru
                            <span class="absolute -bottom-1 left-0 w-0 h-0.5 bg-cyan-300 transition-all group-hover:w-full"></span>
                        </a>
                        <a href="<?php echo e(url('/')); ?>#prestasi" class="text-sm font-bold text-blue-100 hover:text-white transition relative group">
                            Prestasi
                            <span class="absolute -bottom-1 left-0 w-0 h-0.5 bg-cyan-300 transition-all group-hover:w-full"></span>
                        </a>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        <a href="<?php echo e(route('portal.index')); ?>" class="text-sm font-bold <?php echo e(request()->routeIs('portal.*') ? 'text-cyan-300' : 'text-blue-100 hover:text-white'); ?> transition flex items-center gap-2">
                            Portal Siswa
                        </a>
                        ...
                        <?php if(Auth::guard('student')->check()): ?>
                            ...
                            <div class="flex items-center gap-3 pl-2">
                                <a href="<?php echo e(route('students.learning.index')); ?>" class="text-xs font-bold px-4 py-2 rounded-full bg-white text-blue-700 hover:bg-cyan-50 transition shadow-lg shadow-blue-900/30 flex items-center gap-2">
                        ...
                        <?php elseif(Auth::check()): ?>
                            ...
                            <a href="<?php echo e(route('dashboard')); ?>" class="text-xs font-bold px-5 py-2.5 rounded-full bg-white/10 backdrop-blur-md text-white hover:bg-white hover:text-blue-700 transition shadow-lg border border-white/20 flex items-center gap-2">
                                <i class="ph-bold ph-squares-four"></i> Dashboard Guru
                            </a>

                        <?php else: ?>
                            <!-- Jika BELUM LOGIN -->
                            <a href="<?php echo e(route('login')); ?>" class="text-xs font-bold px-5 py-2.5 rounded-full bg-white/10 backdrop-blur-md text-white hover:bg-white hover:text-blue-700 transition shadow-lg border border-white/20 flex items-center gap-2">
        ...
        <div x-show="mobileMenuOpen" x-cloak
            ...
            <nav class="flex flex-col p-6 space-y-4">
                <a href="<?php echo e(url('/')); ?>#profil" class="text-lg font-bold text-blue-100 hover:text-cyan-300">Profil Sekolah</a>
                <a href="<?php echo e(url('/')); ?>#guru" class="text-lg font-bold text-blue-100 hover:text-cyan-300">Guru & Staff</a>
                <a href="<?php echo e(url('/')); ?>#prestasi" class="text-lg font-bold text-blue-100 hover:text-cyan-300">Prestasi</a>
                <a href="<?php echo e(route('portal.index')); ?>" class="text-lg font-bold text-cyan-400">Portal Siswa</a>
                
                <hr class="border-blue-800/50">
                
                <?php if(Auth::guard('student')->check()): ?>
                    <a href="<?php echo e(route('students.learning.index')); ?>" class="block w-full text-center px-6 py-3 rounded-xl bg-cyan-500 text-blue-950 font-bold shadow-lg shadow-cyan-900/20">Dashboard Siswa</a>
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="block w-full text-center px-6 py-3 rounded-xl bg-white/10 text-white font-bold border border-white/20">Login Staff</a>
                <?php endif; ?>
            </nav>
        </div>
    </nav>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-blue-200/70">
                        <li><a href="<?php echo e(url('/')); ?>" class="hover:text-cyan-300 transition-colors">Beranda</a></li>
                        <li><a href="<?php echo e(route('portal.index')); ?>" class="hover:text-cyan-300 transition-colors">Portal Siswa</a></li>
                        <li><a href="<?php echo e(route('library.kiosk.index')); ?>" class="hover:text-cyan-300 transition-colors">E-Library</a></li>
                    </ul>
                </div>
                <div>
