                                ...
                                <?php
                                    ...
                                    if (!empty($book->cover_image)) {
                                        if (filter_var($book->cover_image, FILTER_VALIDATE_URL)) {
                                            $imageSrc = $book->cover_image; // Gunakan langsung jika URL
                                        } else {
                                            $imageSrc = asset('storage/' . $book->cover_image); // Tambah storage/ jika path lokal
                                        }
                                    }
                                ?>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        scanInput.addEventListener('keydown', (e) => {
            if (e.key === 'Enter') {
                ...
                scanInput.blur();   // Memicu proses (via event change atau manual)
                scanInput.focus(); 
            }
        });
