            ...
            <div class="relative w-56 h-56 mx-auto mb-6">
                ...
                <div class="absolute inset-0 flex items-center justify-center z-10 pointer-events-none">
                    <div class="text-center">
                        <span class="text-5xl font-black text-slate-800 tracking-tighter block"><?php echo e($attendancePercentage); ?><span class="text-2xl text-slate-400">%</span></span>
            ...
            <div class="bg-slate-50 p-4 rounded-2xl border border-slate-100 relative z-10">
                ...
                <div class="w-full bg-slate-200 rounded-full h-2.5 overflow-hidden mb-2">
                    <div class="h-full rounded-full transition-all duration-1000 shadow-[0_0_10px_currentColor] 
                        <?php echo e($attendancePercentage >= 90 ? 'bg-emerald-500 text-emerald-500' : ($attendancePercentage >= 80 ? 'bg-amber-500 text-amber-500' : 'bg-rose-500 text-rose-500')); ?>" 
    ...
    <div class="lg:col-span-2 space-y-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div class="bg-white p-4 rounded-[2rem] border border-emerald-100 shadow-sm flex flex-col items-center text-center group hover:bg-emerald-50/50 transition-colors relative overflow-hidden">
                ...
                <span class="text-2xl font-black text-slate-800"><?php echo e($hadir - $terlambat); ?></span>
            ...
            <div class="bg-white p-4 rounded-[2rem] border border-amber-100 shadow-sm flex flex-col items-center text-center group hover:bg-amber-50/50 transition-colors relative overflow-hidden">
                ...
                <span class="text-2xl font-black text-slate-800"><?php echo e($terlambat); ?></span>
                <span class="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Terlambat</span>
                
                
                <?php if($terlambat > 0): ?>
                    <div class="mt-2">
                        <span class="inline-flex items-center gap-1 px-2 py-1 bg-rose-50 text-rose-600 text-[9px] font-black uppercase rounded-lg border border-rose-100 animate-pulse">
                            <i class="ph-bold ph-trend-down"></i> -<?php echo e($terlambat * 5); ?> Poin
                        </span>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="bg-white p-4 rounded-[2rem] border border-blue-100 shadow-sm flex flex-col items-center text-center group hover:bg-blue-50/50 transition-colors relative overflow-hidden">
                ...
                <span class="text-2xl font-black text-slate-800"><?php echo e($sakit); ?></span>
            ...
            <div class="bg-white p-4 rounded-[2rem] border border-purple-100 shadow-sm flex flex-col items-center text-center group hover:bg-purple-50/50 transition-colors relative overflow-hidden">
                ...
                <span class="text-2xl font-black text-slate-800"><?php echo e($izin); ?></span>
            ...
            <div class="col-span-2 md:col-span-2 bg-white p-4 rounded-[2rem] border border-rose-100 shadow-sm flex flex-row items-center justify-between px-6 group hover:bg-rose-50/50 transition-colors relative overflow-hidden">
                <div class="flex items-center gap-4">
                    ...
                    <div class="text-left">
                        <span class="text-3xl font-black text-rose-600 block leading-none"><?php echo e($alpa); ?></span>
                ...
                <?php if($alpa > 0): ?>
                    <div class="text-right">
                        <span class="inline-flex items-center gap-1 px-3 py-1.5 bg-rose-100 text-rose-700 text-[10px] font-black uppercase rounded-lg border border-rose-200">
                            <i class="ph-bold ph-warning"></i> -<?php echo e($alpa * 10); ?> Poin
                        </span>
                    </div>
                <?php else: ?>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $attendance_history; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="relative pl-8 group">
                        ...
                        <div class="absolute left-[11px] top-1.5 w-3 h-3 rounded-full border-2 border-white shadow-sm z-10
                            <?php echo e(($log->status == 'Hadir') ? 'bg-emerald-500 ring-4 ring-emerald-50' : 
                        ...
                        <div class="bg-white rounded-2xl p-4 border border-slate-100 hover:shadow-md hover:border-slate-200 transition-all duration-300">
                            ...
                            <div class="flex justify-between items-start mb-3">
                                <div>
                                    ...
                                    <div class="flex items-center gap-1.5 mt-1">
                                        ...
                                        <span class="inline-block px-2.5 py-0.5 rounded-md text-[10px] font-black uppercase tracking-wide border
                                            <?php echo e(($log->status == 'Hadir') ? 'bg-emerald-50 text-emerald-600 border-emerald-100' : 
                                        ...
                                        <?php if($log->status == 'Terlambat'): ?>
                                            <span class="inline-block px-2 py-0.5 rounded-md text-[10px] font-black uppercase tracking-wide bg-rose-50 text-rose-600 border border-rose-100">
                                                -5 Poin
                                            </span>
                                        <?php endif; ?>
                                    </div>
                            ...
                            <?php if($log->notes): ?>
                                <div class="mt-3 flex items-start gap-2">
                                    ...
                                    <p class="text-xs text-slate-500 italic leading-snug">"<?php echo e(Str::limit($log->notes, 80)); ?>"</p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
...
</div><?php /**PATH C:\Users\ronie\Documents\aplikasi terpadu\sistem_absensi_sekolah\resources\views/students/portal/partials/tab-kehadiran.blade.php ENDPATH**/ ?>