                    ...
                    <div class="p-6 flex-1 flex flex-col">
                        ...
                        <?php if($totalImages > 1): ?>
                            <div class="mb-4 pt-4 border-t border-slate-100">
                                <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2"><i class="ph-fill ph-images text-indigo-500"></i> <?php echo e($totalImages); ?> Foto Tersedia</p>
                                <div class="flex gap-2 overflow-x-auto pb-2 mini-scroll">
                                    <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <button @click="activeImg = '<?php echo e(asset('storage/' . $img)); ?>'" 
                                                ...
                                                :class="activeImg === '<?php echo e(asset('storage/' . $img)); ?>' ? 'border-indigo-600 opacity-100 shadow-md' : 'border-transparent opacity-60 hover:opacity-100 hover:scale-105'">
                        ...
                        <div class="mt-auto pt-4 border-t border-slate-100 flex gap-2">
                            ...
                            <!-- Tombol Lihat Video -->
                            <?php if(!empty($activity->video_url)): ?>
                                <a href="<?php echo e($activity->video_url); ?>" target="_blank" class="<?php echo e(empty($coverImage) ? 'w-full' : 'flex-1'); ?> flex items-center justify-center gap-2 px-4 py-2.5 bg-rose-50 text-rose-600 hover:bg-rose-600 hover:text-white rounded-xl text-sm font-bold transition-colors">
