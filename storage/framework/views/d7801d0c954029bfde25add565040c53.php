                    ...
                    <div class="p-6 flex-1 flex flex-col">
                        ...
                        <?php if($totalImages > 1): ?>
                            <div class="mb-4 pt-4 border-t border-slate-100">
                                <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2"><i class="ph-fill ph-images text-cyan-500"></i> <?php echo e($totalImages); ?> Foto Tersedia</p>
                                <div class="flex gap-2 overflow-x-auto pb-2 mini-scroll">
                                    <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <button @click="activeImg = '<?php echo e(asset('storage/' . $img)); ?>'" 
                                                ...
                                                :class="activeImg === '<?php echo e(asset('storage/' . $img)); ?>' ? 'border-cyan-500 opacity-100 shadow-md' : 'border-transparent opacity-60 hover:opacity-100 hover:scale-105'">
