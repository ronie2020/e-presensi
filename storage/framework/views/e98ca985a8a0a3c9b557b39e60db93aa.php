                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div class="flex flex-col items-center md:items-end gap-2">
                        <div class="bg-white/10 backdrop-blur-md px-5 py-3 rounded-2xl border border-white/10 text-center shadow-lg">
                            <span class="block text-2xl font-black text-white"><?php echo e(count($students)); ?></span>
                        ...
                        <tbody class="divide-y divide-slate-50">
                            <?php $__empty_1 = true; $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <tr class="hover:bg-blue-50/20 transition-colors group"
                                    x-show="searchQuery === '' || '<?php echo e(strtolower($student->name)); ?>'.includes(searchQuery.toLowerCase()) || '<?php echo e($student->student_id); ?>'.includes(searchQuery)"
                                        ...
                                        <div class="w-full">
                                            <div class="flex justify-between items-end mb-1">
                                                <span class="text-xs font-bold <?php echo e($textColor); ?>">
                                                    <?php echo e($completedSubjects); ?> / <?php echo e($totalSubjects); ?> Mapel
                                                </span>
...
<?php endif; ?><?php /**PATH E:\drive aplikasi\aplikasi terpadu\sistem_absensi_sekolah versi 3.00\resources\views/grades/list.blade.php ENDPATH**/ ?>