        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden relative">
                ...
                <div class="p-8">
                    ...
                    <form action="<?php echo e(route('users.update', $user->id)); ?>" method="POST" enctype="multipart/form-data" class="space-y-10" x-data="{ role: '<?php echo e($user->role); ?>' }">
                        <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-rose-500 text-xs mt-1 font-bold"><?php echo e($message); ?></p> <?php unset($message);
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="nip" value="<?php echo e(old('nip', $user->nip ?? '')); ?>" placeholder="Contoh: 19800101..."
                                           class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-emerald-500 focus:ring-emerald-500 font-bold text-slate-700 py-3 px-4 transition-colors">
                                    <?php $__errorArgs = ['nip'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="pangkat" value="<?php echo e(old('pangkat', $user->pangkat ?? '')); ?>" placeholder="Contoh: Penata Muda, III/a"
                                           class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-emerald-500 focus:ring-emerald-500 font-bold text-slate-700 py-3 px-4 transition-colors">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="md:col-span-2">
                                    <label class="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-2 ml-1">Jabatan / Mata Pelajaran</label>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="bio" rows="2" class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-emerald-500 focus:ring-emerald-500 font-medium text-slate-700 py-3 px-4 transition-colors placeholder:font-normal" placeholder="Tulis motto atau deskripsi singkat..."><?php echo e(old('bio', $user->bio)); ?></textarea>
                                    <?php $__errorArgs = ['bio'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="md:col-span-2">
                                    <label class="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-2 ml-1">Update Foto Profil</label>
                                    <div class="relative bg-slate-50 p-4 rounded-2xl border border-dashed border-slate-300">
                                        <input type="file" name="photo" accept="image/*" class="block w-full text-xs text-slate-500 file:mr-4 file:py-3 file:px-6 file:rounded-xl file:border-0 file:text-xs file:font-bold file:bg-emerald-50 file:text-emerald-700 hover:file:bg-emerald-100 transition-colors cursor-pointer focus:outline-none">
                                        <p class="text-[10px] text-slate-400 mt-2 ml-1 italic">*Format JPG/PNG, Maksimal 2MB.</p>
                                    </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-slate-50/50 p-6 rounded-[2rem] border border-slate-200">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="phone" value="<?php echo e(old('phone', $user->phone ?? '')); ?>" placeholder="08xxxxxx"
                                           class="w-full rounded-2xl border-slate-200 bg-white focus:border-emerald-500 focus:ring-emerald-500 font-bold text-slate-700 py-3 px-4 transition-colors">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" name="instagram" value="<?php echo e(old('instagram', $user->instagram ?? '')); ?>" placeholder="username"
                                               class="w-full rounded-2xl border-slate-200 pl-9 bg-white focus:border-pink-500 focus:ring-pink-500 font-bold text-slate-700 py-3 px-4 transition-colors">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" name="tiktok" value="<?php echo e(old('tiktok', $user->tiktok ?? '')); ?>" placeholder="username"
                                               class="w-full rounded-2xl border-slate-200 pl-9 bg-white focus:border-slate-800 focus:ring-slate-800 font-bold text-slate-700 py-3 px-4 transition-colors">
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="facebook" value="<?php echo e(old('facebook', $user->facebook ?? '')); ?>" placeholder="Nama Profil"
                                           class="w-full rounded-2xl border-slate-200 bg-white focus:border-blue-600 focus:ring-blue-600 font-bold text-slate-700 py-3 px-4 transition-colors">
...
<?php endif; ?><?php /**PATH E:\drive aplikasi\aplikasi terpadu\sistem_absensi_sekolah versi 3.00\resources\views/users/edit.blade.php ENDPATH**/ ?>