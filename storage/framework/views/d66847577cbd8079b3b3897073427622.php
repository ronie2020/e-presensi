    ...
    <div id="guru" class="py-24 bg-slate-50 dark:bg-slate-900/50 relative transition-colors duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="group relative bg-white dark:bg-slate-800 rounded-2xl overflow-hidden border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 h-full flex flex-col" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                        ...
                        <div class="p-5 text-center relative bg-white dark:bg-slate-800 flex-1 flex flex-col justify-end">
                            <div class="absolute -top-4 left-0 right-0 flex justify-center px-4">
                                <span class="bg-gradient-to-r from-elevate-accent to-elevate-primary text-white text-[10px] font-bold uppercase tracking-wider py-1 px-3 rounded-full shadow-lg border-2 border-white dark:border-slate-800 truncate max-w-full" title="<?php echo e($displayRole); ?>">
                                    <?php echo e($displayRole); ?>

                                </span>
                            </div>
                            <h3 class="mt-4 text-lg font-bold text-slate-900 dark:text-white group-hover:text-elevate-primary dark:group-hover:text-elevate-accent transition-colors line-clamp-1"><?php echo e($teacher->name); ?></h3>
            ...
            <div class="text-center mt-12" data-aos="fade-up">
                <a href="<?php echo e(route('teachers.index')); ?>" class="inline-flex items-center justify-center px-6 py-3 text-sm font-bold text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-full hover:bg-elevate-accent/10 dark:hover:bg-slate-700 hover:text-elevate-primary dark:hover:text-elevate-accent hover:border-elevate-accent/30 dark:hover:border-elevate-accent/50 transition-all shadow-sm hover:shadow-md">Lihat Seluruh Staff <i class="ph-bold ph-arrow-right ml-2"></i></a>
            </div>
        </div>
