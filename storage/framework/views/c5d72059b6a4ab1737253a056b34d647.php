...
<div class="w-full max-w-5xl mx-auto pb-20 px-4 sm:px-6 pt-6 md:pt-10">
    ...
    <div class="flex items-center justify-between mb-6">
        <a href="<?php echo e(route('student.bk.index')); ?>" class="inline-flex items-center text-sm text-slate-500 hover:text-slate-800 font-bold transition-colors">
            <i class="ph-bold ph-arrow-left mr-2"></i> Kembali
        </a>
        <div class="text-xs font-mono text-slate-400">ID: #<?php echo e($session->id); ?></div>
    </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    ?>
                    <span class="inline-flex items-center px-4 py-2 rounded-xl text-sm font-black border <?php echo e($statusColor); ?>">
                ...
                <div class="bg-white rounded-3xl p-8 border-l-4 border-blue-500 shadow-sm relative">
                    ...
                    <div class="flex items-start gap-4 mb-6 p-4 bg-blue-50/50 rounded-2xl border border-blue-100">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-black text-slate-800"><?php echo e($session->scheduled_at->translatedFormat('l, d F Y')); ?></p>
                            <p class="text-sm font-bold text-slate-600">Pukul <?php echo e($session->scheduled_at->format('H:i')); ?> WIB</p>
                            <p class="text-xs text-slate-500 mt-1">Konselor: <span class="font-bold"><?php echo e($session->teacher->name ?? '-'); ?></span></p>
                        </div>
                    </div>
                    <?php endif; ?>
