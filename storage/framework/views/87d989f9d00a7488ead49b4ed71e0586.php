        ...
        <div class="bg-white p-6 rounded-[2.5rem] shadow-sm border border-slate-100">
            ...
            <div class="space-y-4">
                <div class="flex items-center justify-between group">
                    ...
                    <span class="text-xl font-black text-slate-800"><?php echo e($literacy_stats['total_books'] ?? 0); ?></span>
                </div>
                ...
                <div class="flex items-center justify-between group">
                    ...
                    <span class="text-xl font-black text-slate-800"><?php echo e(number_format($literacy_stats['total_pages'] ?? 0)); ?></span>
                </div>
            </div>
        </div>
                    ...
                    <div class="flex-grow bg-white p-6 rounded-[2.5rem] rounded-tl-none sm:rounded-tl-[2.5rem] shadow-sm border border-slate-100 group-hover:shadow-md transition-all">
                        <div class="flex flex-col sm:flex-row justify-between items-start gap-2 mb-3">
                            <div>
                                ...
                                <h3 class="font-black text-slate-800 text-lg leading-snug"><?php echo e($journal->title); ?></h3>
                                <p class="text-xs text-slate-400 font-bold mt-0.5">
                                    <i class="ph-bold ph-pen-nib"></i> <?php echo e($journal->author ?? 'Tanpa Penulis'); ?>
...
</div><?php /**PATH E:\drive aplikasi\aplikasi terpadu\sistem_absensi_sekolah versi 3.00\resources\views/students/portal/partials/tab-literasi-mandiri.blade.php ENDPATH**/ ?>