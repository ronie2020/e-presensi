...
<body>
    ...
    <table>
        <thead>
            ...
            <tr>
                <th colspan="<?php echo e($totalColumns); ?>" style="font-size: 16px; font-weight: bold; text-align: center; height: 30px;">
                    REKAPITULASI NILAI SISWA
                </th>
            </tr>
            <tr>
                <th colspan="<?php echo e($totalColumns); ?>" style="font-size: 12px; font-weight: bold; text-align: center;">
                    Kelas: <?php echo e($selectedClass->name ?? '-'); ?> | Mata Pelajaran: <?php echo e($selectedSubject->name ?? '-'); ?>

                </th>
            </tr>
            <tr>
                <th colspan="<?php echo e($totalColumns); ?>" style="font-size: 11px; font-style: italic; text-align: center;">
                    Dicetak pada: <?php echo e(date('d F Y')); ?> oleh <?php echo e($teacher->name ?? Auth::user()->name ?? '-'); ?> | Periode: <?php echo e(ucfirst($selectedPeriod ?? 'Semester')); ?>
            ...
            <tr>
                ...
                <th style="width: 15px;"><?php echo e(($selectedPeriod ?? 'semester') == 'semester' ? 'Nilai Rapor' : 'Rata2'); ?></th>
            </tr>
        </thead>
        <tbody>
            <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td style="font-weight: bold;"><?php echo e($student->total_score ?? 0); ?></td>
                    <td style="font-weight: bold;"><?php echo e($student->average_score ?? 0); ?></td>
                </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
        ...
        <tfoot>
            ...
            <tr>
                ...
                <td colspan="<?php echo e($spasiTengah); ?>"></td> 
            ...
            <tr>
                ...
                <td style="text-align: center; font-weight: bold; text-decoration: underline;">
                    ...
                    <?php echo e($headmaster ?? 'TANTAN SUTANDI NUGRAHA, S.Si, M.Pd.'); ?>

                </td>
                <td colspan="<?php echo e($spasiTengah); ?>"></td>
                <td colspan="2" style="text-align: center; font-weight: bold; text-decoration: underline;">
                    <?php echo e($teacher->name ?? Auth::user()->name ?? '-'); ?>

                </td>
            </tr>
            <tr>
                <td></td>
                <td style="text-align: center;">NIP. <?php echo e($headmaster_nip ?? '197xxxxxxxxxxxxx'); ?></td>
                <td colspan="<?php echo e($spasiTengah); ?>"></td>
                <td colspan="2" style="text-align: center;">NIP. <?php echo e($teacher->nip ?? Auth::user()->nip ?? '-'); ?></td>
            </tr>
        </tfoot>
    </table>
</body>
