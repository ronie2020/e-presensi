...
<body class="font-sans antialiased bg-slate-50">
    ...
    <div class="pt-20 min-h-screen flex flex-col bg-slate-50">
        ...
        <footer class="text-center py-6 text-slate-400 text-[10px] font-medium pb-20 md:pb-6">
            <p>Computer Based Test (CBT) System Netil@ Berjaya Ri.. &copy; <?php echo e(date('Y')); ?></p>
        </footer>
    </div>
</body>
</html><?php /**PATH E:\drive aplikasi\aplikasi terpadu\sistem_absensi_sekolah versi 3.00\resources\views/layouts/student.blade.php ENDPATH**/ ?>