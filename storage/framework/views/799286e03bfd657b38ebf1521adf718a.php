...
<?php $component->withAttributes([]); ?>
    ...
    <div x-data="{ 
        ...
        <div class="py-8 sm:py-10 font-sans text-slate-800">
                                    ...
                                    <template x-if="createType === 'choice'">
                                        <div class="space-y-3">
                                            ...
                                            <div class="flex gap-3 items-center group">
                                                ...
                                                <input type="text" name="option_<?php echo e($opt); ?>" class="flex-1 rounded-xl border-slate-200 bg-white text-sm py-2 px-3 focus:ring-blue-500" placeholder="Jawaban <?php echo e($opt); ?>">
                                            </div>
            ...
            <script>
                // PENGEMBANGAN: Fungsi Konfirmasi Canggih untuk Import/Export Bank Soal
