            ...
            <div class="p-8 md:p-12 min-h-[400px]">
                ...
                <div x-show="step === 2" class="animate-enter h-full flex flex-col justify-between" style="display: none;">
                    ...
                    <div class="flex justify-between pt-8 mt-4 border-t border-slate-100">
                        ...
                        <a href="<?php echo e(route('ppdb.create')); ?>" class="px-6 py-4 text-xs font-bold text-blue-600 hover:text-blue-700 transition-colors flex items-center gap-2 bg-blue-50 rounded-xl border border-blue-100 hover:border-blue-200">
