                ...
                <div class="flex items-center justify-between min-w-max px-6 gap-2">
                    ...
                    <?php $__currentLoopData = $tabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button type="button" @click="tab = '<?php echo e($key); ?>'" 
                            ...
                            :class="tab === '<?php echo e($key); ?>' ? 'bg-white text-elevate-primary shadow-sm ring-1 ring-slate-200' : 'text-slate-400 hover:bg-white hover:text-elevate-dark'">
                            
                            <div class="flex flex-col items-start text-left">
                                <span class="text-[10px] font-extrabold uppercase tracking-wider mb-0.5" 
                                      :class="tab === '<?php echo e($key); ?>' ? 'text-elevate-primary' : 'text-slate-400'">Step <?php echo e($item['step']); ?></span>
                            ...
                            <div x-show="tab === '<?php echo e($key); ?>'" class="absolute bottom-0 left-6 right-6 h-[3px] bg-elevate-primary rounded-t-full"></div>
                        </button>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                        ...
                        <label class="cursor-pointer group relative">
                            ...
                            <div class="selection-card h-full p-6 rounded-[2rem] border border-slate-200 bg-white <?php echo e($opt['border']); ?> <?php echo e($opt['bg']); ?> peer-checked:ring-4 <?php echo e($opt['ring']); ?> transition-all duration-300 flex flex-col items-center justify-center text-center relative overflow-hidden">
                                ...
                                <span class="font-extrabold text-lg text-elevate-dark mb-1"><?php echo e($opt['label']); ?></span>
                                ...
                                <div class="absolute top-4 right-4 opacity-0 peer-checked:opacity-100 transition-all duration-300 transform scale-50 peer-checked:scale-100">
                                    <div class="<?php echo e($opt['checkBg']); ?> text-white rounded-full p-1 shadow-md">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="form-group col-span-1">
                            ...
                            <div class="relative group">
                                ...
                                <div id="preview-<?php echo e($file['name']); ?>-default" class="h-28 border border-dashed border-slate-300 rounded-2xl bg-slate-50 hover:bg-elevate-soft hover:border-elevate-accent transition-all flex items-center justify-center gap-4 group-hover:shadow-sm">
                                ...
                                <div id="preview-<?php echo e($file['name']); ?>-selected" class="hidden h-28 border border-solid border-elevate-accent/50 bg-elevate-soft rounded-2xl px-6 flex items-center justify-between">
