        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form id="gradeForm" action="<?php echo e(route('grades.store_by_student')); ?>" method="POST" @submit="isDirty = false">
                ...
                <div class="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden relative">
                    ...
                    <div class="bg-fuchsia-50/50 px-8 py-3 text-xs font-bold text-fuchsia-700 flex flex-col sm:flex-row items-center justify-between border-b border-fuchsia-100/50 gap-2">
                        <div class="flex items-center gap-2">
                            <i class="ph-fill ph-info text-lg"></i>
                            <span>Isi semua mata pelajaran. Gunakan <strong>Panah Atas/Bawah</strong> untuk navigasi.</span>
                        </div>
                         <div class="flex gap-4 font-mono opacity-80 bg-white px-3 py-1 rounded-lg border border-fuchsia-100 shadow-sm">
                        ...
                        <table class="w-full text-left border-collapse relative">
                            <thead class="bg-slate-50 sticky top-0 z-10 shadow-sm text-slate-500 border-b border-slate-200">
                                <tr>
                                    ...
                                    <th class="px-6 py-5 text-xs font-black uppercase tracking-wider min-w-[300px]">Deskripsi / Catatan</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-slate-50 bg-white">
                                <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <tr class="hover:bg-fuchsia-50/20 transition-colors group focus-within:bg-fuchsia-50/30" 
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center gap-4">
                                                <div class="w-10 h-10 rounded-xl bg-white border border-slate-100 text-fuchsia-600 flex items-center justify-center shadow-sm text-xl shrink-0">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="relative flex items-center justify-center gap-3">
                                                <input type="number" 
                                                       ...
                                                       min="0" max="100"
                                                       class="input-score w-20 rounded-xl border-slate-200 bg-slate-50 focus:bg-white focus:border-fuchsia-500 focus:ring-fuchsia-500 text-center font-black text-slate-800 py-2.5 transition-all shadow-sm placeholder:font-normal placeholder:text-slate-300 text-lg"
                                                       placeholder="-">
                                        ...
                                        <td class="px-6 py-4">
                                            <input type="text" 
                                                   name="descriptions[<?php echo e($subject->id); ?>]" 
                                                   value="<?php echo e($existingDesc); ?>"
                                                   @input="isDirty = true"
                                                   @keydown="handleKeydown($event, <?php echo e($index); ?>, 'desc')"
                                                   class="input-desc w-full rounded-xl border-slate-200 bg-slate-50 focus:bg-white focus:border-fuchsia-500 focus:ring-fuchsia-500 text-sm font-medium text-slate-600 py-2.5 px-4 transition-all shadow-sm"
                    ...
                    <div class="p-6 bg-white border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between sticky bottom-0 z-20 shadow-[0_-10px_40px_rgba(0,0,0,0.05)] gap-4">
                        <div class="text-xs text-slate-400 font-medium hidden sm:block">
                            ...
                            <span>Menilai siswa <strong><?php echo e($student->name); ?></strong></span>
                        </div>
                        <div class="flex gap-3 w-full sm:w-auto">
                            ...
                            <button type="submit" class="px-8 py-3 bg-fuchsia-600 text-white font-bold rounded-xl hover:bg-fuchsia-700 shadow-lg shadow-fuchsia-500/30 transition flex items-center justify-center gap-2 w-full sm:w-auto transform active:scale-95">
                                <i class="ph-bold ph-floppy-disk text-lg"></i> Simpan Nilai
                            </button>
                        </div>
                    </div>
                </div>
...
<?php endif; ?><?php /**PATH E:\drive aplikasi\aplikasi terpadu\sistem_absensi_sekolah versi 3.00\resources\views/grades/create-by-student.blade.php ENDPATH**/ ?>