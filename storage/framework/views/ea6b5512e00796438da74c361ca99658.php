                ...
                <div class="relative rounded-[2rem] bg-gray-900 bg-gradient-to-br from-slate-900 via-indigo-900 to-indigo-800 p-8 text-white shadow-xl shadow-indigo-900/30 overflow-hidden border border-white/10">
                    ...
                    <div class="relative z-10">
                        <div class="flex items-center gap-2 mb-2">
                                <a href="<?php echo e(route('bank.index')); ?>" class="text-xs font-bold text-blue-300 hover:text-white transition flex items-center gap-1"><i class="ph-bold ph-arrow-left"></i> Kembali</a>
            ...
            <div class="flex min-h-screen items-center justify-center p-4">
                <div class="relative transform overflow-hidden rounded-[2.5rem] bg-white text-left shadow-2xl transition-all sm:w-full sm:max-w-md border border-slate-100">
                    <div class="px-8 py-6 border-b border-slate-100 flex justify-between items-center">
                        <h3 class="text-xl font-black text-slate-800 flex items-center gap-2"><i class="ph-fill ph-file-arrow-up text-indigo-600"></i> Import dari Excel</h3>
                    ...
                    <form action="<?php echo e(route('bank.questions.import', $bank->id)); ?>" method="POST" enctype="multipart/form-data" class="p-8 space-y-6">
                        ...
                        <div class="bg-indigo-50 p-4 rounded-2xl border border-indigo-100 mb-4">
                            ...
                            <a href="<?php echo e(route('bank.questions.template')); ?>" class="inline-flex items-center gap-1 mt-2 text-xs font-black text-indigo-600 hover:underline">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="file" name="file" required class="block w-full text-xs text-slate-500 file:mr-4 file:py-3 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-bold file:bg-indigo-600 file:text-white hover:file:bg-indigo-700 cursor-pointer border border-slate-200 rounded-xl bg-slate-50">
                        </div>
                        ...
                        <div class="flex gap-3 pt-4">
                            ...
                            <button type="submit" class="flex-1 py-3 bg-indigo-600 text-white font-bold rounded-xl hover:bg-indigo-700 transition shadow-lg shadow-indigo-500/30 text-sm">Mulai Import</button>
                        </div>
                    </form>
                </div>
            </div>
...
<?php endif; ?><?php /**PATH C:\Users\ronie\Documents\aplikasi terpadu\sistem_absensi_sekolah\resources\views/cbt/bank/questions.blade.php ENDPATH**/ ?>