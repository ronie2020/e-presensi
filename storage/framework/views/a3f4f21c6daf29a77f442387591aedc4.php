                            ...
                            <form action="<?php echo e(route('cbt.questions.store', $exam->id)); ?>" method="POST" enctype="multipart/form-data" class="space-y-5" id="createQuestionForm">
                                ...
                                <div class="space-y-3 pt-2">
                                    ...
                                    <div class="flex gap-3 items-center group">
                                        ...
                                        <input type="text" name="option_<?php echo e($opt); ?>" required class="flex-1 rounded-xl border-slate-200 bg-white text-sm py-2.5 px-4 focus:ring-blue-500 focus:border-blue-500 font-medium" placeholder="Jawaban <?php echo e($opt); ?>">
                                    </div>
                ...
                <div class="flex min-h-screen items-center justify-center p-4">
                    <div class="relative transform overflow-hidden rounded-[2.5rem] bg-white text-left shadow-2xl transition-all sm:w-full sm:max-w-md border border-slate-100">
                        <div class="bg-white p-8 text-center">
                            ...
                            <?php $banks = \App\Models\CbtQuestionBank::withCount('questions')->orderBy('created_at', 'desc')->get(); ?>
                            <form action="<?php echo e(route('cbt.import_from_bank', $exam->id)); ?>" method="POST" class="space-y-5 text-left">
                                <?php echo csrf_field(); ?>
                                <div>
                                    ...
                                    <select name="bank_id" required class="w-full rounded-xl border-slate-200 font-bold text-slate-700 py-3 px-4 focus:ring-indigo-500 bg-white">
                                        ...
                                        <?php $__currentLoopData = $banks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($b->id); ?>"><?php echo e($b->title); ?> (<?php echo e($b->subject_name); ?> - Kls <?php echo e($b->class_level); ?>) - <?php echo e($b->questions_count); ?> Soal</option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                ...
                <div class="flex min-h-screen items-center justify-center p-4">
                    <div class="relative transform overflow-hidden rounded-[2.5rem] bg-white text-left shadow-2xl transition-all sm:w-full sm:max-w-md border border-slate-100">
                        <div class="bg-white p-8 text-center">
                            ...
                            <p class="text-sm text-slate-500 mb-6 font-medium">Amankan <?php echo e($exam->questions->count()); ?> soal ini ke dalam Bank Soal agar bisa digunakan kembali.</p>
                            
                            <form action="<?php echo e(route('cbt.export_to_bank', $exam->id)); ?>" method="POST" class="space-y-5 text-left">
                                <?php echo csrf_field(); ?>
                                ...
                                <div x-show="exportMode === 'new'">
                                    ...
                                    <input type="text" name="new_title" value="Bank Soal: <?php echo e($exam->title); ?>" class="w-full rounded-xl border-slate-200 font-bold text-slate-700 py-3 px-4 focus:ring-blue-500">
                                </div>
                ...
                <div class="flex min-h-screen items-center justify-center p-4">
                    <div class="relative transform overflow-hidden rounded-[2.5rem] bg-white text-left shadow-2xl transition-all sm:w-full sm:max-w-md border border-slate-100">
                        <div class="bg-white p-8 text-center">
                            ...
                            <div class="mb-6"><a href="<?php echo e(route('cbt.questions.template')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 bg-slate-100 text-slate-600 rounded-xl text-xs font-bold hover:bg-slate-200 border border-slate-200"><i class="ph-bold ph-download-simple text-lg"></i> Download Template</a></div>
