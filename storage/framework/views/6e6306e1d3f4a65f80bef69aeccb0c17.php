...
<head>
    ...
    <title>Cetak Bebas Pustaka - <?php echo e($student->name); ?></title>
...
<body>
    ...
    <div class="no-print fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-md border-b border-slate-200 shadow-sm p-4 flex justify-between items-center z-50">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-xs text-slate-500 font-sans font-bold"><?php echo e($student->name); ?> - <?php echo e($student->schoolClass ? $student->schoolClass->name : 'Kelas Tidak Diketahui'); ?></p>
            </div>
        </div>
        <div class="flex gap-3">
            
            <a href="<?php echo e(route('library.tools.bebas_pustaka')); ?>" class="px-5 py-2.5 text-xs font-bold text-slate-600 bg-white border border-slate-300 rounded-xl hover:bg-slate-50 hover:text-slate-800 transition shadow-sm font-sans flex items-center gap-2">
    ...
    <div class="sheet">
         <div class="relative py-2">
            <img src="<?php echo e(asset('img/logo_ciamis.png')); ?>" alt="Logo Ciamis" class="absolute left-0 top-1 w-20 h-auto object-contain" onerror="this.style.display='none'"> 
            ...
            <img src="<?php echo e(asset('img/logo_sekolah.png')); ?>" alt="Logo Sekolah" class="absolute right-0 top-1 w-24 h-auto object-contain" onerror="this.style.display='none'">
        </div>
        <div class="double-line"></div>

        <div class="judul-surat">
            <h2>SURAT KETERANGAN BEBAS PERPUSTAKAAN</h2>
            <p>Nomor: 421.3 / &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; / SMPN.3 / <?php echo e(date('Y')); ?></p>
        </div>
        ...
        <div class="isi-surat">
            ...
            <table class="identitas">
                ...
                <tr>
                    <td>Kelas</td>
                    <td>:</td>
                    <td><?php echo e($student->schoolClass ? $student->schoolClass->name : '-'); ?></td>
                </tr>
            </table>
        ...
        <div class="ttd-box">
            <p>Lakbok, <?php echo e(\Carbon\Carbon::now()->isoFormat('D MMMM Y')); ?></p>
...
</html><?php /**PATH C:\Users\ronie\Documents\aplikasi terpadu\sistem_absensi_sekolah\resources\views/library/reports/print-bebas-pustaka.blade.php ENDPATH**/ ?>