        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-5 rounded-[2rem] shadow-sm border border-slate-100">
                <div>
                    <div class="flex items-center gap-2 text-slate-400 text-sm font-bold mb-1">
                        <a href="<?php echo e(route('cbt.index')); ?>" class="hover:text-[#0d52a1] transition flex items-center gap-1">
                            <i class="ph-bold ph-folders"></i> Dashboard Folder
                        </a>
                        <span>/</span>
                        <span class="text-[#0d52a1]"><?php echo e($event->name); ?></span>
                    </div>
                    <h1 class="text-2xl font-black text-[#2c3f61] tracking-tight">Manajemen Ujian</h1>
                </div>
                <div class="flex gap-2 w-full md:w-auto">
                    <a href="<?php echo e(route('cbt.create', ['event_id' => $event->id])); ?>" class="w-full md:w-auto px-6 py-3 bg-[#2c3f61] text-white font-bold rounded-xl hover:bg-[#1c2940] transition shadow-lg shadow-[#2c3f61]/20 flex items-center justify-center gap-2">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                <div class="bg-white rounded-[2rem] p-5 border border-slate-100 shadow-xl shadow-[#56bbf1]/5 flex items-center gap-4 hover:-translate-y-1 transition-transform">
                    ...
                    <div><p class="text-[10px] text-slate-400 font-bold uppercase mb-0.5 tracking-wider">Ujian Aktif</p><h4 class="text-2xl font-black text-[#2c3f61]"><?php echo e($stats['active_exams']); ?></h4></div>
                </div>
                <div class="bg-white rounded-[2rem] p-5 border border-slate-100 shadow-xl shadow-[#56bbf1]/5 flex items-center gap-4 hover:-translate-y-1 transition-transform">
                    ...
                    <div><p class="text-[10px] text-slate-400 font-bold uppercase mb-0.5 tracking-wider">Total Soal</p><h4 class="text-2xl font-black text-[#2c3f61]"><?php echo e(number_format($stats['total_questions'])); ?></h4></div>
                </div>
                <div class="bg-white rounded-[2rem] p-5 border border-slate-100 shadow-xl shadow-[#56bbf1]/5 flex items-center gap-4 hover:-translate-y-1 transition-transform">
                    ...
                    <div><p class="text-[10px] text-slate-400 font-bold uppercase mb-0.5 tracking-wider">Siswa Ujian</p><h4 class="text-2xl font-black text-[#2c3f61]"><?php echo e(number_format($stats['students_working'])); ?></h4></div>
                </div>
                <div class="bg-white rounded-[2rem] p-5 border border-slate-100 shadow-xl shadow-[#56bbf1]/5 flex items-center gap-4 hover:-translate-y-1 transition-transform">
                    ...
                    <div><p class="text-[10px] text-slate-400 font-bold uppercase mb-0.5 tracking-wider">Rata Nilai</p><h4 class="text-2xl font-black text-[#2c3f61]"><?php echo e(number_format($stats['avg_score'], 1)); ?></h4></div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="col-span-full mb-2 mt-4 first:mt-0">
                        <div class="flex items-center gap-4">
                            <div class="bg-white border border-slate-200 rounded-[1rem] p-3 pr-5 flex items-center gap-3 shadow-sm w-max cursor-default">
                                <div class="w-10 h-10 rounded-[0.75rem] flex items-center justify-center shadow-sm border <?php echo e($dateLabel === 'Belum Dijadwalkan' ? 'bg-rose-50 border-rose-100 text-rose-500' : 'bg-[#e5eff5] border-[#56bbf1]/30 text-[#0d52a1]'); ?>">
                                ...
                                <div>
                                    ...
                                    <h3 class="text-sm font-black <?php echo e($dateLabel === 'Belum Dijadwalkan' ? 'text-rose-600' : 'text-[#2c3f61]'); ?>"><?php echo e($dateLabel); ?></h3>
                                </div>
                            </div>
                        ...
                        <div class="bg-white border border-slate-100 rounded-[2.5rem] p-6 hover:shadow-xl hover:shadow-[#56bbf1]/10 hover:border-[#56bbf1]/50 transition-all duration-300 group relative flex flex-col h-full">
                           ...
                           <div class="absolute top-6 right-6 z-10" title="Aktifkan / Nonaktifkan Ujian">
                            ...
                            <div class="mb-4 pr-16">
                                ...
                                <h4 class="font-black text-xl text-[#2c3f61] leading-tight group-hover:text-[#0d52a1] transition-colors line-clamp-2"><?php echo e($exam->title); ?></h4>
                            </div>
                            ...
                            <div class="flex-1 space-y-4">
                                <div class="bg-white border border-slate-200 rounded-2xl p-4 flex items-center justify-between group/token cursor-pointer hover:bg-[#e5eff5]/50 hover:border-[#56bbf1]/50 transition shadow-sm" onclick="copyToken('<?php echo e($exam->token); ?>')">
                                    <div>
                                        <span class="text-[10px] text-slate-400 uppercase font-bold tracking-wider block mb-0.5">Token Ujian</span>
                                        <span class="font-mono font-black text-xl text-[#2c3f61] tracking-widest group-hover/token:text-[#0d52a1]"><?php echo e($exam->token); ?></span>
                                    </div>
                                ...
                                <div class="flex items-center gap-4 text-xs text-slate-500 font-bold">
                                    <span class="flex items-center gap-1.5"><i class="ph-bold ph-users text-[#c86845]"></i> Kelas <?php echo e($exam->class_level); ?></span>
                                    <span class="flex items-center gap-1.5"><i class="ph-bold ph-clock text-[#56bbf1]"></i> <?php echo e($exam->duration_minutes); ?> Menit</span>
                                </div>
                            </div>
                            ...
                            <div class="mt-5 pt-4 border-t border-slate-100 grid grid-cols-2 gap-2">
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e(route('cbt.questions.manage', $exam->id)); ?>" class="flex items-center justify-center p-2.5 bg-[#e5eff5] text-[#0d52a1] border border-[#56bbf1]/30 rounded-xl text-xs font-bold hover:bg-[#0d52a1] hover:text-white transition-all group/btn active:scale-95" title="Kelola Soal Ujian">
                                        <i class="ph-bold ph-list-numbers text-lg mr-2"></i> Soal
                                    </a>
                                <?php endif; ?>
                                <a href="<?php echo e(route('cbt.monitoring', $exam->id)); ?>" class="flex items-center justify-center p-2.5 bg-[#56bbf1]/10 text-[#0d52a1] rounded-xl text-xs font-bold hover:bg-[#56bbf1] hover:text-white transition-all active:scale-95">
                                    <i class="ph-bold ph-desktop text-lg mr-2"></i> Monitor
                                </a>

                                <!-- Baris 2: Rekap -->
                                <a href="<?php echo e(route('cbt.recap', $exam->id)); ?>" class="col-span-2 flex items-center justify-center p-2.5 bg-[#2c3f61] text-white rounded-xl text-xs font-bold hover:bg-[#1c2940] transition-all shadow-md shadow-[#2c3f61]/20 active:scale-95">
                                    <i class="ph-bold ph-chart-bar text-lg mr-2"></i> Rekapitulasi Nilai
                                </a>

                                <!-- Baris 3: SEB & Edit -->
                                <a href="<?php echo e(route('cbt.download_seb', $exam->id)); ?>" class="col-span-1 flex items-center justify-center p-2.5 bg-white border border-slate-200 text-slate-600 rounded-xl text-xs font-bold hover:bg-slate-50 hover:text-[#0d52a1] hover:border-[#56bbf1]/50 transition-all">
                                    <i class="ph-bold ph-file-lock text-lg mr-2"></i> SEB
                                </a>
                                <a href="<?php echo e(route('cbt.edit', $exam->id)); ?>" class="col-span-1 flex items-center justify-center p-2.5 bg-white border border-slate-200 text-slate-600 rounded-xl text-xs font-bold hover:bg-slate-50 hover:text-[#0d52a1] hover:border-[#56bbf1]/50 transition-all">
                                ...
                                <button onclick="confirmDelete('<?php echo e($exam->id); ?>')" class="col-span-1 flex items-center justify-center p-2.5 bg-white border border-rose-200 text-rose-500 rounded-xl text-xs font-bold hover:bg-rose-50 hover:text-rose-600 transition-all active:scale-95">
                                ...
                                <a href="<?php echo e(route('cbt.attendance', $exam->id)); ?>" target="_blank" class="col-span-1 flex items-center justify-center p-2.5 bg-white border border-slate-200 text-slate-600 rounded-xl text-xs font-bold hover:bg-slate-50 hover:text-[#0d52a1] hover:border-[#56bbf1]/50 transition-all">
                                    <i class="ph-bold ph-users-three text-lg mr-2"></i> Absen
                                </a>
                                <a href="<?php echo e(route('cbt.minutes', $exam->id)); ?>" target="_blank" class="col-span-1 flex items-center justify-center p-2.5 bg-white border border-slate-200 text-slate-600 rounded-xl text-xs font-bold hover:bg-slate-50 hover:text-[#0d52a1] hover:border-[#56bbf1]/50 transition-all">
               ...
               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    ...
                    <div class="col-span-1 md:col-span-2 lg:col-span-3 text-center py-20 bg-white rounded-[2.5rem] border-2 border-dashed border-slate-200 mt-4">
                        ...
                        <a href="<?php echo e(route('cbt.create', ['event_id' => $event->id])); ?>" class="inline-flex items-center gap-2 px-6 py-3.5 bg-[#2c3f61] text-white rounded-xl font-bold hover:bg-[#1c2940] transition shadow-lg shadow-[#2c3f61]/30 text-sm">
...
<?php endif; ?><?php /**PATH C:\Users\ronie\Documents\aplikasi terpadu\sistem_absensi_sekolah\resources\views/cbt/show_event.blade.php ENDPATH**/ ?>