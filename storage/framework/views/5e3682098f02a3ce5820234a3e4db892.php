                ...
                <div x-show="mode === 'note'" class="lg:col-span-5 h-full">
                    ...
                    <div class="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 overflow-hidden flex flex-col h-[650px] hover:shadow-[#56bbf1]/5 transition-all">
                        <div class="p-8 border-b border-slate-50 flex items-center justify-between">
                            ...
                            <span class="bg-[#56bbf1]/10 text-[10px] font-black px-4 py-1.5 rounded-full text-[#0d52a1] uppercase tracking-widest"><?php echo e($messages->total()); ?> Data</span>
                        </div>
                                ...
                                <div class="p-6 bg-white rounded-[2rem] border border-slate-100 hover:border-[#56bbf1]/40 transition-all group shadow-sm">
                                    <div class="flex items-center justify-between mb-4">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p class="text-xs font-black text-[#2c3f61]"><?php echo e($msg->student->name ?? 'Siswa'); ?></p>
                                    ...
                                    <h4 class="font-black text-[#2c3f61] text-sm mb-2 group-hover:text-[#0d52a1] transition-colors uppercase tracking-tight"><?php echo e($msg->title); ?></h4>
