...
<div class="bg-slate-950 text-white pt-24 pb-12 relative overflow-hidden">
    ...
    <div class="absolute -right-20 top-20 w-96 h-96 bg-cyan-600 rounded-full mix-blend-overlay filter blur-[100px] opacity-20"></div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="mb-24">
            ...
            <div class="grid gap-6 md:grid-cols-3">
                <?php $__empty_1 = true; $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <article class="bg-slate-900/50 backdrop-blur-md rounded-2xl p-6 border border-slate-800 hover:border-cyan-500/50 transition-all duration-300 hover:bg-slate-900 hover:-translate-y-1 group h-full flex flex-col cursor-pointer" @click="openAnnouncementByIndex(<?php echo e($index); ?>)" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                        <div class="flex justify-between items-start mb-4">
                            <span class="px-2 py-1 rounded bg-cyan-500/10 text-cyan-400 text-[10px] font-bold uppercase tracking-wide border border-cyan-500/20">Info</span>
                            <span class="text-xs text-slate-500 font-medium flex items-center gap-1">
                                <i class="ph-fill ph-calendar-blank"></i> <?php echo e($item->created_at->format('d M')); ?>

                            </span>
                        </div>
                        <h3 class="text-lg font-bold text-white mb-3 line-clamp-2 group-hover:text-cyan-400 transition-colors"><?php echo e($item->title); ?></h3>
                        ...
                        <div class="flex items-center text-sm text-cyan-400 font-semibold mt-auto gap-1 group-hover:gap-2 transition-all">
                            Baca Selengkapnya <i class="ph-bold ph-arrow-right text-xs"></i>
                        </div>
                    </article>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="col-span-3 text-center py-12 border border-dashed border-slate-800 rounded-xl bg-slate-900/30">
        ...
        <!-- AGENDA KEGIATAN -->
        <div class="bg-slate-900/50 rounded-3xl p-8 mb-16 border border-slate-800 backdrop-blur-md">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <?php $__empty_1 = true; $__currentLoopData = $agendas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agenda): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="bg-slate-800/50 p-4 rounded-xl border-l-4 border-<?php echo e($color); ?>-500 flex items-start gap-4 hover:bg-slate-800 transition cursor-default group h-full">
                        <div class="text-center bg-slate-900 p-2 rounded-lg min-w-[60px] shadow-lg group-hover:bg-slate-950 transition-colors shrink-0">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16 border-t border-slate-800 pt-16">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-slate-400">
                    <li><a href="#profil" class="hover:text-cyan-400 transition-colors flex items-center gap-2"><i class="ph-bold ph-caret-right text-xs"></i> Profil Sekolah</a></li>
                    <li><a href="#guru" class="hover:text-cyan-400 transition-colors flex items-center gap-2"><i class="ph-bold ph-caret-right text-xs"></i> Tenaga Pendidik</a></li>
                    <li><a href="#kegiatan" class="hover:text-cyan-400 transition-colors flex items-center gap-2"><i class="ph-bold ph-caret-right text-xs"></i> Galeri Kegiatan</a></li>
                    <li><a href="<?php echo e(route('login')); ?>" class="hover:text-cyan-400 transition-colors flex items-center gap-2"><i class="ph-bold ph-caret-right text-xs"></i> Login Staff</a></li>
                </ul>
            </div>
            <div>
                ...
                <ul class="space-y-4 text-sm text-slate-400">
                    <li class="flex items-start gap-3">
                        <i class="ph-fill ph-map-pin mt-1 text-cyan-500 shrink-0"></i>
                        <span class="leading-relaxed">Jl. Mekarjaya No.199 Sidaharja Kec. Lakbok, Kab. Ciamis, Jawa Barat 46385</span>
                    </li>
                    <li class="flex items-center gap-3">
                        <i class="ph-fill ph-phone text-cyan-500 shrink-0"></i>
                        <span>+62 85135961994</span>
                    </li>
                    <li class="flex items-center gap-3">
                        <i class="ph-fill ph-envelope text-cyan-500 shrink-0"></i>
        ...
        <!-- COPYRIGHT -->
        <div class="text-center pt-8 border-t border-slate-800/80">
