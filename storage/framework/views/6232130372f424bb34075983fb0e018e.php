            ...
            <div class="grid gap-6 md:grid-cols-3">
                <?php $__empty_1 = true; $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <article class="bg-white dark:bg-slate-900/50 backdrop-blur-md rounded-2xl p-6 border border-slate-200 dark:border-slate-800 hover:border-elevate-accent dark:hover:border-elevate-accent/50 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 group h-full flex flex-col cursor-pointer" @click="openAnnouncementByIndex(<?php echo e($index); ?>)" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                        ...
                        <h3 class="text-lg font-bold text-slate-800 dark:text-white mb-3 line-clamp-2 group-hover:text-elevate-primary dark:group-hover:text-elevate-accent transition-colors"><?php echo e($item->title); ?></h3>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $agendas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agenda): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-xl border-l-4 border-elevate-accent flex items-start gap-4 hover:bg-slate-100 dark:hover:bg-slate-800 transition cursor-default group h-full">
                        <div class="text-center bg-white dark:bg-slate-900 border border-slate-200 dark:border-none p-2 rounded-lg min-w-[60px] shadow-sm dark:shadow-lg transition-colors shrink-0 group-hover:border-elevate-accent/50">
                            ...
                            <span class="block text-xl font-bold text-elevate-dark dark:text-white"><?php echo e($agenda->event_date->format('d')); ?></span>
                        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16 border-t border-slate-200 dark:border-slate-800 pt-16">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-slate-500 dark:text-slate-400">
                    ...
                    <li><a href="<?php echo e(route('login')); ?>" class="hover:text-elevate-primary dark:hover:text-elevate-accent transition-colors flex items-center gap-2"><i class="ph-bold ph-caret-right text-xs"></i> Login Staff</a></li>
                </ul>
            </div>
            <div>
