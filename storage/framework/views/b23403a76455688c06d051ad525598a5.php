    ...
    <div class="w-full max-w-lg z-10 animate-enter">
        ...
        <div class="text-center mb-12 animate-enter">
            ...
            <h1 class="text-4xl md:text-6xl font-black text-elevate-dark tracking-tight mb-4">
                Hasil Seleksi <span class="text-transparent bg-clip-text bg-gradient-to-r from-elevate-primary to-elevate-accent">PPDB <?php echo e(date('Y')); ?></span>
            </h1>
        </div>
                        ...
                        <div class="mb-10">
                            ...
                            <?php if(isset($announcementDate)): ?>
                                ...
                                <div class="inline-block px-6 py-3 rounded-2xl bg-elevate-soft border border-elevate-accent/30">
                                    <p class="text-xl text-elevate-primary font-black font-mono"><?php echo e($announcementDate->translatedFormat('l, d F Y - H:i')); ?> WIB</p>
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                            <?php $__currentLoopData = ['Hari' => 'days', 'Jam' => 'hours', 'Menit' => 'minutes', 'Detik' => 'seconds']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="countdown-box rounded-2xl p-6 flex flex-col items-center justify-center aspect-square md:aspect-auto group hover:border-elevate-accent/50 transition-colors">
                                    <span id="<?php echo e($id); ?>" class="text-4xl md:text-5xl font-black text-elevate-dark font-mono tracking-tighter mb-2 group-hover:text-elevate-primary transition-colors">00</span>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\aplikasi terpadu\sistem_absensi_sekolah\resources\views/ppdb/check.blade.php ENDPATH**/ ?>