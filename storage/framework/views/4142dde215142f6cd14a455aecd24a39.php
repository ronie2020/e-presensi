            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div>
                    ...
                    <p class="text-slate-500 font-medium text-sm mt-1">
                        No. Reg: <span class="font-mono font-bold text-slate-700 bg-slate-100 px-2 py-0.5 rounded"><?php echo e($registrant->registration_number); ?></span>
                    </p>
                </div>
                <div class="flex gap-3">
                    <a href="<?php echo e(route('admin.ppdb.index')); ?>" class="px-4 py-2.5 bg-white border border-slate-300 rounded-xl text-sm font-bold text-slate-600 hover:bg-slate-50 transition shadow-sm flex items-center gap-2">
                        <i class="ph-bold ph-arrow-left"></i> Kembali
                    </a>
                    
                    
                    <a href="<?php echo e(route('admin.ppdb.print', $registrant->id)); ?>" target="_blank" class="px-4 py-2.5 bg-slate-800 text-white rounded-xl text-sm font-bold hover:bg-slate-700 transition shadow-lg shadow-slate-900/20 flex items-center gap-2">
                ...
                <div class="space-y-8">
                    ...
                    <div class="bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden p-6">
                        <div class="text-center mb-6">
                            ...
                            <h2 class="text-xl font-bold text-slate-800"><?php echo e($registrant->full_name); ?></h2>
                            <p class="text-sm text-slate-500 font-medium"><?php echo e($registrant->school_origin); ?></p>
                        </div>

                        <form action="<?php echo e(route('admin.ppdb.update_status', $registrant->id)); ?>" method="POST" class="bg-slate-50 rounded-2xl p-5 border border-slate-200">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="flex gap-2 mb-4">
                                <select name="status" class="w-full rounded-xl border-slate-300 text-sm font-bold focus:ring-blue-500 focus:border-blue-500">
                                    <option value="pending" <?php echo e($registrant->status == 'pending' ? 'selected' : ''); ?>>Pending</option>
                            ...
                            <textarea name="admin_note" rows="2" class="w-full rounded-xl border-slate-300 text-sm focus:ring-blue-500 focus:border-blue-500 mb-4" placeholder="Misal: Lulus jalur prestasi..."><?php echo e($registrant->admin_note); ?></textarea>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="font-bold text-slate-800 capitalize flex items-center gap-2">
                                    <?php if($registrant->track == 'prestasi'): ?> <i class="ph-fill ph-trophy text-yellow-500"></i> <?php endif; ?>
                                    <?php if($registrant->track == 'zonasi'): ?> <i class="ph-fill ph-map-pin text-red-500"></i> <?php endif; ?>
                                    <?php if($registrant->track == 'afirmasi'): ?> <i class="ph-fill ph-hand-heart text-purple-500"></i> <?php endif; ?>
                                    <?php echo e($registrant->track); ?>

                                </p>
                            </div>
                            
                            <?php if($registrant->track == 'prestasi'): ?>
                            <div class="bg-yellow-50 p-3 rounded-xl border border-yellow-100">
                                ...
                                <p class="text-sm font-bold text-slate-800"><?php echo e($registrant->achievement_name ?? '-'); ?></p>
                                <p class="text-xs text-slate-600"><?php echo e($registrant->achievement_level); ?> - <?php echo e($registrant->achievement_rank); ?></p>
                                
                                
                                <?php if($registrant->file_achievement): ?>
                                    <a href="<?php echo e(asset('storage/' . $registrant->file_achievement)); ?>" target="_blank" class="w-full flex items-center justify-center gap-2 bg-white border border-yellow-200 text-yellow-700 px-3 py-2 rounded-lg text-xs font-bold hover:bg-yellow-100 transition shadow-sm mt-2">
                            ...
                            <div>
                                ...
                                <p class="text-2xl font-black text-blue-600"><?php echo e($registrant->average_grade); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-white rounded-3xl shadow-sm border border-slate-200 p-6 sm:p-8">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-y-6 gap-x-8">
                            <div>
                                ...
                                <p class="font-bold text-slate-700"><?php echo e($registrant->nisn); ?></p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <p class="font-bold text-slate-700">
                                    <?php echo e($registrant->birth_place); ?>, <?php echo e(\Carbon\Carbon::parse($registrant->birth_date)->translatedFormat('d F Y')); ?>

                                </p>
                            </div>
                            <div>
                                <p class="text-xs text-slate-400 font-bold uppercase">Jenis Kelamin</p>
                                <p class="font-bold text-slate-700"><?php echo e($registrant->gender == 'L' ? 'Laki-laki' : 'Perempuan'); ?></p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <p class="font-bold text-slate-700"><?php echo e($registrant->student_phone ?? '-'); ?></p>
                            </div>
                            <div class="sm:col-span-2">
                                <p class="text-xs text-slate-400 font-bold uppercase">Alamat Lengkap</p>
                                <p class="font-bold text-slate-700"><?php echo e($registrant->address); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-3xl shadow-sm border border-slate-200 p-6 sm:p-8">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-y-6 gap-x-8">
                            ...
                            <div>
                                ...
                                <p class="font-bold text-slate-700"><?php echo e($registrant->parent_job ?? '-'); ?></p>
                            </div>
                            <div>
                                <p class="text-xs text-slate-400 font-bold uppercase">Penghasilan</p>
                                <p class="font-bold text-slate-700"><?php echo e($registrant->parent_income ?? '-'); ?></p>
                            </div>
                            <div>
                                ...
                                <p class="font-bold text-slate-700 flex items-center gap-2">
                                    <?php echo e($registrant->parent_phone); ?>

                                    <a href="https://wa.me/<?php echo e(preg_replace('/^0/', '62', $registrant->parent_phone)); ?>" target="_blank" class="text-green-500 hover:text-green-600">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            <?php $__currentLoopData = [
                                ...
                                <?php if($registrant->$field): ?>
                                    <a href="<?php echo e(asset('storage/' . $registrant->$field)); ?>" target="_blank" class="group p-4 rounded-xl border border-slate-200 bg-slate-50 hover:bg-white hover:border-blue-300 hover:shadow-md transition flex items-center gap-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <p class="font-bold text-sm text-slate-700 group-hover:text-blue-700 truncate"><?php echo e($label); ?></p>
...
<?php endif; ?><?php /**PATH E:\drive aplikasi\aplikasi terpadu\sistem_absensi_sekolah versi 3.00\resources\views/admin/ppdb/show.blade.php ENDPATH**/ ?>