...
<head>
    ...
    <title>Surat Peringatan - <?php echo e($student->name); ?></title>
    <style>
...
<body>
    ...
    <div class="page-container">
        <div class="outer-border">
            ...
            <!-- HEADER / KOP -->
            <div class="header">
                <img src="<?php echo e(asset('img/logo_ciamis.png')); ?>" class="logo-left" onerror="this.style.display='none'">
                ...
                <img src="<?php echo e(asset('img/logo_sekolah.png')); ?>" class="logo-right" onerror="this.style.display='none'">
            </div>
            ...
            <!-- JUDUL -->
            <div class="judul-box">
                <h1>SURAT PERINGATAN <?php echo e($spLevel); ?></h1>
                <p>Nomor: 421.3 / BK / <?php echo e(date('Y')); ?> / <?php echo e(str_pad($student->id, 3, '0', STR_PAD_LEFT)); ?></p>
            </div>
            ...
            <div class="content">
                ...
                <table class="student-info">
                    <tr><td width="160">Nama Lengkap</td><td width="10">:</td><td style="font-weight: bold; text-transform: uppercase;"><?php echo e($student->name); ?></td></tr>
                    <tr><td>NIS / NISN</td><td>:</td><td><?php echo e($student->nis); ?> / <?php echo e($student->student_id); ?></td></tr>
                    <tr><td>Kelas</td><td>:</td><td><?php echo e($student->schoolClass->name ?? '-'); ?></td></tr>
                    <tr><td>Total Poin Pelanggaran</td><td>:</td><td style="color: #dc2626; font-weight: bold;"><?php echo e($totalMinus); ?> Poin</td></tr>
                </table>
            ...
            <div class="footer-section">
                <div class="ttd-grid">
                    ...
                    <div class="ttd-col">
                        ...
                        <div class="ttd-space"></div>
                        <p style="font-weight: bold; text-decoration: underline;"><?php echo e(auth()->user()->name ?? 'GURU BK'); ?></p>
                        <p>NIP. ...................................</p>
                    </div>
                </div>
            </div>
...
</html><?php /**PATH E:\aplikasi terpadu\sistem_absensi_sekolah\resources\views\discipline\sp_print.blade.php ENDPATH**/ ?>