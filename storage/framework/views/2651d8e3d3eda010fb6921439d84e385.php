...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-8 sm:py-10 font-sans text-slate-800">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <a href="<?php echo e(route('library.books.index')); ?>" class="inline-flex items-center gap-2 text-sm font-bold text-slate-500 hover:text-cyan-600 mb-6 transition-colors group">
                            ...
                            <div class="space-y-5">
                                ...
                                <div class="mt-4">
                                    <label class="flex items-center gap-3 p-4 border border-cyan-200 bg-white rounded-xl cursor-pointer hover:bg-cyan-50 transition">
                                        <input type="checkbox" name="is_textbook" value="1" <?php echo e(old('is_textbook') ? 'checked' : ''); ?> class="w-5 h-5 text-cyan-600 border-cyan-300 rounded focus:ring-cyan-500 cursor-pointer">
                                        <div>
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <textarea name="description" rows="3" placeholder="Tuliskan deskripsi singkat tentang isi buku..."
                                        class="w-full px-4 py-3 rounded-2xl border-cyan-200 bg-white focus:border-cyan-500 focus:ring-cyan-500 font-medium text-slate-600 transition-all shadow-sm custom-scrollbar text-sm resize-none"><?php echo e(old('description')); ?></textarea>
                                </div>
                            </div>
                        </div>
