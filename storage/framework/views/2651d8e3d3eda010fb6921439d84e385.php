                                    ...
                                    <div class="space-y-5">
                                        ...
                                        <div class="grid grid-cols-2 gap-4 bg-white p-2 rounded-2xl border border-slate-200 shadow-sm">
                                            <label class="relative cursor-pointer">
                                                <input type="radio" name="generation_mode" value="manual" class="peer sr-only" onchange="toggleMode()" checked>
                                            ...
                                            <label class="relative cursor-pointer">
                                                <input type="radio" name="generation_mode" value="auto" class="peer sr-only" onchange="toggleMode()">
                                        ...
                                        <div id="manualArea" class="bg-indigo-50 border border-indigo-100 p-5 rounded-2xl animate-fade-in-down">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div id="autoArea" class="hidden bg-blue-50 border border-blue-100 p-5 rounded-2xl animate-fade-in-down">
