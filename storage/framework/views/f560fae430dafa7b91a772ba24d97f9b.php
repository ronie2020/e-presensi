<!-- MONITORING 7 KEBIASAAN SECTION -->
                ...
                <div class="w-full lg:w-5/12" data-aos="fade-right">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="bg-slate-50 dark:bg-slate-800 p-6 rounded-2xl border border-slate-100 dark:border-slate-700 hover:shadow-xl hover:shadow-cyan-500/5 transition-all group">
                            ...
                            <p class="text-3xl font-black text-slate-800 dark:text-white"><?php echo e($habitStats['submitted'] ?? 0); ?> <span class="text-xs font-bold text-slate-400 dark:text-slate-500">Siswa</span></p>
                        </div>
                        ...
                        <div class="bg-slate-50 dark:bg-slate-800 p-6 rounded-2xl border border-slate-100 dark:border-slate-700 hover:shadow-xl hover:shadow-amber-500/5 transition-all group">
                            ...
                            <p class="text-3xl font-black text-slate-800 dark:text-white"><?php echo e($habitStats['missing'] ?? 0); ?> <span class="text-xs font-bold text-slate-400 dark:text-slate-500">Siswa</span></p>
                        </div>
                        ...
                        <div class="sm:col-span-2 bg-gradient-to-br from-cyan-500 to-blue-600 p-6 rounded-2xl shadow-lg shadow-cyan-500/20 flex items-center justify-between group">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <p class="text-[10px] font-extrabold text-cyan-50 uppercase tracking-widest">Tingkat Partisipasi</p>
                    ...
                    <div class="bg-slate-900 rounded-[2.5rem] shadow-2xl p-6 lg:p-10 border border-slate-800">
                        <div class="flex items-center justify-between mb-8 border-b border-slate-800 pb-6">
                            <h3 class="font-bold text-lg text-white flex items-center gap-3">
                                <div class="p-2 bg-cyan-500/10 rounded-lg text-cyan-400 border border-cyan-500/20">
    ...
    </div><?php /**PATH C:\Users\ronie\Documents\aplikasi terpadu\sistem_absensi_sekolah\resources\views/landing/character.blade.php ENDPATH**/ ?>