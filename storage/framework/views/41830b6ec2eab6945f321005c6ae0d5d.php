    ...
    <div class="a4-paper-container max-w-[210mm] mx-auto bg-white shadow-2xl shadow-slate-300/50 rounded-lg p-[15mm] min-h-[297mm] relative border border-slate-200 text-black">
        ...
        <div class="font-serif"> 
            ...
            <table class="table-induk">
                ...
                <tr><td class="label-col">43. Tanggal Tamat</td><td class="separator">:</td><td class="value-col"><?php echo e($student->graduated_date ? \Carbon\Carbon::parse($student->graduated_date)->translatedFormat('d F Y') : '-'); ?></td></tr>
                <tr><td class="label-col">44. Nomor Ijazah</td><td class="separator">:</td><td class="value-col"><?php echo e($student->graduated_diploma_no ?? '-'); ?></td></tr>
                <tr><td class="label-col">45. Melanjutkan Ke</td><td class="separator">:</td><td class="value-col"><?php echo e($student->continuing_to_school ?? '-'); ?></td></tr>
                <tr><td class="label-col">46. Alamat Sekolah Lanjutan</td><td class="separator">:</td><td class="value-col"><?php echo e($student->continuing_school_address ?? '-'); ?></td></tr>

                <!-- PINDAH -->
                <tr><td colspan="3" class="sub-header">B. Pindah Sekolah (Mutasi)</td></tr>
                <tr><td class="label-col">47. Tanggal Pindah</td><td class="separator">:</td><td class="value-col"><?php echo e($student->leaving_date ? \Carbon\Carbon::parse($student->leaving_date)->translatedFormat('d F Y') : '-'); ?></td></tr>
                <tr><td class="label-col">48. Dari Kelas</td><td class="separator">:</td><td class="value-col"><?php echo e($student->leaving_class ?? '-'); ?></td></tr>
                <tr><td class="label-col">49. Ke Sekolah</td><td class="separator">:</td><td class="value-col"><?php echo e($student->leaving_to_school ?? '-'); ?></td></tr>
                <tr><td class="label-col">50. Alasan Pindah</td><td class="separator">:</td><td class="value-col"><?php echo e($student->leaving_reason ?? '-'); ?></td></tr>

                <!-- PUTUS -->
                <tr><td colspan="3" class="sub-header">C. Putus Sekolah</td></tr>
                <tr><td class="label-col">51. Tanggal / Alasan Putus</td><td class="separator">:</td><td class="value-col"><?php echo e($student->dropout_date ? \Carbon\Carbon::parse($student->dropout_date)->translatedFormat('d F Y') : '-'); ?> / <?php echo e($student->dropout_reason ?? '-'); ?></td></tr>
            </table>

            <!-- G. LAIN-LAIN -->
            <div class="header-section print-break">G. LAIN-LAIN</div>
            <table class="table-induk">
                <tr><td class="label-col">52. Prestasi Siswa</td><td class="separator">:</td><td class="value-col"><?php echo e($student->achievements ?? '-'); ?></td></tr>
                <tr><td class="label-col">53. Beasiswa</td><td class="separator">:</td><td class="value-col"><?php echo e($student->scholarship_info ?? '-'); ?></td></tr>
                <tr><td class="label-col">54. Catatan Penting</td><td class="separator">:</td><td class="value-col"><?php echo e($student->general_notes ?? '-'); ?></td></tr>
            </table>
            ...
            <table class="w-full text-center text-[11px] font-serif mb-6" style="border-collapse: collapse; border: 1.5px solid #000;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid #000; padding: 4px; font-size: 10px;"><?php echo e($student->getAbsence(7, 1)); ?></td>
                        <td style="border: 1px solid #000; padding: 4px; font-size: 10px;"><?php echo e($student->getAbsence(7, 2)); ?></td>
                        
                        <td style="border: 1px solid #000; padding: 4px; font-size: 10px;"><?php echo e($student->getAbsence(8, 1)); ?></td>
                        <td style="border: 1px solid #000; padding: 4px; font-size: 10px;"><?php echo e($student->getAbsence(8, 2)); ?></td>
                        
                        <td style="border: 1px solid #000; padding: 4px; font-size: 10px;"><?php echo e($student->getAbsence(9, 1)); ?></td>
                        <td style="border: 1px solid #000; padding: 4px; font-size: 10px;"><?php echo e($student->getAbsence(9, 2)); ?></td>
                    </tr>
                </tbody>
            </table>
