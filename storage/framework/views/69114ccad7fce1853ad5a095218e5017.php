                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
                    ...
                    <div class="flex gap-4">
                        <div class="bg-white/60 backdrop-blur-md px-6 py-5 rounded-2xl border border-white/80 min-w-[140px] text-center md:text-left hover:bg-white transition-colors shadow-sm">
                            ...
                            <span class="block text-3xl font-black text-elevate-dark tracking-tight"><?php echo e($years->count()); ?></span>
                        </div>
                    </div>
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden sticky top-24 relative group hover:shadow-2xl hover:shadow-elevate-accent/10 transition-all duration-300">
                        ...
                        <div class="p-8 relative z-10">
                            <form action="<?php echo e(route('settings.academic.store')); ?>" method="POST" class="space-y-6">
                                <?php echo csrf_field(); ?>
                                <div>
                            ...
                            <table class="w-full text-left text-sm text-elevate-dark">
                                ...
                                <tbody class="divide-y divide-slate-50">
                                    <?php $__currentLoopData = $years; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="group hover:bg-elevate-soft/30 transition-colors <?php echo e($year->is_active ? 'bg-elevate-soft/50' : ''); ?>">
                                            <td class="px-8 py-5">
                                                <div class="flex items-center gap-4">
                                                    <div class="w-12 h-12 rounded-2xl flex items-center justify-center text-xl shadow-sm <?php echo e($year->is_active ? 'bg-white text-elevate-primary border border-elevate-accent/30' : 'bg-slate-50 text-slate-400 border border-slate-200'); ?>">
                                                        <i class="ph-duotone ph-calendar-blank"></i>
                                                    </div>
                                                    <div>
                                                        <p class="font-black text-elevate-dark text-base mb-0.5"><?php echo e($year->name); ?></p>
                                                        <p class="text-xs font-bold text-elevate-dark/50 uppercase tracking-wide">Semester <?php echo e($year->semester); ?></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-6 py-5">
                                            ...
                                            <td class="px-8 py-5 text-right">
                                                <div class="flex justify-end gap-2">
                                                    <?php if(!$year->is_active): ?>
                                                        <form action="<?php echo e(route('settings.academic.activate', $year->id)); ?>" method="POST">
                                                        ...
                                                        <form action="<?php echo e(route('settings.academic.destroy', $year->id)); ?>" 
                                                              method="POST" 
                                                              id="delete-form-<?php echo e($year->id); ?>">
                                                            <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                                                            
                                                            <button type="button" 
                                                                    onclick="confirmDelete('<?php echo e($year->id); ?>', '<?php echo e($year->name); ?> (Sem. <?php echo e($year->semester); ?>)')"
...
<?php endif; ?><?php /**PATH C:\Users\ronie\Documents\aplikasi terpadu\sistem_absensi_sekolah\resources\views/settings/academic-year.blade.php ENDPATH**/ ?>