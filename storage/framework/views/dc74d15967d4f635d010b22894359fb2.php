        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-xs font-bold text-slate-400 bg-slate-100 px-2 py-1 rounded-lg">
                    <?php echo e(isset($ebooks) ? $ebooks->count() : 0); ?> Buku
                </span>
            </div>
                        ...
                        <div class="group relative bg-slate-50 rounded-2xl p-2 border border-slate-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                            ...
                            <div class="aspect-[2/3] bg-slate-200 rounded-xl overflow-hidden mb-2 relative shadow-inner">
                                ...
                                <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center backdrop-blur-[1px]">
                                    ...
                                    <a href="<?php echo e(route('library.books.read', ['book' => $book->id, 'origin' => 'portal'])); ?>" class="px-3 py-1.5 bg-white text-blue-900 rounded-full text-[10px] font-bold shadow-xl transform scale-90 group-hover:scale-100 transition-transform flex items-center gap-1 hover:bg-blue-50">
                            ...
                            <div class="px-1">
                                ...
                                <p class="text-[10px] text-slate-400 line-clamp-1"><?php echo e($book->author ?? 'Tanpa Pengarang'); ?></p>
                            </div>
                        </div>
                ...
                <?php if(isset($library_history) && count($library_history) > 0): ?>
                    ...
                    <div class="p-5 hover:bg-indigo-50/30 transition-colors flex items-center gap-4">
                        ...
                        <div class="flex-grow min-w-0">
                            <h4 class="font-bold text-slate-800 truncate text-sm" title="<?php echo e($loan->book->title ?? 'Judul Tidak Diketahui'); ?>">
                            ...
                            <div class="flex flex-wrap items-center gap-3 mt-1 text-xs text-slate-500 font-medium">
                                <span class="flex items-center gap-1">
                                    ...
                                    Pinjam: <?php echo e(\Carbon\Carbon::parse($loan->borrow_date)->translatedFormat('d M Y')); ?>
...
</div><?php /**PATH E:\aplikasi terpadu\sistem_absensi_sekolah\resources\views/students/portal/partials/tab-perpustakaan.blade.php ENDPATH**/ ?>