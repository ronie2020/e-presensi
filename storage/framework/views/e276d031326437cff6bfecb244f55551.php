        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden relative">
                ...
                <div class="p-8">
                    ...
                    <form action="<?php echo e(route('letters.incoming.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-5">
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" name="nomor_surat" value="<?php echo e(old('nomor_surat')); ?>" required placeholder="Contoh: 421.2/005/SMP/2024"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" name="pengirim" value="<?php echo e(old('pengirim')); ?>" required placeholder="Contoh: Dinas Pendidikan Ciamis"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="date" name="tgl_surat" value="<?php echo e(old('tgl_surat')); ?>" required
                            ...
                            <div class="space-y-5">
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="date" name="tgl_terima" value="<?php echo e(old('tgl_terima', date('Y-m-d'))); ?>" required
                                               class="w-full px-4 rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-blue-600 focus:ring-blue-600 text-sm py-3 font-bold text-slate-700 transition-all">
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea name="perihal" rows="4" required placeholder="Jelaskan isi ringkas surat..."
                                              class="w-full px-4 rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-blue-600 focus:ring-blue-600 text-sm py-3 font-medium text-slate-700 transition-all"><?php echo e(old('perihal')); ?></textarea>
                                </div>
