<table border="1">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="mso-number-format:'\@'"><?php echo e($permit->student->student_id); ?></td>
            ...
            <td><?php echo e($permit->time_out->format('Y-m-d H:i')); ?></td>
            <td><?php echo e($permit->time_in ? $permit->time_in->format('Y-m-d H:i') : '-'); ?></td>
