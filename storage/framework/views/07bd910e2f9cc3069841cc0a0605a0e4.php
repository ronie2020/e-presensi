    ...
    <table class="data">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center"><?php echo e($data->total_students); ?></td>
                <td class="text-center"><?php echo e($data->hadir); ?></td>
                <td class="text-center"><?php echo e($data->telat); ?></td>
                <td class="text-center"><?php echo e($data->izin_sakit); ?></td>
                <td class="text-center"><?php echo e($data->alpha); ?></td>
                <td class="text-center font-bold"><?php echo e($data->rate); ?>%</td>
            </tr>
...
</html><?php /**PATH E:\drive aplikasi\aplikasi terpadu\sistem_absensi_sekolah versi 3.00\resources\views/reports/pdf_class_recap.blade.php ENDPATH**/ ?>