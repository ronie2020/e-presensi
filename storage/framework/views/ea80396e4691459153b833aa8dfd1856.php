...
<?php endif; ?>
            ...
            <p class="text-blue-200 text-lg font-medium tracking-widest uppercase opacity-80">
                ...
                Tahun Pelajaran <?php echo e($tahunAjaran ?? (date('Y') . '/' . (date('Y')+1))); ?>
        ...
        <div class="glass-card rounded-[2.5rem] overflow-hidden relative" data-aos="fade-up">
            ...
            <div class="bg-slate-900/80 border-t border-white/5 p-4 text-center backdrop-blur-sm">
                <p class="text-xs text-slate-500 font-medium tracking-wide">&copy; <?php echo e(date('Y')); ?> SIMADU (Sistem Informasi Terpadu SMPN 3 Lakbok)</p>
            </div>
        </div>
    </div>
</div>
...
<?php if(!$isOpen): ?>
<script>
    // Menggunakan ISO string agar timezone lebih akurat di berbagai browser
    const targetDateStr = "<?php echo e($targetDate->toIso8601String()); ?>";
