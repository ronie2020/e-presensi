    ...
    <div class="min-h-screen bg-[#f8fafc] font-jakarta p-4 md:p-8 pb-20 text-[#2A3B52]">
        ...
        <div class="relative rounded-2xl md:rounded-[3rem] bg-gradient-to-br from-[#25D0FF] via-[#5295FF] to-[#FFC9B9] p-8 md:p-12 text-[#2A3B52] shadow-[0_10px_40px_-10px_rgba(37,208,255,0.4)] overflow-hidden text-center mb-10 md:mb-16 border border-white/40">
            ...
            <div class="relative z-10">
                ...
                <p class="text-[#2A3B52]/80 font-medium text-sm md:text-base max-w-xl mx-auto leading-relaxed">
                    Daftar apresiasi siswa paling konsisten dalam membangun kebiasaan baik pada bulan <span class="font-bold text-[#2A3B52]"><?php echo e(\Carbon\Carbon::now()->translatedFormat('F Y')); ?></span>.
                </p>
            </div>
        </div>
        ...
        <?php if($leaderboard->isEmpty()): ?>
            <div class="text-center py-20 bg-white rounded-[2rem] border border-slate-100 shadow-sm max-w-3xl mx-auto fluent-card">
                ...
                <p class="text-slate-500 text-sm">Belum ada siswa yang terekam pada bulan ini.</p>
            </div>
        <?php else: ?>
...
<?php endif; ?><?php /**PATH C:\Users\ronie\Documents\aplikasi terpadu\sistem_absensi_sekolah\resources\views/habits/teacher_leaderboard.blade.php ENDPATH**/ ?>