                ...
                <div class="bg-white rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl hover:shadow-slate-200/40 overflow-hidden group hover:-translate-y-2 transition-all duration-500 flex flex-col">
                    ...
                    <div class="p-6 md:p-8 flex flex-col flex-1">
                        ...
                        <div class="mt-auto pt-4 border-t border-slate-100">
                            <a href="<?php echo e($article->url ?? route('teachers.show', $article->user_id)); ?>" target="<?php echo e($article->url ? '_blank' : '_self'); ?>" class="inline-flex items-center gap-2 text-sm font-bold text-orange-500 hover:text-orange-600 group/link">
                                Baca Selengkapnya 
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\drive aplikasi\aplikasi terpadu\sistem_absensi_sekolah versi 3.00\resources\views/articles/index.blade.php ENDPATH**/ ?>