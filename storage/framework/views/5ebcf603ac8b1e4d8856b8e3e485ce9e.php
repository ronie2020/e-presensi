        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100 mb-8 flex flex-col lg:flex-row gap-6 justify-between items-center relative overflow-hidden">
                ...
                <div class="flex gap-3 w-full lg:w-auto relative z-10">
                    ...
                    <a href="<?php echo e(route('library.books.create')); ?>" class="flex-1 lg:flex-none px-6 py-3.5 bg-cyan-600 text-white hover:bg-cyan-700 rounded-2xl font-bold text-sm transition-all shadow-lg shadow-cyan-500/30 hover:shadow-cyan-500/50 flex items-center justify-center gap-2 transform active:scale-95">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div class="p-6 flex-1 flex flex-col">
                            ...
                            <div class="mt-auto pt-4 border-t border-slate-50 flex items-center justify-between">
                                ...
                                <div class="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity transform translate-y-2 group-hover:translate-y-0 duration-300">
                                    <a href="<?php echo e(route('library.books.edit', $book->id)); ?>" class="w-8 h-8 rounded-lg bg-cyan-50 text-cyan-600 flex items-center justify-center hover:bg-cyan-600 hover:text-white transition-colors" title="Edit">
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="col-span-full py-20 text-center bg-white rounded-[2.5rem] border-2 border-dashed border-slate-200">
                        ...
                        <a href="<?php echo e(route('library.books.create')); ?>" class="inline-flex items-center gap-2 px-6 py-3 bg-cyan-600 text-white font-bold rounded-xl hover:bg-cyan-700 transition shadow-lg shadow-cyan-500/30">
