...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative flex items-center">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-cyan-600">
                                    <i class="ph-fill ph-folder text-xl"></i>
                                </div>
                                <select name="cbt_event_id" required class="w-full pl-12 rounded-2xl border-cyan-200 bg-cyan-50/30 focus:bg-white focus:border-cyan-500 focus:ring-cyan-500 font-bold text-slate-800 py-3.5 px-5 appearance-none cursor-pointer transition-all <?php $__errorArgs = ['cbt_event_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <div class="absolute inset-y-0 right-5 flex items-center pointer-events-none text-cyan-600">
