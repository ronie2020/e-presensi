...
<head>
    ...
    <style>
        ...
        .id-card {
            width: 54mm;  /* Lebar Portrait */
            height: 85.6mm; /* Tinggi Portrait */
...
<body class="flex flex-col items-center py-10 min-h-screen">
    ...
    <div class="no-print fixed top-5 right-5 z-50 flex gap-3">
        <!-- Tombol kembali menyesuaikan referer (apakah dari admin atau portal) -->
        <button onclick="history.back()" class="px-4 py-2 bg-white border border-gray-300 rounded-full shadow hover:bg-gray-50 text-sm font-bold transition">
            &larr; Kembali
        </button>
        <button onclick="window.print()" class="px-4 py-2 bg-emerald-600 text-white rounded-full shadow hover:bg-emerald-700 text-sm font-bold transition flex items-center gap-2">
        ...
        <div class="id-card items-center justify-center">
            ...
            <div class="z-10 flex flex-col items-center w-full px-6 flex-1 justify-center mt-6">
                ...
                <div class="bg-white p-1 rounded-lg border border-slate-200 mb-5 shadow-sm">
                    <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=<?php echo e($student->student_id); ?>" 
                         alt="QR Code" 
...
</html><?php /**PATH C:\Users\ronie\Documents\aplikasi\E-Presensi Netila\resources\views/students/osis_card.blade.php ENDPATH**/ ?>