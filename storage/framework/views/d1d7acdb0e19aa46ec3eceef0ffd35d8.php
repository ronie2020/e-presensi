...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <style>
            ...
            /* Efek Grid Halus untuk Background Login dengan warna elevate-accent (#38bdf8 RGB: 56,189,248) */
            .bg-grid-pattern {
    ...
    <body class="font-sans text-elevate-text antialiased min-h-screen bg-slate-50 bg-grid-pattern relative overflow-x-hidden flex flex-col md:flex-row">
        ...
        <div class="absolute -top-32 -left-32 w-[500px] h-[500px] bg-elevate-accent/10 rounded-full blur-[80px] pointer-events-none"></div>
        <div class="absolute bottom-0 right-0 w-[600px] h-[600px] bg-elevate-primary/5 rounded-tl-[100%] pointer-events-none"></div>

        <!-- SPLIT LAYOUT UNTUK DESKTOP -->
        
        <!-- BAGIAN KIRI (Branding & Ilustrasi) -->
        <div class="hidden md:flex md:w-1/2 lg:w-3/5 bg-gradient-to-br from-elevate-dark to-elevate-primary p-12 text-white flex-col justify-between relative shadow-2xl z-10 rounded-br-[4rem] min-h-screen">
            <!-- Aksen Garis Elevate -->
            <div class="absolute top-0 right-0 w-full h-full overflow-hidden pointer-events-none rounded-br-[4rem]">
                <div class="absolute top-[-10%] right-[-10%] w-[50%] h-[50%] bg-gradient-to-bl from-elevate-accent/30 to-transparent rounded-full blur-3xl"></div>
                <div class="absolute bottom-[10%] left-[10%] w-[30%] h-[30%] bg-gradient-to-tr from-elevate-peach/20 to-transparent rounded-full blur-3xl"></div>
            </div>
            ...
            <div class="relative z-10">
                <div class="flex items-center gap-4 mb-16">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-elevate-accent font-bold uppercase tracking-widest">Sistem Informasi Terpadu</p>
                    </div>
                </div>
                ...
                <div class="max-w-lg">
                    <h2 class="text-4xl lg:text-5xl font-black mb-6 leading-tight">
                        Platform <br>
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-elevate-accent to-white">E-Presensi & Ujian</span> <br>
                        Terintegrasi.
                    </h2>
                    <p class="text-slate-100 text-lg font-medium leading-relaxed opacity-90">
            ...
            <div class="relative z-10 mt-12 flex items-center gap-4 text-xs font-bold text-elevate-accent uppercase tracking-widest">
        ...
        <div class="w-full md:w-1/2 lg:w-2/5 flex flex-col justify-center items-center p-6 sm:p-12 relative z-20 min-h-screen">
            ...
            <div class="md:hidden text-center mb-8 pt-4">
                ...
                <h1 class="font-black text-2xl text-elevate-dark tracking-tight">SIMADU LAKBOK</h1>
                <p class="text-xs text-elevate-primary font-bold uppercase tracking-widest">Portal Guru & Admin</p>
            </div>

            <!-- Login Box -->
            <div class="w-full max-w-md">
                <div class="bg-white/80 backdrop-blur-xl rounded-[2.5rem] shadow-2xl shadow-elevate-accent/10 border border-slate-100 p-8 sm:p-10 relative overflow-hidden">
                    
                    <!-- Decorative Corner -->
                    <div class="absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl from-elevate-peach-light to-transparent rounded-bl-[3rem] pointer-events-none opacity-60"></div>
                ...
                <div class="mt-8 text-center pb-6">
                    <div class="flex flex-col items-center gap-3">
                        <a href="<?php echo e(url('/')); ?>" class="inline-flex items-center gap-2 text-sm font-bold text-slate-400 hover:text-elevate-primary transition-colors group">
...
</html><?php /**PATH E:\drive aplikasi\aplikasi terpadu\sistem_absensi_sekolah versi 3.00\resources\views/layouts/guest.blade.php ENDPATH**/ ?>