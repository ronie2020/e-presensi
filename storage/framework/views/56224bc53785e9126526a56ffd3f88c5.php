                        ...
                        <div class="p-6 flex-1 flex flex-col">
                            ...
                            <div class="mt-auto pt-4 border-t border-slate-50 flex items-center justify-between">
                                ...
                                <div class="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity transform translate-y-2 group-hover:translate-y-0 duration-300">
                                    ...
                                    <form action="<?php echo e(route('library.books.destroy', $book->id)); ?>" method="POST" onsubmit="return confirm('Hapus buku ini?');">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            Swal.fire({
                icon: 'error',
                title: 'Gagal Upload',
                text: '<?php echo e($errors->first('file')); ?>',
...
<?php endif; ?><?php /**PATH E:\drive aplikasi\aplikasi terpadu\sistem_absensi_sekolah versi 3.00\resources\views/books/index.blade.php ENDPATH**/ ?>