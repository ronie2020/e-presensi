                            ...
                            <div class="relative group">
                                ...
                                <div class="flex items-start justify-between gap-3 p-3 rounded-2xl hover:bg-slate-50 transition-colors -mt-2 -ml-2">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="text-sm font-bold text-slate-800 line-clamp-1 group-hover:text-blue-700 transition-colors"><?php echo e($studentName); ?></p>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center justify-between p-3 rounded-2xl border border-slate-50 hover:bg-red-50/30 transition-colors">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div class="text-xs font-bold text-slate-800 line-clamp-1"><?php echo e($student->student?->name ?? 'Siswa Terhapus'); ?></div>
...
<?php endif; ?><?php /**PATH E:\aplikasi terpadu\sistem_absensi_sekolah\resources\views\students\dashboard.blade.php ENDPATH**/ ?>