<nav 
    ...
    <div class="relative z-10 shrink-0 flex items-center h-24 px-6 border-b border-white/10 bg-white/5 backdrop-blur-sm">
        <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-3 group w-full transition-all duration-300">
            <!-- Logo Container -->
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.application-logo','data' => ['class' => 'w-6 h-6 object-contain']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-6 h-6 object-contain']); ?>
                ...
                <div class="space-y-1">
                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <a href="<?php echo e(route($item['route'])); ?>" 
                           class="flex items-center px-4 py-3 rounded-xl transition-all duration-300 group relative overflow-hidden <?php echo e($isActive ? 'bg-blue-600 text-white shadow-lg shadow-blue-900/50 ring-1 ring-white/20' : 'text-blue-100/70 hover:bg-white/10 hover:text-white'); ?>">
                            ...
                            <div class="relative z-10 mr-3 <?php echo e($isActive ? 'text-white' : 'text-blue-300 group-hover:text-white'); ?> transition-colors">
                                <i class="<?php echo e($item['icon'] ?? 'ph-circle'); ?> text-xl"></i>
                            </div>
                            
                            <span class="relative z-10 text-sm font-bold tracking-wide"><?php echo e($item['name']); ?></span>
...
</nav><?php /**PATH C:\Users\ronie\Documents\aplikasi\E-Presensi Netila\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>