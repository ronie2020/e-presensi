        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="<?php echo e(route('recovery.index')); ?>" class="px-5 py-2.5 bg-elevate-primary rounded-2xl text-white font-bold hover:bg-elevate-dark transition-all flex items-center gap-2 shadow-lg shadow-elevate-primary/20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm">
                    ...
                    <div class="text-3xl font-black text-elevate-dark mt-1"><?php echo e(number_format($classSummaries->sum('total_violation'))); ?> <span class="text-xs text-slate-400">Poin</span></div>
                </div>
                ...
                <div class="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm">
                    ...
                    <div class="text-3xl font-black text-elevate-dark mt-1"><?php echo e(number_format($classSummaries->sum('total_merit'))); ?> <span class="text-xs text-slate-400">Poin</span></div>
                </div>
                ...
                <div class="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm">
                    ...
                    <div class="text-3xl font-black text-elevate-dark mt-1"><?php echo e(\App\Models\BkSession::where('status', 'pending')->count()); ?></div>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
                ...
                <div class="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
                    <h3 class="font-black text-elevate-dark mb-6 flex items-center gap-2">
                        <i class="ph-bold ph-trend-up text-elevate-primary"></i> Tren Disiplin (Tahun <?php echo e(date('Y')); ?>)
                    </h3>
                    <div class="h-[300px]">
                    ...
                    <table class="w-full text-left">
                        ...
                        <tbody class="divide-y divide-slate-50">
                            ...
                            <tr class="hover:bg-slate-50 transition-colors">
                                <td class="px-8 py-4">
                                    <div class="font-black text-elevate-dark uppercase tracking-tight"><?php echo e($sv->name); ?></div>
                                ...
                                <td class="px-8 py-4 text-right">
                                    <div class="flex justify-end gap-2">
                                        <a href="<?php echo e(route('discipline.sp_print', $sObj->id)); ?>" target="_blank" class="p-2 bg-slate-100 hover:bg-elevate-dark hover:text-white text-slate-500 rounded-xl transition-all shadow-sm" title="Cetak SP">
                                            <i class="ph-bold ph-printer text-lg"></i>
                                        </a>
                                        <a href="<?php echo e(route('admin.bk.index')); ?>?search=<?php echo e(urlencode($sv->name)); ?>" class="p-2 bg-elevate-accent/10 hover:bg-elevate-primary hover:text-white text-elevate-primary rounded-xl transition-all shadow-sm" title="Lihat Riwayat BK">
...
<?php endif; ?><?php /**PATH C:\Users\ronie\Documents\aplikasi terpadu\sistem_absensi_sekolah\resources\views/discipline/discipline_analytics.blade.php ENDPATH**/ ?>