            ...
            <?php $__empty_1 = true; $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="bg-white rounded-3xl p-8 shadow-sm border border-slate-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col h-full relative group overflow-hidden">
                    ...
                    <div class="flex items-center gap-4 mb-6 relative z-10">
                        ...
                        <div class="min-w-0">
                            <h4 class="font-bold text-slate-900 text-base truncate" title="<?php echo e($testi->student->name ?? 'Alumni'); ?>">
                    ...
                    <div class="mt-6 pt-4 border-t border-slate-50 flex items-center justify-between text-xs text-slate-400">
                        <span><?php echo e($testi->updated_at->format('d M Y')); ?></span>
        ...
        <div class="mt-16 bg-white rounded-3xl p-8 md:p-12 text-center shadow-lg border border-slate-100 relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <?php if(auth()->guard('student')->check()): ?>
                    <a href="<?php echo e(route('alumni.tracer')); ?>" class="inline-flex items-center justify-center px-8 py-3.5 text-sm font-bold text-white bg-indigo-600 rounded-full hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-600/20">
                        <i class="ph-bold ph-pencil-simple mr-2"></i> Tulis Testimoni
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('student.login')); ?>" class="inline-flex items-center justify-center px-8 py-3.5 text-sm font-bold text-white bg-slate-900 rounded-full hover:bg-slate-800 transition-all shadow-lg shadow-slate-900/20">
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\aplikasi terpadu\sistem_absensi_sekolah\resources\views\testimonials.blade.php ENDPATH**/ ?>