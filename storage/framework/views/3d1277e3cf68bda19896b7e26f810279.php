                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" class="flex items-center gap-3 focus:outline-none group">
                                <div class="text-right hidden sm:block">
                                    <p class="text-sm font-bold text-slate-800 group-hover:text-cyan-600 transition-colors"><?php echo e(Auth::user()->name); ?></p>
                            ...
                            <div x-show="open" @click.away="open = false" 
                                ...
                                <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center px-4 py-2 text-sm text-slate-600 hover:bg-cyan-50 hover:text-cyan-600 font-medium transition-colors">
