            ...
            <div class="relative rounded-[2rem] bg-gray-900 bg-gradient-to-br from-blue-900 via-blue-800 to-cyan-900 p-8 text-white shadow-xl shadow-blue-900/30 overflow-hidden border border-white/10">
                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div>
                        <div class="flex items-center gap-2 mb-2">
                            ...
                            <span class="text-[10px] font-bold text-cyan-200 uppercase tracking-wider">Gudang Soal</span>
                        </div>
                ...
                <div class="mt-8 relative max-w-lg">
                    ...
                    <input type="text" x-model="search" placeholder="Cari nama mapel, judul bank soal, atau kode..." 
                        class="w-full pl-12 pr-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-blue-200 focus:bg-white/20 focus:ring-0 focus:border-white/40 transition font-medium backdrop-blur-sm">
                </div>
            </div>
                    ...
                    <div class="relative bg-white rounded-[2.5rem] shadow-2xl max-w-md w-full p-8 border border-slate-100"
                        ...
                        <form action="<?php echo e(route('bank.store')); ?>" method="POST" class="space-y-4">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select name="class_level" class="w-full rounded-xl border-slate-200 font-bold text-slate-700 py-3 px-4 focus:ring-blue-500 focus:border-blue-500 bg-white appearance-none cursor-pointer">
                            ...
                            <div class="pt-4 flex gap-3">
                                ...
                                <button type="submit" class="flex-1 py-3 rounded-xl bg-blue-600 text-white font-bold hover:bg-blue-700 shadow-lg shadow-blue-500/30">Simpan</button>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="relative bg-white rounded-[2.5rem] shadow-2xl max-w-md w-full p-8 border border-slate-100"
                        ...
                        <form :action="editUrl" method="POST" class="space-y-4">
                            ...
                            <div>
                                <label class="block text-xs font-bold text-slate-400 uppercase mb-2 ml-1">Tingkat Kelas</label>
                                <div class="relative">
                                    <select name="class_level" x-model="editData.class_level" required class="w-full rounded-xl border-slate-200 font-bold text-slate-700 py-3 px-4 focus:ring-blue-500 focus:border-blue-500 bg-white appearance-none cursor-pointer">
                            ...
                            <div class="pt-4 flex gap-3">
                                ...
                                <button type="submit" class="flex-1 py-3 rounded-xl bg-blue-600 text-white font-bold hover:bg-blue-700 shadow-lg shadow-blue-500/30">Simpan Perubahan</button>
                            </div>
                        </form>
                    </div>
                </div>
