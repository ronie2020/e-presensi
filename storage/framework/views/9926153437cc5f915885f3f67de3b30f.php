               ...
               <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div>
                        <div class="flex items-center gap-2 mb-2">
                            <a href="<?php echo e(route('cbt.index')); ?>" class="text-xs font-bold text-elevate-primary hover:text-elevate-dark transition flex items-center gap-1 bg-white/60 px-3 py-1 rounded-full border border-white backdrop-blur-sm shadow-sm">
                            ...
                            <div class="bg-white border border-slate-200 rounded-[1rem] p-3 pr-5 flex items-center gap-3 shadow-sm w-max hover:shadow-md transition-shadow cursor-default group/folder">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-2">
                                        <h3 class="text-sm font-black text-elevate-dark"><?php echo e($subjectName); ?></h3>
                                ...
                                <div class="bank-card bg-elevate-surface border border-slate-100 rounded-[2rem] p-6 hover:shadow-xl hover:shadow-elevate-accent/10 hover:border-elevate-accent/50 transition-all duration-300 group relative flex flex-col h-full"
                                    ...
                                    <div class="mb-4">
                                        <div class="flex justify-between items-start mb-3">
                                            ...
                                            <span class="text-[10px] bg-slate-50 px-2 py-0.5 rounded border border-slate-100 font-mono text-slate-400 group-hover:text-elevate-primary transition" title="Kode Bank Soal">#<?php echo e($bank->code); ?></span>
                                        </div>
                                    ...
                                    <div class="flex-1 flex items-end mb-5">
                                        <div class="flex items-center gap-2 text-slate-500 text-xs font-bold bg-elevate-soft/40 group-hover:bg-elevate-soft px-4 py-2.5 rounded-xl w-full border border-slate-100 transition-colors">
                                            ...
                                            <span class="text-elevate-dark text-sm"><?php echo e($bank->questions_count); ?></span> Soal Tersedia
                                        </div>
                                    </div>

                                    
                                    <div class="pt-4 border-t border-slate-50 flex gap-2">
                                        <a href="<?php echo e(route('bank.manage', $bank->id)); ?>" class="flex-1 flex items-center justify-center p-2.5 bg-elevate-dark text-white rounded-xl text-xs font-bold hover:bg-elevate-dark/90 transition-all shadow-lg shadow-elevate-dark/20 active:scale-95" title="Kelola Soal">
