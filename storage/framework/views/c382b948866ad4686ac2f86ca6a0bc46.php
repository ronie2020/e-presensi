...
<?php $component->withAttributes([]); ?>
    ...
    <div x-data="{ 
       showEditModal: false,
        showImportModal: false, // TAMBAHKAN INI AGAR TOMBOL BERFUNGSI
        questionSearch: '', 
                ...
                <div class="relative rounded-[2rem] bg-gray-900 bg-gradient-to-br from-blue-900 via-blue-800 to-cyan-900 p-8 text-white shadow-xl shadow-blue-900/30 overflow-hidden border border-white/10">
                    ...
                    <div class="relative z-10">
                        <div class="flex items-center gap-2 mb-2">
                                <a href="<?php echo e(route('bank.index')); ?>" class="text-xs font-bold text-cyan-300 hover:text-white transition flex items-center gap-1"><i class="ph-bold ph-arrow-left"></i> Kembali</a>
                        ...
                        <p class="text-blue-100 text-sm font-medium">Total: <?php echo e($bank->questions->count()); ?> Soal • Kode: <?php echo e($bank->code); ?></p>
                    </div>
                </div>
                        ...
                        <div class="bg-white p-6 rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/50 lg:sticky lg:top-8">
                            ...
                            <form action="<?php echo e(route('bank.questions.store', $bank->id)); ?>" method="POST" enctype="multipart/form-data" class="space-y-5" id="createQuestionForm">
                                ...
                                <div class="bg-blue-50/50 p-4 rounded-2xl border border-blue-100">
                                    <label class="block text-xs font-bold text-blue-400 uppercase mb-2 ml-1"><i class="ph-fill ph-tag"></i> Materi / KD (Opsional)</label>
                                    <div class="flex flex-wrap gap-2 mb-2">
                                        <template x-for="(tag, index) in createTags" :key="index">
                                            <span class="inline-flex items-center gap-1 px-3 py-1 bg-blue-100 text-blue-700 rounded-lg text-xs font-bold border border-blue-200">
                                    ...
                                    <div class="flex gap-2">
                                        <input type="text" x-model="newTag" @keydown.enter.prevent="addTag(newTag, 'create')" placeholder="Ketik lalu Enter..." class="w-full rounded-xl border-slate-200 text-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500">
                                        <button type="button" @click="addTag(newTag, 'create')" class="px-4 bg-blue-600 text-white rounded-xl hover:bg-blue-700 font-bold text-xs">Tambah</button>
                                    </div>
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div class="flex gap-3 items-start group">
                                                ...
                                                <div class="flex-1 space-y-2" x-data="{ optPreview: null }">
                                                    <div class="flex gap-2">
                                                        <input type="text" name="option_<?php echo e($opt); ?>" class="flex-1 rounded-xl border-slate-200 bg-white text-sm py-2 px-3 focus:ring-blue-500" placeholder="Teks Jawaban <?php echo e($opt); ?>">
                    ...
                    <div class="w-full lg:w-3/5 order-1 lg:order-2 space-y-6">
                        ...
                        <div class="flex flex-col sm:flex-row justify-between items-center px-2 gap-4">
                            <div class="flex items-center gap-3 flex-wrap">
                                <h3 class="font-black text-slate-800 text-lg flex items-center gap-2">
                                    <i class="ph-fill ph-list-dashes text-blue-500"></i> Isi Bank Soal
                                </h3>
                                
                                
                                <button @click="showImportModal = true" class="px-3 py-1.5 bg-blue-600 text-white rounded-lg text-xs font-bold hover:bg-blue-700 transition shadow-sm flex items-center gap-1.5 ml-2">
                                ...
                                <?php if($bank->questions->count() > 0): ?>
                                    ...
                                    <a href="<?php echo e(route('bank.export_word', $bank->id)); ?>" class="px-3 py-1.5 bg-cyan-600 text-white rounded-lg text-xs font-bold hover:bg-cyan-700 transition shadow-sm flex items-center gap-1.5">
                                    ...
                                    <a href="<?php echo e(route('bank.questions.print', $bank->id)); ?>" target="_blank" class="px-3 py-1.5 bg-white text-slate-600 border border-slate-200 rounded-lg text-xs font-bold hover:text-blue-600 hover:bg-blue-50 hover:border-blue-200 transition shadow-sm flex items-center gap-1.5">
                        ...
                        <div class="flex flex-col sm:flex-row justify-between items-center px-2 gap-4">
                            ...
                            <div class="relative w-full md:w-80 shrink-0">
                                ...
                                <input type="text" x-model="questionSearch" placeholder="Cari pertanyaan atau tag..." class="w-full pl-10 pr-4 py-2 text-sm font-bold border-slate-200 rounded-xl focus:ring-blue-500 focus:border-blue-500 bg-white shadow-sm transition">
                            </div>
                        </div>                      
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $bank->questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <div class="absolute top-8 left-[4.5rem] z-10">
                                <input type="checkbox" value="<?php echo e($q->id); ?>" x-model="selectedQuestions" class="question-checkbox w-5 h-5 rounded border-slate-300 text-blue-600 focus:ring-blue-500 cursor-pointer shadow-sm">
                            </div>
                            ...
                            <div class="pl-20 sm:pl-24">
                                ...
                                <div class="absolute top-6 right-6 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                                    ...
                                    <button type="button" @click="openEdit({
                                        ...
                                        class="w-9 h-9 rounded-xl bg-white border border-slate-200 text-slate-400 hover:text-blue-600 hover:border-blue-200 shadow-sm flex items-center justify-center transition-all hover:scale-105">
                    ...
                    <form :action="editState.url" method="POST" enctype="multipart/form-data" id="editQuestionForm">
                        ...
                        <div class="p-8 space-y-6 max-h-[70vh] overflow-y-auto custom-scrollbar bg-slate-50/30">
                            ...
                            <div class="bg-blue-50/50 p-4 rounded-2xl border border-blue-100">
                                ...
                                <div class="flex gap-2">
                                    <input type="text" x-model="editNewTag" @keydown.enter.prevent="addTag(editNewTag, 'edit')" placeholder="Ketik lalu Enter..." class="w-full rounded-xl border-slate-200 text-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500">
                                    <button type="button" @click="addTag(editNewTag, 'edit')" class="px-4 bg-blue-600 text-white rounded-xl hover:bg-blue-700 font-bold text-xs">Tambah</button>
                                </div>
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div class="flex gap-3 items-start">
                                            ...
                                            <div class="flex-1 space-y-2" x-data="{ optPreviewEdit: null, deleteOptImage: false }">
                                                <div class="flex gap-2">
                                                    <input type="text" name="option_<?php echo e($opt); ?>" x-model="editState.option_<?php echo e($opt); ?>" class="flex-1 rounded-xl border-slate-200 text-sm py-2.5 px-4 focus:ring-blue-500 font-medium" placeholder="Teks opsi <?php echo e($opt); ?>">
            ...
            <div class="flex min-h-screen items-center justify-center p-4">
                <div class="relative transform overflow-hidden rounded-[2.5rem] bg-white text-left shadow-2xl transition-all sm:w-full sm:max-w-md border border-slate-100">
                    <div class="px-8 py-6 border-b border-slate-100 flex justify-between items-center">
                        <h3 class="text-xl font-black text-slate-800 flex items-center gap-2"><i class="ph-fill ph-file-arrow-up text-blue-600"></i> Import dari Excel</h3>
                    ...
                    <form action="<?php echo e(route('bank.questions.import', $bank->id)); ?>" method="POST" enctype="multipart/form-data" class="p-8 space-y-6">
                        ...
                        <div class="bg-blue-50 p-4 rounded-2xl border border-blue-100 mb-4">
                            ...
                            <a href="<?php echo e(route('bank.questions.template')); ?>" class="inline-flex items-center gap-1 mt-2 text-xs font-black text-blue-600 hover:underline">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="file" name="file" required class="block w-full text-xs text-slate-500 file:mr-4 file:py-3 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-bold file:bg-blue-600 file:text-white hover:file:bg-blue-700 cursor-pointer border border-slate-200 rounded-xl bg-slate-50">
                        </div>
                        ...
                        <div class="flex gap-3 pt-4">
                            ...
                            <button type="submit" class="flex-1 py-3 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 transition shadow-lg shadow-blue-500/30 text-sm">Mulai Import</button>
                        </div>
                    </form>
                </div>
            </div>
