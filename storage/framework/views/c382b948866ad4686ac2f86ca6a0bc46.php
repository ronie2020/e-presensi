...
<?php $component->withAttributes([]); ?>
    ...
    <div x-data="{ 
       showEditModal: false,
        ...
        createType: '<?php echo e(old('question_type', 'choice')); ?>',
        createQuestionText: <?php echo e(json_encode(old('question_text', ''))); ?>,
        matchPairs: <?php echo e(json_encode(old('matches', [['left' => '', 'right' => '']]))); ?>, 
        createTags: <?php echo e(old('tags') ? json_encode(array_map('trim', explode(',', old('tags')))) : '[]'); ?>,
        newTag: '',
        ...
        removeCurrentImage() {
         ...
         <?php $__env->slot('header', null, []); ?> 
            <h2 class="font-semibold text-xl text-[#2c3f61] leading-tight"><?php echo e(__('Kelola Bank Soal')); ?></h2>
         <?php $__env->endSlot(); ?>
                ...
                <div class="relative rounded-[2rem] bg-gradient-to-r from-[#56bbf1] via-[#e5eff5] to-[#f4d1c0] p-8 text-[#2c3f61] shadow-xl shadow-[#56bbf1]/10 overflow-hidden border border-white/60">
                    ...
                    <div class="relative z-10">
                        <div class="flex items-center gap-2 mb-2">
                                <a href="<?php echo e(route('bank.index')); ?>" class="text-xs font-bold text-[#0d52a1] hover:text-[#2c3f61] transition flex items-center gap-1 bg-white/60 px-3 py-1 rounded-full border border-white backdrop-blur-sm shadow-sm"><i class="ph-bold ph-arrow-left"></i> Kembali</a>
                                <span class="text-[#2c3f61]/30 text-xs">•</span>
                                <span class="px-2 py-0.5 rounded text-[10px] font-black uppercase tracking-wide bg-white/60 text-[#2c3f61] border border-white shadow-sm"><?php echo e($bank->subject_name); ?></span>
                            </div>
                        <h1 class="text-4xl font-extrabold tracking-tight leading-none text-[#2c3f61] mb-2"><?php echo e($bank->title); ?></h1>
                        <p class="text-[#2c3f61]/80 text-sm font-medium">Total: <?php echo e($bank->questions->count()); ?> Soal • Kode: <?php echo e($bank->code); ?></p>
                    </div>
                </div>
                        ...
                        <div class="bg-white p-6 rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/50 lg:sticky lg:top-8">
                            ...
                            <form action="<?php echo e(route('bank.questions.store', $bank->id)); ?>" method="POST" enctype="multipart/form-data" class="space-y-5" id="createQuestionForm">
                                ...
                                <div>
                                    ...
                                    <input id="q_input_create" type="hidden" name="question_text" value="<?php echo e(old('question_text')); ?>">
                                ...
                                <div class="bg-slate-50 rounded-2xl p-4 border border-slate-100">
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div class="flex gap-3 items-start group">
                                                ...
                                                <div class="flex-1 space-y-2" x-data="{ optPreview: null }">
                                                    <div class="flex gap-2">
                                                        <input type="text" name="option_<?php echo e($opt); ?>" value="<?php echo e(old('option_'.$opt)); ?>" class="flex-1 rounded-xl border-slate-200 bg-white text-sm py-2 px-3 focus:ring-[#56bbf1] focus:border-[#56bbf1]" placeholder="Teks Jawaban <?php echo e($opt); ?>">
                                                        <label class="w-10 h-10 shrink-0 bg-white border border-slate-200 rounded-xl flex items-center justify-center text-slate-400 hover:text-[#0d52a1] hover:bg-[#e5eff5] cursor-pointer transition" title="Upload Gambar Opsi <?php echo e($opt); ?>">
                                        ...
                                        <div>
                                            ...
                                            <div class="flex gap-4">
                                                <label class="flex-1 cursor-pointer">
                                                    <input type="radio" name="correct_answer" value="A" <?php echo e(old('correct_answer') == 'A' ? 'checked' : ''); ?> class="peer sr-only">
                                                ...
                                                <label class="flex-1 cursor-pointer">
                                                    <input type="radio" name="correct_answer" value="B" <?php echo e(old('correct_answer') == 'B' ? 'checked' : ''); ?> class="peer sr-only">
                                    ...
                                    <template x-if="createType === 'essay'">
                                        <div>
                                            ...
                                            <input type="text" name="correct_answer" value="<?php echo e(old('correct_answer')); ?>" class="w-full rounded-xl border-slate-200 text-sm py-2 px-3 focus:ring-[#56bbf1] focus:border-[#56bbf1]" placeholder="Jawaban singkat (Auto-grade)">
                                        </div>
                                    </template>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="score_weight" value="<?php echo e(old('score_weight', 2)); ?>" required class="w-full rounded-xl border-slate-200 bg-slate-50 text-sm font-bold text-center h-11 focus:ring-[#56bbf1] focus:border-[#56bbf1]">
                                </div>
                    ...
                    <div class="w-full lg:w-3/5 order-1 lg:order-2 space-y-6">
                        ...
                        <div class="flex flex-col sm:flex-row justify-between items-center px-2 gap-4">
                            <div class="flex items-center gap-3 flex-wrap">
                                ...
                                <?php if($bank->questions->count() > 0): ?>
                                    ...
                                    <a href="<?php echo e(route('bank.export_word', $bank->id)); ?>" class="px-3 py-1.5 bg-[#0d52a1] text-white rounded-lg text-xs font-bold hover:bg-blue-800 transition shadow-sm flex items-center gap-1.5">
                                    ...
                                    <a href="<?php echo e(route('bank.questions.print', $bank->id)); ?>" target="_blank" class="px-3 py-1.5 bg-white text-slate-600 border border-slate-200 rounded-lg text-xs font-bold hover:text-[#0d52a1] hover:bg-[#e5eff5] hover:border-[#56bbf1]/50 transition shadow-sm flex items-center gap-1.5">
                        ...
                        <div class="flex flex-col sm:flex-row justify-between items-center px-2 gap-4">
                            ...
                            <span class="text-xs font-bold text-[#0d52a1] bg-[#56bbf1]/10 border border-[#56bbf1]/20 px-3 py-1.5 rounded-lg shadow-sm flex items-center gap-1.5" title="Total Nilai">
                                <i class=" ph-fill ph-book-open-text text-base"></i> Soal <?php echo e($bank->questions->count()); ?>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $bank->questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <div class="absolute top-6 left-6 w-10 h-10 bg-slate-100 rounded-xl flex items-center justify-center font-black text-slate-500 text-sm group-hover:bg-[#2c3f61] group-hover:text-white transition-colors shadow-inner"><?php echo e($index + 1); ?></div>
                            ...
                            <div class="pl-20 sm:pl-24">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <?php elseif($qType == 'true_false'): ?> <span class="text-[10px] font-bold bg-[#f9a282]/10 text-[#c86845] px-2 py-0.5 rounded border border-[#f9a282]/20">BENAR / SALAH</span>
                                        <?php elseif($qType == 'matching'): ?> <span class="text-[10px] font-bold bg-[#e5eff5] text-[#2c3f61] px-2 py-0.5 rounded border border-slate-200">MENJODOHKAN</span>
                                        <?php elseif($qType == 'essay'): ?> <span class="text-[10px] font-bold bg-slate-100 text-slate-600 px-2 py-0.5 rounded border border-slate-200">ESSAI</span>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <?php elseif($qType == 'essay'): ?>
                                        <div class="text-xs text-slate-500 bg-slate-50 p-3 rounded-xl border border-slate-200">
                                            <span class="font-bold">Kunci:</span> <span class="text-[#2c3f61] font-medium"><?php echo e($q->correct_answer ?: '(Koreksi Manual)'); ?></span>
                                        </div>
                                    ...
                                    <div class="mt-5 pt-3 border-t border-slate-50 flex items-center gap-3">
                                        <span class="text-[10px] font-bold text-[#0d52a1] uppercase bg-[#56bbf1]/10 px-2 py-1 rounded-md border border-[#56bbf1]/20">Bobot: <?php echo e($q->score_weight); ?> Poin</span>
                                    </div>
                                </div>
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div class="flex gap-3 items-start">
                                            ...
                                            <div class="flex-1 space-y-2" x-data="{ optPreviewEdit: null, deleteOptImage: false }">
                                                <div class="flex gap-2">
                                                    <input type="text" name="option_<?php echo e($opt); ?>" x-model="editState.option_<?php echo e($opt); ?>" class="flex-1 rounded-xl border-slate-200 text-sm py-2.5 px-4 focus:ring-[#56bbf1] focus:border-[#56bbf1] font-medium" placeholder="Teks opsi <?php echo e($opt); ?>">
                                                    <label class="w-11 h-11 shrink-0 bg-white border border-slate-200 rounded-xl flex items-center justify-center text-slate-400 hover:text-[#0d52a1] hover:bg-[#e5eff5] cursor-pointer transition" title="Ganti Gambar Opsi <?php echo e($opt); ?>">
                                                        <i class="ph-bold ph-image text-lg"></i>
        ...
        <div x-show="showImportModal" style="display: none;" class="fixed inset-0 z-50 overflow-y-auto">
            ...
            <div class="flex min-h-screen items-center justify-center p-4">
                <div class="relative transform overflow-hidden rounded-[2.5rem] bg-white text-left shadow-2xl transition-all sm:w-full sm:max-w-md border border-slate-100">
                    ...
                    <form action="<?php echo e(route('bank.questions.import', $bank->id)); ?>" method="POST" enctype="multipart/form-data" class="p-8 space-y-6">
                        <?php echo csrf_field(); ?>
                        <div class="bg-[#e5eff5]/50 p-4 rounded-2xl border border-[#56bbf1]/20 mb-4">
                            ...
                            <a href="<?php echo e(route('bank.questions.template')); ?>" class="inline-flex items-center gap-1 mt-2 text-xs font-black text-[#2c3f61] hover:text-[#0d52a1] hover:underline transition">
