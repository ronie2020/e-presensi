            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
                ...
                <div class="relative rounded-[2rem] bg-gray-900 bg-gradient-to-br from-slate-900 via-indigo-900 to-indigo-800 p-8 text-white shadow-xl shadow-indigo-900/30 overflow-hidden border border-white/10">
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-indigo-200 text-sm font-medium">Total: <?php echo e($bank->questions->count()); ?> Soal</p>
                    </div>
                </div>
                            ...
                            <form action="<?php echo e(route('bank.questions.store', $bank->id)); ?>" method="POST" enctype="multipart/form-data" class="space-y-5" id="createQuestionForm">
                                ...
                                <div class="space-y-3 pt-2">
                                    ...
                                    <div class="flex gap-3 items-center group">
                                        ...
                                        <input type="text" name="option_<?php echo e($opt); ?>" required class="flex-1 rounded-xl border-slate-200 bg-white text-sm py-2.5 px-4 focus:ring-indigo-500 focus:border-indigo-500 font-medium" placeholder="Jawaban <?php echo e($opt); ?>">
                                    </div>
                                ...
                                <div class="pl-16">
                                    <?php if($q->question_image): ?>
                                        <div class="mb-4 group/img relative w-fit">
                                            <img src="<?php echo e(asset('storage/' . $q->question_image)); ?>" class="max-h-48 rounded-2xl border border-slate-100 shadow-sm object-cover">
                                        </div>
                                    <?php endif; ?>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-1 gap-3">
                                    ...
                                    <div class="flex gap-3 items-center">
                                        <span class="w-10 h-10 rounded-xl bg-slate-100 text-slate-500 flex items-center justify-center font-black text-sm"><?php echo e($opt); ?></span>
                                        <input type="text" name="option_<?php echo e($opt); ?>" x-model="editState.option_<?php echo e($opt); ?>" required class="flex-1 rounded-xl border-slate-200 text-sm py-2.5 px-4 focus:ring-indigo-500 font-medium">
                                    </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
