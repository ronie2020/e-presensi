    ...
    <div x-data="{
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 no-print">
            <div>
                ...
                <p class="text-sm text-slate-500 mt-1">Monitoring ibadah: <span class="font-bold text-slate-700"><?php echo e(\Carbon\Carbon::parse($date)->isoFormat('dddd, D MMMM Y')); ?></span></p>
            </div>
            ...
            <form action="<?php echo e(route('admin.ramadan.reports')); ?>" method="GET" class="flex flex-wrap gap-3 bg-white p-2 rounded-2xl shadow-sm border border-slate-100">
                ...
                <div class="flex items-center px-3 gap-2">
                    ...
                    <input type="date" name="date" value="<?php echo e($date); ?>" onchange="this.form.submit()" class="border-none bg-transparent text-sm font-bold focus:ring-0 cursor-pointer">
                </div>
                <div class="px-2">
                ...
                <div class="p-6 overflow-y-auto space-y-6">
                    ...
                    <div class="bg-slate-50 p-4 rounded-2xl border border-slate-100 space-y-3">
                        ...
                        <template x-if="details.khotib">
                         ...
                         <template x-if="!details.khotib && '<?php echo e($isFriday); ?>'">
                             <div class="mt-3 pt-3 border-t border-slate-200">
