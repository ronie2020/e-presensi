                ...
                <?php if(isset($tabs) && is_array($tabs)): ?>
                    <?php $__currentLoopData = $tabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $tab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <button @click="
                                ...
                                " 
                            :class="activeTab === '<?php echo e($key); ?>' ? 'bg-gradient-to-r from-cyan-500 to-blue-600 text-white shadow-lg shadow-cyan-500/30 transform scale-100' : 'text-slate-500 hover:bg-cyan-50 hover:text-cyan-700'"
                            ...
                            <i :class="activeTab === '<?php echo e($key); ?>' ? 'ph-fill text-white' : 'ph-bold group-hover:text-cyan-500'" 
