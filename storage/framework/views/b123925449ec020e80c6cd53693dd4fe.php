    ...
    <section class="py-20 bg-slate-50 dark:bg-slate-900/50 relative overflow-hidden border-b border-slate-100 dark:border-slate-800 transition-colors duration-300">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <a href="<?php echo e(route('ppdb.create')); ?>" class="group relative bg-white dark:bg-slate-800 rounded-[2rem] p-8 shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-700 hover:-translate-y-2 hover:shadow-elevate-primary/10 transition-all duration-300 h-full flex flex-col">
                ...
                <a href="<?php echo e(route('ppdb.check')); ?>" class="group relative bg-white dark:bg-slate-800 rounded-[2rem] p-8 shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-700 hover:-translate-y-2 hover:shadow-elevate-accent/10 transition-all duration-300 h-full flex flex-col">
