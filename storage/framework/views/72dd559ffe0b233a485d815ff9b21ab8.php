        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-center gap-6">
                    <div class="text-center md:text-left">
                        ...
                        <div class="mt-6 flex flex-wrap justify-center md:justify-start gap-3 ml-0 md:ml-12">
                            <a href="<?php echo e(route('letters.outgoing.create')); ?>" class="group bg-white text-elevate-dark px-5 py-3 rounded-2xl font-bold text-sm transition-all hover:bg-slate-50 flex items-center gap-2 shadow-lg shadow-elevate-dark/5 border border-white active:scale-95">
            ...
            <div class="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 overflow-hidden">
                ...
                <div class="p-6 border-b border-slate-100 bg-slate-50/50 flex flex-col xl:flex-row gap-4 justify-between items-center">
                    ...
                    <form action="<?php echo e(route('letters.outgoing.index')); ?>" method="GET" class="flex flex-col sm:flex-row gap-3 w-full xl:w-auto">
                        <div class="relative w-full sm:w-64">
                            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari nomor, perihal..." class="w-full pl-10 pr-4 py-2.5 rounded-xl border-slate-200 bg-white shadow-sm focus:border-elevate-primary focus:ring-elevate-primary text-sm font-medium text-slate-700 transition-all">
                        ...
                        <?php if(request('search') || request('sifat_surat')): ?>
                            <a href="<?php echo e(route('letters.outgoing.index')); ?>" class="px-4 py-2.5 bg-slate-100 text-slate-500 hover:bg-rose-50 hover:text-rose-600 rounded-xl text-sm font-bold transition-colors flex items-center justify-center gap-2" title="Reset Filter">
                        ...
                        <tbody class="divide-y divide-slate-50">
                            ...
                            <tr class="hover:bg-slate-50/80 transition-colors group">
                                <td class="px-6 py-5 align-top">
                                    ...
                                    <div class="text-xs text-slate-500 font-medium flex items-center gap-1.5 mt-1">
                                        <i class="ph-bold ph-calendar-blank"></i> <?php echo e(\Carbon\Carbon::parse($letter->tgl_surat)->translatedFormat('d M Y')); ?>
                                ...
                                <td class="px-6 py-5 align-top">
                                    <div class="flex items-start gap-2 mb-2">
                                        ...
                                        <span class="font-bold text-elevate-dark text-sm"><?php echo e($letter->tujuan_surat); ?></span>
                                    </div>
                                ...
                                <td class="px-6 py-5 align-top text-right">
                                    <div class="flex flex-col items-end gap-2">
                                        ...
                                        <div class="flex items-center gap-2 mt-1">
                                            ...
                                            <a href="<?php echo e(route('letters.outgoing.edit', $letter->id)); ?>" class="w-9 h-9 flex items-center justify-center rounded-xl bg-white border border-slate-200 text-slate-400 hover:text-amber-600 hover:border-amber-200 hover:bg-amber-50 hover:shadow-sm transition-all" title="Edit">
                                        ...
                                        <form id="delete-form-<?php echo e($letter->id); ?>" action="<?php echo e(route('letters.outgoing.destroy', $letter->id)); ?>" method="POST" class="hidden">
                            ...
                            <tr>
                                <td colspan="4" class="px-6 py-20 text-center">
                                    ...
                                    <a href="<?php echo e(route('letters.outgoing.create')); ?>" class="inline-flex items-center gap-2 px-6 py-3.5 bg-elevate-dark text-white rounded-xl font-bold text-sm hover:bg-elevate-primary transition-colors shadow-lg shadow-elevate-dark/20">
...
<?php endif; ?><?php /**PATH C:\Users\ronie\Documents\aplikasi terpadu\sistem_absensi_sekolah\resources\views/letters/outgoing/index.blade.php ENDPATH**/ ?>