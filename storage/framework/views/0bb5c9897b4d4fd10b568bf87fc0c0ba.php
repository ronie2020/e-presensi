    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center w-20 h-20 bg-white rounded-2xl shadow-lg mb-4 p-2">
                ...
                <img src="<?php echo e(asset('images/logo.png')); ?>" class="w-full h-full object-contain" alt="Logo Sekolah">
            </div>
        ...
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden border border-white/10 relative">
            ...
            <div class="p-8 pt-6">
                ...
                <form action="<?php echo e(route('student.login.post')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
            ...
            <div class="bg-slate-50 px-6 py-4 text-center border-t border-slate-100">
                <p class="text-[10px] text-slate-400 font-medium">
                    &copy; <?php echo e(date('Y')); ?> Sistem Ujian Sekolah. <br>
...
</html><?php /**PATH E:\aplikasi terpadu\sistem_absensi_sekolah\resources\views\auth\seb_login.blade.php ENDPATH**/ ?>