                    ...
                    <div class="bg-white p-6 md:p-8 rounded-xl fluent-card relative overflow-hidden animate-enter delay-100 group">
                        ...
                        <div class="mt-4 flex justify-between items-center px-1">
                            ...
                            <div class="text-[10px] text-slate-400 font-medium ml-auto">
                                Petugas: <span class="text-[#2A3B52] font-bold"><?php echo e(Auth::user()->name ?? 'Admin'); ?></span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="flex items-center justify-between p-3 rounded-xl border border-slate-100 hover:border-[#B7DFB9] hover:bg-[#DFF6DD]/30 transition-all duration-300 group">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="min-w-0 pr-2">
                                        <div class="text-sm font-bold text-[#2A3B52] line-clamp-1 group-hover:text-[#5295FF] transition-colors"><?php echo e($history->student->name); ?></div>
                                    ...
                                    <div class="permit-card group relative bg-white p-5 rounded-xl border transition-all duration-300 flex flex-col justify-between shadow-sm hover:-translate-y-1
                                        ...
                                        <div class="flex items-start gap-4 mb-4">
                                            <div class="w-12 h-12 rounded-lg flex-shrink-0 flex items-center justify-center text-lg font-bold shadow-sm transition-colors border
                                                <?php echo e($permit->is_overdue ? 'bg-[#FDE7E9] text-[#D13438] border-[#F4C3C9]' : 'bg-[#F3F9FD] text-[#5295FF] border-[#D0E7F8] group-hover:bg-[#5295FF] group-hover:text-white'); ?>">
                                                <?php echo e(substr($permit->student->name, 0, 1)); ?>

                                            </div>
                                            <div class="min-w-0 pr-2">
                                                <h4 class="font-bold text-[#2A3B52] leading-snug truncate text-sm md:text-base"><?php echo e($permit->student->name); ?></h4>
                                        ...
                                        <div class="space-y-3">
                                            ...
                                            <div class="bg-slate-50 rounded-lg p-3 border border-slate-100 group-hover:bg-white transition-colors">
                                                <div class="flex justify-between items-center mb-1">
                                                    ...
                                                    <span class="text-[10px] font-bold text-[#2A3B52] px-2 py-0.5 bg-white rounded-md border border-slate-200 shadow-sm"><?php echo e($permit->reason_category); ?></span>
                                                </div>
                                                <?php if($permit->notes): ?>
                                            ...
                                            <div class="flex items-end justify-between pt-2 border-t border-slate-50">
                                                <div class="text-[10px] font-bold text-slate-400 uppercase tracking-wide">
                                                    Keluar <span class="text-[#2A3B52] font-mono text-xs ml-1"><?php echo e($permit->time_out->format('H:i')); ?></span>
                                                </div>
                                                <div class="live-timer text-right" data-start="<?php echo e($permit->time_out); ?>">
                                                    <span class="text-2xl font-black font-mono leading-none tracking-tight <?php echo e($permit->is_overdue ? 'text-[#D13438]' : 'text-[#2A3B52]'); ?>">
