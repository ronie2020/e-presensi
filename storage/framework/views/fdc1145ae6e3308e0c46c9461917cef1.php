        ...
        <div class="animate-enter relative rounded-[2.5rem] bg-gradient-to-r from-blue-900 via-slate-800 to-slate-900 p-8 md:p-12 text-white shadow-2xl shadow-blue-900/20 overflow-hidden group border border-white/10">
            ...
            <div class="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-10">
                ...
                <div class="w-full lg:w-auto">
                    <form id="filterForm" action="<?php echo e(route('teacher.habits.index')); ?>" method="GET" class="glass-card p-6 rounded-3xl shadow-xl flex flex-col md:flex-row gap-4 border-white/20 relative">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 animate-enter" style="animation-delay: 100ms">
                <div class="glass-card p-6 rounded-[2rem] shadow-sm flex items-center gap-5 group hover:shadow-lg transition-all duration-300 border-white">
                    ...
                    <div>
                        ...
                        <p class="text-3xl font-black text-slate-800 tracking-tight"><?php echo e($stats['submitted']); ?> <span class="text-xs font-bold text-slate-400 uppercase">Siswa</span></p>
                    </div>
                </div>
                ...
                <div class="glass-card p-6 rounded-[2rem] shadow-sm flex items-center gap-5 group hover:shadow-lg transition-all duration-300 border-white">
                    ...
                    <div>
                        ...
                        <p class="text-3xl font-black text-slate-800 tracking-tight"><?php echo e($stats['missing']); ?> <span class="text-xs font-bold text-slate-400 uppercase">Siswa</span></p>
                    </div>
                </div>
                ...
                <div class="bg-blue-600 p-6 rounded-[2rem] shadow-xl shadow-blue-900/10 flex items-center gap-5 group hover:bg-blue-700 transition-all duration-300 border border-blue-500/20">
                    ...
                    <div>
                        ...
                        <p class="text-3xl font-black text-white tracking-tight"><?php echo e($stats['percentage']); ?>%</p>
                    </div>
                </div>
            </div>
                                ...
                                <tr class="hover:bg-slate-50/50 transition-colors group">
                                    <td class="px-8 py-5">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                <div class="font-extrabold text-slate-700 group-hover:text-blue-600 transition-colors uppercase tracking-tight"><?php echo e($student->name); ?></div>
                                                <div class="text-[10px] text-slate-400 font-bold tracking-widest uppercase"><?php echo e($student->student_id); ?></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-5">
                                    ...
                                    <td class="px-6 py-5">
                                        <?php if($student->habit_data): ?>
                                            <div class="flex items-center gap-2 text-slate-600 font-extrabold text-xs">
                                                ...
                                                <?php echo e($student->habit_data->created_at->format('H:i')); ?> <span class="text-[9px] text-slate-400">WIB</span>
                                            </div>
                                        <?php else: ?>
