            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php if($att->status == 'Terlambat'): ?> <small>(Poin)</small> <?php endif; ?>
                    </td>
                </tr>
        ...
        <table class="data">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo e($att->student->name); ?></td>
                    <td class="center"><?php echo e($att->student->schoolClass->name ?? '-'); ?></td>
                    <td class="center" style="font-weight: bold;"><?php echo e($att->status); ?></td>
...
</html><?php /**PATH C:\Users\ronie\Documents\aplikasi\E-Presensi Netila\resources\views/reports/print_daily.blade.php ENDPATH**/ ?>