                    ...
                    <div class="p-6 md:p-10 space-y-10">
                        ...
                        <div class="bg-slate-50/50 rounded-[2rem] p-6 md:p-8 border border-slate-100">
                                ...
                                <div class="bg-[#FFEFD6] border border-[#FFD8A8] rounded-2xl p-5 flex items-start gap-4 shadow-sm mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-[#D83B01]/80 mt-1.5 font-bold leading-relaxed">
                                            Saat ini fitur edit <b>detail butir soal</b> belum tersedia di halaman ini. Jika ada kesalahan fatal pada soal, disarankan untuk menghapus dan membuat tugas baru agar nilai siswa tidak rusak. Anda hanya dapat mengubah instruksi dan durasi waktu di sini.
                                        </p>
                                    </div>
                                </div>
                            </div>

                            <!-- D. JIKA VIDEO INTERAKTIF (BARU DITAMBAHKAN) -->
                            <div x-show="assignmentType === 'interactive_video'" x-cloak>
                                ...
                                <label class="block text-[10px] font-bold text-elevate-primary uppercase tracking-widest mb-2 ml-1">Instruksi Tugas <span class="text-[#D13438]">*</span></label>
                                ...
                                <div class="bg-[#FFEFD6] border border-[#FFD8A8] rounded-2xl p-5 flex items-start gap-4 shadow-sm mb-4">
                                    <div class="p-2.5 bg-white text-[#D83B01] rounded-xl shrink-0 shadow-sm border border-[#FFD8A8]"><i class="ph-bold ph-warning text-xl"></i></div>
                                    <div>
                                        <h4 class="font-black text-[#D83B01] text-sm">Peringatan Edit Titik Kuis</h4>
                                        <p class="text-xs text-[#D83B01]/80 mt-1.5 font-bold leading-relaxed">
                                            Saat ini fitur edit <b>detail titik waktu soal interaktif</b> belum tersedia di halaman ini. Anda hanya dapat mengubah Link YouTube dan instruksi tugas. Jika ada kesalahan pada soal interaktif yang sudah terlanjur dibuat, disarankan untuk menghapus dan membuat tugas baru.
                                        </p>
                                    </div>
                                </div>
                            </div>
