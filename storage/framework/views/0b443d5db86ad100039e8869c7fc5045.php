                        ...
                        <div class="p-6 bg-slate-50/50 rounded-[2rem] border border-slate-100 relative group hover:border-slate-200 transition-colors">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pl-9">
                                <div>
                                    ...
                                    <input type="text" name="nomor_agenda" value="<?php echo e(old('nomor_agenda', $letter->nomor_agenda)); ?>" readonly class="w-full px-4 rounded-2xl border-slate-200 bg-slate-100 shadow-inner focus:outline-none text-sm py-3 font-bold text-slate-500 cursor-not-allowed transition-all" title="Nomor Agenda tidak dapat diubah">
                        ...
                        <div class="p-6 bg-slate-50/50 rounded-[2rem] border border-slate-100 relative group hover:border-slate-200 transition-colors">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pl-9">
                                <div>
                                    ...
                                    <input type="date" name="tgl_surat" value="<?php echo e(old('tgl_surat', $letter->tgl_surat)); ?>" required class="w-full px-4 rounded-2xl border-slate-200 bg-white shadow-sm focus:border-elevate-primary focus:ring-elevate-primary text-sm py-3 font-bold text-elevate-dark transition-all">
                                </div>
                                <div>
