                        ...
                        <div class="p-6 bg-slate-50/50 rounded-[2rem] border border-slate-100 relative group hover:border-slate-200 transition-colors">
                            ...
                            <div class="pl-9">
                                ...
                                <div>
                                    ...
                                    <p class="text-[10px] text-slate-400 mt-2 ml-1 flex items-center gap-1 font-medium"><i class="ph-fill ph-info text-elevate-primary"></i> PDF / JPG / PNG (Max 2MB).</p>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function confirmSubmit(e) {
            ...
            Swal.fire({
                ...
                reverseButtons: true, 
                customClass: {
                    confirmButton: 'bg-elevate-dark text-white px-6 py-3 rounded-xl font-bold hover:bg-elevate-primary mx-2 shadow-lg',
                    cancelButton: 'bg-slate-100 text-slate-600 px-6 py-3 rounded-xl font-bold hover:bg-slate-200 mx-2'
                }, 
                buttonsStyling: false
            }).then((result) => {
                if (result.isConfirmed) {
                    Swal.fire({ title: 'Memperbarui...', showConfirmButton: false, didOpen: () => Swal.showLoading() });
                    form.submit();
                }
            });
        }
