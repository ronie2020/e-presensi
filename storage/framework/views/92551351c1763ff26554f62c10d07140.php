...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative flex items-center">
                                ...
                                <select name="cbt_event_id" required class="w-full pl-12 rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-[#56bbf1] focus:ring-[#56bbf1] font-bold text-[#2c3f61] py-3.5 px-5 appearance-none cursor-pointer transition-all <?php $__errorArgs = ['cbt_event_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="title" value="<?php echo e(old('title')); ?>" required 
                                   class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-[#56bbf1] focus:ring-[#56bbf1] font-bold text-[#2c3f61] py-3.5 px-5 transition-all placeholder:font-normal placeholder:text-slate-400 <?php $__errorArgs = ['title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <select name="subject_name" required class="w-full pl-11 rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-[#56bbf1] focus:ring-[#56bbf1] font-bold text-[#2c3f61] py-3.5 px-5 appearance-none cursor-pointer transition-all <?php $__errorArgs = ['subject_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 <?php unset($message);
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="start_time" x-model="startTime" value="<?php echo e(old('start_time')); ?>" required 
                                       class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-[#56bbf1] focus:ring-[#56bbf1] font-bold text-[#2c3f61] py-3.5 px-5 transition-all <?php $__errorArgs = ['start_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="end_time" x-model="endTime" value="<?php echo e(old('end_time')); ?>" required 
                                       class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-[#56bbf1] focus:ring-[#56bbf1] font-bold text-[#2c3f61] py-3.5 px-5 transition-all <?php $__errorArgs = ['end_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-6">
                            ...
                            <div class="col-span-1">
                                ...
                                <div class="relative">
                                    <input type="number" name="duration_minutes" value="<?php echo e(old('duration_minutes', 90)); ?>" required class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-[#56bbf1] focus:ring-[#56bbf1] font-bold text-[#2c3f61] py-3.5 px-5 transition-all text-center">
                            ...
                            <div class="col-span-1" x-show="examType === 'cbt'">
                                ...
                                <div class="relative">
                                    <input type="number" name="question_limit" value="<?php echo e(old('question_limit', 0)); ?>" class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-[#56bbf1] focus:ring-[#56bbf1] font-bold text-[#2c3f61] py-3.5 px-5 transition-all text-center" placeholder="0 = Semua">
                            ...
                            <div class="col-span-1" x-show="examType === 'cbt'">
                                ...
                                <input type="number" name="passing_grade" value="<?php echo e(old('passing_grade', 75)); ?>" class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-[#56bbf1] focus:ring-[#56bbf1] font-bold text-[#2c3f61] py-3.5 px-5 transition-all text-center">
                            </div>
                             ...
                             <div class="col-span-2 md:col-span-1">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="token" value="<?php echo e(old('token')); ?>" maxlength="6" class="w-full pl-11 rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-[#56bbf1] focus:ring-[#56bbf1] font-mono font-black text-[#2c3f61] py-3.5 px-5 transition-all uppercase tracking-widest placeholder:tracking-normal <?php $__errorArgs = ['token'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="AUTO">
                        ...
                        <div class="pt-4 border-t border-slate-100 flex flex-col-reverse md:flex-row justify-end gap-3">
                            <a href="<?php echo e(route('cbt.index')); ?>" class="w-full md:w-auto text-center px-6 py-3.5 bg-white border border-slate-200 rounded-xl text-slate-600 font-bold hover:bg-slate-50 transition text-sm shadow-sm">Batal</a>
...
<?php endif; ?><?php /**PATH C:\Users\ronie\Documents\aplikasi terpadu\sistem_absensi_sekolah\resources\views/cbt/create.blade.php ENDPATH**/ ?>