<aside class="fixed inset-y-0 left-0 z-50 w-72 bg-white border-r border-slate-200 transition-transform duration-300 lg:translate-x-0"
    ...
    <div class="p-4 space-y-1 overflow-y-auto h-[calc(100vh-5rem)] custom-scrollbar">
        ...
        <a href="<?php echo e(route('portal.index')); ?>" 
           ...
           <?php echo e(request()->routeIs('portal.index') 
                ? 'bg-blue-50 text-blue-600 font-bold shadow-sm ring-1 ring-blue-100' 
                : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900 font-medium'); ?>">
            <i class="text-xl <?php echo e(request()->routeIs('portal.index') ? 'ph-fill ph-squares-four' : 'ph-bold ph-squares-four'); ?>"></i>
            <span>Dashboard</span>
        </a>

        
        <a href="<?php echo e(route('portal.show', Auth::guard('student')->id())); ?>" 
           class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all group
           <?php echo e(request()->routeIs('portal.show') 
                ? 'bg-blue-50 text-blue-600 font-bold shadow-sm ring-1 ring-blue-100' 
                : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900 font-medium'); ?>">
            <i class="text-xl <?php echo e(request()->routeIs('portal.show') ? 'ph-fill ph-user-circle' : 'ph-bold ph-user-circle'); ?>"></i>
        ...
        <a href="<?php echo e(route('students.learning.index')); ?>" 
           ...
           <?php echo e(request()->routeIs('students.learning.*') 
                ? 'bg-blue-50 text-blue-600 font-bold shadow-sm ring-1 ring-blue-100' 
                : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900 font-medium'); ?>">
            <i class="text-xl <?php echo e(request()->routeIs('students.learning.*') ? 'ph-fill ph-books' : 'ph-bold ph-books'); ?>"></i>
            <span>Ruang Belajar</span>
        </a>

        
        <a href="<?php echo e(route('student.schedule.index')); ?>" 
           class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all group
           <?php echo e(request()->routeIs('student.schedule.*') 
                ? 'bg-blue-50 text-blue-600 font-bold shadow-sm ring-1 ring-blue-100' 
                : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900 font-medium'); ?>">
            <i class="text-xl <?php echo e(request()->routeIs('student.schedule.*') ? 'ph-fill ph-calendar-blank' : 'ph-bold ph-calendar-blank'); ?>"></i>
        ...
        <a href="<?php echo e(route('student.exam.index')); ?>" 
           ...
           <?php echo e(request()->routeIs('student.exam.*') 
                ? 'bg-blue-50 text-blue-600 font-bold shadow-sm ring-1 ring-blue-100' 
                : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900 font-medium'); ?>">
            <i class="text-xl <?php echo e(request()->routeIs('student.exam.*') ? 'ph-fill ph-desktop' : 'ph-bold ph-desktop'); ?>"></i>
        ...
        <a href="<?php echo e(route('student.liaison.index')); ?>" 
           class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all group
           <?php echo e(request()->routeIs('student.liaison.*') 
            ...
            <i class="text-xl <?php echo e(request()->routeIs('student.liaison.*') ? 'ph-fill ph-chat-circle-text' : 'ph-bold ph-chat-circle-text'); ?>"></i>
            <span>Buku Penghubung</span>
        </a>

        
        <a href="<?php echo e(route('student.complaints.index')); ?>" 
           class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all group
           <?php echo e(request()->routeIs('student.complaints.*') 
            ...
            <i class="text-xl <?php echo e(request()->routeIs('student.complaints.*') ? 'ph-fill ph-megaphone' : 'ph-bold ph-megaphone'); ?>"></i>
            <span>Pengaduan & Lapor</span>
            
            <?php if(request()->routeIs('student.complaints.*')): ?>
                <span class="ml-auto w-1.5 h-1.5 bg-rose-500 rounded-full animate-pulse"></span>
            <?php endif; ?>
        </a>
        <a href="<?php echo e(route('student.habits.index')); ?>" 
            class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all group
            <?php echo e(request()->routeIs('student.habits.*') 
                ...
                <i class="text-xl <?php echo e(request()->routeIs('student.habits.*') ? 'ph-fill ph-check-square-offset' : 'ph-bold ph-check-square-offset'); ?>"></i>
...
</aside><?php /**PATH E:\aplikasi terpadu\sistem_absensi_sekolah\resources\views\layouts\student-sidebar.blade.php ENDPATH**/ ?>