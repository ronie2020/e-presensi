            ...
            <div class="relative rounded-[2rem] bg-gray-900 bg-gradient-to-br from-slate-900 via-indigo-900 to-purple-900 p-8 text-white shadow-xl shadow-indigo-900/30 overflow-hidden border border-white/10 print:hidden">
                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    ...
                    <div class="flex gap-3">                       
                        ...
                        <form action="<?php echo e(route('cbt.sync_grades', $exam->id)); ?>" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin memposting nilai ini ke Buku Nilai (LMS)?\n\nData akan masuk sebagai Tugas Baru di rekap nilai siswa.')">
                            <?php echo csrf_field(); ?>
                        ...
                        <button onclick="window.print()" class="group px-5 py-3 bg-white/10 backdrop-blur-md text-white font-bold rounded-2xl hover:bg-white/20 transition flex items-center gap-2 border border-white/10">
