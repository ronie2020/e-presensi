                ...
                <form action="<?php echo e(route('lms.materials.store')); ?>" method="POST" enctype="multipart/form-data" 
                    ...
                    <div class="p-6 md:p-8 space-y-8">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <textarea name="resume" rows="6" class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:ring-blue-500 focus:border-blue-500 shadow-sm p-4 text-slate-700 leading-relaxed font-medium placeholder:font-normal placeholder:text-slate-400 transition-colors focus:bg-white" placeholder="Tuliskan rangkuman materi, tujuan pembelajaran, atau instruksi untuk siswa..."><?php echo e(old('resume')); ?></textarea>
