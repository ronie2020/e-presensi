                                    ...
                                    <div class="space-y-5">
                                        ...
                                        <div>
                                            ...
                                            <div class="flex gap-2">
                                                <div class="relative flex-1 group">
                                                    ...
                                                    <input type="text" name="book_code" id="book_code" value="<?php echo e($autoCode ?? ''); ?>" required placeholder="Scan atau ketik kode..."
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <input type="number" name="year" placeholder="YYYY" min="1900" max="<?php echo e(date('Y') + 1); ?>"
                                                    class="w-full px-4 py-3 rounded-2xl border-slate-200 bg-white focus:border-blue-500 focus:ring-blue-500 font-bold text-slate-700 transition-all shadow-sm">
                                            </div>
                                        </div>
                                    </div>
...
<?php endif; ?><?php /**PATH E:\drive aplikasi\aplikasi terpadu\sistem_absensi_sekolah versi 3.00\resources\views/books/create.blade.php ENDPATH**/ ?>