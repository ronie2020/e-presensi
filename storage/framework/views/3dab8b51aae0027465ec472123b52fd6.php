        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 animate-enter">
            <div class="flex flex-col md:flex-row items-center md:items-start gap-8">
                ...
                <div class="text-center md:text-left flex-1 mt-4 md:mt-0">
                    ...
                    <p class="text-cyan-100 font-mono text-sm mb-6"><?php echo e(!empty($teacher->nip) ? 'NIP. ' . $teacher->nip : 'Non-NIP'); ?></p>
                   ...
                   <!-- Sosial Media (Warna tombol diubah menyesuaikan background terang) -->
                    <div class="flex items-center justify-center md:justify-start gap-4">
                        ...
                        <a href="<?php echo e($teacher->instagram); ?>" target="_blank" class="w-11 h-11 rounded-xl bg-white/10 border border-white/20 text-white hover:bg-gradient-to-tr hover:from-pink-500 hover:to-purple-500 flex items-center justify-center transition-all duration-300 shadow-lg hover:-translate-y-1 backdrop-blur-sm">
                            <i class="ph ph-instagram-logo text-2xl"></i>
                        </a>
                        <?php endif; ?>

                        <?php if(!empty($teacher->facebook)): ?>
                        <a href="<?php echo e($teacher->facebook); ?>" target="_blank" class="w-11 h-11 rounded-xl bg-white/10 border border-white/20 text-white hover:bg-blue-600 flex items-center justify-center transition-all duration-300 shadow-lg hover:-translate-y-1 backdrop-blur-sm">
                            <i class="ph ph-facebook-logo text-2xl"></i>
                        </a>
                        <?php endif; ?>

                        <?php if(!empty($teacher->tiktok)): ?>
                        <a href="<?php echo e($teacher->tiktok); ?>" target="_blank" class="w-11 h-11 rounded-xl bg-white/10 border border-white/20 text-white hover:bg-slate-900 flex items-center justify-center transition-all duration-300 shadow-lg hover:-translate-y-1 backdrop-blur-sm">
                            <i class="ph ph-tiktok-logo text-2xl"></i>
                        </a>
                        <?php endif; ?>

                        <?php if(!empty($teacher->phone)): ?>
                        <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $teacher->phone)); ?>" target="_blank" class="w-11 h-11 rounded-xl bg-white/10 border border-white/20 text-white hover:bg-emerald-500 flex items-center justify-center transition-all duration-300 shadow-lg hover:-translate-y-1 backdrop-blur-sm">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex flex-wrap justify-center md:justify-start gap-2">
                                    <?php $__currentLoopData = array_map('trim', explode(',', $teacher->keahlian ?? '')); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keahlian): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <span class="px-3 py-1 bg-white/10 text-white border border-white/20 rounded-lg text-xs font-medium shadow-sm backdrop-blur-sm"><?php echo e($keahlian); ?></span>
                                        <?php endif; ?>
                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex flex-wrap justify-center md:justify-start gap-2">
                                    <?php $__currentLoopData = array_map('trim', explode(',', $teacher->hobi ?? '')); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hobi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(!empty($hobi)): ?>
                                        <span class="px-3 py-1 bg-white/10 text-white border border-white/20 rounded-lg text-xs font-medium shadow-sm backdrop-blur-sm"><?php echo e($hobi); ?></span>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
