...
<body>
    ...
    <div class="content">
        ...
        <p style="text-align: justify;">
            Berdasarkan hasil Rapat Pleno Dewan Guru tentang Kelulusan Peserta Didik Tahun Pelajaran <?php echo e($student->graduation->academic_year ?? ($settings['academic_year'] ?? '')); ?> yang dilaksanakan pada tanggal <?php echo e(\Carbon\Carbon::parse($student->graduation->announcement_date ?? now())->isoFormat('D MMMM Y')); ?>, maka peserta didik tersebut dinyatakan:
        </p>
...
</html><?php /**PATH C:\Users\ronie\Documents\aplikasi terpadu\sistem_absensi_sekolah\resources\views/graduation/pdf_skl.blade.php ENDPATH**/ ?>