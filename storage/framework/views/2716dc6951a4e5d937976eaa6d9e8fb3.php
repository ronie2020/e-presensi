    ...
    <div class="sheet">
        ...
        <div style="line-height: 1.3;">
            ...
            <p style="text-align: justify;">
                Berdasarkan hasil Rapat Pleno Dewan Guru tentang Kelulusan Peserta Didik Tahun Pelajaran <?php echo e($student->graduation->academic_year ?? ($settings['academic_year'] ?? '')); ?> yang dilaksanakan pada tanggal <?php echo e(\Carbon\Carbon::parse($student->graduation->announcement_date ?? now())->locale('id')->isoFormat('D MMMM Y')); ?>, maka peserta didik tersebut dinyatakan:
            </p>
