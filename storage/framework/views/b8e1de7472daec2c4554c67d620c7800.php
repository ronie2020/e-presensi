    ...
    <section class="py-24 bg-slate-50 dark:bg-slate-900 relative overflow-hidden transition-colors duration-300">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="flex flex-col md:flex-row justify-between items-end mb-12 gap-6" data-aos="fade-up">
                ...
                <a href="<?php echo e(route('library.catalogue')); ?>" class="group flex items-center gap-2 px-6 py-3 bg-cyan-600 dark:bg-white text-white dark:text-slate-900 font-bold rounded-full hover:bg-cyan-500 dark:hover:bg-cyan-50 transition-all shadow-xl shadow-cyan-500/20 dark:shadow-cyan-900/20">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $latestBooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="group relative" data-aos="fade-up" data-aos-delay="<?php echo e($loop->iteration * 100); ?>">
                        ...
                        <div class="bg-white dark:bg-slate-800/50 backdrop-blur-md border border-slate-100 dark:border-slate-700/50 rounded-2xl p-3 h-full flex flex-col hover:-translate-y-2 transition-all duration-300 shadow-lg dark:shadow-2xl">
                            ...
                            <div class="mt-auto">
                                <h3 class="text-slate-800 dark:text-white font-bold text-sm line-clamp-2 leading-snug mb-1 group-hover:text-cyan-600 dark:group-hover:text-cyan-400 transition-colors" title="<?php echo e($book->title); ?>">
    ...
    </section><?php /**PATH E:\aplikasi terpadu\sistem_absensi_sekolah\resources\views/landing/ebooks.blade.php ENDPATH**/ ?>