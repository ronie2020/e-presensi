            ...
            <div class="relative z-10 flex flex-col md:flex-row justify-between items-center gap-10">
                <div class="text-center md:text-left flex-1">
                    ...
                    <h1 class="text-4xl md:text-6xl font-black text-white mb-4 tracking-tight leading-tight">
                        Halo, <span class="text-transparent bg-clip-text bg-gradient-to-r from-rose-300 via-purple-300 to-indigo-300 animate-gradient"><?php echo e(explode(' ', Auth::guard('student')->user()->name)[0]); ?>!</span>
                    </h1>
            ...
            <div class="animate-enter mb-16" style="animation-delay: 100ms">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php $__currentLoopData = $prioritySubjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('students.learning.subject.show', $subject->id)); ?>" class="group relative bg-white rounded-[2rem] p-1 shadow-sm hover:shadow-xl hover:shadow-rose-900/10 transition-all duration-300 hover:-translate-y-1">
                            ...
                            <div class="relative bg-white rounded-[1.8rem] p-6 h-full border border-rose-100/50 flex flex-col">
                                ...
                                <h3 class="font-bold text-lg text-slate-800 mb-1 group-hover:text-rose-600 transition-colors line-clamp-1"><?php echo e($subject->name); ?></h3>
            ...
            <?php else: ?>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    <?php $__currentLoopData = $allSubjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <a href="<?php echo e(route('students.learning.subject.show', $subject->id)); ?>" class="group relative flex flex-col bg-white rounded-[2rem] p-1.5 shadow-sm hover:shadow-2xl hover:shadow-slate-200/50 transition-all duration-300 hover:-translate-y-1.5 h-full">
                            ...
                            <div class="flex-1 bg-white rounded-[1.7rem] p-5 border border-slate-100 relative overflow-hidden">
                                ...
                                <h4 class="font-bold text-lg text-slate-800 leading-snug mb-1 group-hover:<?php echo e($t['text']); ?> transition-colors line-clamp-2">
                            ...
                            <div class="px-5 py-3 flex items-center justify-between">
                                <span class="text-[10px] font-black text-slate-300 uppercase tracking-widest group-hover:<?php echo e($t['text']); ?> transition-colors">Masuk Kelas</span>
...
<?php endif; ?><?php /**PATH E:\drive aplikasi\aplikasi terpadu\sistem_absensi_sekolah versi 3.00\resources\views/students/lms/index.blade.php ENDPATH**/ ?>