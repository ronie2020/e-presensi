...
<head>
    ...
    <title>Surat Keterangan Diterima - <?php echo e($registrant->full_name); ?></title>
...
<body>
    ...
    <div class="no-print fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-md border-b border-slate-200 shadow-sm p-4 flex justify-between items-center z-50">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-xs text-slate-500 font-sans font-bold">Ref: <?php echo e($registrant->registration_number); ?></p>
            </div>
        </div>
        <div class="flex gap-3">
            <a href="<?php echo e(route('ppdb.check')); ?>" class="px-5 py-2.5 text-xs font-bold text-slate-600 bg-white border border-slate-300 rounded-xl hover:bg-slate-50 hover:text-slate-800 transition shadow-sm font-sans flex items-center gap-2">
    ...
    <div class="sheet">
        ...
        <div class="relative py-2">
            ...
            <img src="<?php echo e(asset('img/logo_ciamis.png')); ?>" alt="Logo Kab" 
        ...
        <div class="judul-surat">
            ...
            <p>Nomor: 421.3/<?php echo e(str_pad($registrant->id, 3, '0', STR_PAD_LEFT)); ?>/PPDB/<?php echo e(date('Y')); ?></p>
        </div>

        <p class="content-text">
            Yang bertanda tangan di bawah ini, Kepala SMP Negeri 3 Lakbok, Kabupaten Ciamis, berdasarkan hasil seleksi Penerimaan Peserta Didik Baru (PPDB) Tahun Ajaran <?php echo e($registrant->academic_year); ?>/<?php echo e($registrant->academic_year + 1); ?>, menerangkan bahwa:
        </p>
        ...
        <table class="content-table">
            <tr>
                ...
                <td class="col-value" style="text-transform: uppercase;"><?php echo e($registrant->full_name); ?></td>
            </tr>
            <tr>
                <td class="col-label">Nomor Pendaftaran</td>
                <td class="col-separator">:</td>
                <td class="col-value"><?php echo e($registrant->registration_number); ?></td>
            </tr>
            <tr>
                <td class="col-label">NISN</td>
                <td class="col-separator">:</td>
                <td><?php echo e($registrant->nisn); ?></td>
            </tr>
            <tr>
                <td class="col-label">Tempat, Tanggal Lahir</td>
                <td class="col-separator">:</td>
                <td><?php echo e($registrant->birth_place); ?>, <?php echo e(\Carbon\Carbon::parse($registrant->birth_date)->isoFormat('D MMMM Y')); ?></td>
            </tr>
            <tr>
                <td class="col-label">Asal Sekolah</td>
                <td class="col-separator">:</td>
                <td><?php echo e($registrant->school_origin); ?></td>
            </tr>
            <tr>
                <td class="col-label">Jalur Pendaftaran</td>
                <td class="col-separator">:</td>
                <td style="text-transform: capitalize;"><?php echo e($registrant->track); ?></td>
            </tr>
        </table>
    ...
    <div class="no-print text-center text-slate-400 text-xs pb-8">
        &copy; <?php echo e(date('Y')); ?> Sistem Informasi PPDB SMPN 3 Lakbok
    </div>

</body>
</html><?php /**PATH E:\aplikasi terpadu\sistem_absensi_sekolah\resources\views/ppdb/print-letter.blade.php ENDPATH**/ ?>