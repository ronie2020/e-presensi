    ...
    <div class="py-8 sm:py-10 font-sans text-[#2c3f61]">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="relative rounded-[2rem] bg-gradient-to-r from-[#56bbf1] via-[#e5eff5] to-[#f4d1c0] p-8 mb-8 text-[#2c3f61] shadow-xl shadow-[#56bbf1]/10 overflow-hidden border border-white/60">
                ...
                <div class="absolute -bottom-20 -right-10 w-64 h-64 bg-[#f9a282]/30 rounded-[3rem] -rotate-12 pointer-events-none backdrop-blur-2xl"></div>
                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div>
                        <div class="flex items-center gap-2 mb-2">
                            ...
                            <span class="text-[10px] font-bold text-[#2c3f61]/70 uppercase tracking-wider">Edit Jadwal</span>
                        </div>
                        <h1 class="text-3xl font-extrabold tracking-tight leading-none text-[#2c3f61] mb-2">Edit Data Ujian</h1>
                        <p class="text-[#2c3f61]/80 text-sm font-medium">Perbarui detail pelaksanaan, metode ujian, durasi, atau token.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[2.5rem] shadow-xl shadow-[#56bbf1]/10 border border-slate-100 overflow-hidden">
                <div class="px-8 py-6 border-b border-slate-100 bg-[#e5eff5]/30 flex items-center gap-3">
                    <div class="w-10 h-10 rounded-xl bg-[#f9a282]/20 text-[#c86845] flex items-center justify-center text-xl shadow-sm">
                        <i class="ph-bold ph-pencil-simple-line"></i>
                    </div>
                    <h3 class="font-bold text-[#2c3f61] text-lg">Formulir Perubahan Data</h3>
                </div>
...
unset($__errorArgs, $__bag); ?>">
                                    <option value="" disabled>-- Pilih Folder Kegiatan --</option>
                                    <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($evt->id); ?>" <?php echo e(old('cbt_event_id', $exam->cbt_event_id) == $evt->id ? 'selected' : ''); ?>>
                                            <?php echo e($evt->name); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-6">
                            ...
                            <div class="col-span-1">
                                ...
                                <div class="relative">
                                    <input type="number" name="duration_minutes" value="<?php echo e(old('duration_minutes', $exam->duration_minutes)); ?>" required class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-[#56bbf1] focus:ring-[#56bbf1] font-bold text-[#2c3f61] py-3.5 px-5 transition-all text-center">
                            ...
                            <div class="col-span-1" x-show="examType === 'cbt'">
                                ...
                                <div class="relative">
                                    <input type="number" name="question_limit" value="<?php echo e(old('question_limit', $exam->question_limit ?? 0)); ?>" class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-[#56bbf1] focus:ring-[#56bbf1] font-bold text-[#2c3f61] py-3.5 px-5 transition-all text-center" placeholder="0 = Semua">
                            ...
                            <div class="col-span-1" x-show="examType === 'cbt'">
                                ...
                                <input type="number" name="passing_grade" value="<?php echo e(old('passing_grade', $exam->passing_grade)); ?>" class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-[#56bbf1] focus:ring-[#56bbf1] font-bold text-[#2c3f61] py-3.5 px-5 transition-all text-center">
                            </div>
                             ...
                             <div class="col-span-2 md:col-span-1">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="token" value="<?php echo e(old('token', $exam->token)); ?>" maxlength="6" class="w-full pl-11 rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-[#56bbf1] focus:ring-[#56bbf1] font-mono font-black text-[#2c3f61] py-3.5 px-5 transition-all uppercase tracking-widest placeholder:tracking-normal <?php $__errorArgs = ['token'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="flex flex-row items-center gap-4 bg-[#e5eff5]/50 p-5 rounded-2xl border border-[#56bbf1]/30">
                            <div class="relative flex items-center">
                            ...
                            <label for="active" class="text-sm font-bold text-[#2c3f61] cursor-pointer select-none">Status Ujian Aktif</label>
                        </div>
...
<?php endif; ?><?php /**PATH C:\Users\ronie\Documents\aplikasi terpadu\sistem_absensi_sekolah\resources\views/cbt/edit.blade.php ENDPATH**/ ?>