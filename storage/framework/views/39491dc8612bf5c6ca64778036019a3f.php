                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
                    ...
                    <div class="max-w-2xl">
                        ...
                        <p class="text-blue-100/80 text-sm md:text-base font-medium leading-relaxed max-w-lg">
                            Kelola akun akses untuk Guru, Staf, dan Administrator sistem. Data lengkap profil dapat dilengkapi melalui menu Edit.
                        </p>
                    </div>
                        ...
                        <div class="p-8 relative z-10">
                            <form action="<?php echo e(route('users.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <select name="role" required class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-blue-600 focus:ring-blue-600 font-bold text-slate-700 py-3 px-4 transition-colors appearance-none cursor-pointer">
                                    ...
                                    <p class="text-[10px] text-slate-400 mt-2 ml-1 italic">
                                        *Data NIP, Pangkat, dan Bio dapat dilengkapi setelah akun dibuat melalui tombol Edit.
                                    </p>
                                </div>
                                            ...
                                            <td class="px-6 py-5 whitespace-nowrap">
                                                ...
                                                <div class="flex flex-col items-start gap-1.5">
                                                    ...
                                                    <?php if($user->position || $user->pangkat): ?>
                                                        <div class="text-xs text-slate-500 font-bold flex flex-col gap-0.5">
...
<?php endif; ?><?php /**PATH E:\drive aplikasi\aplikasi terpadu\sistem_absensi_sekolah versi 3.00\resources\views/users/index.blade.php ENDPATH**/ ?>