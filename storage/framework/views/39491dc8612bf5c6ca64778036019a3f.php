                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden sticky top-24 relative group hover:shadow-2xl hover:shadow-blue-900/10 transition-all duration-300">
                        ...
                        <div class="p-8 relative z-10">
                            <form action="<?php echo e(route('users.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-5" x-data="{ role: 'Guru' }">
                                <?php echo csrf_field(); ?>
                                                ...
                                                <div class="flex flex-col items-start gap-1.5">
                                                    ...
                                                    <?php if($user->position): ?>
                                                        <span class="text-xs text-slate-500 font-bold flex items-center gap-1">
                                                            <i class="ph-bold ph-briefcase text-slate-300"></i> <?php echo e($user->position); ?>
                                            ...
                                            <td class="px-6 py-5 whitespace-nowrap text-right">
                                                <div class="flex justify-end gap-2 opacity-60 group-hover:opacity-100 transition-opacity">
                                                    <?php if(Auth::id() != $user->id): ?>
                                                        <a href="<?php echo e(route('users.edit', $user->id)); ?>" class="w-9 h-9 flex items-center justify-center rounded-xl bg-white border border-slate-200 text-slate-400 hover:text-blue-600 hover:border-blue-200 hover:bg-blue-50 transition-all shadow-sm" title="Edit Data">
