        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="animate-enter relative rounded-xl bg-gradient-to-br from-[#25D0FF] via-[#5295FF] to-[#FFC9B9] p-8 md:p-10 mb-10 text-[#2A3B52] shadow-[0_10px_40px_-10px_rgba(37,208,255,0.4)] overflow-hidden border border-white/40 group">
                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8">
                    ...
                    <a href="<?php echo e(route('lms.materials.create')); ?>" class="w-full md:w-auto group bg-[#2A3B52] text-white px-7 py-4 rounded-xl font-bold text-sm shadow-md hover:bg-[#182436] transition-all duration-300 flex items-center justify-center gap-3 active:scale-95 border border-transparent">
            ...
            <div class="animate-enter mb-10 bg-white p-4 rounded-xl fluent-card flex flex-col md:flex-row gap-4" style="animation-delay: 100ms">
                <form action="<?php echo e(route('lms.materials.index')); ?>" method="GET" class="flex-1 flex flex-col md:flex-row gap-4 w-full">
                    <div class="relative flex-1">
                        ...
                        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari judul materi..." class="w-full pl-11 pr-4 h-12 rounded-xl border-slate-200 bg-slate-50 focus:bg-white focus:ring-[#5295FF] focus:border-[#5295FF] text-sm font-medium transition-colors">
                    </div>
            ...
            <?php if($materials->count() > 0): ?>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php $__currentLoopData = $materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $material): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="animate-enter group relative bg-white rounded-xl fluent-card flex flex-col h-full hover:border-transparent hover:ring-2 <?php echo e($theme['ring']); ?>" style="animation-delay: <?php echo e(($index + 1) * 100); ?>ms">
                            ...
                            <div class="p-6 h-full flex flex-col relative overflow-hidden">
                                ...
                                <div class="mb-4 relative z-10">
                                    <h3 class="font-bold text-lg text-[#2A3B52] group-hover:text-[#5295FF] transition-colors line-clamp-2 leading-snug min-h-[3rem]" title="<?php echo e($material->title); ?>">
                                    ...
                                    <div class="flex flex-wrap gap-2 mt-3">
                                        <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg text-xs font-bold border <?php echo e($theme['bg']); ?> <?php echo e($theme['text']); ?> <?php echo e($theme['border']); ?> shadow-sm">
                                ...
                                <div class="pt-4 border-t border-slate-100 mt-auto flex items-center justify-between relative z-10">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <a href="<?php echo e($finalUrl); ?>" target="<?php echo e($targetAttr); ?>" class="w-9 h-9 rounded-lg <?php echo e($theme['bg']); ?> <?php echo e($theme['text']); ?> hover:bg-[#2A3B52] hover:text-white hover:border-[#2A3B52] transition-all flex items-center justify-center active:scale-95 border <?php echo e($theme['border']); ?> shadow-sm" title="Buka / Download">
                                        ...
                                        <a href="<?php echo e(route('lms.materials.edit', $material->id)); ?>" class="w-9 h-9 rounded-lg bg-white text-[#D83B01] hover:bg-[#FFEFD6] transition-all flex items-center justify-center active:scale-95 border border-[#FFD8A8] shadow-sm" title="Edit Materi">
            ...
            <?php else: ?>
                ...
                <div class="animate-enter bg-white rounded-xl fluent-card border-2 border-dashed border-slate-200 p-12 flex flex-col items-center justify-center text-center group hover:border-[#5295FF] transition-colors" style="animation-delay: 200ms">
                    ...
                    <h3 class="font-black text-[#2A3B52] text-xl mb-2"><?php echo e(request('search') ? 'Materi Tidak Ditemukan' : 'Belum Ada Materi'); ?></h3>
                    ...
                    <a href="<?php echo e(route('lms.materials.create')); ?>" class="px-8 py-3.5 bg-[#2A3B52] text-white font-bold rounded-xl hover:bg-[#182436] transition shadow-md flex items-center gap-2 active:scale-95 border border-transparent">
