                   ...
                   <div class="p-4 border-b border-slate-100 bg-slate-50/50 flex justify-between items-center">
                        ...
                        <div class="flex gap-2">
                             <div class="hidden sm:flex items-center gap-2 text-[10px] font-bold uppercase tracking-wider bg-white border border-slate-200 px-3 py-1.5 rounded-lg shadow-sm">
                                <span class="w-2 h-2 rounded-full bg-emerald-500"></span> H: Hadir Full
                                <span class="w-2 h-2 rounded-full bg-blue-500 ml-2"></span> H½: Hadir Setengah
                                <span class="w-2 h-2 rounded-full bg-amber-500 ml-2"></span> T: Telat
                        ...
                        <table class="w-full border-collapse text-sm text-left">
                            <thead>
                                <tr class="bg-slate-100 border-b border-slate-200 text-slate-600">
                                    ...
                                    <th class="p-2 font-bold text-emerald-600 bg-emerald-50/50 text-center w-10 border-l border-slate-200" title="Hadir Full">H</th>
                                    <th class="p-2 font-bold text-blue-500 bg-blue-50/50 text-center w-10" title="Hadir Setengah Hari (Belum Absen Pulang)">H½</th>
                                    ...
                                    <tr class="hover:bg-slate-50 transition-colors group">
                                        ...
                                        <?php $__currentLoopData = $dates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php 
                                                ...
                                                // FIX: Menggunakan data_get untuk akses aman ke attendance_map
                                                // Jika attendance_map null/tidak ada, return array kosong
                                                $data = data_get($student, 'attendance_map.' . $dateStr, ['code' => '-', 'class' => 'text-slate-300']);
                                            ?>
                                            <td class="p-1 text-center border-r border-slate-50 text-[10px] <?php echo e($data['class'] ?? 'text-slate-300'); ?>">
                                        ...
                                        <td class="p-2 text-center font-bold text-blue-500 bg-blue-50/30 text-xs">
                                            <?php echo e(data_get($student, 'summary.H_half', 0)); ?>
                                        ...
                                        <td class="p-2 text-center font-bold text-rose-600 bg-rose-50/30 text-xs">
