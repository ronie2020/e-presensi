                     ...
                     <form action="<?php echo e(route('reports.class.detail')); ?>" method="GET" class="w-full flex flex-col md:flex-row gap-4 items-end md:items-center" @submit="loading = true">
                        ...
                        <div class="flex-1 w-full">
                            ...
                            <div class="relative">
                                ...
                                <select name="class_id" class="w-full pl-11 rounded-xl border-slate-200 bg-slate-50 font-bold h-12 text-sm focus:ring-indigo-900 focus:border-indigo-900 shadow-sm" onchange="this.form.submit()">
                ...
                <div class="animate-enter bg-white rounded-[1.5rem] shadow-sm border border-slate-200 overflow-hidden" style="animation-delay: 200ms">
                   ...
                   <div class="p-4 border-b border-slate-100 bg-slate-50/50 flex justify-between items-center">
                        <div>
                            ...
                            <h3 class="font-bold text-slate-800 text-lg"><?php echo e(optional($classes->where('id', $classId)->first())->name ?? 'Kelas'); ?></h3>
                            <p class="text-xs text-slate-500 font-medium"><?php echo e($startDate->translatedFormat('F Y')); ?></p>
                        </div>
                        <div class="flex gap-2">
                             <div class="hidden sm:flex items-center gap-2 text-[10px] font-bold uppercase tracking-wider bg-white border border-slate-200 px-3 py-1.5 rounded-lg shadow-sm">
                                <span class="w-2 h-2 rounded-full bg-emerald-500"></span> H: Hadir
                                <span class="w-2 h-2 rounded-full bg-rose-500 ml-2"></span> B: Bolos Pulang
                                ...
                                <span class="w-2 h-2 rounded-full bg-red-800 ml-2"></span> A: Alfa
                            </div>
                        ...
                        <table class="w-full border-collapse text-sm text-left">
                            <thead>
                                <tr class="bg-slate-100 border-b border-slate-200 text-slate-600">
                                    ...
                                    <th rowspan="2" class="p-2 font-bold text-emerald-600 bg-emerald-50/50 text-center w-10 border-l border-slate-200 align-middle" title="Hadir Full">H</th>
                                    <th rowspan="2" class="p-2 font-bold text-rose-500 bg-rose-50/50 text-center w-10 align-middle" title="Bolos (Tidak Absen Pulang)">B</th>
                                    <th rowspan="2" class="p-2 font-bold text-blue-600 bg-blue-50/50 text-center w-10 align-middle">S</th>
                                    <th rowspan="2" class="p-2 font-bold text-indigo-600 bg-indigo-50/50 text-center w-10 align-middle">I</th>
                                    <th rowspan="2" class="p-2 font-bold text-red-800 bg-rose-50/50 text-center w-10 align-middle">A</th>
                                </tr>
                                ...
                                <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-slate-50 transition-colors group">
                                        ...
                                        <td class="p-3 font-bold text-slate-700 whitespace-nowrap sticky left-10 bg-white group-hover:bg-slate-50 z-10 shadow-[2px_0_5px_rgba(0,0,0,0.05)] border-r border-slate-100">
                                            <?php echo e(data_get($student, 'name')); ?>
                                        ...
                                        <?php $__currentLoopData = $dates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            ?>
                                            <td class="p-1 text-center border-r border-slate-50 text-[10px] <?php echo e($data['in_class'] ?? 'text-slate-300'); ?>">
                                                <?php echo e($data['in_code'] ?? '-'); ?>

                                            </td>
                                            <td class="p-1 text-center border-r border-slate-200 text-[10px] <?php echo e($data['out_class'] ?? 'text-slate-300'); ?>">
                                                <?php echo e($data['out_code'] ?? '-'); ?>

                                            </td>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                                        
                                        <td class="p-2 text-center font-bold text-emerald-600 bg-emerald-50/30 text-xs border-l border-slate-100">
                                            <?php echo e(data_get($student, 'summary.H', 0)); ?>

                                        </td>
                                        <td class="p-2 text-center font-bold text-rose-500 bg-rose-50/30 text-xs">
                                            <?php echo e(data_get($student, 'summary.B', 0)); ?>

                                        </td>
                                        <td class="p-2 text-center font-bold text-blue-600 bg-blue-50/30 text-xs">
                                            <?php echo e(data_get($student, 'summary.S', 0)); ?>

                                        </td>
                                        <td class="p-2 text-center font-bold text-indigo-600 bg-indigo-50/30 text-xs">
                                            <?php echo e(data_get($student, 'summary.I', 0)); ?>

                                        </td>
                                        <td class="p-2 text-center font-bold text-red-800 bg-rose-50/30 text-xs">
                                            <?php echo e(data_get($student, 'summary.A', 0)); ?>
