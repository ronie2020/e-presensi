...
<head>
    ...
    <style>
        ...
        /* Perbaikan: Hilangkan border tabel global yang bocor ke Kop Surat */
        ...
        /* Perbaikan Final Garis Kop Surat */
        .garis-kop { 
            display: block;
            border: none; 
            border-top: 4px solid #000; /* Garis tebal atas */
            border-bottom: 1px solid #000; /* Garis tipis bawah */
            height: 2px; /* Ruang putih di tengah */
