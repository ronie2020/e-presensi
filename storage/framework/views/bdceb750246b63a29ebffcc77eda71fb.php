...
<body onload="window.print()">
    ...
    <div class="judul-laporan">
        ...
        <p>
            Periode: <strong><?php echo e(\Carbon\Carbon::parse($startDate)->locale('id')->translatedFormat('d F Y')); ?></strong> s.d. <strong><?php echo e(\Carbon\Carbon::parse($endDate)->locale('id')->translatedFormat('d F Y')); ?></strong>
        </p>
    </div>
