...
<body class="antialiased text-slate-800 bg-slate-50 overflow-x-hidden selection:bg-blue-500 selection:text-white" 
    ...
    <!-- Elemen mengambang di pojok KIRI bawah -->
    <div 
        class="fixed bottom-6 left-6 z-40 bg-white/95 backdrop-blur-sm border border-slate-200 shadow-lg px-4 py-2 rounded-full flex items-center gap-3 hover:-translate-y-1 hover:shadow-xl transition-all duration-300 group cursor-default"
        title="Total pengunjung website"
    >
        <div class="bg-blue-50 text-blue-600 p-2 rounded-full group-hover:bg-blue-600 group-hover:text-white transition-colors duration-300">
