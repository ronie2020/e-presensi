    ...
    <div id="prestasi" class="py-24 bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-900 relative overflow-hidden border-t border-slate-100 dark:border-slate-800 transition-colors duration-300" x-data="{ activeFilter: 'Terbaru' }">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <div class="group bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] hover:shadow-xl hover:shadow-elevate-accent/10 hover:-translate-y-1 transition-all duration-300 relative overflow-hidden h-full flex flex-col" 
                        ...
                        <div class="h-48 w-full bg-slate-100 dark:bg-slate-700 relative overflow-hidden group">
                            ...
                            <div class="absolute top-3 right-3">
                                 <span class="px-2.5 py-1 rounded-full bg-white/90 dark:bg-slate-900/90 backdrop-blur border border-white/20 dark:border-slate-700 text-[10px] font-bold uppercase text-elevate-primary dark:text-elevate-accent tracking-wide shadow-sm"><?php echo e($prestasi->level ?? 'Sekolah'); ?></span>
                            </div>
                        </div>
                        <div class="p-5 flex-1 flex flex-col relative z-10">
                            ...
                            <h4 class="text-lg font-bold text-elevate-dark dark:text-white mb-2 leading-tight group-hover:text-elevate-primary dark:group-hover:text-elevate-accent transition-colors line-clamp-2"><?php echo e($prestasi->title ?? 'Juara Lomba'); ?></h4>
            ...
            <div class="mt-12 text-center" data-aos="fade-up">
                 <a href="<?php echo e(route('public.achievements')); ?>" class="inline-flex items-center justify-center px-6 py-3 text-sm font-bold text-elevate-primary dark:text-elevate-accent bg-elevate-accent/10 dark:bg-elevate-accent/20 border border-elevate-accent/30 dark:border-elevate-accent/20 rounded-full hover:bg-elevate-accent/20 dark:hover:bg-elevate-accent/30 transition-all shadow-sm">Lihat Arsip Prestasi <i class="ph-bold ph-arrow-right ml-2"></i></a>
            </div>
        </div>
