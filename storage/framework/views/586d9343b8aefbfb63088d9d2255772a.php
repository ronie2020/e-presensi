    ...
    <div id="prestasi" class="py-24 bg-gradient-to-b from-cyan-50/50 to-white relative overflow-hidden border-t border-slate-100" x-data="{ activeFilter: 'Terbaru' }">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <div class="group bg-white rounded-2xl border border-cyan-100 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] hover:shadow-xl hover:shadow-cyan-500/10 hover:-translate-y-1 transition-all duration-300 relative overflow-hidden h-full flex flex-col" 
                        ...
                        <div class="h-48 w-full bg-slate-100 relative overflow-hidden group">
                            ...
                            <div class="absolute top-3 right-3">
                                 <span class="px-2.5 py-1 rounded-full bg-white/90 backdrop-blur border border-white/20 text-[10px] font-bold uppercase text-cyan-700 tracking-wide shadow-sm"><?php echo e($prestasi->level ?? 'Sekolah'); ?></span>
                            </div>
                        </div>
                        <div class="p-5 flex-1 flex flex-col relative z-10">
                            ...
                            <h4 class="text-lg font-bold text-slate-900 mb-2 leading-tight group-hover:text-cyan-600 transition-colors line-clamp-2"><?php echo e($prestasi->title ?? 'Juara Lomba'); ?></h4>
            ...
            <div class="mt-12 text-center" data-aos="fade-up">
                 <a href="<?php echo e(route('public.achievements')); ?>" class="inline-flex items-center justify-center px-6 py-3 text-sm font-bold text-cyan-700 bg-cyan-50 border border-cyan-200 rounded-full hover:bg-cyan-100 hover:text-cyan-800 transition-all shadow-sm">Lihat Arsip Prestasi <i class="ph-bold ph-arrow-right ml-2"></i></a>
            </div>
        </div>
