...
<?php
    ...
    // Default Start Date (Awal Ramadhan) jika tidak dikirim controller
    // Ganti '2025-03-01' sesuai tanggal 1 Ramadhan tahun ini
    $startDate = $startDate ?? Carbon::now()->startOfMonth()->format('Y-m-d'); 
    
    // Default hari ini
    $today = $today ?? Carbon::now()->format('Y-m-d');
    
    // Default variabel lain untuk mencegah error lanjutan
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-amber-50 border border-amber-200 p-6 rounded-[2rem] text-center mb-8">
            ...
            <p class="text-sm text-amber-600 mt-1 max-w-md mx-auto">
                Formulir ini hanya terbuka selama <b>1x24 jam</b> pada tanggal <?php echo e(\Carbon\Carbon::parse($today)->format('d F Y')); ?>. Anda tidak dapat mengisi untuk tanggal yang lalu atau akan datang.
            </p>
        </div>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ronie\Documents\aplikasi terpadu\sistem_absensi_sekolah\resources\views/ramadan/student_index.blade.php ENDPATH**/ ?>