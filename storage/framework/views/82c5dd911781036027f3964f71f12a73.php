...
<div id="kegiatan" class="py-24 bg-white dark:bg-slate-900 relative overflow-hidden border-t border-slate-100 dark:border-slate-800 transition-colors duration-300">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="flex flex-col md:flex-row justify-between items-end mb-12 gap-6" data-aos="fade-up">
            ...
            <a href="<?php echo e(route('public.activities')); ?>" class="hidden md:inline-flex items-center text-sm font-bold text-cyan-600 dark:text-cyan-400 hover:text-cyan-800 dark:hover:text-cyan-300 transition group/btn">
                ...
                <div class="group bg-white dark:bg-slate-800 rounded-3xl overflow-hidden shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] hover:shadow-2xl hover:shadow-cyan-900/10 dark:hover:shadow-cyan-500/10 hover:-translate-y-2 transition-all duration-500 border border-slate-100 dark:border-slate-700 flex flex-col h-full" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                    ...
                    <div class="p-6 flex-1 flex flex-col">
                        <a href="<?php echo e(route('public.activities')); ?>">
                            <h4 class="text-xl font-black text-slate-800 dark:text-white mb-3 group-hover:text-cyan-600 dark:group-hover:text-cyan-400 transition-colors line-clamp-2 leading-snug"><?php echo e($activity->title); ?></h4>
                        </a>
        ...
        <div class="mt-10 text-center md:hidden" data-aos="fade-up">
            <a href="<?php echo e(route('public.activities')); ?>" class="inline-flex items-center justify-center px-6 py-3 text-sm font-bold text-cyan-600 dark:text-cyan-400 bg-cyan-50 dark:bg-cyan-900/20 border border-cyan-100 dark:border-cyan-800 rounded-full hover:bg-cyan-100 dark:hover:bg-cyan-900/40 hover:text-cyan-800 dark:hover:text-cyan-300 transition-all shadow-sm active:scale-95">
