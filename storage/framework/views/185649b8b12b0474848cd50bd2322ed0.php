                        ...
                        <div class="w-[calc(100%-4.5rem)] md:w-[calc(50%-3rem)] bg-white rounded-[2rem] p-6 shadow-sm border border-slate-100 hover:shadow-xl hover:shadow-blue-900/5 hover:border-blue-200 hover:-translate-y-1 transition-all duration-300 group-hover:ring-1 group-hover:ring-blue-100">
                            ...
                            <div class="flex justify-between items-start mb-4 border-b border-slate-50 pb-3">
                                ...
                                <div class="text-right bg-slate-50 px-3 py-1.5 rounded-xl border border-slate-100 min-w-[60px]">
                                    <div class="text-xl font-black text-slate-800 leading-none"><?php echo e(\Carbon\Carbon::parse($history->date)->format('d')); ?></div>
                                    <div class="text-[10px] font-bold text-slate-400 uppercase tracking-wide"><?php echo e(\Carbon\Carbon::parse($history->date)->format('M')); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <a href="<?php echo e(route('teaching.show', $history->id)); ?>" class="group/link flex items-center gap-1 text-xs font-bold text-white bg-slate-800 hover:bg-blue-600 px-4 py-2 rounded-xl transition-all shadow-md hover:shadow-lg">
...
<?php endif; ?><?php /**PATH D:\aplikasi terpadu\sistem_absensi_sekolah\resources\views/teaching/history.blade.php ENDPATH**/ ?>