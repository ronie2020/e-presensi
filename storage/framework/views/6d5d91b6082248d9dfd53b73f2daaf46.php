        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="relative rounded-xl bg-gradient-to-br from-[#25D0FF] via-[#5295FF] to-[#FFC9B9] p-8 mb-8 text-[#2A3B52] shadow-[0_10px_40px_-10px_rgba(37,208,255,0.4)] overflow-hidden border border-white/40">
                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    ...
                    <a href="<?php echo e(route('lms.materials.index')); ?>" class="flex items-center justify-center gap-2 px-4 py-2 bg-white/40 hover:bg-white/60 rounded-xl text-sm font-bold backdrop-blur-sm transition text-[#2A3B52] border border-white/50 btn-cancel-confirm w-full md:w-auto shadow-sm active:scale-95">
                ...
                <form action="<?php echo e(route('lms.materials.update', $material->id)); ?>" method="POST" enctype="multipart/form-data" 
                    ...
                    <div class="p-8 space-y-8">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <textarea name="resume" rows="6" class="w-full rounded-xl border-slate-200 bg-slate-50 focus:ring-[#5295FF] focus:border-[#5295FF] shadow-sm p-4 text-[#2A3B52] leading-relaxed font-medium transition-colors"><?php echo e(old('resume', $material->resume)); ?></textarea>
                                    ...
                                    <?php $__currentLoopData = $material->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $att): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-center justify-between p-3 bg-white border border-slate-200 rounded-xl shadow-sm">
                                            <div class="flex items-center gap-3 overflow-hidden">
                                                ...
                                                <div class="truncate">
                                                    <p class="text-sm font-bold text-[#2A3B52] truncate"><?php echo e($att->file_name); ?></p>
                                                    <a href="<?php echo e($att->file_type == 'file' ? asset('storage/'.$att->file_path) : $att->file_path); ?>" target="_blank" class="text-[10px] text-[#5295FF] hover:underline font-bold uppercase tracking-wider">Lihat File</a>
                                                </div>
                                            </div>
                                            <label class="flex items-center gap-2 cursor-pointer bg-white px-3 py-1.5 rounded-lg border border-slate-200 hover:bg-[#FDE7E9] hover:border-[#F4C3C9] transition group">
                                                <input type="checkbox" name="delete_attachments[]" value="<?php echo e($att->id); ?>" class="rounded text-[#D13438] focus:ring-[#D13438] border-slate-300">
                    ...
                    <div class="bg-slate-50 px-8 py-6 flex flex-col md:flex-row justify-end gap-3 border-t border-slate-100">
                        <a href="<?php echo e(route('lms.materials.index')); ?>" class="px-6 py-3 bg-white border border-slate-200 text-slate-600 font-bold rounded-xl hover:bg-slate-100 transition text-center text-sm btn-cancel-confirm active:scale-95 shadow-sm">Batal</a>
