                    ...
                    <div class="flex flex-row md:flex-col lg:flex-row gap-4 w-full md:w-auto">
                        <?php if($selectedEkskulId): ?>
                            <div class="bg-white/60 backdrop-blur-md px-6 py-5 rounded-[2rem] border border-white flex-1 md:flex-none min-w-[160px] text-center md:text-left shadow-sm">
                                ...
                                <span class="block text-4xl font-black text-elevate-dark tracking-tight"><?php echo e($members->total()); ?></span>
                                <span class="text-[10px] text-elevate-dark/70 font-bold block mt-1 truncate max-w-[140px]"><?php echo e($extracurriculars->find($selectedEkskulId)->name); ?></span>
                            </div>
                        <?php else: ?>
                            <div class="bg-white/60 backdrop-blur-md px-6 py-5 rounded-[2rem] border border-white flex-1 md:flex-none min-w-[160px] text-center md:text-left shadow-sm">
                                <div class="flex items-center justify-center md:justify-start gap-2 mb-1 text-elevate-primary">
                                ...
                                ?>
                                <span class="block text-4xl font-black text-elevate-dark tracking-tight"><?php echo e($totalAll); ?></span>
                                ...
                                <div class="space-y-2">
                                    <?php $__currentLoopData = $extracurriculars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ekskul): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <button type="submit" name="ekskul_id" value="<?php echo e($ekskul->id); ?>" 
                                            class="w-full flex items-center justify-between p-3 rounded-2xl transition-all group <?php echo e($selectedEkskulId == $ekskul->id ? 'bg-elevate-dark text-white shadow-lg shadow-elevate-dark/20' : 'bg-white hover:bg-slate-50 text-slate-600 border border-slate-100 hover:border-elevate-accent/30'); ?>">
                                            <div class="flex items-center gap-3 text-left overflow-hidden">
                                                <div class="w-10 h-10 shrink-0 rounded-xl flex items-center justify-center text-lg <?php echo e($selectedEkskulId == $ekskul->id ? 'bg-white/20 text-white' : 'bg-elevate-accent/10 text-elevate-primary group-hover:bg-elevate-primary group-hover:text-white transition-colors'); ?>">
                                            ...
                                            <span class="text-[10px] font-black px-2.5 py-1 rounded-lg shrink-0 <?php echo e($selectedEkskulId == $ekskul->id ? 'bg-white text-elevate-dark' : 'bg-slate-100 text-slate-500 group-hover:bg-elevate-accent/20 group-hover:text-elevate-primary transition-colors'); ?>">
                                            ...
                                            <tr class="hover:bg-slate-50/80 transition-colors group">
                                                ...
                                                <td class="px-6 py-4 print:py-2">
                                                    <div class="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            <span class="font-bold text-elevate-dark text-sm block group-hover:text-elevate-primary transition-colors"><?php echo e($member->student->name); ?></span>
...
<?php endif; ?><?php /**PATH C:\Users\ronie\Documents\aplikasi terpadu\sistem_absensi_sekolah\resources\views/extracurriculars/members.blade.php ENDPATH**/ ?>