...
<body class="bg-slate-900 text-slate-800 antialiased min-h-screen flex flex-col items-center justify-center p-4 py-10 relative overflow-x-hidden overflow-y-auto">
    ...
    <div class="print-area w-full max-w-lg relative z-10 my-auto">
        ...
        <div class="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl shadow-black/30 border border-white/20 overflow-hidden">
            ...
            <div class="p-8 text-center">
                ...
                <div class="bg-slate-50 rounded-2xl p-6 border border-slate-200 text-left mb-8 relative overflow-hidden group hover:border-blue-300 transition-colors">
                    ...
                    <p class="text-4xl font-black text-blue-600 tracking-tighter mb-5"><?php echo e($registrant->registration_number); ?></p>

                    <div class="space-y-3 text-sm border-t border-slate-200 pt-4">
                        <div class="flex justify-between items-center">
                            <span class="text-slate-500 font-medium">Nama Siswa</span>
                            <span class="font-bold text-slate-800 text-right"><?php echo e($registrant->full_name); ?></span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-slate-500 font-medium">Jalur Seleksi</span>
                            <span class="font-bold text-white bg-blue-500 px-2 py-0.5 rounded text-xs uppercase"><?php echo e($registrant->track); ?></span>
                        </div>
                        <div class="flex justify-between items-center">
                ...
                <div class="flex flex-col sm:flex-row gap-3 no-print">
                    <a href="<?php echo e(url('/')); ?>" class="flex-1 py-3.5 bg-slate-100 text-slate-600 font-bold rounded-xl text-sm hover:bg-slate-200 hover:text-slate-800 transition text-center border border-slate-200">
                        Ke Beranda
                    </a>
        ...
        <p class="text-center text-slate-500 text-xs mt-6 font-medium no-print">
            &copy; <?php echo e(date('Y')); ?> Sistem Informasi Akademik
        </p>
    </div>

</body>
</html><?php /**PATH E:\aplikasi terpadu\sistem_absensi_sekolah\resources\views\ppdb\success.blade.php ENDPATH**/ ?>