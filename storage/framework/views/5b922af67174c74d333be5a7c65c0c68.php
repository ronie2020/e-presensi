        ...
        items: [
            <?php if(isset($exams)): ?>
                <?php $__currentLoopData = $exams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $examItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    ?>
                    { 
                        id: <?php echo e($examItem->id); ?>,
                        title: '<?php echo e(strtolower(addslashes($examItem->title))); ?>', 
                        subject: '<?php echo e(strtolower(addslashes($examItem->subject_name))); ?>', 
                        filter: '<?php echo e($filterCategory); ?>' 
                    },
        ...
        <?php else: ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <?php $__currentLoopData = $exams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $examItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <!-- Logika X-Show yang bersih berkat Array Getter AlpineJS -->
                    <div x-show="(activeFilter === 'all' || activeFilter === '<?php echo e($filterCategory); ?>') && 
                                 ('<?php echo e(strtolower(addslashes($examItem->title))); ?>'.includes(searchQuery.toLowerCase()) || 
                                  '<?php echo e(strtolower(addslashes($examItem->subject_name))); ?>'.includes(searchQuery.toLowerCase()))"
                         x-transition.duration.300ms
                         class="animate-enter group bg-white rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-2xl hover:shadow-slate-200/50 hover:border-blue-200 transition-all duration-300 overflow-hidden flex flex-col h-full hover:-translate-y-1" style="animation-delay: <?php echo e(($index + 1) * 100); ?>ms">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                ...
                                <div class="p-3 rounded-xl bg-emerald-50 border border-emerald-100">
                                    ...
                                    <p class="text-xs font-bold text-emerald-800 flex items-center gap-1.5">
                                        ...
                                        <?php echo e($examItem->student_score ?? 0); ?>
