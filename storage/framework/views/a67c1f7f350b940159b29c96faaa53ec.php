    ...
    <div class="py-8 sm:py-10 font-sans text-slate-700 bg-slate-50 min-h-screen">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden relative">
                ...
                <div class="p-8">
                    <form id="form-create-keluar" action="<?php echo e(route('letters.outgoing.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-8">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="p-6 bg-slate-50/50 rounded-[2rem] border border-slate-100 relative group hover:border-slate-200 transition-colors">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pl-9">
                                <div>
                                    ...
                                    <input type="text" name="nomor_agenda" value="<?php echo e(old('nomor_agenda', $nextAgendaKeluar)); ?>" readonly class="w-full px-4 rounded-2xl border-slate-200 bg-slate-100 shadow-inner focus:outline-none text-sm py-3 font-bold text-slate-500 cursor-not-allowed transition-all">
                                </div>
                                <div>
                                    <label class="block text-xs font-bold text-slate-400 uppercase mb-2 ml-1">Nomor Surat</label>
                                    <input type="text" name="nomor_surat" value="<?php echo e(old('nomor_surat')); ?>" required placeholder="005/SMA/2026..." class="w-full px-4 rounded-2xl border-slate-200 bg-white shadow-sm focus:border-elevate-primary focus:ring-elevate-primary text-sm py-3 font-bold text-elevate-dark transition-all">
                                </div>
                                <div class="md:col-span-2">
                                    <label class="block text-xs font-bold text-slate-400 uppercase mb-2 ml-1">Tujuan / Penerima Surat</label>
                                    <input type="text" name="tujuan_surat" value="<?php echo e(old('tujuan_surat')); ?>" required placeholder="Contoh: Kepala Dinas Pendidikan / Wali Murid" class="w-full px-4 rounded-2xl border-slate-200 bg-white shadow-sm focus:border-elevate-primary focus:ring-elevate-primary text-sm py-3 font-bold text-elevate-dark transition-all">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 bg-slate-50/50 rounded-[2rem] border border-slate-100 relative group hover:border-slate-200 transition-colors">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pl-9">
                                <div>
                                    ...
                                    <input type="date" name="tgl_surat" value="<?php echo e(old('tgl_surat', date('Y-m-d'))); ?>" required class="w-full px-4 rounded-2xl border-slate-200 bg-white shadow-sm focus:border-elevate-primary text-sm py-3 font-bold text-elevate-dark transition-all">
                                </div>
                                <div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="perihal" rows="3" required placeholder="Undangan Rapat, Permohonan Bantuan, dll..." class="w-full px-4 rounded-2xl border-slate-200 bg-white shadow-sm focus:border-elevate-primary text-sm py-3 font-medium text-elevate-dark transition-all"><?php echo e(old('perihal')); ?></textarea>
                                </div>
                            </div>
                        </div>
...
<?php endif; ?><?php /**PATH E:\drive aplikasi\aplikasi terpadu\sistem_absensi_sekolah versi 3.00\resources\views/letters/outgoing/create.blade.php ENDPATH**/ ?>