                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <label class="relative cursor-pointer group">
                                ...
                                <div class="rounded-xl border-2 border-slate-100 p-4 hover:border-blue-300 hover:bg-blue-50/50 transition-all peer-checked:border-blue-600 peer-checked:bg-blue-50 peer-checked:shadow-md flex items-center gap-3">
                                    ...
                                    <span class="text-sm font-bold text-slate-600 peer-checked:text-blue-800 transition-colors"><?php echo e($cat->name); ?></span>
                                </div>
                            </label>
...
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-rose-500 text-xs mt-2 font-bold flex items-center gap-1"><i class="ph-bold ph-warning"></i> <?php echo e($message); ?></p> <?php unset($message);
