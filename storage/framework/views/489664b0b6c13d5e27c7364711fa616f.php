                                            ...
                                            <?php $__currentLoopData = $recentScans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr class="log-entry group hover:bg-white transition-all duration-300 rounded-xl border-b border-slate-50 last:border-0"
                                                    ...
                                                    <td class="px-6 py-4 rounded-l-xl">
                                                        <div class="font-bold text-slate-800 group-hover:text-cyan-600 transition-colors"><?php echo e($scan['student_name']); ?></div>
                ...
                <form action="<?php echo e(route('reports.storeManual')); ?>" method="POST" class="p-6 space-y-4" @submit="submitForm">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="date" name="date" required value="<?php echo e(date('Y-m-d')); ?>" class="w-full rounded-xl border-slate-200 bg-slate-50 focus:ring-cyan-600 focus:border-cyan-600 font-bold text-slate-700 text-sm">
                        </div>
                        <div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="time" name="time_in" value="<?php echo e(now()->format('H:i')); ?>" class="w-full rounded-xl border-slate-200 bg-slate-50 focus:ring-cyan-600 focus:border-cyan-600 text-center font-mono font-bold text-slate-700">
                        </div>
                        <div>
