...
<?php $component->withAttributes([]); ?>
    ...
    <script>
        ...
        // PERBAIKAN: SweetAlert HTML untuk Bulk Alpha
        function confirmBulkAlphaReligious(count) {
            Swal.fire({
                title: 'Tandai ' + count + ' Siswa Alfa?',
                html: "Siswa akan ditandai <b>Alfa</b> untuk Shalat <?php echo e($selectedActivity); ?>.<br>" +
        ...
        function openEditModalReligious(id, name, status, notes, activity) {
            ...
            checkEditReligiousStatus(status); // Cek visual alert
...
<?php endif; ?><?php /**PATH E:\drive aplikasi\aplikasi terpadu\sistem_absensi_sekolah versi 3.00\resources\views/reports/religious.blade.php ENDPATH**/ ?>