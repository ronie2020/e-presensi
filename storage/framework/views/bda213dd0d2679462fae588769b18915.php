                ...
                <div class="w-full lg:w-[450px] xl:w-[500px] shrink-0 flex flex-col gap-4">
                    ...
                    <?php if($selectedClass): ?>
                        <div class="flex items-center gap-2 mt-2">
                            ...
                            <a href="<?php echo e(route('admin.ramadan.exportPdf', ['class_id' => $selectedClass])); ?>" 
                               target="_blank"
                               class="flex-1 py-3 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl font-bold shadow-lg flex flex-col items-center justify-center gap-1 transition-all active:scale-95 border border-white/10">
                                <i class="ph-bold ph-file-pdf text-xl"></i>
                                <span class="uppercase tracking-wider text-[9px]">Rekap Full</span>
                            </a>

                            
                            <a href="<?php echo e(route('admin.ramadan.exportExcel', ['class_id' => $selectedClass])); ?>" 
                               class="flex-1 py-3 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-bold shadow-lg flex flex-col items-center justify-center gap-1 transition-all active:scale-95 border border-white/10">
