...
<?php $component->withAttributes([]); ?>
    ...
    <div x-data="{
        ...
        // PERBAIKAN: Fungsi buka modal sekarang menerima Objek JSON Utuh
                ...
                <div class="w-full lg:w-[450px] xl:w-[500px] shrink-0 flex flex-col gap-4">
                    ...
                    <?php if($selectedClass): ?>
                        <div class="grid grid-cols-2 gap-3 mt-2">
                            ...
                            <a href="<?php echo e(route('admin.ramadan.exportPdf', ['class_id' => $selectedClass, 'month' => \Carbon\Carbon::parse($date)->format('Y-m')])); ?>" 
                               target="_blank"
