                    ...
                    <div class="relative z-10 h-full flex flex-col justify-between">
                        ...
                        <div class="mt-6">
                            <span class="bg-white/10 backdrop-blur-md px-4 py-2.5 rounded-xl text-sm font-bold border border-white/10 shadow-sm inline-flex items-center gap-2">
                                ...
                                <?php echo e(count($schedules)); ?> Sesi Pelajaran
                            </span>
                        </div>
                    </div>
                </div>
...
<?php endif; ?><?php /**PATH D:\aplikasi terpadu\sistem_absensi_sekolah\resources\views/teaching/index.blade.php ENDPATH**/ ?>