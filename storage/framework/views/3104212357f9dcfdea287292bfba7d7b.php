                ...
                <div class="p-8">
                    <form id="form-edit-keluar" action="<?php echo e(route('letters.outgoing.update', $letter->id)); ?>" method="POST" enctype="multipart/form-data" class="space-y-8">
                        ...
                        <div class="p-6 bg-slate-50/50 rounded-[2rem] border border-slate-100 relative group hover:border-slate-200 transition-colors">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pl-9">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="tujuan_surat" value="<?php echo e(old('tujuan_surat', $letter->tujuan_surat)); ?>" required class="w-full px-4 rounded-2xl border-slate-200 bg-white shadow-sm focus:border-elevate-primary focus:ring-elevate-primary text-sm py-3 font-bold text-elevate-dark transition-all">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pt-6 mt-4 border-t border-slate-100 flex items-center justify-end gap-4">
                            <a href="<?php echo e(route('letters.outgoing.index')); ?>" class="px-6 py-3.5 rounded-xl text-slate-500 font-bold text-sm hover:bg-slate-100 hover:text-slate-700 transition-colors">
                                Batal
                            </a>
...
<?php endif; ?><?php /**PATH C:\Users\ronie\Documents\aplikasi terpadu\sistem_absensi_sekolah\resources\views/letters/outgoing/edit.blade.php ENDPATH**/ ?>