                ...
                <div class="flex-1">
                    ...
                    <div class="max-w-md mx-auto md:mx-0">
                        ...
                        <div class="h-2 w-full bg-blue-900/50 rounded-full overflow-hidden backdrop-blur-sm border border-white/10">
                            <div class="h-full bg-gradient-to-r from-amber-400 to-orange-500 rounded-full transition-all duration-1000 ease-out" style="width: <?php echo e($progressPercent); ?>%"></div>
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
...
</div><?php /**PATH E:\drive aplikasi\aplikasi terpadu\sistem_absensi_sekolah versi 3.00\resources\views/students/portal/partials/header.blade.php ENDPATH**/ ?>