                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap items-center gap-4 text-elevate-dark/80 text-sm font-bold">
                            <span class="flex items-center gap-1.5 bg-white/40 backdrop-blur px-4 py-2 rounded-xl border border-white/50 shadow-sm">
                                <i class="ph-bold ph-book-open text-elevate-dark"></i> <?php echo e($assignment->subject->name); ?>
                            ...
                            <span class="flex items-center gap-1.5 bg-[#FDE7E9]/90 backdrop-blur px-4 py-2 rounded-xl border border-[#F4C3C9] text-[#D13438] shadow-sm">
                                <i class="ph-bold ph-clock"></i> Deadline: <?php echo e($assignment->deadline->format('d M Y, H:i')); ?>

                            </span>
                        </div>
                    </div>
                    
                    <a href="<?php echo e(route('lms.assignments.index')); ?>" class="group/btn shrink-0 bg-white/60 hover:bg-white text-elevate-dark px-6 py-3.5 rounded-xl font-bold text-sm backdrop-blur-md border border-white/60 transition-all flex items-center gap-2 shadow-sm active:scale-95">
                    ...
                    <table class="w-full text-left border-collapse" id="submissionsTable">
                        ...
                        <tbody class="divide-y divide-slate-50">
                            <?php $__currentLoopData = $allStudents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr class="group hover:bg-elevate-soft/30 transition-colors student-row" data-class="<?php echo e($student->schoolClass->name ?? '-'); ?>">
                                    <!-- Siswa -->
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                <div class="font-black text-elevate-dark text-base group-hover:text-elevate-primary transition-colors"><?php echo e($student->name); ?></div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <?php if($submission): ?>
                                            <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-wide <?php echo e($isLate ? 'bg-[#FFEFD6] text-[#D83B01] border border-[#FFD8A8]' : 'bg-[#DFF6DD] text-[#107C10] border border-[#B7DFB9]'); ?> shadow-sm">
                                                <span class="w-1.5 h-1.5 rounded-full <?php echo e($isLate ? 'bg-[#D83B01]' : 'bg-[#107C10]'); ?>"></span> 
                                            ...
                                            <div class="flex flex-col gap-2">
                                                <?php if($assignment->assignment_type == 'quiz'): ?>
                                                    <button type="button" 
                                                        ...
                                                        <?php else: ?>
                                                            <span class="ml-1 px-2 py-0.5 rounded-md bg-[#107C10] text-white text-[9px] shadow-sm"><?php echo e($ansCount); ?> Jawaban</span>
                                                        <?php endif; ?>
                                                    </button>
                                                
                                                <?php elseif($submission->link_url): ?>
                                                    <a href="<?php echo e($submission->link_url); ?>" target="_blank" class="inline-flex items-center gap-2 px-4 py-2.5 bg-white border border-slate-200 text-elevate-primary hover:bg-elevate-soft hover:border-elevate-accent rounded-xl text-xs font-bold transition-all w-fit shadow-sm group/link active:scale-95">
                                                        <i class="ph-bold ph-link text-lg"></i>
                                                        Buka Link
                                                    </a>

                                                <?php elseif($submission->file_path): ?>
                                                    <a href="<?php echo e(asset('storage/'.$submission->file_path)); ?>" target="_blank" class="inline-flex items-center gap-2 px-4 py-2.5 bg-white border border-slate-200 hover:border-elevate-accent hover:bg-elevate-soft hover:text-elevate-primary rounded-xl text-xs font-bold transition-all w-fit shadow-sm text-slate-600 group/file active:scale-95">
                                                ...
                                                <?php if($submission->student_note): ?>
                                                    <div class="bg-elevate-soft/50 p-3 rounded-xl border border-slate-200 text-xs text-elevate-primary italic relative w-fit max-w-[220px] mt-1">
                                                        ...
                                                        <span class="relative z-10 font-medium leading-relaxed">"<?php echo e(Str::limit($submission->student_note, 50)); ?>"</span>
                                                    </div>
                                                <?php elseif(!$submission->link_url && !$submission->file_path && $assignment->assignment_type != 'quiz'): ?>
                                            ...
                                            <form action="<?php echo e(route('lms.submissions.grade', $submission->id)); ?>" method="POST" class="contents grade-form" id="form-grade-<?php echo e($submission->id); ?>">
                                                ...
                                                <?php if($assignment->assignment_type == 'quiz'): ?>
                                                    ...
                                                    <div class="text-[10px] text-slate-400 mb-1.5 font-bold uppercase tracking-widest">
                                                        PG: <span class="text-elevate-primary"><?php echo e($autoScore); ?></span>
                                                    </div>
                                                <?php endif; ?>
...
<?php endif; ?><?php /**PATH C:\Users\ronie\Documents\aplikasi terpadu\sistem_absensi_sekolah\resources\views/lms/assignments/submissions.blade.php ENDPATH**/ ?>