                        ...
                        <div class="md:col-span-5">
                            ...
                            <div class="flex flex-col sm:flex-row gap-2">
                                ...
                                <div class="flex gap-1.5">
                                    <button type="button" onclick="setDate('<?php echo e(date('Y-m-d')); ?>')" class="px-4 py-2 bg-slate-100 hover:bg-cyan-100 text-slate-500 hover:text-cyan-600 border border-slate-200 hover:border-cyan-200 rounded-xl text-xs font-bold transition-all shadow-sm">Hari Ini</button>
                                    <button type="button" onclick="setDate('<?php echo e(date('Y-m-d', strtotime('-1 days'))); ?>')" class="px-4 py-2 bg-slate-100 hover:bg-cyan-100 text-slate-500 hover:text-cyan-600 border border-slate-200 hover:border-cyan-200 rounded-xl text-xs font-bold transition-all shadow-sm">Kemarin</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <tr class="table-row-hover transition-colors group <?php echo e($rowClass); ?> status-border-left hover:bg-slate-50">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            <div class="font-bold text-slate-700 text-sm group-hover:text-cyan-600 transition-colors"><?php echo e($permit->student->name); ?></div>
