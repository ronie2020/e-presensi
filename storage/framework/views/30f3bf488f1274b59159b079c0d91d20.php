                ...
                <div class="p-8 border-b border-amber-200/50 bg-white/50 backdrop-blur-sm relative z-10">
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        <div>
                            ...
                            <p class="text-amber-700/80 text-sm mt-2 font-medium">10 Siswa yang direkomendasikan sistem berdasarkan kelengkapan tugas, poin prestasi, dan <strong>bebas dari Pelanggaran & Alpa</strong>.</p>
                        </div>
                        <div class="shrink-0 bg-white px-4 py-2 rounded-xl border border-amber-200 shadow-sm text-xs font-bold text-amber-800 flex items-center gap-2">
                            <span class="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span> Auto-Generated by System
                        </div>
                    </div>
                </div>
                ...
                <div class="p-8 relative z-10">
                            ...
                            <?php $__currentLoopData = $awardNominees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $nominee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center gap-4 p-4 rounded-2xl bg-white border border-amber-100 shadow-sm hover:shadow-md hover:border-amber-300 transition-all">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="flex flex-wrap gap-2 mt-1.5">
                                            <span class="text-[10px] font-bold px-2 py-0.5 rounded bg-emerald-100 text-emerald-700 border border-emerald-200 flex items-center gap-1" title="0 Alpa, 0 Pelanggaran">
                                                <i class="ph-bold ph-shield-check"></i> Catatan Bersih
                                            </span>
                                            
                                            <?php if($nominee->merit_points > 0): ?>
                                                <span class="text-[10px] font-bold px-2 py-0.5 rounded bg-blue-100 text-blue-700 border border-blue-200 flex items-center gap-1">
                                                    <i class="ph-bold ph-star"></i> <?php echo e($nominee->merit_points); ?> Pts
                                                </span>
                                            <?php endif; ?>
                                            
                                            <?php if($nominee->literacy_count > 0 || $nominee->habit_count > 0): ?>
                                                <span class="text-[10px] font-bold px-2 py-0.5 rounded bg-purple-100 text-purple-700 border border-purple-200 flex items-center gap-1">
                                                    <i class="ph-bold ph-check-square-offset"></i> Tugas Lengkap
                                                </span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="shrink-0 text-right">
                                        <p class="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-0.5">Skor Sistem</p>
                    ...
                    <?php else: ?>
                        <div class="text-center py-10 bg-white/50 rounded-2xl border border-amber-200/50 border-dashed">
                            ...
                            <p class="text-sm text-amber-700/70 max-w-md mx-auto mt-1">Saat ini belum ada siswa di kelas Anda yang memenuhi kriteria ketat (Bebas dari nilai Alpa dan Pelanggaran) sekaligus memiliki poin kebaikan/tugas.</p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
