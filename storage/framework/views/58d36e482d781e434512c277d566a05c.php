        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <?php if(isset($publicExams) && $publicExams->isNotEmpty()): ?>
                <?php $__currentLoopData = $publicExams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $exam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <!-- Card Ujian -->
                    <div class="bg-white rounded-3xl p-6 md:p-8 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] hover:shadow-xl hover:shadow-cyan-900/10 border border-slate-100 transition-all duration-300 hover:-translate-y-2 group flex flex-col h-full" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                        ...
                        <div class="flex justify-between items-start mb-6">
                            ...
                            <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg text-[10px] font-black uppercase tracking-wider border shadow-sm <?php echo e($statusClass); ?>">
                                <i class="ph-fill <?php echo e($iconClass); ?>"></i> <?php echo e($statusLabel); ?>
                        ...
                        <div class="flex-1 mb-6">
                            ...
                            <div class="flex flex-wrap items-center gap-2 mb-4">
                                <div class="inline-flex items-center gap-2 text-xs font-bold text-slate-500 bg-slate-50 px-3 py-1.5 rounded-lg border border-slate-100">
                                    <i class="ph-fill ph-book-open text-cyan-500"></i> <?php echo e($exam->subject_name ?? 'Mata Pelajaran'); ?>

                                </div>
                                <!-- BADGE KELAS (BARU) -->
                                <div class="inline-flex items-center gap-2 text-xs font-bold text-slate-500 bg-slate-50 px-3 py-1.5 rounded-lg border border-slate-100">
                                    <i class="ph-fill ph-users-three text-indigo-500"></i> <?php echo e($exam->class_level ?? 'Semua Kelas'); ?>
                            ...
                            <div class="space-y-3 mt-2">
                                <div class="flex items-center gap-3 text-sm text-slate-600">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-semibold"><?php echo e($startTime->translatedFormat('l, d M Y')); ?></p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-3 text-sm text-slate-600">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-semibold"><?php echo e($startTime->format('H:i')); ?> WIB - Selesai</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-auto pt-5 border-t border-slate-100">
                            <a href="<?php echo e(route('student.login')); ?>" class="w-full inline-flex justify-center items-center gap-2 px-4 py-3 rounded-xl bg-slate-900 text-white text-sm font-bold hover:bg-cyan-600 transition-colors shadow-md hover:shadow-cyan-500/25 group/btn">
