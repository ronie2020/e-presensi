        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php if(isset($publicExams) && $publicExams->isNotEmpty()): ?>
                <?php $__currentLoopData = $publicExams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $exam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <!-- Card Ujian -->
                    <div class="bg-white rounded-[1.25rem] p-5 shadow-sm hover:shadow-xl border border-slate-100 transition-all duration-300 hover:-translate-y-1 group flex flex-col h-full" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                            ...
                            <div class="bg-slate-50/80 rounded-xl p-3 border border-slate-100">
                                ...
                                <div class="flex items-center gap-2.5 text-xs mb-2">
                                    ...
                                    <div class="flex items-center gap-1.5">
                                        ...
                                        <span class="font-bold text-slate-700">: <?php echo e($startTime->translatedFormat('d M Y, H:i')); ?></span>
                                    </div>
                                </div>
                                <!-- Baris Akhir -->
                                <div class="flex items-center gap-2.5 text-xs">
                                    ...
                                    <div class="flex items-center gap-1.5">
                                        ...
                                        <span class="font-bold text-slate-700">: <?php echo e($endTime ? $endTime->translatedFormat('d M Y, H:i') : 'Tidak dibatasi'); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- CTA Button -->
                        <div class="mt-auto">
                            <a href="<?php echo e(route('student.login')); ?>" class="w-full inline-flex justify-center items-center gap-2 px-4 py-2.5 rounded-xl bg-slate-900 text-white text-xs font-bold hover:bg-cyan-600 transition-colors shadow-md hover:shadow-cyan-500/25 group/btn">
