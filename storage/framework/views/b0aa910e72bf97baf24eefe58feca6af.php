            ...
            <div class="relative rounded-[2rem] bg-elevate-gradient-main p-8 mb-8 text-elevate-dark shadow-xl shadow-elevate-accent/10 overflow-hidden border border-white/60">
                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-center md:items-start gap-6">
                    ...
                    <div class="flex flex-wrap justify-center gap-3">
                        ...
                        <a href="<?php echo e(route('discipline.analytics')); ?>" class="group bg-white text-elevate-dark px-5 py-3.5 rounded-2xl font-bold text-sm transition-all hover:bg-slate-50 flex items-center gap-2 shadow-lg shadow-elevate-dark/5 border border-white active:scale-95">
                        ...
                        <a href="<?php echo e(route('discipline-types.index')); ?>" class="group bg-white/60 backdrop-blur-md hover:bg-white text-elevate-dark px-5 py-3.5 rounded-2xl font-bold text-sm border border-white transition-all flex items-center gap-2 shadow-sm active:scale-95">
                    ...
                    <div class="flex flex-col sm:flex-row items-center gap-3 w-full lg:w-auto">
                        <form action="<?php echo e(route('discipline.index')); ?>" method="GET" class="flex flex-col sm:flex-row w-full gap-2">
                            ...
                            <?php if(request('search') || request('filter_date')): ?>
                                <a href="<?php echo e(route('discipline.index')); ?>" class="bg-slate-200 hover:bg-slate-300 text-elevate-dark px-4 py-2 rounded-xl text-sm font-bold transition-colors flex items-center justify-center">
                                    Reset
                                </a>
                            <?php endif; ?>
                        </form>
                        ...
                        <tbody class="divide-y divide-slate-50">
                            <?php $__empty_1 = true; $__currentLoopData = $historyRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <tr class="hover:bg-slate-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm font-bold text-elevate-dark"><?php echo e($record->student->name); ?></div>
                                        <div class="text-xs text-slate-500 font-medium"><?php echo e($record->student->schoolClass->name ?? '-'); ?></div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-sm font-bold text-elevate-dark"><?php echo e($record->disciplineType->name ?? '-'); ?></div>
                                        <?php if($record->notes): ?> 
