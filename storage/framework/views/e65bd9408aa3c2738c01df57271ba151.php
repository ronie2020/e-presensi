                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-center gap-6">
                    <div class="text-center md:text-left">
                        ...
                        <div class="mt-6 flex flex-wrap justify-center md:justify-start gap-3">
                            <a href="<?php echo e(route('letters.spt.create')); ?>" class="px-6 py-3 bg-white text-blue-900 font-bold rounded-xl shadow-lg hover:bg-blue-50 hover:scale-105 transition-all flex items-center gap-2 transform active:scale-95">
                    ...
                    <div class="flex gap-3">
                        <div class="bg-blue-950/40 backdrop-blur-md px-5 py-4 rounded-2xl border border-blue-400/20 text-center min-w-[120px] shadow-lg">
                            <span class="block text-3xl font-black text-white"><?php echo e($spts->total()); ?></span>
                        ...
                        <tbody class="divide-y divide-slate-50">
                            ...
                            <tr class="hover:bg-blue-50/40 transition-colors group">
                                <td class="px-6 py-5 align-top">
                                    ...
                                    <div class="font-bold text-slate-800 text-sm mb-1"><?php echo e($spt->tempat_tujuan); ?></div>
                                    
                                    <div class="flex items-center gap-2 text-xs text-slate-500 mt-1">
                                        <i class="ph-bold ph-calendar-blank"></i>
                                        <span><?php echo e($spt->tgl_berangkat->format('d/m/Y')); ?> s.d <?php echo e($spt->tgl_kembali->format('d/m/Y')); ?></span>
                                    ...
                                    <div class="text-[11px] text-slate-400 mt-2 italic line-clamp-1 border-t border-slate-100 pt-1">
                                        "<?php echo e($spt->untuk); ?>"
                                    </div>
                                </td>
                                <td class="px-6 py-5 align-top">
                                    <div class="flex flex-wrap gap-1.5">
                                        <?php $__currentLoopData = $spt->users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-[10px] font-bold bg-white border border-slate-200 text-slate-600 shadow-sm">
                                                <i class="ph-fill ph-user text-blue-400"></i> <?php echo e($user->name); ?>
                                ...
                                <td class="px-6 py-5 align-top">
                                    <?php if($spt->letterIncoming): ?>
                                        <div class="bg-slate-50 p-2.5 rounded-xl border border-slate-100 max-w-xs">
                                            ...
                                            <div class="text-xs font-bold text-slate-700 truncate"><?php echo e($spt->letterIncoming->nomor_surat); ?></div>
                                            <div class="text-[10px] text-slate-500 line-clamp-1 italic mt-0.5"><?php echo e($spt->letterIncoming->perihal); ?></div>
                                        </div>
                                    <?php else: ?>
                                ...
                                <td class="px-6 py-5 align-top text-right">
                                    <div class="flex flex-col items-end gap-2">
                                        <a href="<?php echo e(route('letters.spt.print', $spt->id)); ?>" target="_blank" class="inline-flex items-center gap-2 px-3 py-1.5 bg-blue-600 text-white hover:bg-blue-700 rounded-lg text-xs font-bold transition-all shadow-sm shadow-blue-500/30">
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            <button type="button" onclick="confirmDelete('<?php echo e($spt->id); ?>')" class="w-8 h-8 flex items-center justify-center rounded-lg bg-white border border-slate-200 text-slate-400 hover:text-rose-600 hover:border-rose-200 hover:shadow-sm transition-all" title="Hapus">
