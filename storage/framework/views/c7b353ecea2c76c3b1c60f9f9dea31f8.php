                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
                    ...
                    <div class="flex flex-row md:flex-col lg:flex-row gap-4 w-full md:w-auto">
                        <div class="bg-white/10 backdrop-blur-md px-6 py-5 rounded-2xl border border-white/10 flex-1 md:flex-none min-w-[140px] text-center md:text-left hover:bg-white/15 transition-colors">
                            ...
                            <span class="block text-3xl font-black text-white tracking-tight"><?php echo e($classes->count()); ?></span>
                        </div>
                    </div>
                            ...
                            <div>
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="text" name="name" value="<?php echo e(old('name')); ?>" required placeholder="Contoh: 7A" 
                                           class="w-full pl-11 pr-4 py-3 rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-blue-600 focus:ring-blue-600 font-bold text-slate-700 transition-all shadow-sm placeholder:font-normal placeholder:text-slate-400 <?php $__errorArgs = ['name'];
                        ...
                        <div class="p-8 border-b border-slate-50 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-6">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-slate-400 font-bold uppercase tracking-wider">Total <?php echo e($classes->count()); ?> Kelas</p>
                                </div>
                            </div>
                                        ...
                                        <tr class="hover:bg-slate-50 transition-colors group"
                                            ...
                                            <td class="px-6 py-5 whitespace-nowrap">
                                                <div class="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        <span class="block font-black text-slate-700 text-sm"><?php echo e($class->name); ?></span>
                                                        <span class="text-[10px] font-bold text-slate-400 uppercase tracking-wide">ID: <?php echo e($class->id); ?></span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-6 py-5 whitespace-nowrap">
                                            ...
                                            <td class="px-6 py-5 whitespace-nowrap text-right">
                                                <div class="flex items-center justify-end gap-2">
                                                    ...
                                                    <a href="<?php echo e(route('classes.edit', $class->id)); ?>" class="w-9 h-9 flex items-center justify-center rounded-xl bg-white border border-slate-200 text-slate-300 hover:text-blue-600 hover:border-blue-200 hover:bg-blue-50 transition-all shadow-sm" title="Edit Kelas">
                                                    ...
                                                    <form action="<?php echo e(route('classes.destroy', $class->id)); ?>" 
                                                          method="POST" 
                                                          id="delete-form-<?php echo e($class->id); ?>">
                                                        <?php echo csrf_field(); ?> 
...
<?php endif; ?><?php /**PATH C:\Users\ronie\Documents\aplikasi\E-Presensi Netila\resources\views/classes/index.blade.php ENDPATH**/ ?>