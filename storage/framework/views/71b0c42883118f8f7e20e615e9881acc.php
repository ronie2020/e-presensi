                                ...
                                <tr class="group hover:bg-slate-50/80 transition-colors">
                                    ...
                                    <td class="p-5 align-top max-w-sm lg:max-w-md">
                                        ...
                                        <div class="bg-slate-50 p-4 rounded-2xl border border-slate-100 text-xs text-slate-600 leading-relaxed relative group-hover:bg-white group-hover:border-elevate-accent/30 transition-all font-medium">
                                            ...
                                            <span class="relative z-10"><?php echo e(Str::limit($item->summary, 150)); ?></span>
                                        </div>
                                    </td>
                                        ...
                                        <div class="flex flex-col gap-2 items-end">
                                            <?php if(!$item->verified_at): ?>
                                                <form action="<?php echo e(route('admin.literacy.verify', $item->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <button type="submit" class="w-full px-5 py-2.5 bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl text-xs font-bold shadow-lg shadow-emerald-500/20 transition-all flex items-center justify-center gap-2 active:scale-95">
                                                        <i class="ph-bold ph-check-circle text-base"></i> Verifikasi
                                                    </button>
                                                </form>
                                            <?php else: ?>
                                                <div class="w-full px-4 py-2 bg-emerald-50 text-emerald-600 border border-emerald-100 rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 cursor-default shadow-sm">
                                            ...
                                            <form action="<?php echo e(route('admin.literacy.destroy', $item->id)); ?>" method="POST" 
                                                  onsubmit="event.preventDefault(); 
                                                            ...
                                                            Swal.fire({
                                                                title: 'Hapus Jurnal?',
                                                                text: 'Yakin ingin menghapus jurnal literasi ini?',
                                                                icon: 'warning',
                                                ...
                                                <button type="submit" class="text-[10px] font-black text-slate-400 hover:text-rose-500 flex items-center gap-1.5 mt-1 transition-colors uppercase tracking-wider py-1">
...
<?php endif; ?><?php /**PATH C:\Users\ronie\Documents\aplikasi terpadu\sistem_absensi_sekolah\resources\views/literacy/index.blade.php ENDPATH**/ ?>