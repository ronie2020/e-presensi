...
<div class="w-full max-w-6xl mx-auto pb-20 px-4 sm:px-6 pt-6 md:pt-10">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            <a href="<?php echo e(route('portal.show', Auth::guard('student')->id())); ?>" class="inline-flex items-center px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-bold rounded-xl transition-all shadow-lg shadow-blue-500/30 hover:-translate-y-1">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <tr class="hover:bg-slate-50/50 transition-colors group">
                              <td class="px-6 py-4">
                                ...
                                <?php if($item->is_system_generated ?? false): ?>
                                    <?php if(str_contains($item->initial_message, 'PELANGGARAN')): ?>
                                        <span class="inline-flex items-center px-2 py-1 ml-1 rounded text-[10px] font-black bg-rose-100 text-rose-700 uppercase tracking-wider mb-1 animate-pulse">
                                            <i class="ph-fill ph-warning mr-1"></i> Panggilan
                                        </span>
                                    <?php else: ?>
                                        <span class="inline-flex items-center px-2 py-1 ml-1 rounded text-[10px] font-black bg-blue-100 text-blue-700 uppercase tracking-wider mb-1">
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\aplikasi terpadu\sistem_absensi_sekolah\resources\views\students\bk\index.blade.php ENDPATH**/ ?>