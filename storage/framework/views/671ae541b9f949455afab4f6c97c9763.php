...
<body>
    ...
    <div class="report-title">
        <h3>REKAPITULASI MUTABAAH FULL RAMADHAN</h3>
        <p>
            <strong>Kelas:</strong> <?php echo e($class->name); ?> &nbsp;|&nbsp;
            <strong>Periode:</strong> <?php echo e(\Carbon\Carbon::parse($startDate)->translatedFormat('d M Y')); ?> 
            s/d <?php echo e(\Carbon\Carbon::parse($endDate)->translatedFormat('d M Y')); ?>
...
</html><?php /**PATH E:\aplikasi terpadu\sistem_absensi_sekolah\resources\views\ramadan\export-excel.blade.php ENDPATH**/ ?>