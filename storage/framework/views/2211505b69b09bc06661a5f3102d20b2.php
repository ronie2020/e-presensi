            ...
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center gap-4">
                    <div class="text-right hidden sm:block">
                        <p class="text-xs font-bold text-white"><?php echo e(Auth::guard('student')->user()->name); ?></p>
                        <p class="text-[10px] text-cyan-200"><?php echo e(Auth::guard('student')->user()->student_id); ?></p>
                    </div>
                    
                    <a href="<?php echo e(route('portal.index')); ?>" class="px-4 py-2 bg-white/10 border border-white/20 rounded-lg text-white text-xs font-bold hover:bg-rose-500 hover:border-rose-400 hover:text-white transition-all flex items-center gap-2 group backdrop-blur-sm" title="Kembali ke Portal Utama">
