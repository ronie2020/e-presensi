        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-[72px] items-center">
                ...
                <div class="flex items-center gap-3 sm:gap-5">
                    ...
                    <a href="<?php echo e(route('portal.index')); ?>" class="px-4 py-2 bg-[#e5eff5] text-[#0d52a1] font-bold text-xs rounded-xl hover:bg-[#56bbf1] hover:text-white transition flex items-center gap-2 border border-[#56bbf1]/20 active:scale-95 hidden md:flex">
