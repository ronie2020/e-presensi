                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                        <h2 class="text-3xl font-extrabold tracking-tight mb-2 flex items-center gap-3">
                            <i class="ph-duotone ph-scroll text-blue-400"></i>
                            Riwayat Perizinan
                        </h2>
                    ...
                    <div class="flex gap-2">
                        <a href="<?php echo e(route('permit.export', request()->all())); ?>" target="_blank" class="group flex items-center gap-2 px-4 py-2.5 bg-white/10 hover:bg-white/20 backdrop-blur-md rounded-xl text-sm font-bold transition border border-white/10 cursor-pointer text-blue-100 hover:text-white shadow-sm">
                            <i class="ph-bold ph-microsoft-excel-logo text-emerald-400 group-hover:scale-110 transition-transform"></i>
                            <span class="hidden sm:inline">Export Excel</span>
                        </a>
                        <a href="<?php echo e(route('permit.print', request()->all())); ?>" target="_blank" class="group flex items-center gap-2 px-4 py-2.5 bg-white/10 hover:bg-white/20 backdrop-blur-md rounded-xl text-sm font-bold transition border border-white/10 cursor-pointer text-blue-100 hover:text-white shadow-sm">
...
<?php endif; ?><?php /**PATH E:\drive aplikasi\aplikasi terpadu\sistem_absensi_sekolah versi 3.00\resources\views/permit/history.blade.php ENDPATH**/ ?>