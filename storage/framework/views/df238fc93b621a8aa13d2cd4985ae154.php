                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
                    <div class="flex-1">
                        <div class="flex items-center gap-4 mb-4">
                            <a href="<?php echo e(route('portal.show', Auth::guard('student')->id())); ?>"  class="group flex items-center justify-center w-10 h-10 rounded-xl bg-white/10 backdrop-blur-md border border-white/10 text-slate-300 hover:bg-white/20 hover:text-white hover:border-white/30 transition-all active:scale-95 shrink-0 shadow-sm" title="Kembali">
                                            ...
                                            <div class="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="flex flex-wrap gap-2 mt-1">
                                                        <p class="text-xs text-emerald-600 font-medium">Dikirim pada <?php echo e($mySubmission->submitted_at->translatedFormat('d F Y • H:i')); ?></p>
                                                        
                                                        
                                                        <?php if($mySubmission->link_url): ?>
                                                            <a href="<?php echo e($mySubmission->link_url); ?>" target="_blank" class="text-[10px] font-bold bg-white px-2 py-0.5 rounded border border-emerald-200 text-emerald-600 hover:text-emerald-800 flex items-center gap-1">
                                                                <i class="ph-bold ph-link"></i> Link Tugas
                                                            </a>
                                                        <?php elseif($mySubmission->file_path): ?>
                                                            <a href="<?php echo e(route('students.learning.material.download', $task->id)); ?>" class="text-[10px] font-bold bg-white px-2 py-0.5 rounded border border-emerald-200 text-emerald-600 hover:text-emerald-800 flex items-center gap-1">
                                            ...
                                            <div x-show="openUpload" x-transition class="mt-6 p-6 border-t border-emerald-100">
                                                <form action="<?php echo e(route('students.learning.assignment.submit', $task->id)); ?>" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="space-y-4">
                                                        ...
                                                        <textarea name="student_note" rows="2" class="w-full rounded-xl border-slate-200 text-sm p-3 placeholder:text-slate-400" placeholder="Update catatan..."><?php echo e($mySubmission->student_note); ?></textarea>
...
<?php endif; ?><?php /**PATH E:\aplikasi terpadu\sistem_absensi_sekolah\resources\views/students/lms/show.blade.php ENDPATH**/ ?>