...
<head>
    ...
    <style>
        ...
        .sticker {
            width: 75mm;  /* Sebelumnya 90mm */
            height: 35mm; /* Sebelumnya 40mm */
            display: flex;
            background: white;
        ...
        /* BAGIAN COVER BUKU (QR Code) */
        .cover-label {
            width: 50mm; /* Sebelumnya 60mm */
            height: 100%;
            padding: 4px 6px; /* Tambah padding agar tidak terlalu mepet tepi */
            display: flex;
            flex-direction: column;
            align-items: center;
            justify-content: center;
    ...
    <div class="page mt-24">
        ...
        <div class="sticker" :class="showBorder ? 'show-border' : 'no-border'">
            ...
            <div class="cover-label">
                ...
                <p class="text-[13px] font-extrabold text-slate-800 text-center leading-tight mb-1 w-full line-clamp-2 px-1">
                ...
                <div class="flex-1 flex items-center justify-center w-full">
                    ...
                    <?php echo QrCode::size(70)->margin(1)->generate($copyCode); ?>

                </div>
                
                
                <div class="w-full text-center px-1 mt-0.5">
                    <p class="text-[11px] font-mono font-bold text-slate-800 truncate w-full">
                        <?php echo e($copyCode); ?>

                    </p>
                    
                    
                    <?php if($copy->book->purchase_date): ?>
                        <p class="text-[10px] font-bold text-slate-500 mt-[1px] uppercase tracking-widest leading-none">
                            <?php echo e(\Carbon\Carbon::parse($copy->book->purchase_date)->format('d/m/Y')); ?>
