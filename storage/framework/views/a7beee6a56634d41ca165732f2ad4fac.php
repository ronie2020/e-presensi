<div x-data="{
        ...
        <div class="lg:col-span-2 bg-white dark:bg-slate-800/80 p-6 sm:p-8 rounded-[2.5rem] shadow-sm border border-slate-100 dark:border-slate-700/50 flex flex-col justify-center relative overflow-hidden group hover:border-elevate-accent/30 transition-colors">
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-4 relative z-10">
                <div>
                    ...
                    <p class="text-sm font-bold text-slate-500 dark:text-slate-400 flex items-center gap-2 mt-1">
                        <i class="ph-bold ph-calendar-blank text-elevate-accent"></i> <?php echo e(\Carbon\Carbon::now()->translatedFormat('l, d F Y')); ?>
            ...
            <div class="relative z-10 mt-2">
                <div class="flex justify-between items-end mb-2">
                    ...
                    <span class="text-lg font-black text-elevate-dark dark:text-slate-100"><?php echo e($completedHabits); ?> <span class="text-sm text-slate-400 dark:text-slate-500">/ 7 Selesai</span></span>
                </div>
    ...
    <div class="bg-white dark:bg-slate-800/80 rounded-[2.5rem] border border-slate-100 dark:border-slate-700/50 shadow-sm p-6 sm:p-8 hover:shadow-md transition-shadow">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="<?php echo e(route('student.habits.index')); ?>" class="px-5 py-2 bg-elevate-dark dark:bg-elevate-primary text-white rounded-xl text-xs font-bold hover:bg-elevate-primary dark:hover:bg-elevate-dark transition shadow-lg shadow-elevate-dark/10 flex items-center gap-2">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="p-4 rounded-2xl border transition-all flex items-center gap-4 <?php echo e($isDone ? 'bg-emerald-50 dark:bg-emerald-900/20 border-emerald-100 dark:border-emerald-800/50' : 'bg-slate-50 dark:bg-slate-800/50 border-slate-100 hover:border-elevate-accent/30 dark:border-slate-700'); ?>">
            ...
            <div class="grid grid-rows-2 gap-4">
                ...
                <div class="p-3 rounded-2xl border transition-all flex items-center gap-3 <?php echo e($isSocialDone ? 'bg-emerald-50 dark:bg-emerald-900/20 border-emerald-100 dark:border-emerald-800/50' : 'bg-slate-50 dark:bg-slate-800/50 border-slate-100 hover:border-elevate-accent/30 dark:border-slate-700'); ?>">
                ...
                <div class="p-3 rounded-2xl border transition-all flex items-center gap-3 <?php echo e($isSleepDone ? 'bg-emerald-50 dark:bg-emerald-900/20 border-emerald-100 dark:border-emerald-800/50' : 'bg-slate-50 dark:bg-slate-800/50 border-slate-100 hover:border-elevate-accent/30 dark:border-slate-700'); ?>">
...
</div><?php /**PATH C:\Users\ronie\Documents\aplikasi terpadu\sistem_absensi_sekolah\resources\views/students/portal/partials/tab-kebiasaan.blade.php ENDPATH**/ ?>