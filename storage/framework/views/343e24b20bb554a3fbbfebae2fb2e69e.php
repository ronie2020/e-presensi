...
<?php $component->withAttributes([]); ?>
                                ...
                                <div class="bg-indigo-50/50 p-6 rounded-[2rem] border border-indigo-100">
                                    ...
                                    <div class="space-y-5">
                                        ...
                                        <div>
                                            ...
                                            <div class="flex gap-2">
                                                <div class="relative flex-1 group">
                                                    ...
                                                    <input type="text" name="book_code" id="book_code" value="<?php echo e(old('book_code', $book->book_code)); ?>" required placeholder="Scan atau ketik kode..."
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="title" value="<?php echo e(old('title', $book->title)); ?>" placeholder="Masukkan judul lengkap..." required 
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <input type="number" name="stock" value="<?php echo e(old('stock', $book->stock)); ?>" min="0" required 
                                                    class="w-full px-4 py-3 rounded-2xl border-slate-200 bg-white focus:border-indigo-500 focus:ring-indigo-500 font-bold text-slate-700 transition-all shadow-sm">
                                            </div>
                                            <div>
    ...
    <script>
        ...
        async function addNewCategory() {
            // ... (Copy paste logika ajax yang sama dari create.blade.php jika perlu konsistensi) ...
            // Karena fungsi ini diulang, pastikan scriptnya sama persis dengan create.blade.php
