                            ...
                            <div class="space-y-6">
                                <div class="bg-indigo-50/50 p-6 rounded-[2rem] border border-indigo-100">
                                    ...
                                    <div class="space-y-5">
                                        ...
                                        <div>
                                            <label class="block text-xs font-bold text-slate-400 uppercase mb-2 ml-1">Kode Buku / Barcode Induk</label>
                                            <div class="flex gap-2">
                                                <div class="relative flex-1 group">
                                                    ...
                                                    <input type="text" name="book_code" id="book_code" value="<?php echo e(old('book_code', $book->book_code)); ?>" readonly
                                                        class="w-full pl-11 pr-4 py-3 rounded-2xl border-slate-200 bg-slate-100 cursor-not-allowed font-mono font-bold text-slate-500 shadow-sm" title="Kode buku tidak dapat diubah setelah dibuat">
                                                </div>
                                            </div>
                                            <p class="text-[10px] text-slate-400 mt-1 ml-1"><i class="ph-bold ph-info"></i> Kode induk tidak dapat diubah untuk menjaga sinkronisasi eksemplar.</p>
                                        </div>
                                       ...
                                       <div class="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <input type="number" name="stock" value="<?php echo e(old('stock', $book->stock)); ?>" readonly 
                                        ...
                                        <div>
                                            <label class="flex items-center gap-3 p-4 border border-indigo-200 bg-white rounded-xl cursor-pointer hover:bg-indigo-50 transition mt-2">
                                                <input type="checkbox" name="is_textbook" value="1" <?php echo e(old('is_textbook', $book->is_textbook) ? 'checked' : ''); ?> class="w-5 h-5 text-indigo-600 border-indigo-300 rounded focus:ring-indigo-500">
                                                <div>
                                                    <span class="block text-sm font-bold text-indigo-800">Ini Buku Paket / Pelajaran</span>
                                                    <span class="block text-xs text-indigo-600">Buku paket bisa dipinjam massal selama 1 tahun.</span>
                                                </div>
                                            </label>
                                        </div>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="border-t border-slate-100 pt-6">
                            ...
                            <textarea name="description" rows="3" placeholder="Ringkasan cerita..." class="w-full px-4 py-3 rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-indigo-500 focus:ring-indigo-500 font-medium text-slate-700 transition-all shadow-inner"><?php echo e(old('description', $book->description)); ?></textarea>
                        </div>
...
<?php endif; ?><?php /**PATH E:\aplikasi terpadu\sistem_absensi_sekolah\resources\views/books/edit.blade.php ENDPATH**/ ?>