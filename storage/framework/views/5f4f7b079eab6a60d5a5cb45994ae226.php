...
<nav x-data="{
        ...
        <div class="flex justify-between h-20 items-center">
            ...
            <div class="hidden md:flex items-center gap-8">
                ...
                <?php if(Auth::guard('student')->check()): ?>
                    <a href="<?php echo e(route('students.learning.index')); ?>" class="px-5 py-2.5 rounded-full bg-elevate-accent text-elevate-dark text-xs font-bold shadow-lg shadow-elevate-accent/40 hover:bg-elevate-accent/80 transition border border-elevate-accent flex items-center gap-2 group">
                        <span>Dashboard</span>
                        <i class="ph-bold ph-arrow-right group-hover:translate-x-1 transition-transform"></i>
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('library.catalogue')); ?>" class="text-sm font-bold text-elevate-accent hover:text-white transition flex items-center gap-2">
                        Katalog Buku
                    </a>
                    <a href="<?php echo e(route('ppdb.create')); ?>" class="text-sm font-bold text-elevate-accent hover:text-white transition flex items-center gap-2">
                        PPDB
                    </a> 
                    <a href="<?php echo e(route('portal.index')); ?>" class="mr-2 text-sm font-bold text-slate-100 hover:text-white transition">
                        Portal Siswa
                    </a>
                    <!-- Tombol Staff -->
                    <a href="<?php echo e(route('login')); ?>" class="px-5 py-2.5 rounded-full bg-white/10 backdrop-blur-md text-white text-xs font-bold hover:bg-white hover:text-elevate-primary transition border border-white/20 flex items-center gap-2">
    ...
    <div x-show="mobileMenuOpen" x-cloak
        ...
        <nav class="flex flex-col items-center space-y-6 text-center w-full px-8">
            <!-- Mobile PPDB Link -->
            <a href="<?php echo e(route('ppdb.create')); ?>" class="w-full py-3 bg-elevate-accent rounded-xl text-elevate-dark font-bold text-lg shadow-lg shadow-elevate-accent/30">
            ...
            <div class="flex flex-col gap-4 w-full pb-10">
                ...
                <?php if(Auth::guard('student')->check()): ?>
                    <a href="<?php echo e(route('students.learning.index')); ?>" class="block w-full py-3 rounded-xl bg-elevate-primary text-white font-bold shadow-lg shadow-elevate-dark/30">Dashboard Siswa</a>
                <?php else: ?>
