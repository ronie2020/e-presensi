        ...
        <div class="sticker" :class="showBorder ? 'show-border' : 'no-border'">
            ...
            <div class="cover-label">
                ...
                <div class="flex-1 flex items-center justify-center w-full">
                    ...
                    <?php echo QrCode::size(50)->margin(1)->generate($copyCode); ?>

                </div>
                
                
                <div class="w-full text-center px-1 mt-0.5">
                    <p class="text-[9.5px] font-mono font-bold text-slate-800 truncate w-full">
                        <?php echo e($copyCode); ?>
                    ...
                    <?php if($copy->book->purchase_date): ?>
                        <p class="text-[6.5px] font-bold text-slate-500 mt-[1px] uppercase tracking-widest leading-none">
