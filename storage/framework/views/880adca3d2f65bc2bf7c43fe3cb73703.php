            ...
            <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                ...
                <div class="flex items-center gap-4">
                    <div class="bg-white/40 backdrop-blur-md p-5 rounded-3xl border border-white/50 text-center min-w-[130px] shadow-sm">
                        <div class="text-3xl font-black text-elevate-dark"><?php echo e($topStudents->count()); ?></div>
                        <div class="text-[10px] font-bold uppercase tracking-widest text-elevate-dark/70 mt-1">Peserta Aktif</div>
                    </div>
                    <div class="bg-white/40 backdrop-blur-md p-5 rounded-3xl border border-white/50 text-center min-w-[130px] shadow-sm">
                        <div class="text-3xl font-black text-elevate-dark"><?php echo e(number_format($topStudents->sum('points'), 0, ',', '.')); ?></div>
            ...
            <div class="order-2 md:order-1 flex flex-col items-center <?php echo e(!isset($topStudents[1]) ? 'invisible md:visible opacity-0' : ''); ?>">
                ...
                <div class="relative mb-5">
                    <div class="w-24 h-24 rounded-full border-4 border-elevate-accent/50 overflow-hidden shadow-lg bg-white p-1">
                        <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($topStudents[1]->name)); ?>&background=0d52a1&color=ffffff&bold=true" alt="Runner up" class="w-full h-full object-cover rounded-full">
                    </div>
                ...
                <div class="bg-white fluent-card p-6 rounded-[2rem] rounded-b-xl w-full text-center h-44 flex flex-col justify-center">
                    <h4 class="font-bold text-elevate-dark text-lg line-clamp-1"><?php echo e($topStudents[1]->name); ?></h4>
                    ...
                    <div class="text-elevate-primary font-black text-2xl"><?php echo e(number_format($topStudents[1]->points, 0, ',', '.')); ?> <span class="text-xs font-bold text-slate-400">pts</span></div>
                </div>
                <?php endif; ?>
            </div>
            ...
            <div class="order-1 md:order-2 flex flex-col items-center scale-110 md:-translate-y-6 z-10">
                ...
                <div class="relative mb-6">
                    ...
                    <div class="w-32 h-32 rounded-full border-4 border-elevate-peach overflow-hidden shadow-xl bg-white ring-8 ring-elevate-peach-light/50 p-1.5">
                        <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($topStudents[0]->name)); ?>&background=c86845&color=ffffff&bold=true" alt="Winner" class="w-full h-full object-cover rounded-full">
                    </div>
                ...
                <div class="bg-white fluent-card p-8 rounded-[2.5rem] rounded-b-xl w-full text-center h-56 flex flex-col justify-center border-t border-elevate-peach">
                    <h4 class="font-black text-elevate-dark text-xl line-clamp-1"><?php echo e($topStudents[0]->name); ?></h4>
            ...
            <div class="order-3 flex flex-col items-center <?php echo e(!isset($topStudents[2]) ? 'invisible md:visible opacity-0' : ''); ?>">
                ...
                <div class="relative mb-5">
                    <div class="w-24 h-24 rounded-full border-4 border-emerald-300 overflow-hidden shadow-lg bg-white p-1">
                        <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($topStudents[2]->name)); ?>&background=059669&color=ffffff&bold=true" alt="3rd place" class="w-full h-full object-cover rounded-full">
                    </div>
                ...
                <div class="bg-white fluent-card p-6 rounded-[2rem] rounded-b-xl w-full text-center h-44 flex flex-col justify-center">
                    <h4 class="font-bold text-elevate-dark text-lg line-clamp-1"><?php echo e($topStudents[2]->name); ?></h4>
                    ...
                    <div class="text-emerald-600 font-black text-2xl"><?php echo e(number_format($topStudents[2]->points, 0, ',', '.')); ?> <span class="text-xs font-bold text-slate-400">pts</span></div>
                </div>
                <?php endif; ?>
            </div>
        </div>
                ...
                <div class="group flex items-center justify-between p-5 hover:bg-slate-50/50 transition-colors cursor-default">
                    <div class="flex items-center gap-5">
                        ...
                        <div class="w-12 h-12 rounded-full overflow-hidden border border-slate-200 shadow-sm">
                            <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($student->name)); ?>&background=f1f5f9&color=2c3f61&bold=true" alt="avatar" class="w-full h-full object-cover">
                        </div>
                        <div>
                            <div class="text-sm font-bold text-elevate-dark group-hover:text-elevate-primary transition-colors"><?php echo e($student->name); ?></div>
                    ...
                    <div class="text-right">
                        <div class="text-base font-black text-elevate-primary"><?php echo e(number_format($student->points, 0, ',', '.')); ?> <span class="text-[10px] text-slate-400 font-bold">pts</span></div>
                        <div class="w-24 bg-slate-100 rounded-full h-1.5 mt-2 overflow-hidden shadow-inner border border-slate-200/50">
                            ...
                            <div class="bg-elevate-primary h-full rounded-full transition-all duration-1000" style="width: <?php echo e($percent); ?>%"></div>
                        </div>
                    </div>
                </div>
