        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php if(isset($publicExams) && $publicExams->isNotEmpty()): ?>
                <?php $__currentLoopData = $publicExams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $exam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <!-- Card Ujian -->
                    <div class="bg-white dark:bg-slate-800 rounded-[1.25rem] p-5 shadow-sm hover:shadow-xl border border-slate-100 dark:border-slate-700 transition-all duration-300 hover:-translate-y-1 group flex flex-col h-full hover:border-elevate-accent/50" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
...
</div><?php /**PATH C:\Users\ronie\Documents\aplikasi terpadu\sistem_absensi_sekolah\resources\views/landing/exams.blade.php ENDPATH**/ ?>