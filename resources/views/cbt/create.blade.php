            ...
            <div class="relative rounded-[2rem] bg-gray-900 bg-gradient-to-br from-slate-900 via-blue-900 to-blue-800 p-8 mb-8 text-white shadow-xl shadow-blue-900/30 overflow-hidden border border-white/10">
                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    ...
                    <div class="hidden md:block">
                        <div class="w-16 h-16 bg-white/10 backdrop-blur-md rounded-2xl flex items-center justify-center text-3xl border border-white/20 shadow-inner">
                            <i class="ph-duotone ph-calendar-plus text-blue-300"></i>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <form action="{{ route('cbt.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="title" required 
                                   class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-blue-500 focus:ring-blue-500 font-bold text-slate-700 py-3.5 px-5 transition-all placeholder:font-normal placeholder:text-slate-400" 
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="subject_name" required 
                                           class="w-full pl-11 rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-blue-500 focus:ring-blue-500 font-bold text-slate-700 py-3.5 px-5 transition-all" placeholder="Nama Mapel">
                                </div>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="start_time" required class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-blue-500 focus:ring-blue-500 font-bold text-slate-700 py-3.5 px-5 transition-all">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="end_time" required class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-blue-500 focus:ring-blue-500 font-bold text-slate-700 py-3.5 px-5 transition-all">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-6">
                            ...
                            <div class="col-span-1">
                                ...
                                <div class="relative">
                                    <input type="number" name="duration_minutes" value="90" required class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-blue-500 focus:ring-blue-500 font-bold text-slate-700 py-3.5 px-5 transition-all text-center">
                            ...
                            <div class="col-span-1">
                                ...
                                <input type="number" name="passing_grade" value="75" required class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-blue-500 focus:ring-blue-500 font-bold text-slate-700 py-3.5 px-5 transition-all text-center">
                            </div>
                             ...
                             <div class="col-span-2 md:col-span-1">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="token" maxlength="6" class="w-full pl-11 rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-blue-500 focus:ring-blue-500 font-mono font-black text-slate-800 py-3.5 px-5 transition-all uppercase tracking-widest placeholder:tracking-normal" placeholder="AUTO">
                                </div>
                        ...
                        <div class="flex items-center gap-3 p-4 bg-blue-50 rounded-2xl border border-blue-100">
                            <div class="relative flex items-center">
                                <input type="checkbox" name="is_active" value="1" checked id="active" class="peer sr-only">
