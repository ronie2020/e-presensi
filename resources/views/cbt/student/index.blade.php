            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-8">
                ...
                <div class="flex gap-4">
                    <div class="bg-white/5 backdrop-blur-md border border-white/10 p-5 rounded-2xl text-center min-w-[110px] shadow-lg">
                        ...
                        <p class="text-3xl font-black text-yellow-400">{{ isset($exams) ? $exams->where('status', 'active')->count() : 0 }}</p>
                    </div>
                    <div class="bg-white/5 backdrop-blur-md border border-white/10 p-5 rounded-2xl text-center min-w-[110px] shadow-lg">
                        <p class="text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-1">Selesai</p>
                        <p class="text-3xl font-black text-white">{{ isset($exams) ? $exams->where('status', 'finished')->count() : 0 }}</p>
                    </div>
                </div>
            </div>
        </div>
