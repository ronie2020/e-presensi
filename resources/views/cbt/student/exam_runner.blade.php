...
<body class="h-screen flex flex-col"
    ...
    <nav class="bg-slate-900 text-white h-16 shrink-0 flex items-center justify-between px-4 lg:px-8 shadow-lg z-50 relative">
        <div class="flex items-center gap-4 min-w-0">
            ...
            <div class="truncate"><h1 class="font-bold text-sm lg:text-base truncate">{{ $exam->title }}</h1><p class="text-[10px] lg:text-xs text-slate-400 font-bold uppercase tracking-wider truncate">{{ $exam->subject_name }}</p></div>
        </div>
