...
<head>
    <meta charset="utf-8">
    <title>Bank Soal - {{ $bank->title }}</title>
    <style>
        body {
...
<body>
    ...
    <div class="header-box">
        ...
        <h3>{{ strtoupper($bank->title) }}</h3>
        <table class="meta">
            <tr>
                <td width="15%">Mata Pelajaran</td><td width="2%">:</td><td>{{ $bank->subject_name }}</td>
                <td width="15%">Kelas</td><td width="2%">:</td><td>{{ $bank->class_level }}</td>
            </tr>
            <tr>
                <td>Kode Bank</td><td>:</td><td>{{ $bank->code }}</td>
                <td>Total Soal</td><td>:</td><td>{{ $bank->questions->count() }}</td>
            </tr>
        </table>
    </div>
