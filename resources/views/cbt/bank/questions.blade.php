<x-app-layout>
    ...
    <div x-data="{ 
       showEditModal: false,
                ...
                <div class="relative rounded-[2rem] bg-gray-900 bg-gradient-to-br from-slate-900 via-indigo-900 to-indigo-800 p-8 text-white shadow-xl shadow-indigo-900/30 overflow-hidden border border-white/10">
                    ...
                    <div class="relative z-10">
                        <div class="flex items-center gap-2 mb-2">
                                <a href="{{ route('bank.index') }}" class="text-xs font-bold text-blue-300 hover:text-white transition flex items-center gap-1"><i class="ph-bold ph-arrow-left"></i> Kembali</a>
        ...
        {{-- MODAL IMPORT SOAL (Tambahkan di bagian bawah, dekat Modal Edit) --}}
                ...
                <div class="relative transform overflow-hidden rounded-[2.5rem] bg-white text-left shadow-2xl transition-all sm:w-full sm:max-w-md border border-slate-100">
                    ...
                    <form action="{{ route('bank.questions.import', $bank->id) }}" method="POST" enctype="multipart/form-data" class="p-8 space-y-6">
                        ...
                        <div class="bg-indigo-50 p-4 rounded-2xl border border-indigo-100 mb-4">
                            ...
                            <a href="{{ route('bank.questions.template') }}" class="inline-flex items-center gap-1 mt-2 text-xs font-black text-indigo-600 hover:underline">
