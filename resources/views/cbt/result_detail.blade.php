                        ...
                        <div class="flex items-center gap-6">
                            ...
                            <div class="relative w-32 h-32 flex items-center justify-center rounded-full border-8 {{ $examSession->total_score >= $exam->passing_grade ? 'border-emerald-100 bg-emerald-50' : 'border-rose-100 bg-rose-50' }} print:border-black print:bg-white">
                                <div class="text-center">
                                    <span id="displayTotalScore" class="block text-4xl font-black {{ $examSession->total_score >= $exam->passing_grade ? 'text-emerald-600' : 'text-rose-600' }} print:text-black">
                            ...
                            @elseif($qType == 'essay')
                                <div class="space-y-4">
                                    ...
                                    <div class="flex items-center gap-4 bg-white p-4 rounded-xl border border-slate-200 shadow-sm print:hidden">
                                        ...
                                        {{-- PERBAIKAN UTAMA: Gunakan item.answer_id --}}
