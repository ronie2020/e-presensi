<x-app-layout>
    ...
    {{-- 
        ...
        Mencakup: Update Data Otomatis, Rotasi Token, dan Modal Foto Pengawasan
    --}}
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('monitoringData', () => ({
                ...
                init() {
                    // 1. Timer Auto Update Data (Tiap 1 detik kurangi timer)
                    setInterval(() => {
                        if (this.timer > 0) {
                            this.timer--;
                        } else {
                    ...
                    // 2. Logic Token (Load state dari localStorage jika ada)
                    this.loadTokenState();
    ...
    <div class="py-8 sm:py-10 font-sans text-slate-800" x-data="monitoringData">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            {{-- HEADER INFO & TOKEN (Tampilan Atas) --}}
            ...
            <div class="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden min-h-[500px]">
                    ...
                    <table class="w-full text-left text-sm text-slate-600">
                        <thead class="bg-slate-50 text-slate-400 font-bold uppercase text-[10px] tracking-wider border-b border-slate-100">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-center">Keamanan & Perangkat</th> {{-- KOLOM BARU --}}
                ...
                {{-- MOBILE LIST (Sudah termasuk indikator) --}}
        ...
        <div x-show="showPhotoModal" style="display: none;" class="fixed inset-0 z-50 overflow-y-auto">
            <div class="fixed inset-0 bg-slate-900/80 backdrop-blur-sm transition-opacity" @click="showPhotoModal = false"></div>
            <div class="flex min-h-screen items-center justify-center p-4">
                <div class="relative bg-white rounded-[2rem] shadow-2xl max-w-3xl w-full p-8 overflow-hidden">
