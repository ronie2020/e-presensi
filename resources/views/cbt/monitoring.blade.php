    ...
    <div class="py-8 sm:py-10 font-sans text-[#2c3f61]" x-data="monitoringData">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
                ...
                <div class="md:col-span-2 relative rounded-[2rem] bg-gradient-to-r from-[#56bbf1] via-[#e5eff5] to-[#f4d1c0] p-8 text-[#2c3f61] shadow-xl shadow-[#56bbf1]/10 overflow-hidden border border-white/60">
                    ...
                    <div class="relative z-10">
                        <div class="flex flex-wrap items-center gap-3 mb-2">
                            ...
                            @endif
                            <span class="text-[#0d52a1] text-xs font-black uppercase tracking-wider bg-white/40 px-2 py-0.5 rounded border border-white/60">Kelas {{ $exam->class_level }}</span>
                        ...
                        <h1 class="text-3xl font-black tracking-tight leading-none mb-4 text-[#2c3f61]">{{ $exam->title }}</h1>
                        
                        <div class="flex gap-3">
                            <div class="bg-white/60 backdrop-blur-md px-5 py-3 rounded-2xl border border-white/60 text-center min-w-[90px] shadow-sm">
                                <h4 class="text-2xl font-black text-[#0d52a1] leading-none" x-text="stats.working">{{ $stats['working'] }}</h4>
                            ...
                            <div class="bg-emerald-400/20 backdrop-blur-md px-5 py-3 rounded-2xl border border-emerald-400/30 text-center min-w-[90px] shadow-sm">
                                <h4 class="text-2xl font-black text-emerald-700 leading-none" x-text="stats.finished">{{ $stats['finished'] }}</h4>
                ...
                <div class="md:col-span-1 bg-white p-6 rounded-[2.5rem] shadow-xl shadow-[#56bbf1]/10 border border-slate-100 flex flex-col justify-between relative overflow-hidden">
                    <div>
                        ...
                        <div class="flex items-center justify-between gap-3 mb-4">
                            <h2 class="text-5xl font-mono font-black tracking-widest text-[#0d52a1]" x-text="currentToken">{{ $exam->token ?? '-----' }}</h2>
            ...
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                <a href="{{ route('cbt.index') }}" class="group inline-flex items-center gap-2 text-sm font-bold text-slate-400 hover:text-[#0d52a1] transition">
