<x-app-layout>
    ...
    <div class="py-8 sm:py-10 font-sans text-[#2c3f61]">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {{-- HERO SECTION MICROSOFT ELEVATE THEME (With subtle orange edit vibe) --}}
                    ...
                    <form action="{{ route('cbt.update', $exam->id) }}" method="POST" class="space-y-8" 
                            ...
                            <div class="relative flex items-center">
                                ...
                                <select name="cbt_event_id" required class="w-full pl-12 rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-[#56bbf1] focus:ring-[#56bbf1] font-bold text-[#2c3f61] py-3.5 px-5 appearance-none cursor-pointer transition-all @error('cbt_event_id') border-rose-500 @enderror">
                                    ...
                                    @foreach($events as $evt)
                                        <option value="{{ $evt->id }}" {{ old('cbt_event_id', $exam->cbt_event_id) == $evt->id ? 'selected' : '' }}>
                                            {{ $evt->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-6">
                            ...
                            <div class="col-span-1">
                                ...
                                <div class="relative">
                                    <input type="number" name="duration_minutes" value="{{ old('duration_minutes', $exam->duration_minutes) }}" required class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-[#56bbf1] focus:ring-[#56bbf1] font-bold text-[#2c3f61] py-3.5 px-5 transition-all text-center">
                            ...
                            <div class="col-span-1" x-show="examType === 'cbt'">
                                ...
                                <div class="relative">
                                    <input type="number" name="question_limit" value="{{ old('question_limit', $exam->question_limit ?? 0) }}" class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-[#56bbf1] focus:ring-[#56bbf1] font-bold text-[#2c3f61] py-3.5 px-5 transition-all text-center" placeholder="0 = Semua">
                            ...
                            <div class="col-span-1" x-show="examType === 'cbt'">
                                ...
                                <input type="number" name="passing_grade" value="{{ old('passing_grade', $exam->passing_grade) }}" class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-[#56bbf1] focus:ring-[#56bbf1] font-bold text-[#2c3f61] py-3.5 px-5 transition-all text-center">
                            </div>
                             ...
                             <div class="col-span-2 md:col-span-1">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="token" value="{{ old('token', $exam->token) }}" maxlength="6" class="w-full pl-11 rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-[#56bbf1] focus:ring-[#56bbf1] font-mono font-black text-[#2c3f61] py-3.5 px-5 transition-all uppercase tracking-widest placeholder:tracking-normal @error('token') border-rose-500 @enderror" placeholder="KOSONG = TETAP">
                                </div>
