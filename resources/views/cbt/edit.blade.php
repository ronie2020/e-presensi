<x-app-layout>
    ...
    <div class="py-8 sm:py-10 font-sans text-slate-800">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {{-- HERO SECTION (CYAN-BLUE THEME FOR EDIT MODE) --}}
                    ...
                    <form action="{{ route('cbt.update', $exam->id) }}" method="POST" class="space-y-8" 
                        ...
                        <div>
                            ...
                            <input type="text" name="title" value="{{ old('title', $exam->title) }}" required 
                                   class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-cyan-500 focus:ring-cyan-500 font-bold text-slate-700 py-3.5 px-5 transition-all placeholder:font-normal placeholder:text-slate-400 @error('title') border-rose-500 bg-rose-50 @enderror" 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <select name="subject_name" required class="w-full pl-11 rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-cyan-500 focus:ring-cyan-500 font-bold text-slate-700 py-3.5 px-5 appearance-none cursor-pointer transition-all @error('subject_name') border-rose-500 @enderror">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="start_time" x-model="startTime" required 
                                       class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-cyan-500 focus:ring-cyan-500 font-bold text-slate-700 py-3.5 px-5 transition-all @error('start_time') border-rose-500 @enderror">
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="end_time" x-model="endTime" required 
                                       class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-cyan-500 focus:ring-cyan-500 font-bold text-slate-700 py-3.5 px-5 transition-all @error('end_time') border-rose-500 @enderror"
                                       :min="startTime">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-6">
                            ...
                            <div class="col-span-1">
                                ...
                                <div class="relative">
                                    <input type="number" name="duration_minutes" value="{{ old('duration_minutes', $exam->duration_minutes) }}" required class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-cyan-500 focus:ring-cyan-500 font-bold text-slate-700 py-3.5 px-5 transition-all text-center">
                            ...
                            <div class="col-span-1" x-show="examType === 'cbt'">
                                ...
                                <div class="relative">
                                    <input type="number" name="question_limit" value="{{ old('question_limit', $exam->question_limit ?? 0) }}" class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-blue-500 focus:ring-blue-500 font-bold text-slate-700 py-3.5 px-5 transition-all text-center" placeholder="0 = Semua">
                            ...
                            <div class="col-span-1" x-show="examType === 'cbt'">
                                ...
                                <input type="number" name="passing_grade" value="{{ old('passing_grade', $exam->passing_grade) }}" class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-cyan-500 focus:ring-cyan-500 font-bold text-slate-700 py-3.5 px-5 transition-all text-center">
                            </div>
                             ...
                             <div class="col-span-2 md:col-span-1">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="token" value="{{ old('token', $exam->token) }}" maxlength="6" class="w-full pl-11 rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-cyan-500 focus:ring-cyan-500 font-mono font-black text-slate-800 py-3.5 px-5 transition-all uppercase tracking-widest placeholder:tracking-normal @error('token') border-rose-500 @enderror" placeholder="KOSONG = TETAP">
                                </div>
