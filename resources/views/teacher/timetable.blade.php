<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8 relative z-10">
            <div class="relative rounded-[2rem] bg-elevate-gradient-main p-6 sm:p-10 text-elevate-dark shadow-xl shadow-elevate-accent/20 overflow-hidden border border-white/60">
                ...
                <p class="text-elevate-dark/80 text-sm font-semibold max-w-2xl">
                    Pilih mata pelajaran dan kelas pada setiap jam sesuai dengan jadwal yang telah Anda terima. Perubahan akan disimpan secara otomatis.
                </p>
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            @foreach($days as $day)
                                @php
                                    ...
                                    $key = $day . '-' . $slot->id;
                                    $currentLoadId = isset($myTimetables[$key]) ? $myTimetables[$key]->teaching_load_id : '';
                                @endphp
    ...
    <script>
        function autoSaveJadwal(selectElement, day, timeslotId) {
            ...
            // Tampilkan animasi loading kecil
            ...
            .then(data => {
                ...
                if(!data.success) {
                    ...
                    // Reset dropdown ke kosong jika bentrok
                    selectElement.value = '';
                }
            })
            .catch(error => {
