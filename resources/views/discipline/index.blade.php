                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-center gap-6">
                    <div class="text-center md:text-left">
                        <h1 class="text-3xl font-extrabold tracking-tight mb-2 flex items-center justify-center md:justify-start gap-3">
                            <span class="text-4xl">⚖️</span> Catatan Kedisiplinan
                        </h1>
                            ...
                            @forelse ($studentSummaries as $index => $summary)
                                <tr class="hover:bg-blue-50/20 transition-colors group">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="font-bold text-slate-800 group-hover:text-blue-600 transition-colors">{{ $summary->name }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="inline-flex px-2.5 py-1 rounded-lg bg-slate-100 text-xs font-bold text-slate-500 border border-slate-200">{{ $summary->class }}</span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
