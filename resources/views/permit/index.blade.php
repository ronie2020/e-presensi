            ...
            <div class="relative rounded-[2rem] bg-gradient-to-r from-indigo-900 to-slate-900 p-6 mb-8 text-white shadow-xl overflow-hidden border border-white/10">
                ...
                <div class="relative z-10 flex justify-between items-center">
                    ...
                    <div class="hidden md:block text-right">
                        ...
                        <div class="font-bold text-lg">{{ Auth::user()->name ?? 'Administrator' }}</div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center justify-between p-3 bg-slate-50 rounded-xl border border-slate-100">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div class="text-sm font-bold text-slate-700">{{ $history->student->name }}</div>
                                        <div class="text-[10px] text-slate-500">{{ $history->reason_category }} • {{ $history->duration_minutes }} menit</div>
                                    </div>
                                </div>
                ...
                <div class="lg:col-span-7">
                    <div class="bg-white rounded-[2rem] shadow-xl border border-slate-100 overflow-hidden min-h-[500px] flex flex-col">
                        ...
                        <div class="flex-1 overflow-y-auto custom-scrollbar p-4 space-y-3">
                            ...
                            <div class="group relative bg-white p-4 rounded-2xl border-2 {{ $permit->is_overdue ? 'border-rose-100 bg-rose-50/30' : 'border-slate-100' }} hover:shadow-md transition-all animate-enter">
                                <div class="flex justify-between items-start">
                                    <div class="flex gap-4">
                                        ...
                                        <div>
                                            <h4 class="font-bold text-slate-800 text-base">{{ $permit->student->name }}</h4>
                                            ...
                                            @if($permit->notes)
                                                <span class="text-[10px] text-slate-400 italic ml-2">"{{ $permit->notes }}"</span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="text-right">
                                        ...
                                        <div class="text-2xl font-black font-mono {{ $permit->is_overdue ? 'text-rose-600 animate-pulse' : 'text-slate-700' }}">
                                            {{ $permit->minutes_elapsed }}<span class="text-sm text-slate-400 font-normal">m</span>
                                        </div>
