...
<head>
    ...
    {{-- CSS & Meta Tags (Pastikan file landing/styles.blade.php sudah Anda buat dari langkah sebelumnya) --}}
...
<body class="antialiased text-slate-800 bg-slate-50 overflow-x-hidden selection:bg-blue-500 selection:text-white" 
    ...
    {{-- Scripts JS (Pastikan file landing/scripts.blade.php sudah dibuat) --}}
