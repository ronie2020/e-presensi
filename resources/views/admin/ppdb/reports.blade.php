                    ...
                    <div class="flex flex-col sm:flex-row items-center gap-8">
                        <div class="relative w-40 h-40 md:w-48 md:h-48 flex-shrink-0">
                            ...
                            <div class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                                <span class="text-3xl font-black text-[#2A3B52]">{{ $totalRegistrants }}</span>
                        ...
                        <div class="flex-1 w-full space-y-3">
                            ...
                            <div class="flex justify-between items-center p-3 rounded-lg border {{ $stat['bg'] }} {{ $stat['border'] }} hover:shadow-sm transition-shadow">
                                ...
                                <span class="font-black text-[#2A3B52] text-sm">{{ $stat['val'] }}</span>
                            </div>
                            @endforeach
                        </div>
                    </div>
                ...
                <div class="animate-enter delay-100 bg-white rounded-xl p-6 md:p-8 fluent-card relative overflow-hidden flex flex-col group">
                    ...
                    <div class="grid grid-cols-2 gap-4 flex-1">
                        ...
                        <div class="bg-[#F3F9FD] border border-[#D0E7F8] rounded-xl p-5 flex flex-col justify-center hover:bg-[#E3F2FD] transition-colors shadow-sm">
                            ...
                            <span class="text-3xl font-extrabold text-[#2A3B52]">{{ $genderStats['L'] }}</span>
                        ...
                        <div class="bg-[#FDE7E9] border border-[#F4C3C9] rounded-xl p-5 flex flex-col justify-center hover:bg-[#FCE0E3] transition-colors shadow-sm">
                            ...
                            <span class="text-3xl font-extrabold text-[#2A3B52]">{{ $genderStats['P'] }}</span>
                        ...
                        <div class="col-span-2 bg-[#DFF6DD] border border-[#B7DFB9] rounded-xl p-6 text-[#107C10] relative overflow-hidden flex items-center justify-between fluent-card">
                            ...
                            <div class="relative z-10">
                                ...
                                <p class="text-4xl font-black text-[#107C10] tracking-tight">{{ $totalAccepted }} <span class="text-sm font-bold text-[#107C10]/80">Siswa</span></p>
                            </div>
            ...
            <div class="animate-enter delay-200 border-t border-slate-200 pt-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    ...
                    <div class="bg-white rounded-xl p-6 fluent-card group flex flex-col h-full hover:border-[#107C10]">
                        ...
                        <a href="{{ route('admin.ppdb.export.excel') }}" class="flex items-center justify-center gap-2 w-full py-2.5 bg-[#107C10] text-white font-bold rounded-lg text-sm hover:bg-[#0c5e0c] transition-all shadow-sm">
                    ...
                    <div class="bg-white rounded-xl p-6 fluent-card group flex flex-col h-full hover:border-[#D13438]">
                        ...
                        <a href="{{ route('admin.ppdb.print.recap') }}" target="_blank" class="flex items-center justify-center gap-2 w-full py-2.5 bg-[#D13438] text-white font-bold rounded-lg text-sm hover:bg-[#a62529] transition-all shadow-sm">
                    ...
                    <div class="bg-white rounded-xl p-6 fluent-card group flex flex-col h-full hover:border-[#5295FF]">
                        ...
                        <a href="{{ route('admin.ppdb.print.mass_letters') }}" target="_blank" class="flex items-center justify-center gap-2 w-full py-2.5 bg-[#5295FF] text-white font-bold rounded-lg text-sm hover:bg-[#3b7ee6] transition-all shadow-sm">
