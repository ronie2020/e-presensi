                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <div class="flex gap-1.5">
                                            ...
                                            <div class="w-full">
                                                <input type="time" name="start_in[]" value="{{ optional($regularSchedules->get('Biasa'))->start_in ? \Carbon\Carbon::parse($regularSchedules->get('Biasa')->start_in)->format('H:i') : '' }}" class="w-full rounded-xl border-slate-200 text-xs font-bold text-center bg-white py-2.5 shadow-sm focus:ring-blue-500" title="Jam Buka Scanner Masuk">
                                                <p class="text-[9px] text-slate-400 text-center mt-1">Buka Scan</p>
                                            </div>
                                            <div class="w-full">
                                                <input type="time" name="end_in[]" value="{{ optional($regularSchedules->get('Biasa'))->end_in ? \Carbon\Carbon::parse($regularSchedules->get('Biasa')->end_in)->format('H:i') : '' }}" class="w-full rounded-xl border-slate-200 text-xs font-bold text-center bg-white py-2.5 shadow-sm focus:ring-blue-500" title="Batas Terlambat">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex gap-1.5">
                                            <div class="w-full">
                                                <input type="time" name="start_out[]" value="{{ optional($regularSchedules->get('Biasa'))->start_out ? \Carbon\Carbon::parse($regularSchedules->get('Biasa')->start_out)->format('H:i') : '' }}" class="w-full rounded-xl border-slate-200 text-xs font-bold text-center bg-white py-2.5 shadow-sm focus:ring-blue-500" title="Jam Boleh Pulang">
                                                <p class="text-[9px] text-slate-400 text-center mt-1">Boleh Plg</p>
                                            </div>
                                            <div class="w-full">
                                                <input type="time" name="end_out[]" value="{{ optional($regularSchedules->get('Biasa'))->end_out ? \Carbon\Carbon::parse($regularSchedules->get('Biasa')->end_out)->format('H:i') : '' }}" class="w-full rounded-xl border-slate-200 text-xs font-bold text-center bg-white py-2.5 shadow-sm focus:ring-blue-500" title="Tutup Scanner Pulang">
