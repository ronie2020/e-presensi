    ...
    <div class="py-8 font-sans text-slate-800">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-4 mb-8">
                <a href="{{ route('admin.alumni.index') }}" class="p-3 bg-white rounded-xl border border-gray-200 hover:bg-gray-50 transition shadow-sm">
            ...
            {{-- 
                PERBAIKAN: MENAMBAHKAN ALERT MESSAGE 
                Agar tahu jika ada error atau sukses
            --}}
            @if(session('success'))
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="bg-slate-50 rounded-3xl p-8 border border-slate-200 h-fit">
                    ...
                    <a href="{{ route('admin.alumni.template') }}" class="w-full py-3 bg-white border border-slate-300 hover:border-slate-400 text-slate-700 font-bold rounded-xl shadow-sm transition-all flex items-center justify-center gap-2 group">
