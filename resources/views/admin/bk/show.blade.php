        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-[2.5rem] p-6 md:p-8 shadow-sm border {{ $isLocked ? 'border-emerald-100' : 'border-slate-100' }} mt-6 break-inside-avoid relative overflow-hidden">
                        @if($isLocked)
                        ...
                        <form id="jurnalForm" action="{{ route('admin.bk.store_record', $session->id) }}" method="POST" class="relative z-10">
                            @csrf
                            <div class="space-y-6">
                                <div>
