                ...
                <div class="lg:col-span-1">
                    <div class="bg-white p-8 rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 relative overflow-hidden">
                        ...
                        <p class="text-xs text-slate-500 font-medium mb-6 leading-relaxed">
                            Proses ini akan menyimpan saldo poin terakhir dari <strong class="text-elevate-dark">{{ $activeStudentsCount }} siswa aktif</strong> ke tabel riwayat, lalu mereset saldo poin aktif mereka kembali menjadi 0.
                        </p>
