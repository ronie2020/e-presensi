                ...
                <div class="absolute top-0 right-0 w-64 h-64 bg-white opacity-10 rounded-full -translate-y-1/2 translate-x-1/3 blur-3xl"></div>
                 ...
                 <div class="relative shrink-0" data-aos="zoom-in">
                    ...
                    <div class="w-48 h-48 md:w-64 md:h-64 rounded-full border-4 border-white/20 p-2 relative z-10 bg-white/10 backdrop-blur-sm">
                        <img src="{{ asset('images/kasek.png') }}" alt="Kepala Sekolah" class="w-full h-full object-cover rounded-full filter grayscale hover:grayscale-0 transition-all duration-500 bg-blue-900">
                    </div>
