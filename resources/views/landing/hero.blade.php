...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
    <div class="grid lg:grid-cols-2 gap-10 lg:gap-8 items-center">
        ...
        {{-- Penambahan efek pergerakan teks (parallax) responsif terhadap mouse --}}
        <div class="max-w-2xl text-center lg:text-left mx-auto lg:mx-0 w-full min-w-0" 
            ...
            {{-- Badge Status & Identitas Sekolah --}}
            <div class="flex flex-wrap items-center justify-center lg:justify-start gap-2 mb-6 w-fit max-w-full mx-auto lg:mx-0">
                <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-3xl bg-white/10 border border-white/20 text-elevate-surface text-[10px] sm:text-xs font-bold uppercase tracking-wider backdrop-blur-md shadow-sm">
            ...
            {{-- Judul Utama dengan Parallax Effect --}}
            <h1 class="text-[1.75rem] leading-[1.1] sm:text-5xl lg:text-6xl xl:text-7xl font-black text-white tracking-tight mb-4 sm:mb-6 break-words w-full"
                :style="`transform: translate(${mouseX * 0.01}px, ${mouseY * 0.01}px); transition: transform 0.1s ease-out;`">
            ...
            <p class="text-xs sm:text-base md:text-lg text-slate-100 mb-6 sm:mb-8 leading-relaxed max-w-xl mx-auto lg:mx-0 font-medium opacity-90 break-words w-full"
               :style="`transform: translate(${mouseX * 0.005}px, ${mouseY * 0.005}px); transition: transform 0.1s ease-out;`">
