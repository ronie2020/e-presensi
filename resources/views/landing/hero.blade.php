...
<section id="home" class="relative pt-32 pb-40 md:pt-48 md:pb-40 lg:pt-56 lg:pb-48 overflow-hidden bg-gradient-to-br from-elevate-dark to-elevate-primary block w-full max-w-[100vw]">
        ...
        <div class="grid lg:grid-cols-2 gap-10 lg:gap-8 items-center">
            ...
            <div class="max-w-2xl text-center lg:text-left mx-auto lg:mx-0 w-full min-w-0" 
                ...
                <div class="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start mb-10 w-full mx-auto sm:px-0">
                    <a href="{{ route('ppdb.create') }}" class="group relative px-4 sm:px-6 py-3.5 rounded-full bg-white text-elevate-primary font-bold text-xs sm:text-sm shadow-lg shadow-white/10 hover:bg-slate-50 hover:-translate-y-1 transition-all overflow-hidden w-full sm:w-auto flex justify-center items-center gap-2">
            ...
            <div class="relative w-full max-w-lg mx-auto lg:ml-auto mt-12 lg:mt-0 min-w-0"
                ...
                <div class="relative w-full">
                    ...
                    <!-- Shape Bawah -->
                    <div class="absolute -bottom-4 -right-2 sm:-bottom-8 sm:-right-6 w-28 h-28 sm:w-48 sm:h-48 bg-elevate-accent/40 backdrop-blur-md blur-[2px] border border-white/30 rounded-[2.5rem] shadow-lg transform -rotate-12 z-0 pointer-events-none"></div>
                    <div class="absolute -bottom-6 -left-4 sm:-bottom-10 sm:-left-8 w-24 h-32 sm:w-36 sm:h-40 bg-elevate-primary/30 backdrop-blur-lg blur-[3px] rounded-[2rem] shadow-2xl transform rotate-12 z-0 pointer-events-none"></div>
                    ...
                    <div class="relative z-10 w-full rounded-[2rem] overflow-hidden border-[4px] sm:border-[6px] border-white/80 dark:border-elevate-dark/80 shadow-2xl bg-white/95 dark:bg-elevate-dark/95 backdrop-blur-xl flex flex-col p-4 sm:p-6 lg:p-8 transform hover:scale-[1.02] transition duration-500 max-w-full">
                        ...
                        <div class="absolute inset-0 flex flex-col items-center justify-center opacity-[0.03] dark:opacity-5 pointer-events-none z-0 select-none">
                            <i class="ph-fill ph-shield-check text-[5rem] sm:text-[7rem] text-elevate-dark dark:text-elevate-accent mb-1"></i>
                            <span class="text-xl sm:text-2xl font-black text-elevate-dark dark:text-elevate-accent tracking-widest uppercase text-center leading-tight">Sistem<br>Terintegrasi</span>
                        </div>
                        ...
                        {{-- Absolute inset-0 di dalam container dengan tinggi tetap --}}
    ...
    <div class="absolute bottom-0 left-0 right-0 pointer-events-none translate-y-[1px] z-20">
         <!-- Menyatu dengan bg-slate-50 (body) atau mode gelap -->
