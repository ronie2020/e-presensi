<!-- LIBRARY SECTION -->
    <div class="py-24 bg-blue-50/50 dark:bg-slate-900 border-y border-blue-100/50 dark:border-slate-800 relative overflow-hidden transition-colors duration-300">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
            <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
                <div class="w-full lg:w-5/12" data-aos="fade-right">
                    <!-- Badge -->
                    <span class="inline-flex items-center py-1.5 px-3 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-cyan-400 text-[10px] sm:text-xs font-bold uppercase tracking-wider mb-6 border border-blue-200 dark:border-blue-500/20">
                    ...
                    <h2 class="text-3xl lg:text-4xl font-extrabold text-slate-900 dark:text-white tracking-tight mb-6 break-words">
                        ...
                        <span class="text-blue-600 dark:text-cyan-400">Jelajahi Dunia</span>
                    </h2>
                    ...
                    <div class="grid grid-cols-2 gap-3 sm:gap-6 w-full">
                        <div class="bg-white dark:bg-slate-800 p-3 sm:p-6 rounded-2xl shadow-lg shadow-blue-100 dark:shadow-none border border-blue-50 dark:border-slate-700 min-w-0 overflow-hidden">
                            ...
                            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 mb-2">
                                <div class="p-1.5 sm:p-2 bg-blue-100 dark:bg-blue-900/50 rounded-lg text-blue-600 dark:text-blue-400 shrink-0"><i class="ph-bold ph-users text-sm sm:text-base"></i></div>
                                <p class="text-[9px] sm:text-xs font-bold text-slate-400 uppercase tracking-wide truncate w-full">Pengunjung</p>
                            </div>
                            <p class="text-2xl sm:text-4xl font-black text-slate-800 dark:text-white truncate">{{ $libraryStats['visitors_today'] ?? 0 }}</p>
                            <p class="text-[10px] sm:text-xs text-blue-600 dark:text-blue-400 font-medium mt-1 truncate">Hari ini</p>
                        </div>
                        
                        <div class="bg-white dark:bg-slate-800 p-3 sm:p-6 rounded-2xl shadow-lg shadow-blue-100 dark:shadow-none border border-blue-50 dark:border-slate-700 min-w-0 overflow-hidden">
                            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 mb-2">
                                <div class="p-1.5 sm:p-2 bg-cyan-100 dark:bg-cyan-900/50 rounded-lg text-cyan-600 dark:text-cyan-400 shrink-0"><i class="ph-bold ph-book-bookmark text-sm sm:text-base"></i></div>
                                <p class="text-[9px] sm:text-xs font-bold text-slate-400 uppercase tracking-wide truncate w-full">Dipinjam</p>
                            </div>
                            <p class="text-2xl sm:text-4xl font-black text-slate-800 dark:text-white truncate">{{ $libraryStats['books_borrowed'] ?? 0 }}</p>
                            <p class="text-[10px] sm:text-xs text-cyan-600 dark:text-cyan-400 font-medium mt-1 truncate">Buku Aktif</p>
                        </div>
                    </div>
                </div>
