    ...
    <section class="py-20 bg-slate-50 relative overflow-hidden border-b border-slate-100">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <a href="{{ route('ppdb.create') }}" class="group relative bg-white rounded-[2rem] p-8 shadow-xl shadow-slate-200/50 border border-slate-100 hover:-translate-y-2 hover:shadow-cyan-900/10 transition-all duration-300 h-full flex flex-col">
                ...
                <a href="{{ route('ppdb.collective') }}" class="group relative bg-gradient-to-br from-cyan-700 to-blue-900 rounded-[2rem] p-8 shadow-xl shadow-cyan-900/30 border border-blue-800 hover:-translate-y-2 hover:shadow-cyan-900/40 transition-all duration-300 transform md:scale-105 md:-mt-4 ring-4 ring-cyan-500/20 h-full flex flex-col">
                ...
                <a href="{{ route('ppdb.check') }}" class="group relative bg-white rounded-[2rem] p-8 shadow-xl shadow-slate-200/50 border border-slate-100 hover:-translate-y-2 hover:shadow-blue-900/10 transition-all duration-300 h-full flex flex-col">
