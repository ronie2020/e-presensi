            ...
            <div class="grid gap-6 md:grid-cols-3">
                @forelse ($announcements as $index => $item)
                    ...
                    <article class="bg-slate-900/50 backdrop-blur-md rounded-2xl p-6 border border-slate-800 hover:border-cyan-500/50 transition-all duration-300 hover:bg-slate-900 hover:-translate-y-1 group h-full flex flex-col cursor-pointer" @click="openAnnouncementByIndex({{ $index }})" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
                        ...
                        <h3 class="text-lg font-bold text-white mb-3 line-clamp-2 group-hover:text-cyan-400 transition-colors">{{ $item->title }}</h3>
        ...
        <div class="bg-slate-900/50 rounded-3xl p-8 mb-16 border border-slate-800 backdrop-blur-md">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                @forelse($agendas as $agenda)
                    ...
                    <div class="bg-slate-800/50 p-4 rounded-xl border-l-4 border-{{ $color }}-500 flex items-start gap-4 hover:bg-slate-800 transition cursor-default group h-full">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16 border-t border-slate-800 pt-16">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-slate-400">
                    ...
                    <li><a href="{{ route('login') }}" class="hover:text-cyan-400 transition-colors flex items-center gap-2"><i class="ph-bold ph-caret-right text-xs"></i> Login Staff</a></li>
                </ul>
            </div>
            <div>
