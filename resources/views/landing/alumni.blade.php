         ...
         <!-- SLIDER TESTIMONI ALUMNI -->
            @if(isset($alumniTestimonials) && count($alumniTestimonials) > 0)
                        ...
                        <div class="min-w-[300px] md:min-w-[400px] bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-xl relative snap-center group hover:-translate-y-2 transition-transform duration-300 border border-transparent dark:border-slate-700">
                            ...
                            <div class="relative z-10 h-full flex flex-col">
                                <div class="flex items-center gap-4 mb-6">
                                    ...
                                    <div>
                                        <h4 class="font-bold text-elevate-dark dark:text-white text-base line-clamp-1">{{ $testi->student->name ?? 'Alumni' }}</h4>
                ...
                <div class="mt-12 text-center" data-aos="fade-up">
                    <a href="{{ route('public.testimonials') }}" class="inline-flex items-center justify-center px-8 py-3 text-sm font-bold text-white bg-elevate-primary/80 border border-elevate-primary rounded-full hover:bg-elevate-primary transition-all shadow-lg hover:shadow-elevate-primary/30 group">
