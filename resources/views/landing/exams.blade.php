                            ...
                            <div class="bg-slate-50 dark:bg-slate-800/50 rounded-[1.5rem] p-4 border border-slate-100 dark:border-slate-700 mb-6 flex-1 transition-colors">
                                ...
                                <div class="flex items-center gap-3 text-xs mb-4">
                                    ...
                                    <div class="flex flex-col gap-0.5">
                                        ...
                                        <span class="font-black text-elevate-dark dark:text-slate-200 text-xs">{{ $startTime->translatedFormat('d M Y, H:i') }}</span>
                                    </div>
                                </div>
                                <!-- Baris Akhir -->
                                <div class="flex items-center gap-3 text-xs">
                                    ...
                                    <div class="flex flex-col gap-0.5">
                                        ...
                                        <span class="font-black text-elevate-dark dark:text-slate-200 text-xs">{{ $endTime ? $endTime->translatedFormat('d M Y, H:i') : 'Tidak dibatasi' }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
