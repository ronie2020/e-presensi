...
<section id="ebooks" class="py-24 bg-slate-50 dark:bg-slate-950 relative overflow-hidden border-t border-slate-100 dark:border-slate-900 transition-colors duration-300">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="flex flex-col md:flex-row justify-between items-end mb-12 gap-6" data-aos="fade-up">
            ...
            <a href="{{ route('library.catalogue') }}" class="hidden md:inline-flex items-center px-6 py-3 rounded-full text-xs font-bold text-elevate-dark dark:text-slate-300 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700 hover:text-elevate-primary dark:hover:text-elevate-accent transition-all shadow-sm group">
                ...
                <div class="group bg-white dark:bg-slate-900 rounded-[2rem] p-3 border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-xl hover:shadow-elevate-dark/5 dark:hover:shadow-elevate-accent/5 hover:-translate-y-2 transition-all duration-500 hover:border-elevate-accent/30 dark:hover:border-elevate-accent/50 flex flex-col h-full relative" data-aos="fade-up" data-aos-delay="{{ $loop->iteration * 100 }}">
                    ...
                    <div class="relative aspect-[2/3] rounded-[1.5rem] overflow-hidden mb-4 bg-slate-100 dark:bg-slate-800 shadow-inner group-hover:shadow-md transition-shadow">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-t from-elevate-dark/95 via-elevate-dark/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-4">
                            <a href="{{ route('library.books.read', $book->id) }}" class="w-full py-2.5 bg-elevate-accent hover:bg-white text-elevate-dark text-[10px] font-black uppercase tracking-widest rounded-xl flex items-center justify-center gap-2 shadow-lg transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                    ...
                    <div class="px-1 flex flex-col flex-1">
                        <h3 class="text-elevate-dark dark:text-white font-black text-sm md:text-base line-clamp-2 leading-snug mb-2 group-hover:text-elevate-primary dark:group-hover:text-elevate-accent transition-colors" title="{{ $book->title }}">
                            {{ $book->title }}
                        </h3>
        ...
        <div class="mt-10 text-center md:hidden" data-aos="fade-up">
            <a href="{{ route('library.catalogue') }}" class="inline-flex items-center justify-center px-8 py-3.5 text-xs font-bold text-elevate-primary dark:text-white bg-elevate-soft dark:bg-elevate-primary border border-elevate-accent/30 dark:border-transparent rounded-full hover:bg-white dark:hover:bg-elevate-dark transition-all shadow-sm group">
                Lihat Katalog Lengkap
                <i class="ph-bold ph-arrow-right ml-2 group-hover:translate-x-1 transition-transform"></i>
            </a>
        </div>
