...
@section('content')
    {{-- HEADER SECTION (Tema Diselaraskan: Elevate Light Glassmorphism) --}}
    <div class="relative pt-32 pb-24 rounded-b-[3rem] shadow-sm border-b border-slate-200/50 overflow-hidden -mt-24 mb-12 bg-white">
        ...
        <div class="absolute inset-0 z-0">
            ...
            {{-- 2. OVERLAY BRIGHT (Glassmorphism untuk Tema Elevate) --}}
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
            ...
            @forelse($testimonials as $index => $testi)
                <div class="animate-enter bg-elevate-surface rounded-[2rem] p-8 shadow-sm border border-slate-100 hover:shadow-xl hover:shadow-elevate-accent/10 hover:border-elevate-accent/40 hover:-translate-y-2 transition-all duration-500 flex flex-col h-full relative group overflow-hidden"
                    ...
                    <div class="flex items-center gap-4 mb-6 relative z-10">
                        ...
                        <div class="min-w-0">
                            <h4 class="font-bold text-elevate-dark text-base truncate group-hover:text-elevate-primary transition-colors" title="{{ $testi->student->name ?? 'Alumni' }}">
        ...
        <div class="animate-enter relative bg-elevate-gradient-main rounded-[2.5rem] p-8 md:p-16 text-center shadow-lg overflow-hidden group border border-white/60">
            ...
            <div class="relative z-10 max-w-2xl mx-auto">
                ...
                @auth('student')
                    <a href="{{ route('alumni.tracer') }}" class="inline-flex items-center justify-center px-8 py-4 text-sm font-bold text-white bg-elevate-dark rounded-full hover:bg-elevate-dark/90 hover:-translate-y-1 transition-all shadow-lg shadow-elevate-dark/20 group">
                        <i class="ph-bold ph-pencil-simple mr-2 text-lg"></i> Tulis Testimoni
                    </a>
                @else
                    <a href="{{ route('student.login') }}" class="inline-flex items-center justify-center px-8 py-4 text-sm font-bold text-white bg-elevate-dark rounded-full hover:bg-elevate-dark/90 hover:-translate-y-1 transition-all shadow-lg shadow-elevate-dark/20 group">
