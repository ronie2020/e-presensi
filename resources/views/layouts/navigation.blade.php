<nav 
    ...
    <div class="relative z-10 flex-1 overflow-y-auto py-6 px-4 space-y-8 custom-scrollbar">
        ...
        @php
            // DEFINISI MENU ARRAY
            // Menambah menu baru cukup tambahkan array di sini, tidak perlu copy-paste kode HTML panjang.
            $menus = [
                'Menu Utama' => [
                    [
                        'name' => 'Dashboard',
                        'route' => 'dashboard',
                        'icon' => 'M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z'
                    ],
                    [
                        'name' => 'Scan Aktifitas',
                        'route' => 'scan.show',
