...
<body>
    ...
    <table class="meta-table">
        <tr>
            ...
            <td width="10">:</td>
            <td width="300">{{ \Carbon\Carbon::parse($date)->translatedFormat('l, d F Y') }}</td>
            
            <td class="meta-title">Kelas</td>
            <td width="10">:</td>
            <td>{{ $class->name ?? 'Semua Kelas' }}</td>
        </tr>
        <tr>
    ...
    <table class="data">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="left" style="text-transform: uppercase;">{{ $student->name }}</td>
