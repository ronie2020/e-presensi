...
@section('content')
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 pb-20 pt-24">
        ...
        <div class="space-y-8">
                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    ...
                    <div class="bg-white/10 backdrop-blur-md px-5 py-3 rounded-2xl border border-white/20 flex items-center gap-3 shrink-0">
                        <div class="text-right">
                            ...
                            <p class="text-xl font-black">{{ \Carbon\Carbon::now()->translatedFormat('d F Y') }}</p>
                        </div>
                    ...
                    <div class="bg-white rounded-[2.5rem] p-10 text-center border border-blue-100 shadow-sm relative overflow-hidden group">
                        ...
                        <div class="relative z-10">
                            ...
                            <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
                                <div class="bg-white px-8 py-4 rounded-2xl shadow-sm border border-slate-100 flex items-center gap-4">
                                    <div class="text-left">
                                        ...
                                        <p class="text-xl font-black text-slate-800">{{ $todayEntry->habit_1_time ?? '-' }}</p>
                                    </div>
                            ...
                            <div class="flex justify-center">
                                <a href="{{ route('student.habits.dashboard') }}" class="inline-flex items-center gap-2 px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl shadow-lg shadow-blue-600/20 transition-all hover:scale-105">
                        ...
                        <div class="bg-gradient-to-br from-indigo-600 to-blue-700 rounded-[2rem] p-8 text-white shadow-xl shadow-blue-200 relative overflow-hidden group">
                            <div class="relative z-10">
                                ...
                                <div class="bg-white/10 backdrop-blur-md p-5 rounded-2xl border border-white/20 shadow-inner">
                                    <p class="italic text-base leading-relaxed font-medium">"{{ $todayEntry->teacher_feedback }}"</p>
                                </div>
                            </div>
                        </div>
                    @endif
            ...
            @else
                ...
                <form action="{{ route('student.habits.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8 animate-enter" x-data="{
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <!-- 1. BANGUN PAGI -->
                        <div class="bg-white p-6 rounded-3xl shadow-sm border {{ $errors->has('habit_1_time') ? 'border-red-300 bg-red-50' : 'border-slate-100' }} hover:border-blue-400 transition-all hover:-translate-y-1 group">
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center justify-between mb-2">
                                        ...
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            <input type="checkbox" name="check_1" x-model="habit1" class="sr-only peer" {{ old('check_1') ? 'checked' : '' }}>
                                    ...
                                    <div x-show="habit1" x-collapse>
                                        <div class="grid grid-cols-2 gap-3 mt-4">
                                            <div>
                                                ...
                                                <input type="time" name="habit_1_time" value="{{ old('habit_1_time') }}" class="w-full text-sm rounded-xl border-slate-200 bg-slate-50 focus:ring-blue-500">
                                                @error('habit_1_time') <p class="text-[10px] text-red-500 font-bold mt-1">{{ $message }}</p> @enderror
                                            </div>
                                            <div>
                                                <label class="text-[10px] font-bold text-slate-400 uppercase block mb-1">Ibadah</label>
                                                <input type="text" name="habit_1_note" value="{{ old('habit_1_note') }}" placeholder="Sholat Subuh" class="w-full text-sm rounded-xl border-slate-200 bg-slate-50 focus:ring-blue-500">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center justify-between mb-2">
                                        ...
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            <input type="checkbox" name="check_3" x-model="habit3" class="sr-only peer" {{ old('check_3') ? 'checked' : '' }}>
                                            <div class="w-12 h-7 bg-slate-200 rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-6 after:w-6 after:transition-all peer-checked:bg-blue-600"></div>
                                        </label>
                                    </div>
                                    <div x-show="habit3" x-collapse>
                                        <input type="text" name="habit_3_activity" value="{{ old('habit_3_activity') }}" placeholder="Jenis Olahraga" class="mt-2 w-full text-sm rounded-xl border-slate-200 bg-slate-50 focus:ring-blue-500">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center justify-between mb-2">
                                        ...
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            <input type="checkbox" name="check_4" x-model="habit4" class="sr-only peer" {{ old('check_4') ? 'checked' : '' }}>
                                            <div class="w-12 h-7 bg-slate-200 rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-6 after:w-6 after:transition-all peer-checked:bg-blue-600"></div>
                                        </label>
                                    </div>
                                    <div x-show="habit4" x-collapse>
                                        <input type="text" name="habit_4_subject" value="{{ old('habit_4_subject') }}" placeholder="Materi yang dipelajari" class="mt-2 w-full text-sm rounded-xl border-slate-200 bg-slate-50 focus:ring-blue-500">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center justify-between mb-2">
                                        ...
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            <input type="checkbox" name="check_5" x-model="habit5" class="sr-only peer" {{ old('check_5') ? 'checked' : '' }}>
                                            <div class="w-12 h-7 bg-slate-200 rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-6 after:w-6 after:transition-all peer-checked:bg-blue-600"></div>
                                        </label>
                                    </div>
                                    <div x-show="habit5" x-collapse>
                                        <textarea name="habit_5_menu" rows="2" placeholder="Menu makanan" class="mt-2 w-full text-sm rounded-xl border-slate-200 bg-slate-50 focus:ring-blue-500">{{ old('habit_5_menu') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center justify-between mb-2">
                                        ...
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            <input type="checkbox" name="check_6" x-model="habit6" class="sr-only peer" {{ old('check_6') ? 'checked' : '' }}>
                                            <div class="w-12 h-7 bg-slate-200 rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-6 after:w-6 after:transition-all peer-checked:bg-blue-600"></div>
                                        </label>
                                    </div>
                                    <div x-show="habit6" x-collapse>
                                        <textarea name="habit_6_activity" rows="2" placeholder="Membantu orang tua" class="mt-2 w-full text-sm rounded-xl border-slate-200 bg-slate-50 focus:ring-blue-500">{{ old('habit_6_activity') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center justify-between mb-2">
                                        ...
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            <input type="checkbox" name="check_7" x-model="habit7" class="sr-only peer" {{ old('check_7') ? 'checked' : '' }}>
                                            <div class="w-12 h-7 bg-slate-200 rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-6 after:w-6 after:transition-all peer-checked:bg-blue-600"></div>
                                        </label>
                                    </div>
                                    <div x-show="habit7" x-collapse>
                                        <div class="flex items-center gap-4 mt-2">
                                            ...
                                            <input type="time" name="habit_7_time" value="{{ old('habit_7_time') }}" class="w-32 text-sm rounded-xl border-slate-200 bg-slate-50 focus:ring-blue-500">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    {{-- UPLOAD BUKTI --}}
                    <div class="bg-white p-8 rounded-3xl shadow-sm border {{ $errors->has('habit_photo') ? 'border-red-300 bg-red-50' : 'border-slate-100' }} text-center">
                        <h3 class="font-bold text-slate-800 text-lg mb-4">Bukti Dokumentasi Hari Ini <span class="text-red-500">*</span></h3>
                        
                        @error('habit_photo') <p class="text-red-600 font-bold text-sm mb-3">{{ $message }}</p> @enderror

                        <div class="flex justify-center w-full">
                            <label for="habit_photo" class="flex flex-col items-center justify-center w-full h-64 border-2 {{ $errors->has('habit_photo') ? 'border-red-300' : 'border-slate-300' }} border-dashed rounded-3xl cursor-pointer bg-slate-50 hover:bg-blue-50 hover:border-blue-400 transition-all group relative overflow-hidden">
            ...
            {{-- RIWAYAT JURNAL & FEEDBACK GURU (BAGIAN BAWAH) --}}
                                ...
                                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                    <div class="flex items-center gap-4">
                                        <div class="w-12 h-12 rounded-xl bg-slate-50 border border-slate-100 flex flex-col items-center justify-center shrink-0 group-hover:bg-blue-50 group-hover:border-blue-100 transition-colors">
                                            <span class="text-[10px] font-bold text-slate-400 group-hover:text-blue-400 uppercase">{{ $item->report_date->translatedFormat('D') }}</span>
                                            <span class="text-lg font-black text-slate-700 group-hover:text-blue-600">{{ $item->report_date->format('d') }}</span>
                                        </div>
                                        <div>
                                            <h4 class="font-bold text-slate-800 text-sm">
                                                {{ $item->habit_1 ? 'Bangun Pukul ' . $item->habit_1_time : 'Jurnal Kebiasaan' }}
                                            </h4>
                                            <div class="flex gap-2 mt-1">
                                                @if($item->habit_3) <span class="text-[9px] bg-blue-50 text-blue-600 px-1.5 py-0.5 rounded border border-blue-100 font-bold uppercase">Olahraga</span> @endif
                                                @if($item->habit_4) <span class="text-[9px] bg-indigo-50 text-indigo-600 px-1.5 py-0.5 rounded border border-indigo-100 font-bold uppercase">Belajar</span> @endif
                                            </div>
                                        </div>
                                    </div>
