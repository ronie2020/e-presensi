                ...
                <div class="p-8 sm:p-10">
                    ...
                    <div class="flex items-center gap-4 p-4 bg-slate-50 rounded-2xl border border-slate-100 mb-8">
                        ...
                        <div>
                            ...
                            <h3 class="font-bold text-slate-800 text-lg leading-tight">{{ auth()->user()->name ?? $student->name }}</h3>
                            <p class="text-sm text-blue-600 font-medium">{{ $student->schoolClass->name ?? 'Kelas Tidak Ditemukan' }}</p>
                        </div>
                    </div>
                        ...
                        <div class="text-center py-6">
                            ...
                            <div class="mt-8 grid grid-cols-2 gap-4 text-left max-w-sm mx-auto bg-slate-50 p-4 rounded-2xl border border-slate-100">
                                <div>
                                    ...
                                    <p class="font-mono font-bold text-slate-700">{{ $student->student_id }}</p>
                                </div>
                                <div>
                                    <p class="text-xs font-bold text-slate-400 uppercase mb-1">NIK</p>
                                    <p class="font-mono font-bold text-slate-700">{{ $student->nik }}</p>
                                </div>
                            </div>
                        </div>
                    @else
