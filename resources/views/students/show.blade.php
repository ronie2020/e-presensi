...
<body class="bg-gray-100 min-h-screen p-8 font-serif text-gray-900">
    ...
    <div class="max-w-[210mm] mx-auto bg-white shadow-lg p-[15mm] min-h-[297mm] relative">
            ...
            <div class="w-2/3">
                <table class="w-full text-sm">
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td class="uppercase font-bold">{{ $student->name }}</td>
                    </tr>
                </table>
            </div>
            <div class="w-28 h-36 border border-gray-300 flex items-center justify-center bg-gray-50">
                @if($student->photo_path)
                    <img src="{{ asset('storage/' . $student->photo_path) }}" class="w-full h-full object-cover" alt="Foto">
                @else
        ...
        <table class="table-induk">
            {{-- NOMOR DILANJUTKAN DARI 15 MENJADI 16 --}}
            <tr>
        ...
        <table class="table-induk">
            <tr>
                ...
                <td class="separator">:</td>
                <td class="value-col">{{ $student->prev_school_name ?? '-' }}</td>
            </tr>
            <tr>
