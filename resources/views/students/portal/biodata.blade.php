...
<head>
    ...
    <title>Biodata Lengkap - {{ $student->name }}</title>
...
<body class="min-h-screen py-8 text-elevate-text ui-sans relative">
    ...
    <div class="max-w-[210mm] mx-auto mb-6 flex flex-col sm:flex-row justify-between items-center gap-4 no-print bg-white/80 backdrop-blur-md p-4 rounded-2xl shadow-lg border border-white/60 sticky top-4 z-50">
        ...
        <div class="flex flex-wrap gap-3 items-center">
            ...
            <a href="{{ route('portal.show', $student->id) }}" class="px-4 py-2.5 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-600 hover:bg-slate-50 flex items-center gap-2 group">
    ...
    <div class="a4-paper-container max-w-[210mm] mx-auto bg-white shadow-2xl rounded-lg p-[15mm] min-h-[297mm] relative border border-slate-200 text-black">
        ...
        <div class="font-serif"> 
            ...
            <table class="table-induk">
                ...
                <tr><td class="label-col">8. Jumlah Saudara</td><td class="separator">:</td><td class="value-col">{{ $student->siblings_count ?? '0' }} Kandung / {{ $student->step_siblings_count ?? '0' }} Tiri / {{ $student->adoptive_siblings_count ?? '0' }} Angkat</td></tr>
            ...
            <table class="table-induk">
                ...
                <tr><td class="label-col">25. Tempat, Tanggal Lahir</td><td class="separator">:</td><td class="value-col">{{ $student->father_pob ?? '' }}, {{ $student->father_birth_year ? $student->father_birth_year : '' }}</td></tr>
                ...
                <tr><td class="label-col">30. Tempat, Tanggal Lahir</td><td class="separator">:</td><td class="value-col">{{ $student->mother_pob ?? '' }}, {{ $student->mother_birth_year ? $student->mother_birth_year : '' }}</td></tr>
                ...
                <tr><td class="label-col">34. No. Telepon / WA Ortu</td><td class="separator">:</td><td class="value-col">{{ $student->parent_wa_number ?? '-' }}</td></tr>
            ...
            <table class="w-full text-center text-[10px] font-serif mb-6" style="border-collapse: collapse; border: 1.5px solid #000;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid #000; padding: 4px;">{{ $student->getAbsence(7, 1) }}</td>
                        <td style="border: 1px solid #000; padding: 4px;">{{ $student->getAbsence(7, 2) }}</td>
                        <td style="border: 1px solid #000; padding: 4px;">{{ $student->getAbsence(8, 1) }}</td>
                        <td style="border: 1px solid #000; padding: 4px;">{{ $student->getAbsence(8, 2) }}</td>
                        <td style="border: 1px solid #000; padding: 4px;">{{ $student->getAbsence(9, 1) }}</td>
                        <td style="border: 1px solid #000; padding: 4px;">{{ $student->getAbsence(9, 2) }}</td>
                    </tr>
                </tbody>
            </table>
