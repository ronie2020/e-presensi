                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <div class="mt-4 flex items-center gap-3">
                                        @if(isset($record->photo) && $record->photo)
                                            <a href="{{ asset('storage/' . $record->photo) }}" target="_blank" class="inline-flex items-center gap-2 px-4 py-2 bg-slate-800 text-white text-xs font-bold rounded-xl hover:bg-slate-700 transition-all shadow-md">
                                        ...
                                        <div class="flex items-center gap-1.5 text-[10px] font-bold text-slate-400 bg-slate-50 px-3 py-2 rounded-xl">
                                            <i class="ph-bold ph-user"></i> {{ $record->recorder->name ?? 'Admin Sekolah' }}
                                        </div>
                                    </div>
                                </div>
                            </div>
