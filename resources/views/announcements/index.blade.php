<x-app-layout>
    <div class="py-8 sm:py-10 font-sans text-slate-800">
                    ...
                    <div class="flex flex-row md:flex-col lg:flex-row gap-4 w-full md:w-auto">
                        ...
                        <div class="bg-white/10 backdrop-blur-md px-6 py-5 rounded-2xl border border-white/10 flex-1 md:flex-none min-w-[140px] text-center md:text-left hover:bg-white/15 transition-colors">
                            <div class="flex items-center justify-center md:justify-start gap-2 mb-1 text-blue-300">
                                <i class="ph-duotone ph-newspaper-clipping text-lg"></i>
                                <span class="text-[10px] font-bold uppercase tracking-wider">Postingan</span>
                            </div>
                            <span class="block text-3xl font-black text-white tracking-tight">{{ $announcements->count() }}</span>
                        </div>

                        {{-- Stat 2: WA Gateway Status --}}
                        <div class="bg-emerald-500/20 backdrop-blur-md px-6 py-5 rounded-2xl border border-emerald-400/20 flex-1 md:flex-none min-w-[140px] text-center md:text-left hover:bg-emerald-500/30 transition-colors">
                            <div class="flex items-center justify-center md:justify-start gap-2 mb-1 text-emerald-300">
                                <i class="ph-duotone ph-whatsapp-logo text-lg"></i>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @if (session('error'))
                <div x-data="{ show: true }" x-show="show" x-transition class="mb-8 p-4 bg-rose-50 border border-rose-100 text-rose-700 rounded-2xl flex items-center justify-between shadow-sm">
                    <div class="flex items-center gap-3">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden relative group hover:shadow-2xl hover:shadow-blue-900/10 transition-all duration-300">
                        ...
                        <div class="p-8 relative z-10">
                            <div class="flex items-center gap-4 mb-6 pb-4 border-b border-slate-50">
                                ...
                                <div>
                                    <h3 class="text-xl font-black text-slate-800">Pengumuman Website</h3>
                            ...
                            <form action="{{ route('announcements.store') }}" method="POST" class="space-y-6">
                                ...
                                <div class="flex justify-end pt-2">
                                    <button type="submit" class="py-3 px-8 bg-blue-900 text-white font-bold rounded-xl hover:bg-blue-800 transition-all shadow-lg shadow-blue-900/20 text-sm flex items-center gap-2 transform active:scale-95">
                    ...
                    <div class="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden relative group hover:shadow-2xl hover:shadow-purple-900/10 transition-all duration-300">
                        ...
                        <div class="p-8 relative z-10">
                            <div class="flex items-center gap-4 mb-6 pb-4 border-b border-slate-50">
                                <div class="w-14 h-14 bg-purple-50 text-purple-600 rounded-2xl flex items-center justify-center text-3xl shadow-sm border border-purple-100">
                                    <i class="ph-duotone ph-calendar-plus"></i>
                                </div>
                                <div>
                                    <h3 class="text-xl font-black text-slate-800">Agenda Kegiatan</h3>
                            ...
                            <form action="{{ route('agendas.store') }}" method="POST" class="grid grid-cols-1 md:grid-cols-12 gap-5">
                                ...
                                <div class="md:col-span-5">
                                    ...
                                    <input type="text" name="title" class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-purple-600 focus:ring-purple-600 font-bold text-slate-800 py-3 placeholder:font-normal" placeholder="Contoh: Ujian Tengah Semester" required>
                                </div>
                                ...
                                <div class="md:col-span-4">
                                    ...
                                    <div class="flex gap-2">
                                        ...
                                        <button type="submit" class="p-3 bg-purple-600 text-white rounded-2xl hover:bg-purple-700 transition shadow-lg shadow-purple-500/20 active:scale-95 flex-shrink-0">
                            ...
                            <div class="mt-8 pt-6 border-t border-dashed border-slate-200">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    @forelse($agendas as $agenda)
                                        <div class="flex items-center justify-between p-4 rounded-2xl border border-slate-100 bg-white hover:border-purple-200 hover:shadow-lg hover:shadow-purple-500/5 transition-all group">
                                            ...
                                            <form action="{{ route('agendas.destroy', $agenda->id) }}" method="POST">
                                                @csrf @method('DELETE')
                                                <button type="submit" class="w-8 h-8 rounded-xl flex items-center justify-center text-slate-300 hover:text-white hover:bg-rose-500 transition-all" onclick="return confirm('Hapus agenda ini?')" title="Hapus Agenda">
                                                    <i class="ph-bold ph-trash"></i>
                                                </button>
                                            </form>
                                        </div>
                                    @empty
                                        <div class="col-span-2 text-center py-8 border-2 border-dashed border-slate-100 rounded-2xl bg-slate-50/50">
                    ...
                    <div class="rounded-[2.5rem] bg-gradient-to-br from-emerald-600 to-green-700 shadow-xl shadow-emerald-500/30 text-white overflow-hidden relative group border border-emerald-500/20">
                        ...
                        <div class="p-8 relative z-10" x-data="{ target: 'class', message: '' }">
                            <div class="flex items-center gap-4 mb-8 border-b border-emerald-500/30 pb-6">
                                <div class="w-14 h-14 bg-white/10 backdrop-blur-md text-white rounded-2xl flex items-center justify-center text-3xl shadow-inner border border-white/20">
                                    <i class="ph-fill ph-whatsapp-logo"></i>
                                </div>
                                <div>
                                    <h3 class="text-xl font-black text-white">Broadcast WhatsApp</h3>
                                    <p class="text-xs font-bold text-emerald-200 uppercase tracking-wide mt-1">Kirim Pesan Massal</p>
                                </div>
                            </div>

                            <form action="{{ route('announcements.send') }}" method="POST" class="space-y-6">
                                @csrf
                                ...
                                <div class="flex justify-end pt-2">
                                    <button type="submit" onclick="return confirm('Yakin ingin mengirim pesan massal ini?')" class="py-3 px-8 bg-white text-emerald-700 font-black rounded-xl hover:bg-emerald-50 transition-all shadow-lg text-sm flex items-center gap-2 transform active:scale-95">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden h-full flex flex-col sticky top-24 min-h-[600px]">
                                        ...
                                        <div class="pl-11">
                                            ...
                                            <div class="flex items-center justify-between">
                                                ...
                                                <form action="{{ route('announcements.destroy', $announce->id) }}" method="POST">
                                                    @csrf @method('DELETE')
                                                    <button type="submit" class="w-8 h-8 flex items-center justify-center rounded-xl text-slate-300 hover:text-white hover:bg-rose-500 transition-all opacity-0 group-hover:opacity-100" onclick="return confirm('Hapus pengumuman ini?')" title="Hapus Post">
                                                        <i class="ph-bold ph-trash"></i>
                                                    </button>
                                                </form>
                                            </div>
