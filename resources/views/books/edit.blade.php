                                       ...
                                       <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            <label class="flex items-center gap-3 p-4 border border-indigo-200 bg-white rounded-xl cursor-pointer hover:bg-indigo-50 transition mt-2">
                                                <input type="checkbox" name="is_textbook" value="1" {{ old('is_textbook', $book->is_textbook) ? 'checked' : '' }} class="w-5 h-5 text-indigo-600 border-indigo-300 rounded focus:ring-indigo-500">
                                                <div>
