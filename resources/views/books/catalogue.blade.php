    ...
    <div class="bg-gray-900 bg-gradient-to-b from-blue-900 to-slate-900 pt-16 pb-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div class="absolute top-6 left-6 z-20">
            @if(Auth::guard('student')->check())
                ...
                <a href="{{ route('portal.show', Auth::guard('student')->id()) }}?tab=perpustakaan" class="text-blue-200 hover:text-white flex items-center gap-2 text-sm font-bold transition-colors bg-white/10 hover:bg-white/20 px-4 py-2 rounded-full backdrop-blur-sm border border-white/10">
                    <i class="ph-bold ph-arrow-left"></i> Kembali ke Portal
                </a>
            @else
                {{-- Jika Tamu: Kembali ke Beranda --}}
                <a href="{{ url('/') }}" class="text-blue-200 hover:text-white flex items-center gap-2 text-sm font-bold transition-colors">
