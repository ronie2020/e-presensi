            ...
            <div class="bg-white rounded-xl fluent-card overflow-hidden">
                <form action="{{ route('lms.assignments.store') }}" method="POST" id="createAssignmentForm" 
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="col-span-2">
                                    ...
                                    <input type="text" name="title" value="{{ old('title') }}" required class="w-full rounded-xl border-slate-200 bg-slate-50 font-bold text-[#2A3B52] focus:ring-[#5295FF] focus:border-[#5295FF] h-12 px-4 placeholder:font-normal placeholder:text-slate-400 transition-colors" placeholder="Contoh: Ulangan Harian Bab 1">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="datetime-local" name="deadline" value="{{ old('deadline') }}" required class="w-full rounded-xl border-slate-200 bg-slate-50 font-bold text-[#2A3B52] focus:ring-[#5295FF] focus:border-[#5295FF] h-12 px-4 transition-colors">
                                </div>
                            ...
                            <div x-show="assignmentType === 'link'" style="display: none;">
                                <div class="mb-4">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="url" name="link_url" value="{{ old('link_url') }}" class="w-full rounded-xl border-slate-200 bg-white pl-10 font-bold text-[#5295FF] focus:ring-[#5295FF] focus:border-[#5295FF] h-12 transition-colors shadow-sm" placeholder="https://...">
                                    </div>
                                </div>
                                <label class="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-2 ml-1">Instruksi Tambahan</label>
                                <textarea name="description_link" rows="3" class="w-full rounded-xl border-slate-200 bg-white focus:ring-[#D83B01] focus:border-[#D83B01] p-4 font-medium transition-colors shadow-sm" placeholder="Silakan kerjakan link di atas...">{{ old('description_link') }}</textarea>
                            </div>
                            ...
                            <div x-show="assignmentType === 'quiz'" style="display: none;">
                                <div class="mb-6 flex flex-col md:flex-row gap-4">
                                    <div class="flex-1">
                                        ...
                                        <textarea name="description_quiz" rows="2" class="w-full rounded-xl border-slate-200 bg-white focus:ring-purple-500 focus:border-purple-500 p-3 transition-colors shadow-sm" placeholder="Kerjakan dengan jujur...">{{ old('description_quiz') }}</textarea>
                                    </div>
                                    <div class="w-full md:w-1/3">
                                        ...
                                        <div class="relative">
                                            <input type="number" name="duration_minutes" value="{{ old('duration_minutes', 60) }}" class="w-full rounded-xl border-slate-200 bg-white font-bold text-[#2A3B52] focus:ring-purple-500 focus:border-purple-500 h-11 pl-4 pr-10 transition-colors shadow-sm">
                    ...
                    <div class="bg-slate-50 px-8 py-6 flex justify-end gap-3 border-t border-slate-100">
                        <a href="{{ route('lms.assignments.index') }}" class="px-6 py-3 bg-white border border-slate-200 text-slate-600 font-bold rounded-xl hover:bg-slate-100 transition text-center text-sm shadow-sm btn-cancel-confirm active:scale-95">Batal</a>
