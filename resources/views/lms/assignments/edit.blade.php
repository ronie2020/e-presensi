                    ...
                    <div class="p-8 space-y-8">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="col-span-2">
                                    ...
                                    <input type="text" name="title" value="{{ old('title', $assignment->title) }}" required class="w-full rounded-xl border-slate-200 bg-slate-50 font-bold text-slate-800 focus:ring-orange-500 focus:border-orange-500 h-12 px-4 transition-colors">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="datetime-local" name="deadline" value="{{ old('deadline', $assignment->deadline->format('Y-m-d\TH:i')) }}" required class="w-full rounded-xl border-slate-200 bg-slate-50 font-bold text-slate-800 focus:ring-orange-500 focus:border-orange-500 h-12 px-4 transition-colors">
                                </div>
                        ...
                        <div class="bg-slate-50 rounded-3xl p-6 border border-slate-100">
                            ...
                            <div x-show="assignmentType === 'file_upload'">
                                ...
                                <textarea name="description" rows="5" class="w-full rounded-2xl border-slate-200 bg-white focus:ring-orange-500 focus:border-orange-500 p-4 text-slate-700 font-medium transition-colors">{{ old('description', $assignment->description) }}</textarea>
                            </div>
                            ...
                            <div x-show="assignmentType === 'link'">
                                <div class="mb-4">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="url" name="link_url" value="{{ old('link_url', $assignment->link_url) }}" class="w-full rounded-xl border-slate-200 bg-white pl-10 font-bold text-blue-600 focus:ring-orange-500 h-12 transition-colors">
                                    </div>
                                </div>
                                <label class="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-2 ml-1">Instruksi Tambahan</label>
                                <textarea name="description" rows="3" class="w-full rounded-2xl border-slate-200 bg-white focus:ring-orange-500 p-4 font-medium transition-colors">{{ old('description', $assignment->description) }}</textarea>
                            </div>
                            ...
                            <div x-show="assignmentType === 'quiz'">
                                <div class="mb-6 flex flex-col md:flex-row gap-4">
                                    <div class="flex-1">
                                        ...
                                        <textarea name="description" rows="2" class="w-full rounded-xl border-slate-200 bg-white focus:ring-purple-500 p-3 transition-colors">{{ old('description', $assignment->description) }}</textarea>
                                    </div>
                                    <div class="w-full md:w-1/3">
                                        ...
                                        <div class="relative">
                                            <input type="number" name="duration_minutes" value="{{ old('duration_minutes', $assignment->duration_minutes) }}" class="w-full rounded-xl border-slate-200 bg-white font-bold text-slate-800 focus:ring-purple-500 h-11 pl-4 pr-10 transition-colors">
