            ...
            @if($materials->count() > 0)
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    @foreach($materials as $index => $material)
                        ...
                        {{-- START CARD --}}
                        <div class="animate-enter group relative bg-white border border-slate-100 rounded-[2rem] p-1.5 shadow-sm hover:shadow-2xl hover:shadow-slate-200/50 transition-all duration-300 flex flex-col h-full hover:-translate-y-1 hover:border-transparent hover:ring-2 {{ $theme['ring'] }}" style="animation-delay: {{ ($index + 1) * 100 }}ms">
                            ...
                            <div class="bg-white rounded-[1.7rem] p-6 h-full flex flex-col relative overflow-hidden">
                                ...
                                <div class="mb-4 relative z-10">
                                    <h3 class="font-bold text-lg text-slate-800 group-hover:text-blue-700 transition-colors line-clamp-2 leading-snug min-h-[3rem]" title="{{ $material->title }}">
                                        {{ $material->title }}
                                    </h3>
                                    
                                    {{-- Badge Mata Pelajaran & Kelas --}}
                                    <div class="flex flex-wrap gap-2 mt-3">
                                        <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg text-xs font-bold border {{ $theme['bg'] }} {{ $theme['text'] }} {{ $theme['border'] }}">
                                ...
                                <div class="pt-4 border-t border-slate-100 mt-auto flex items-center justify-between relative z-10">
                                    ...
                                    <div class="flex items-center gap-2">
                                        {{-- Tombol Buka --}}
                                        <a href="{{ $finalUrl }}" target="{{ $targetAttr }}" class="w-10 h-10 rounded-xl {{ $theme['bg'] }} {{ $theme['text'] }} hover:bg-slate-800 hover:text-white hover:shadow-lg transition-all flex items-center justify-center active:scale-95 border {{ $theme['border'] }} hover:border-slate-800" title="Buka / Download">
                                        ...
                                        <a href="{{ route('lms.materials.edit', $material->id) }}" class="w-10 h-10 rounded-xl bg-white text-amber-500 hover:bg-amber-500 hover:text-white hover:shadow-lg hover:shadow-amber-200 transition-all flex items-center justify-center active:scale-95 border border-amber-100 hover:border-amber-500" title="Edit Materi">
