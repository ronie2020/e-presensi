        ...
        <div class="space-y-8">
            ...
            <div class="animate-enter relative rounded-[3rem] bg-elevate-gradient-main p-8 md:p-12 mb-8 text-elevate-dark shadow-xl shadow-elevate-accent/10 overflow-hidden border border-white/60">
                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
                    <div class="max-w-2xl">                        
                        <a href="{{ route('portal.show', Auth::guard('student')->id()) }}" class="inline-flex items-center gap-2 text-slate-500 hover:text-elevate-primary transition-colors mb-6 text-[10px] font-black uppercase tracking-[0.2em]">
                    ...
                    <a href="{{ route('student.complaints.create') }}" class="group bg-elevate-dark text-white px-8 py-4 rounded-[1.5rem] font-black shadow-xl shadow-elevate-dark/20 hover:bg-elevate-primary transition-all flex items-center gap-3 shrink-0 active:scale-95 text-xs uppercase tracking-widest">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 animate-enter" style="animation-delay: 100ms">
                ...
                <div class="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm flex items-center gap-5 group hover:border-amber-200 transition-all">
                    ...
                    <div>
                        ...
                        <p class="text-3xl font-black text-elevate-dark tracking-tight">{{ $complaints->where('status', 'pending')->count() }}</p>
                    </div>
                </div>
                                ...
                                <div class="flex gap-6">
                                    ...
                                    <div class="flex-1">
                                        <div class="flex flex-wrap items-center gap-3 mb-2">
                                            <span class="text-sm font-black text-elevate-dark uppercase tracking-tight">{{ $item->category }}</span>
