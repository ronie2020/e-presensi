...
<x-app-layout>
    ...
    <div class="py-6 sm:py-8" x-data="{ 
        ...
        <div class="mb-8 flex flex-col justify-between gap-6 no-print">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 class="text-3xl font-black text-gray-800 tracking-tight leading-tight">Rekap Absensi Siswa</h1>
                    <p class="text-gray-500 mt-1">
                        Laporan kehadiran siswa berdasarkan periode yang dipilih.
                    </p>
                </div>
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                ...
                {{-- Form Filter --}}
                <form action="{{ route('reports.daily') }}" method="GET" class="flex flex-col sm:flex-row items-end gap-4">
                    {{-- Hidden input untuk menyimpan tipe laporan & tab aktif --}}
                    ...
                    {{-- Tombol Submit --}}
                    <button type="submit" class="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 px-6 rounded-xl transition-all shadow-md flex items-center justify-center gap-2">
    ...
    <div class="hidden print-only mt-8 text-right">
        ...
        <p class="text-xs text-black">Tanda Tangan Pengawas</p>
    </div>
    ...
    <div id="editAttendanceModal" class="fixed inset-0 bg-gray-900/60 backdrop-blur-sm hidden flex items-center justify-center p-4 z-50 transition-opacity no-print">
