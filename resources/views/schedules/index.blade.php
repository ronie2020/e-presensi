<x-app-layout>
    <div class="py-8 sm:py-10 font-sans text-slate-800">
        ...
        {{-- HERO SECTION (IDENTIK DENGAN DASHBOARD) --}}
                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
                    ...
                    <div class="flex flex-row md:flex-col lg:flex-row gap-4 w-full md:w-auto">
                        <div class="bg-white/10 backdrop-blur-md px-6 py-5 rounded-2xl border border-white/10 flex-1 md:flex-none min-w-[140px] text-center md:text-left hover:bg-white/15 transition-colors">
                            ...
                            <span class="block text-3xl font-black text-white tracking-tight">{{ $specialSchedules->count() }}</span>
                        </div>
                    </div>
                                        ...
                                        <tr class="hover:bg-slate-50 transition-colors group">
                                            <td class="px-6 py-5 whitespace-nowrap">
                                                <div class="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        <p class="font-black text-slate-800 text-sm">{{ \Carbon\Carbon::parse($schedule->date)->translatedFormat('d M Y') }}</p>
                                                        <p class="text-xs text-slate-400 font-bold uppercase tracking-wide">{{ \Carbon\Carbon::parse($schedule->date)->translatedFormat('l') }}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-6 py-5">
                                                <p class="text-sm font-bold text-slate-700 leading-snug">{{ $schedule->description }}</p>
