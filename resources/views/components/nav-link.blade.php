...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-cyan-500 text-sm font-bold leading-5 text-slate-800 focus:outline-none focus:border-cyan-600 transition duration-150 ease-in-out'
