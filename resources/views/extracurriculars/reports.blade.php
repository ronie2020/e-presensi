                ...
                <div class="p-8 border-b border-slate-50 bg-slate-50/50">
                    <form method="GET" action="{{ route('extracurriculars.reports') }}" class="grid grid-cols-1 md:grid-cols-12 gap-6 items-end">
                        ...
                        <div class="md:col-span-3">
                            ...
                            <input type="date" name="start_date" value="{{ $startDate }}" class="w-full rounded-2xl border-slate-200 bg-white focus:border-elevate-primary focus:ring-elevate-primary text-sm py-3.5 px-4 font-bold text-elevate-dark transition-all shadow-sm">
                        </div>

                        <div class="md:col-span-3">
                            <label class="block text-xs font-black text-slate-400 uppercase tracking-widest mb-2 ml-1">Sampai Tanggal</label>
                            <input type="date" name="end_date" value="{{ $endDate }}" class="w-full rounded-2xl border-slate-200 bg-white focus:border-elevate-primary focus:ring-elevate-primary text-sm py-3.5 px-4 font-bold text-elevate-dark transition-all shadow-sm">
                        </div>
                    ...
                    @else
                        <div class="mt-6 flex justify-end">
                            <a href="{{ route('extracurriculars.reports.export', request()->query()) }}" target="_blank" class="inline-flex items-center gap-2 px-6 py-3.5 bg-emerald-50 text-emerald-600 border border-emerald-200 rounded-2xl font-bold text-sm hover:bg-emerald-600 hover:text-white transition-all shadow-sm active:scale-95">
                                ...
                                <tr class="hover:bg-slate-50/80 transition-colors group">
                                    <td class="px-8 py-5">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                <div class="font-black text-elevate-dark text-sm group-hover:text-elevate-primary transition-colors">{{ $log->student->name }}</div>
                                    ...
                                    <td class="px-8 py-5">
                                        <div class="flex flex-col gap-2">
                                            ...
                                            <div class="flex items-center gap-3 text-xs font-bold text-slate-500">
                                                ...
                                                <span class="flex items-center gap-1.5 text-elevate-primary"><i class="ph-bold ph-clock"></i> {{ $log->time_in }} WIB</span>
                                            </div>
                                        </div>
                                    </td>
