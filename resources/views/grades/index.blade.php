    ...
    <div class="py-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                {{-- CARD 1: INPUT NILAI --}}
                <div class="bg-white rounded-[2rem] shadow-xl shadow-violet-500/5 border border-slate-100 overflow-hidden relative group hover:shadow-2xl transition-all duration-300">
                        ...
                        <form action="{{ route('grades.create') }}" method="GET">
                            <div class="space-y-4">
                                <div class="bg-slate-50 p-4 rounded-xl border border-slate-100">
                                    ...
                                    <select name="class_id" class="w-full rounded-lg border-slate-200 text-sm font-bold text-slate-700 focus:ring-violet-500" required>
                                ...
                                <div class="bg-slate-50 p-4 rounded-xl border border-slate-100">
                                    ...
                                    <select name="subject_id" class="w-full rounded-lg border-slate-200 text-sm font-bold text-slate-700 focus:ring-violet-500" required>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <select name="academic_year" class="w-full rounded-lg border-slate-200 text-xs font-bold">
                                    ...
                                    <div>
                                        ...
                                        <select name="semester" class="w-full rounded-lg border-slate-200 text-xs font-bold">
                            ...
                            <button type="submit" class="w-full mt-6 py-3 bg-violet-600 text-white font-bold rounded-xl hover:bg-violet-700 transition flex items-center justify-center gap-2">
                ...
                {{-- CARD 2: CETAK RAPOR --}}
                <div class="bg-white rounded-[2rem] shadow-xl shadow-blue-500/5 border border-slate-100 overflow-hidden relative group hover:shadow-2xl transition-all duration-300">
                    ...
                    <div class="p-8">
                        ...
                        <form action="{{ route('grades.list') }}" method="GET">
                            <div class="space-y-4">
                                <div class="bg-slate-50 p-4 rounded-xl border border-slate-100">
                                    <label class="text-xs font-bold text-slate-400 uppercase mb-2 block">Kelas</label>
                                    <select name="class_id" class="w-full rounded-lg border-slate-200 text-sm font-bold text-slate-700 focus:ring-blue-500" required>
                                        <option value="">-- Pilih Kelas --</option>
                                        @foreach($classes as $c) <option value="{{ $c->id }}">{{ $c->name }}</option> @endforeach
                                    </select>
                                </div>
                                
                                {{-- Spacer agar tinggi sama --}}
                                <div class="h-[86px] flex items-center justify-center text-slate-300 italic text-sm bg-slate-50/50 rounded-xl border border-dashed border-slate-200">
                            ...
                            <button type="submit" class="w-full mt-6 py-3 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 transition flex items-center justify-center gap-2">
