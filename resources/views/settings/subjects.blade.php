                                ...
                                <tbody class="divide-y divide-slate-50">
                                    @forelse($subjects as $subject)
                                        <tr class="hover:bg-elevate-soft/30 transition-colors group"
                                            ...
                                            <td class="px-6 py-5">
                                                <div class="font-bold text-elevate-dark text-base mb-0.5">{{ $subject->name }}</div>
                                                @if($subject->code)
                                                    <span class="text-[10px] font-mono font-bold text-elevate-dark/60 bg-elevate-soft px-1.5 py-0.5 rounded border border-slate-200 shadow-sm">{{ $subject->code }}</span>
                                                @endif
                                            </td>
