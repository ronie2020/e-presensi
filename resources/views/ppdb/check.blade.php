...
<script>
    // FIX C2: Gunakan format ISO 8601 dengan timezone offset (+07:00) agar countdown
    // tidak bergantung pada timezone lokal browser, sehingga konsisten di semua perangkat.
    const targetDateStr = "{{ $announcementDate->format('Y-m-d\TH:i:sP') }}";
