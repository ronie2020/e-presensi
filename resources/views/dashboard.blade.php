<x-app-layout>
    ...
    <div x-data="{ 
        ...
        <div x-show="loading" 
         ...
         {{-- HERO SECTION (Diselaraskan ke Tema Utama Netila Elevate - Cyan ke Biru) --}}
            ...
            <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
                <div>
                    ...
                    <h1 class="text-2xl md:text-5xl font-extrabold text-white tracking-tight mb-3">
                        Halo, <span class="text-transparent bg-clip-text bg-gradient-to-r from-white to-cyan-200">{{ Auth::user()->name ?? 'Administrator' }}</span> 
                    </h1>
                ...
                <div class="flex flex-col gap-3 w-full md:w-auto md:min-w-[320px] filter-group no-print">
                    ...
                    <div class="bg-blue-950/40 backdrop-blur-md p-1.5 rounded-xl flex border border-white/20 shadow-lg overflow-x-auto">
                        ...
                        <a href="{{ route('reports.printDaily', ['date' => request('date')]) }}" target="_blank" class="ml-2 bg-white/10 text-white p-2.5 rounded-lg hover:bg-white/20 hover:scale-105 active:scale-95 transition-all shadow-sm border border-white/20 shrink-0 flex items-center gap-2" title="Cetak Laporan Harian">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 mb-8 no-print animate-enter quick-actions" style="animation-delay: 100ms">
            ...
            {{-- 2. Tombol Kebiasaan --}}
             <a href="{{ route('teacher.habits.index') }}" @click.prevent="navigate('{{ route('teacher.habits.index') }}')" class="group bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex flex-col items-center justify-center gap-2 hover:shadow-md transition-all hover:border-emerald-200 cursor-pointer text-center">
            ...
            {{-- 3. Tombol Ujian CBT --}}
            <a href="{{ route('cbt.index') }}" @click.prevent="navigate('{{ route('cbt.index') }}')" class="group bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex flex-col items-center justify-center gap-2 hover:shadow-md transition-all hover:border-purple-200 cursor-pointer text-center">
            ...
            {{-- 4. Tombol Tugas & PR --}}
            <a href="{{ route('lms.assignments.index') }}" @click.prevent="navigate('{{ route('lms.assignments.index') }}')" class="group bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex flex-col items-center justify-center gap-2 hover:shadow-md transition-all hover:border-rose-200 cursor-pointer text-center">
            ...
            {{-- 5. Tombol Rekap Nilai --}}
            <a href="{{ route('lms.grades.index') }}" @click.prevent="navigate('{{ route('lms.grades.index') }}')" class="group bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex flex-col items-center justify-center gap-2 hover:shadow-md transition-all hover:border-emerald-200 cursor-pointer text-center">
                <div class="w-12 h-12 rounded-xl bg-emerald-50 text-emerald-600 flex items-center justify-center group-hover:scale-110 transition-transform shadow-sm">
            ...
            {{-- 6. Tombol Laporan Kelas --}}
            <a href="{{ route('reports.class') }}" @click.prevent="navigate('{{ route('reports.class') }}')" class="group bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex flex-col items-center justify-center gap-2 hover:shadow-md transition-all hover:border-amber-200 cursor-pointer text-center">
            ...
            {{-- 7. Tombol SKL --}}
            <a href="{{ route('admin.graduation.index') }}" @click.prevent="navigate('{{ route('admin.graduation.index') }}')" class="group bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex flex-col items-center justify-center gap-2 hover:shadow-md transition-all hover:border-rose-200 cursor-pointer text-center">
                <div class="w-12 h-12 rounded-xl bg-rose-50 text-rose-600 flex items-center justify-center group-hover:scale-110 transition-transform shadow-sm">
            ...
            {{-- 8. Tombol PPDB --}}
            <a href="{{ route('admin.ppdb.index') }}" @click.prevent="navigate('{{ route('admin.ppdb.index') }}')" class="group bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex flex-col items-center justify-center gap-2 hover:shadow-md transition-all hover:border-amber-200 cursor-pointer text-center">
                <div class="w-12 h-12 rounded-xl bg-amber-50 text-amber-600 flex items-center justify-center group-hover:scale-110 transition-transform shadow-sm">
            ...
            <a href="{{ route('library.dashboard') }}" @click.prevent="navigate('{{ route('library.dashboard') }}')" class="group bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex flex-col items-center justify-center gap-2 hover:shadow-md transition-all hover:border-purple-200 cursor-pointer text-center">
                <div class="w-12 h-12 rounded-xl bg-purple-50 text-purple-600 flex items-center justify-center group-hover:scale-110 transition-transform shadow-sm">
            ...
            {{-- 11. Tombol Atur Jadwal --}}
            <a href="{{ route('schedules.index') }}" @click.prevent="navigate('{{ route('schedules.index') }}')" class="group bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex flex-col items-center justify-center gap-2 hover:shadow-md transition-all hover:border-emerald-200 cursor-pointer text-center">
                <div class="w-12 h-12 rounded-xl bg-emerald-50 text-emerald-600 flex items-center justify-center group-hover:scale-110 transition-transform shadow-sm">
            ...
            <a href="{{ route('discipline.index') }}" @click.prevent="navigate('{{ route('discipline.index') }}')" class="group bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex flex-col items-center justify-center gap-2 hover:shadow-md transition-all hover:border-rose-200 cursor-pointer text-center">
                <div class="w-12 h-12 rounded-xl bg-rose-50 text-rose-600 flex items-center justify-center group-hover:scale-110 transition-transform shadow-sm">
            ...
            {{-- 14. Tombol Ramadhan --}}
            <a href="{{ route('admin.ramadan.reports') }}" @click.prevent="navigate('{{ route('admin.ramadan.reports') }}')" class="group bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex flex-col items-center justify-center gap-2 hover:shadow-md transition-all hover:border-emerald-200 cursor-pointer text-center">
                <div class="w-12 h-12 rounded-xl bg-emerald-50 text-emerald-600 flex items-center justify-center group-hover:scale-110 transition-transform shadow-sm">
            ...
            {{-- 15. Tombol Ekstrakurikuler --}}
            <a href="{{ route('extracurriculars.reports') }}" @click.prevent="navigate('{{ route('extracurriculars.reports') }}')" class="group bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex flex-col items-center justify-center gap-2 hover:shadow-md transition-all hover:border-amber-200 cursor-pointer text-center">
                <div class="w-12 h-12 rounded-xl bg-amber-50 text-amber-600 flex items-center justify-center group-hover:scale-110 transition-transform shadow-sm">
