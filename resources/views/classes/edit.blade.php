    ...
    <div class="py-12 font-sans text-slate-800">
        <div class="max-w-lg mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8 flex items-center justify-between">
                ...
                <a href="{{ route('classes.index') }}" class="group flex items-center gap-2 bg-white px-4 py-2 rounded-2xl shadow-sm border border-slate-200 hover:border-blue-200 hover:shadow-md transition-all">
                ...
                <div class="p-8 sm:p-10">
                    ...
                    <div class="flex items-start gap-4 mb-8 p-5 bg-blue-50/50 rounded-3xl border border-blue-100">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-500 font-medium leading-relaxed mt-1">Ubah nama atau wali kelas untuk rombel <strong class="text-blue-700 bg-blue-100 px-1.5 py-0.5 rounded">{{ $class->name }}</strong>.</p>
                        </div>
                    </div>
