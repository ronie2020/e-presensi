            ...
            <div class="bg-gradient-to-b from-[#031d3d]/90 via-[#021124]/95 to-[#020b18] rounded-[2.5rem] shadow-2xl border border-white/10 overflow-hidden relative">
                ...
                <div class="bg-gradient-to-r from-[#031d3d] via-[#0b2545] to-[#134074] p-8 text-white relative overflow-hidden border-b border-white/10">
                    ...
                    <h2 class="text-2xl font-black relative z-10 flex items-center gap-3">
                        <i class="ph-duotone ph-pencil-simple-slash text-[#56bbf1]"></i> Perbarui Surat Keluar
                    </h2>
                    <p class="text-slate-300 text-sm font-medium relative z-10 mt-1">
                        Edit informasi surat keluar: <span class="text-[#56bbf1] font-mono bg-[#56bbf1]/10 px-2 rounded font-bold">#{{ $letter->nomor_agenda }}</span>
                    </p>
                </div>
                        ...
                        <div class="p-6 bg-white/[0.03] rounded-[2rem] border border-white/10 relative group hover:border-[#56bbf1]/30 transition-colors">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="tujuan_surat" value="{{ old('tujuan_surat', $letter->tujuan_surat) }}" required class="w-full px-4 py-3 rounded-2xl border border-white/10 bg-slate-900/60 focus:border-[#56bbf1] focus:ring-1 focus:ring-[#56bbf1] text-sm font-bold text-white transition-all">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 bg-white/[0.03] rounded-[2rem] border border-white/10 relative group hover:border-[#56bbf1]/30 transition-colors">
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <p class="text-[10px] text-slate-400 mt-2 ml-1 flex items-center gap-1 font-medium"><i class="ph-fill ph-info text-[#56bbf1]"></i> PDF / JPG / PNG (Max 2MB).</p>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        @if ($errors->any())
            Swal.fire({
                ...
                html: '<div class="text-left"><ul class="list-disc list-inside text-sm text-slate-300">@foreach($errors->all() as $e)<li>{{$e}}</li>@endforeach</ul></div>',
