    ...
    <table class="kop-surat text-center">
        <tr>
            ...
            <td width="70%">
                ...
                <div class="kop-sekolah">{{ config('school.name', 'NAMA SEKOLAH') }}</div>
                <div class="kop-alamat">{{ config('school.address', 'Alamat Sekolah Lengkap, Kabupaten/Kota, Provinsi') }}</div>
                <div class="kop-alamat">Website: {{ config('school.website', 'www.sekolah.sch.id') }} | Email: {{ config('school.email', 'info@sekolah.sch.id') }}</div>
            </td>
            <!-- Logo Kanan -->
            <td width="15%">
