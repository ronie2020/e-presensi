                            ...
                            <tr class="group hover:bg-elevate-soft/30 transition-colors">
                                <td class="px-8 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="font-bold text-sm text-elevate-dark">{{ optional($loan->student)->name ?? 'Siswa Terhapus' }}</p>
                                            <p class="text-xs text-elevate-dark/60 font-mono">{{ optional($loan->student)->student_id ?? '-' }}</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-8 py-4">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm font-medium text-elevate-dark/80 truncate max-w-[200px] block" title="{{ optional($loan->book)->title }}">
